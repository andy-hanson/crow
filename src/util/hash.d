...
ulong[2] murmurStep(ulong[2] h, ulong k1, ulong k2) {
	ulong h1 = h[0];
	ulong h2 = h[1];
...
ulong[2] murmurStepTail(ulong[2] h, in ubyte[] tail) {
...
private ulong c1() => 0x87c37b91114253d5;
private ulong c2() => 0x4cf5ad432745937f;

HashCode murmurFinish(ulong[2] h) {
	ulong h1 = h[0];
	ulong h2 = h[1];
