...
void testApplyFn(Alloc)(ref Test!Alloc test) {
	...
	testFn(test, [immutable Nat64(1)], FnOp.not, [immutable Nat64(0)]);
	testFn(test, [immutable Nat64(0)], FnOp.not, [immutable Nat64(1)]);
...
@trusted void testCompareExchangeStrong(Alloc)(ref Test!Alloc test) {
	bool b0 = false;
	bool b1 = false;
