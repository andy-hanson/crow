...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	r0 = (temp0 = (struct my_record*) alloc(ctx, sizeof(struct my_record)), ((*(temp0) = (struct my_record) {(struct arr_0) {1, constantarr_0_13}, (struct arr_0) {1, constantarr_0_14}}, 0), temp0));
	foo(ctx, r0);
	print_sync(r0->a);
	print_sync(r0->b);
...
int64_t literal_2(struct ctx* ctx, struct arr_0 s) {
	...
	uint64_t n1;
	fst0 = at_2(ctx, s, 0);
	if (_op_equal_equal_1(fst0, literal_0((struct arr_0) {1, constantarr_0_15}))) {
		n1 = literal_3(ctx, tail_1(ctx, s));
		return neg_0(ctx, n1);
	} else {
		if (_op_equal_equal_1(fst0, literal_0((struct arr_0) {1, constantarr_0_26}))) {
