...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	r0 = (temp0 = (struct my_record*) alloc(ctx, sizeof(struct my_record)), ((*(temp0) = (struct my_record) {(struct arr_0) {1, constantarr_0_12}, (struct arr_0) {1, constantarr_0_13}}, (struct void_) {}), temp0));
	foo(ctx, r0);
	print(r0->a);
	print(r0->b);
