...
struct void_ mark_visit_260(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_261(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_262(struct mark_ctx* mark_ctx, struct opt_1 value);
struct void_ mark_visit_263(struct mark_ctx* mark_ctx, struct some_1 value);
struct void_ mark_visit_264(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_265(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_266(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_267(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_268(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
