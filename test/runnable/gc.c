...
struct void_ mark_visit_265(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_266(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_267(struct mark_ctx* mark_ctx, struct opt_1 value);
struct void_ mark_visit_268(struct mark_ctx* mark_ctx, struct some_1 value);
struct void_ mark_visit_269(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_270(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_271(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_272(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_273(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_274(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_275(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_276(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_277(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_278(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_279(struct mark_ctx* mark_ctx, struct fut_callback_node_0 value);
struct void_ mark_visit_280(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_281(struct mark_ctx* mark_ctx, struct forward_to__lambda0 value);
struct void_ mark_visit_282(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_283(struct mark_ctx* mark_ctx, struct forward_to__lambda0* value);
struct void_ mark_visit_284(struct mark_ctx* mark_ctx, struct fut_callback_node_0* value);
struct void_ mark_visit_285(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_arr_286(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_287(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0__lambda0* value);
struct void_ mark_visit_288(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0 value);
struct void_ mark_visit_289(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0* value);
struct void_ mark_visit_290(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda0 value);
struct void_ mark_visit_291(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda0* value);
struct void_ mark_visit_292(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0 value);
struct void_ mark_visit_293(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0* value);
struct void_ mark_visit_294(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_295(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_296(struct mark_ctx* mark_ctx, struct mut_arr value);
struct void_ mark_arr_297(struct mark_ctx* mark_ctx, struct arr_2 a);
