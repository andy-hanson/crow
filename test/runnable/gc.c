...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	*_14 = _18;
	...
	assert_0(_25, _32);
	struct ctx* _33 = ctx;
	struct arr_0 _34 = (struct arr_0) {7, constantarr_0_12};
	struct ctx* _35 = ctx;
	struct gc* _36 = gc0;
	struct gc_stats _37 = get_stats(_36);
	struct arr_0 _38 = to_str_1(_35, _37);
	struct arr_0 _39 = _op_plus_1(_33, _34, _38);
	print(_39);
	struct ctx* _40 = ctx;
	struct arr_0 _41 = (struct arr_0) {10, constantarr_0_26};
	struct ctx* _42 = ctx;
	struct gc* _43 = gc0;
	uint64_t _44 = _43->gc_count;
	struct arr_0 _45 = to_str_2(_42, _44);
	struct arr_0 _46 = _op_plus_1(_40, _41, _45);
	print(_46);
	struct ctx* _47 = ctx;
	struct arr_0 _48 = (struct arr_0) {3, constantarr_0_27};
	struct ctx* _49 = ctx;
	struct r* _50 = a1;
	struct arr_0 _51 = to_str_3(_49, _50);
	struct arr_0 _52 = _op_plus_1(_47, _48, _51);
	print(_52);
	struct ctx* _53 = ctx;
	struct arr_0 _54 = (struct arr_0) {21, constantarr_0_31};
	struct ctx* _55 = ctx;
	struct gc* _56 = gc0;
	struct gc_stats _57 = get_stats(_56);
	struct arr_0 _58 = to_str_1(_55, _57);
	struct arr_0 _59 = _op_plus_1(_53, _54, _58);
	print(_59);
	struct ctx* _60 = ctx;
	struct gc* _61 = gc0;
...
struct gc_stats get_stats(struct gc* gc) {
	...
	total_words2 = _op_minus_3(_12, _14);
...
struct arr_0 to_str_3(struct ctx* ctx, struct r* a) {
	...
	struct ctx* _3 = ctx;
	struct ctx* _4 = ctx;
	struct arr_0 _5 = (struct arr_0) {2, constantarr_0_28};
	struct ctx* _6 = ctx;
	struct r* _7 = a;
	uint64_t _8 = _7->a;
	struct arr_0 _9 = to_str_2(_6, _8);
	struct arr_0 _10 = _op_plus_1(_4, _5, _9);
	struct arr_0 _11 = (struct arr_0) {4, constantarr_0_29};
	...
	struct arr_0 _18 = (struct arr_0) {4, constantarr_0_30};
...
struct fut_0* main_0__lambda0(struct ctx* ctx, struct main_0__lambda0* _closure, struct void_ v) {
	struct arr_0 _0 = (struct arr_0) {14, constantarr_0_32};
	print(_0);
	struct ctx* _1 = ctx;
	struct arr_0 _2 = (struct arr_0) {7, constantarr_0_12};
	struct ctx* _3 = ctx;
	struct main_0__lambda0* _4 = _closure;
	struct gc* _5 = _4->gc;
	struct gc_stats _6 = get_stats(_5);
	struct arr_0 _7 = to_str_1(_3, _6);
	struct arr_0 _8 = _op_plus_1(_1, _2, _7);
	print(_8);
	struct ctx* _9 = ctx;
	struct arr_0 _10 = (struct arr_0) {10, constantarr_0_26};
	struct ctx* _11 = ctx;
	struct main_0__lambda0* _12 = _closure;
	struct gc* _13 = _12->gc;
	uint64_t _14 = _13->gc_count;
	struct arr_0 _15 = to_str_2(_11, _14);
	struct arr_0 _16 = _op_plus_1(_9, _10, _15);
	print(_16);
	struct ctx* _17 = ctx;
	struct arr_0 _18 = (struct arr_0) {3, constantarr_0_27};
	struct ctx* _19 = ctx;
	struct main_0__lambda0* _20 = _closure;
	struct r* _21 = _20->a;
	struct arr_0 _22 = to_str_3(_19, _21);
	struct arr_0 _23 = _op_plus_1(_17, _18, _22);
	print(_23);
	struct ctx* _24 = ctx;
	struct arr_0 _25 = (struct arr_0) {21, constantarr_0_31};
	struct ctx* _26 = ctx;
	struct main_0__lambda0* _27 = _closure;
	struct gc* _28 = _27->gc;
	struct gc_stats _29 = get_stats(_28);
	struct arr_0 _30 = to_str_1(_26, _29);
	struct arr_0 _31 = _op_plus_1(_24, _25, _30);
	print(_31);
	struct ctx* _32 = ctx;
	int32_t _33 = 0;
