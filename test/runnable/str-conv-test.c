...
typedef int64_t (*fun_ptr3_6)(struct ctx*, uint8_t*, uint64_t);
typedef char (*fun_ptr3_7)(struct ctx*, uint8_t*, uint64_t);
struct fut_0;
struct lock {
...
struct comparison compare_222(struct opt_9 a, struct opt_9 b);
struct comparison compare_223(struct none a, struct none b);
struct comparison compare_224(struct some_9 a, struct some_9 b);
...
struct comparison compare_237(struct opt_10 a, struct opt_10 b);
struct comparison compare_238(struct some_10 a, struct some_10 b);
...
int64_t call_with_ctx_9(struct ctx* c, struct fun_mut1_6 f, uint64_t p0);
...
char call_11(struct ctx* ctx, struct fun_mut1_7 f, uint64_t p0);
char call_with_ctx_10(struct ctx* c, struct fun_mut1_7 f, uint64_t p0);
...
struct gc new_gc(void) {
	...
	return (struct gc) {new_lock(), (struct opt_1) {0, .as0 = (struct none) {0}}, 0, 0, 16777216u, mark_begin0, mark_begin0, mark_end1, data_begin2, data_begin2, data_end3};
}
struct mut_bag new_mut_bag(void) {
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	print_sync(to_str_2(ctx, parse_nat(ctx, (struct arr_0) {1, constantarr_0_12})));
	return resolved_1(ctx, 0);
}
uint8_t _op_equal_equal_4(struct opt_9 a, struct opt_9 b) {
	struct comparison temp0;
	temp0 = compare_222(a, b);
	switch (temp0.kind) {
		case 0:
			return 0;
		case 1:
...
struct comparison compare_238(struct some_10 a, struct some_10 b) {
	struct comparison temp0;
	temp0 = compare_43(a.value, b.value);
	switch (temp0.kind) {
		case 0:
			return (struct comparison) {0, .as0 = (struct less) {0}};
		case 1:
...
struct opt_10 parse_int(struct ctx* ctx, struct arr_0 a) {
	if (_op_equal_equal_1(at_2(ctx, a, 0u), 45u)) {
		return opt_map(ctx, parse_nat(ctx, tail_1(ctx, a)), (struct fun_mut1_6) {(fun_ptr3_6) parse_int__lambda0, (uint8_t*) NULL});
	} else {
		return opt_map(ctx, parse_nat(ctx, (_op_equal_equal_1(at_2(ctx, a, 0u), 43u) ? tail_1(ctx, a) : a)), (struct fun_mut1_6) {(fun_ptr3_6) parse_int__lambda1, (uint8_t*) NULL});
	}
}
struct opt_10 opt_map(struct ctx* ctx, struct opt_9 a, struct fun_mut1_6 cb) {
	struct opt_9 temp0;
	...
	switch (temp0.kind) {
		...
		case 1:
			s0 = temp0.as1;
			return (struct opt_10) {1, .as1 = (struct some_10) {call_10(ctx, cb, s0.value)}};
		default:
...
struct arr_0 _op_plus_1(struct ctx* ctx, struct arr_0 a, struct arr_0 b) {
	...
	return make_arr_1(ctx, _op_plus_0(ctx, a.size, b.size), (struct fun_mut1_7) {(fun_ptr3_7) _op_plus_1__lambda0, (uint8_t*) (temp0 = (struct _op_plus_1__lambda0*) alloc(ctx, sizeof(struct _op_plus_1__lambda0)), ((*(temp0) = (struct _op_plus_1__lambda0) {a, b}, 0), temp0))});
}
struct arr_0 make_arr_1(struct ctx* ctx, uint64_t size, struct fun_mut1_7 f) {
