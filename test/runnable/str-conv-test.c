...
struct comparison compare_280(struct opt_9 a, struct opt_9 b);
struct comparison compare_281(struct none a, struct none b);
struct comparison compare_282(struct some_9 a, struct some_9 b);
...
struct comparison compare_294(struct opt_10 a, struct opt_10 b);
struct comparison compare_295(struct some_10 a, struct some_10 b);
struct opt_10 parse_int(struct ctx* ctx, struct arr_0 a);
struct opt_10 opt_map(struct ctx* ctx, struct opt_9 a, struct fun_act1_6 cb);
int64_t call_8(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0);
int64_t call_w_ctx_299(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	struct opt_9 _3 = parse_nat(_1, _2);
	struct none _4 = (struct none) {};
	struct opt_9 _5 = (struct opt_9) {0, .as0 = _4};
	uint8_t _6 = _op_equal_equal_4(_3, _5);
	assert_0(_0, _6);
	struct ctx* _7 = ctx;
	struct ctx* _8 = ctx;
	struct arr_0 _9 = (struct arr_0) {1, constantarr_0_15};
	struct opt_9 _10 = parse_nat(_8, _9);
	uint64_t _11 = 1u;
	struct some_9 _12 = (struct some_9) {_11};
	struct opt_9 _13 = (struct opt_9) {1, .as1 = _12};
	uint8_t _14 = _op_equal_equal_4(_10, _13);
	assert_0(_7, _14);
	struct ctx* _15 = ctx;
	struct ctx* _16 = ctx;
	struct arr_0 _17 = (struct arr_0) {3, constantarr_0_16};
	struct opt_9 _18 = parse_nat(_16, _17);
	struct none _19 = (struct none) {};
	struct opt_9 _20 = (struct opt_9) {0, .as0 = _19};
	uint8_t _21 = _op_equal_equal_4(_18, _20);
	assert_0(_15, _21);
	struct ctx* _22 = ctx;
	struct ctx* _23 = ctx;
	struct arr_0 _24 = (struct arr_0) {2, constantarr_0_17};
	struct opt_9 _25 = parse_nat(_23, _24);
	struct none _26 = (struct none) {};
	struct opt_9 _27 = (struct opt_9) {0, .as0 = _26};
	uint8_t _28 = _op_equal_equal_4(_25, _27);
	assert_0(_22, _28);
	struct ctx* _29 = ctx;
	struct ctx* _30 = ctx;
	struct arr_0 _31 = (struct arr_0) {3, constantarr_0_18};
	struct opt_10 _32 = parse_int(_30, _31);
	int64_t _33 = 123;
	struct some_10 _34 = (struct some_10) {_33};
	struct opt_10 _35 = (struct opt_10) {1, .as1 = _34};
	uint8_t _36 = _op_equal_equal_5(_32, _35);
	assert_0(_29, _36);
	struct ctx* _37 = ctx;
	struct ctx* _38 = ctx;
	struct arr_0 _39 = (struct arr_0) {4, constantarr_0_19};
	struct opt_10 _40 = parse_int(_38, _39);
	int64_t _41 = -123;
	struct some_10 _42 = (struct some_10) {_41};
	struct opt_10 _43 = (struct opt_10) {1, .as1 = _42};
	uint8_t _44 = _op_equal_equal_5(_40, _43);
	assert_0(_37, _44);
	struct ctx* _45 = ctx;
	struct ctx* _46 = ctx;
	struct arr_0 _47 = (struct arr_0) {4, constantarr_0_20};
	struct opt_10 _48 = parse_int(_46, _47);
	int64_t _49 = 123;
	struct some_10 _50 = (struct some_10) {_49};
	struct opt_10 _51 = (struct opt_10) {1, .as1 = _50};
	uint8_t _52 = _op_equal_equal_5(_48, _51);
	assert_0(_45, _52);
	struct ctx* _53 = ctx;
	struct ctx* _54 = ctx;
	struct arr_0 _55 = (struct arr_0) {4, constantarr_0_21};
	struct opt_10 _56 = parse_int(_54, _55);
	struct none _57 = (struct none) {};
	struct opt_10 _58 = (struct opt_10) {0, .as0 = _57};
	uint8_t _59 = _op_equal_equal_5(_56, _58);
	assert_0(_53, _59);
	struct ctx* _60 = ctx;
	struct ctx* _61 = ctx;
	struct arr_0 _62 = (struct arr_0) {1, constantarr_0_15};
	struct opt_9 _63 = parse_nat(_61, _62);
...
uint8_t _op_equal_equal_4(struct opt_9 a, struct opt_9 b) {
	struct opt_9 _0 = a;
	struct opt_9 _1 = b;
	struct comparison _2 = compare_280(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			switch (_5.kind) {
				...
				case 1: {
					struct some_9 b1 = _5.as1;
					
					struct some_9 _7 = a1;
					struct some_9 _8 = b1;
					return compare_282(_7, _8);
				}
				default:
					return (assert(0),(struct comparison) {0});
			}
...
struct opt_9 parse_nat_recur(struct ctx* ctx, struct arr_0 a, uint64_t accum) {
	...
	if (_1) {
		uint64_t _2 = accum;
		struct some_9 _3 = (struct some_9) {_2};
		return (struct opt_9) {1, .as1 = _3};
	} else {
		struct ctx* _4 = ctx;
		struct ctx* _5 = ctx;
		struct arr_0 _6 = a;
		char _7 = first(_5, _6);
		struct opt_9 _8 = char_to_nat(_4, _7);
		switch (_8.kind) {
			case 0: {
				struct none _9 = (struct none) {};
				return (struct opt_9) {0, .as0 = _9};
			}
			case 1: {
				struct some_9 s0 = _8.as1;
...
struct opt_9 char_to_nat(struct ctx* ctx, char c) {
	...
	if (_2) {
		uint64_t _3 = 0u;
		struct some_9 _4 = (struct some_9) {_3};
		return (struct opt_9) {1, .as1 = _4};
	} else {
		char _5 = c;
		char _6 = 49u;
		uint8_t _7 = _op_equal_equal_1(_5, _6);
		if (_7) {
			uint64_t _8 = 1u;
			struct some_9 _9 = (struct some_9) {_8};
			return (struct opt_9) {1, .as1 = _9};
		} else {
			char _10 = c;
			char _11 = 50u;
			...
			if (_12) {
				uint64_t _13 = 2u;
				struct some_9 _14 = (struct some_9) {_13};
				return (struct opt_9) {1, .as1 = _14};
			} else {
				char _15 = c;
				char _16 = 51u;
				...
				if (_17) {
					uint64_t _18 = 3u;
					struct some_9 _19 = (struct some_9) {_18};
					return (struct opt_9) {1, .as1 = _19};
				} else {
					char _20 = c;
					char _21 = 52u;
					...
					if (_22) {
						uint64_t _23 = 4u;
						struct some_9 _24 = (struct some_9) {_23};
						return (struct opt_9) {1, .as1 = _24};
					} else {
						char _25 = c;
						char _26 = 53u;
						...
						if (_27) {
							uint64_t _28 = 5u;
							struct some_9 _29 = (struct some_9) {_28};
							return (struct opt_9) {1, .as1 = _29};
						} else {
							char _30 = c;
							char _31 = 54u;
							...
							if (_32) {
								uint64_t _33 = 6u;
								struct some_9 _34 = (struct some_9) {_33};
								return (struct opt_9) {1, .as1 = _34};
							} else {
								char _35 = c;
								char _36 = 55u;
								...
								if (_37) {
									uint64_t _38 = 7u;
									struct some_9 _39 = (struct some_9) {_38};
									return (struct opt_9) {1, .as1 = _39};
								} else {
									char _40 = c;
									char _41 = 56u;
									...
									if (_42) {
										uint64_t _43 = 8u;
										struct some_9 _44 = (struct some_9) {_43};
										return (struct opt_9) {1, .as1 = _44};
									} else {
										char _45 = c;
										char _46 = 57u;
										...
										if (_47) {
											uint64_t _48 = 9u;
											struct some_9 _49 = (struct some_9) {_48};
											return (struct opt_9) {1, .as1 = _49};
										} else {
											struct none _50 = (struct none) {};
											return (struct opt_9) {0, .as0 = _50};
										}
									}
								}
							}
...
uint8_t _op_equal_equal_5(struct opt_10 a, struct opt_10 b) {
	struct opt_10 _0 = a;
	struct opt_10 _1 = b;
	struct comparison _2 = compare_294(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			switch (_5.kind) {
				...
				case 1: {
					struct some_10 b1 = _5.as1;
					
					struct some_10 _7 = a1;
					struct some_10 _8 = b1;
					return compare_295(_7, _8);
				}
				default:
					return (assert(0),(struct comparison) {0});
			}
...
struct comparison compare_295(struct some_10 a, struct some_10 b) {
	...
	struct some_10 _2 = b;
	int64_t _3 = _2.value;
	struct comparison _4 = compare_42(_1, _3);
	switch (_4.kind) {
		case 0: {
			struct less _5 = (struct less) {};
			return (struct comparison) {0, .as0 = _5};
...
struct opt_10 parse_int(struct ctx* ctx, struct arr_0 a) {
	...
	char _4 = 45u;
	uint8_t _5 = _op_equal_equal_1(_3, _4);
	if (_5) {
		struct ctx* _6 = ctx;
		struct ctx* _7 = ctx;
		struct ctx* _8 = ctx;
		...
		struct opt_9 _11 = parse_nat(_7, _10);
		...
		char _20 = 43u;
		uint8_t _21 = _op_equal_equal_1(_19, _20);struct arr_0 _22;
		...
		struct opt_9 _25 = parse_nat(_15, _22);
...
struct opt_10 opt_map(struct ctx* ctx, struct opt_9 a, struct fun_act1_6 cb) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			struct some_10 _7 = (struct some_10) {_6};
			return (struct opt_10) {1, .as1 = _7};
		}
		default:
...
int64_t call_8(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0) {
	...
	struct ctx* _1 = ctx;
	uint64_t _2 = p0;
	return call_w_ctx_299(_0, _1, _2);
}
