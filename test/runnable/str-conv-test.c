...
char constantarr_0_70[17] = "empty-arr<island>";
char constantarr_0_71[7] = "arr<?t>";
char constantarr_0_72[8] = "null<?t>";
char constantarr_0_73[13] = "new-condition";
char constantarr_0_74[9] = "condition";
char constantarr_0_75[22] = "ref-of-val<global-ctx>";
char constantarr_0_76[10] = "new-island";
char constantarr_0_77[14] = "new-task-queue";
...
char constantarr_0_118[13] = "empty-arr<?t>";
...
char constantarr_0_187[10] = "noctx-incr";
char constantarr_0_188[7] = "max-nat";
char constantarr_0_189[9] = "wrap-incr";
...
char constantarr_0_243[14] = "ptr-to<island>";
char constantarr_0_244[7] = "do-main";
char constantarr_0_245[17] = "new-exception-ctx";
char constantarr_0_246[13] = "exception-ctx";
char constantarr_0_247[11] = "new-log-ctx";
...
char constantarr_0_254[7] = "new-ctx";
char constantarr_0_255[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_256[12] = "acquire-lock";
char constantarr_0_257[18] = "acquire-lock-recur";
char constantarr_0_258[16] = "try-acquire-lock";
char constantarr_0_259[7] = "try-set";
char constantarr_0_260[10] = "try-change";
char constantarr_0_261[23] = "compare-exchange-strong";
char constantarr_0_262[12] = "ptr-to<bool>";
char constantarr_0_263[5] = "value";
char constantarr_0_264[23] = "ref-of-val<atomic-bool>";
char constantarr_0_265[9] = "is-locked";
char constantarr_0_266[12] = "yield-thread";
char constantarr_0_267[13] = "pthread-yield";
char constantarr_0_268[9] = "==<int32>";
...
char constantarr_0_278[12] = "release-lock";
char constantarr_0_279[10] = "must-unset";
char constantarr_0_280[9] = "try-unset";
char constantarr_0_281[14] = "ref-of-val<gc>";
char constantarr_0_282[11] = "set-handler";
char constantarr_0_283[11] = "log-handler";
char constantarr_0_284[26] = "ref-of-val<island-gc-root>";
char constantarr_0_285[7] = "gc-root";
char constantarr_0_286[3] = "ctx";
char constantarr_0_287[22] = "as-any-ptr<global-ctx>";
char constantarr_0_288[2] = "id";
char constantarr_0_289[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_290[19] = "as-any-ptr<log-ctx>";
char constantarr_0_291[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_292[15] = "ref-of-val<ctx>";
char constantarr_0_293[79] = "as<fun2<fut<int32>, arr<ptr<char>>, fun-ptr2<fut<int32>, ctx, arr<arr<char>>>>>";
char constantarr_0_294[14] = "add-first-task";
char constantarr_0_295[12] = "then2<int32>";
char constantarr_0_296[16] = "then<?out, void>";
char constantarr_0_297[24] = "new-unresolved-fut<?out>";
char constantarr_0_298[7] = "fut<?t>";
char constantarr_0_299[23] = "fut-state-callbacks<?t>";
char constantarr_0_300[14] = "then-void<?in>";
...
char constantarr_0_307[33] = "call<void, result<?t, exception>>";
...
char constantarr_0_312[16] = "forward-to<?out>";
char constantarr_0_313[13] = "then-void<?t>";
char constantarr_0_314[21] = "resolve-or-reject<?t>";
char constantarr_0_315[27] = "resolve-or-reject-recur<?t>";
char constantarr_0_316[4] = "void";
...
char constantarr_0_324[19] = "call-ref<?out, ?in>";
...
char constantarr_0_366[8] = "call<?t>";
char constantarr_0_367[17] = "call-with-ctx<?r>";
char constantarr_0_368[19] = "call<?t, exception>";
char constantarr_0_369[18] = "call<fut<?r>, ?p0>";
char constantarr_0_370[12] = "fun<?r, ?p0>";
char constantarr_0_371[35] = "call-ref<?out, ?in>.lambda0.lambda0";
char constantarr_0_372[10] = "reject<?r>";
char constantarr_0_373[35] = "call-ref<?out, ?in>.lambda0.lambda1";
char constantarr_0_374[27] = "call-ref<?out, ?in>.lambda0";
char constantarr_0_375[10] = "value<?in>";
char constantarr_0_376[24] = "then<?out, void>.lambda0";
char constantarr_0_377[14] = "call-ref<?out>";
char constantarr_0_378[24] = "island-and-exclusion<?r>";
char constantarr_0_379[13] = "call<fut<?r>>";
char constantarr_0_380[7] = "fun<?r>";
char constantarr_0_381[30] = "call-ref<?out>.lambda0.lambda0";
char constantarr_0_382[30] = "call-ref<?out>.lambda0.lambda1";
char constantarr_0_383[22] = "call-ref<?out>.lambda0";
char constantarr_0_384[20] = "then2<int32>.lambda0";
...
char constantarr_0_392[37] = "call<fut<int32>, ctx, arr<arr<char>>>";
...
char constantarr_0_397[13] = "call<?t, nat>";
char constantarr_0_398[15] = "call<?out, ?in>";
...
char constantarr_0_412[21] = "call<void, exception>";
...
char constantarr_0_533[12] = "==<opt<nat>>";
char constantarr_0_534[9] = "parse-nat";
char constantarr_0_535[15] = "parse-nat-recur";
char constantarr_0_536[11] = "char-to-nat";
char constantarr_0_537[11] = "first<char>";
char constantarr_0_538[13] = "subscript<?t>";
char constantarr_0_539[10] = "tail<char>";
char constantarr_0_540[1] = "*";
char constantarr_0_541[1] = "/";
char constantarr_0_542[12] = "==<opt<int>>";
char constantarr_0_543[9] = "parse-int";
char constantarr_0_544[17] = "opt-map<int, nat>";
char constantarr_0_545[10] = "some<?out>";
char constantarr_0_546[3] = "neg";
char constantarr_0_547[6] = "to-nat";
char constantarr_0_548[9] = "negative?";
char constantarr_0_549[6] = "<<int>";
char constantarr_0_550[7] = "max-int";
char constantarr_0_551[17] = "parse-int.lambda0";
char constantarr_0_552[17] = "parse-int.lambda1";
char constantarr_0_553[3] = "mod";
char constantarr_0_554[10] = "unsafe-mod";
char constantarr_0_555[11] = "to-str<nat>";
...
struct comparison compare_336(struct opt_8 a, struct opt_8 b);
struct comparison compare_337(struct none a, struct none b);
struct comparison compare_338(struct some_8 a, struct some_8 b);
...
struct comparison compare_351(struct opt_9 a, struct opt_9 b);
struct comparison compare_352(struct some_9 a, struct some_9 b);
...
int64_t call_w_ctx_356(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0);
...
struct arr_0 get_fun_name_74(uint64_t fun_id) {switch (fun_id) {
		...
		case 4: {
			return (struct arr_0) {5, constantarr_0_40};
		}
		case 5: {
		...
		case 17: {
			return (struct arr_0) {17, constantarr_0_70};
		}
		case 18: {
			return (struct arr_0) {13, constantarr_0_73};
		}
		case 19: {
			return (struct arr_0) {10, constantarr_0_76};
		}
		case 20: {
			return (struct arr_0) {14, constantarr_0_77};
		}
		case 21: {
		...
		case 115: {
			return (struct arr_0) {17, constantarr_0_245};
		}
		case 116: {
		...
		case 125: {
			return (struct arr_0) {13, constantarr_0_267};
		}
		case 126: {
		...
		case 129: {
			return (struct arr_0) {10, constantarr_0_279};
		}
		case 130: {
			return (struct arr_0) {9, constantarr_0_280};
		}
		case 131: {
		...
		case 133: {
			return (struct arr_0) {16, constantarr_0_296};
		}
		case 134: {
		...
		case 136: {
			return (struct arr_0) {33, constantarr_0_307};
		}
		case 137: {
			return (struct arr_0) {0u, NULL};
		}
		case 138: {
			return (struct arr_0) {16, constantarr_0_312};
		}
		case 139: {
		...
		case 142: {
			return (struct arr_0) {21, constantarr_0_314};
		}
		case 143: {
			return (struct arr_0) {27, constantarr_0_315};
		}
		case 144: {
		...
		case 175: {
			return (struct arr_0) {35, constantarr_0_373};
		}
		case 176: {
			return (struct arr_0) {27, constantarr_0_374};
		}
		case 177: {
		...
		case 357: {
			return (struct arr_0) {3, constantarr_0_546};
		}
		case 358: {
			return (struct arr_0) {3, constantarr_0_546};
		}
		...
		case 368: {
			return (struct arr_0) {3, constantarr_0_553};
		}
		case 369: {
			return (struct arr_0) {11, constantarr_0_555};
		}
		case 370: {
...
uint8_t _op_equal_equal_4(struct opt_8 a, struct opt_8 b) {
	struct comparison _0 = compare_336(a, b);
	switch (_0.kind) {
		case 0: {
			return 0;
		}
...
uint8_t _op_equal_equal_5(struct opt_9 a, struct opt_9 b) {
	struct comparison _0 = compare_351(a, b);
	switch (_0.kind) {
		case 0: {
			return 0;
		}
...
struct arr_0 to_str_3(struct ctx* ctx, struct opt_8 a) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			struct arr_0 _2 = _op_plus_0(ctx, (struct arr_0) {5, constantarr_0_27}, _1);
			return _op_plus_0(ctx, _2, (struct arr_0) {1, constantarr_0_28});
		}
		default:
			return (struct arr_0) {0, NULL};
	}
