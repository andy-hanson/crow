...
struct comparison compare_309(struct opt_5 a, struct opt_5 b);
struct comparison compare_310(struct none a, struct none b);
struct comparison compare_311(struct some_5 a, struct some_5 b);
...
struct comparison compare_323(struct opt_6 a, struct opt_6 b);
struct comparison compare_324(struct some_6 a, struct some_6 b);
...
int64_t call_w_ctx_328(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0);
...
uint8_t _op_equal_equal_4(struct opt_5 a, struct opt_5 b) {
	struct opt_5 _0 = a;
	struct opt_5 _1 = b;
	struct comparison _2 = compare_309(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
uint8_t _op_equal_equal_5(struct opt_6 a, struct opt_6 b) {
	struct opt_6 _0 = a;
	struct opt_6 _1 = b;
	struct comparison _2 = compare_323(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
struct comparison compare_324(struct some_6 a, struct some_6 b) {
	...
	struct some_6 _2 = b;
	int64_t _3 = _2.value;
	struct comparison _4 = compare_33(_1, _3);
	switch (_4.kind) {
		case 0: {
			struct less _5 = (struct less) {};
			return (struct comparison) {0, .as0 = _5};
...
int64_t call_8(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0) {
	...
	struct ctx* _1 = ctx;
	uint64_t _2 = p0;
	return call_w_ctx_328(_0, _1, _2);
}
