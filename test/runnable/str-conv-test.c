...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	assert_0(ctx, _op_equal_equal_4(parse_nat(ctx, (struct arr_0) {0u, NULL}), (struct opt_9) {0, .as0 = (struct none) {}}));
	assert_0(ctx, _op_equal_equal_4(parse_nat(ctx, (struct arr_0) {1, constantarr_0_12}), (struct opt_9) {1, .as1 = (struct some_9) {1u}}));
	assert_0(ctx, _op_equal_equal_4(parse_nat(ctx, (struct arr_0) {3, constantarr_0_13}), (struct opt_9) {0, .as0 = (struct none) {}}));
	assert_0(ctx, _op_equal_equal_4(parse_nat(ctx, (struct arr_0) {2, constantarr_0_14}), (struct opt_9) {0, .as0 = (struct none) {}}));
	...
	assert_0(ctx, _op_equal_equal_5(parse_int(ctx, (struct arr_0) {4, constantarr_0_18}), (struct opt_10) {0, .as0 = (struct none) {}}));
...
struct comparison compare_286(struct some_10 a, struct some_10 b) {
	struct comparison temp0;
	temp0 = compare_41(a.value, b.value);
	switch (temp0.kind) {
		case 0:
			return (struct comparison) {0, .as0 = (struct less) {}};
		case 1:
...
struct opt_10 parse_int(struct ctx* ctx, struct arr_0 a) {
	if (_op_equal_equal_1(at_2(ctx, a, 0u), 45u)) {
		return opt_map(ctx, parse_nat(ctx, tail_1(ctx, a)), (struct fun_mut1_6) {0, .as0 = (struct void_) {}});
	} else {
		return opt_map(ctx, parse_nat(ctx, (_op_equal_equal_1(at_2(ctx, a, 0u), 43u) ? tail_1(ctx, a) : a)), (struct fun_mut1_6) {1, .as1 = (struct void_) {}});
	}
}
