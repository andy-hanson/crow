...
char constantarr_0_552[15] = "resolved<int32>";
...
struct comparison compare_335(struct opt_8 a, struct opt_8 b);
struct comparison compare_336(struct none a, struct none b);
struct comparison compare_337(struct some_8 a, struct some_8 b);
...
struct comparison compare_350(struct opt_9 a, struct opt_9 b);
struct comparison compare_351(struct some_9 a, struct some_9 b);
...
uint8_t _op_equal_equal_4(struct opt_8 a, struct opt_8 b) {
	struct comparison _0 = compare_335(a, b);
	switch (_0.kind) {
		case 0: {
			return 0;
		}
...
uint8_t _op_equal_equal_5(struct opt_9 a, struct opt_9 b) {
	struct comparison _0 = compare_350(a, b);
	switch (_0.kind) {
		case 0: {
			return 0;
		}
...
struct comparison compare_351(struct some_9 a, struct some_9 b) {
	struct comparison _0 = compare_38(a.value, b.value);
	switch (_0.kind) {
		case 0: {
			return (struct comparison) {0, .as0 = (struct less) {}};
		}
...
int64_t subscript_15(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0) {
	return call_w_ctx_355(a, ctx, p0);
}
