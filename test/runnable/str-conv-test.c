...
struct comparison compare_279(struct opt_9 a, struct opt_9 b);
struct comparison compare_280(struct none a, struct none b);
struct comparison compare_281(struct some_9 a, struct some_9 b);
...
struct comparison compare_293(struct opt_10 a, struct opt_10 b);
struct comparison compare_294(struct some_10 a, struct some_10 b);
...
int64_t call_w_ctx_298(struct fun_mut1_6 a, struct ctx* ctx, uint64_t p0);
...
uint8_t _op_equal_equal_4(struct opt_9 a, struct opt_9 b) {
	struct opt_9 _0 = a;
	struct opt_9 _1 = b;
	struct comparison _2 = compare_279(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
int64_t call_8(struct ctx* ctx, struct fun_mut1_6 a, uint64_t p0) {
	...
	struct ctx* _1 = ctx;
	uint64_t _2 = p0;
	return call_w_ctx_298(_0, _1, _2);
}
