...
_Static_assert(sizeof(struct fun_mut1_6) == 8, "");
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	struct ctx* _7 = ctx;
	struct ctx* _8 = ctx;
	struct arr_0 _9 = (struct arr_0) {1, constantarr_0_12};
	...
	struct ctx* _15 = ctx;
	struct ctx* _16 = ctx;
	struct arr_0 _17 = (struct arr_0) {3, constantarr_0_13};
	...
	struct ctx* _22 = ctx;
	struct ctx* _23 = ctx;
	struct arr_0 _24 = (struct arr_0) {2, constantarr_0_14};
	...
	struct ctx* _29 = ctx;
	struct ctx* _30 = ctx;
	struct arr_0 _31 = (struct arr_0) {3, constantarr_0_15};
	...
	struct ctx* _37 = ctx;
	struct ctx* _38 = ctx;
	struct arr_0 _39 = (struct arr_0) {4, constantarr_0_16};
	...
	struct ctx* _45 = ctx;
	struct ctx* _46 = ctx;
	struct arr_0 _47 = (struct arr_0) {4, constantarr_0_17};
	...
	struct ctx* _53 = ctx;
	struct ctx* _54 = ctx;
	struct arr_0 _55 = (struct arr_0) {4, constantarr_0_18};
	...
	struct ctx* _60 = ctx;
	struct ctx* _61 = ctx;
	struct arr_0 _62 = (struct arr_0) {1, constantarr_0_12};
	struct opt_9 _63 = parse_nat(_61, _62);
	struct arr_0 _64 = to_str_2(_60, _63);
	print(_64);
	struct ctx* _65 = ctx;
	int32_t _66 = 0;
...
uint8_t _op_equal_equal_4(struct opt_9 a, struct opt_9 b) {
	struct opt_9 _0 = a;
	struct opt_9 _1 = b;
	struct comparison _2 = compare_270(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
uint8_t _op_equal_equal_5(struct opt_10 a, struct opt_10 b) {
	struct opt_10 _0 = a;
	struct opt_10 _1 = b;
	struct comparison _2 = compare_285(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
struct comparison compare_286(struct some_10 a, struct some_10 b) {
	...
	struct some_10 _2 = b;
	int64_t _3 = _2.value;
	struct comparison _4 = compare_41(_1, _3);
	switch (_4.kind) {
		case 0: {
			struct less _5 = (struct less) {};
			return (struct comparison) {0, .as0 = _5};
...
struct opt_10 parse_int(struct ctx* ctx, struct arr_0 a) {
	...
	if (_5) {
		...
		struct fun_mut1_6 _13 = (struct fun_mut1_6) {0, .as0 = _12};
		...
		struct fun_mut1_6 _27 = (struct fun_mut1_6) {1, .as1 = _26};
...
int64_t call_8(struct ctx* ctx, struct fun_mut1_6 a, uint64_t p0) {
	...
	struct ctx* _1 = ctx;
	uint64_t _2 = p0;
	return call_w_ctx_290(_0, _1, _2);
}
...
struct arr_0 to_str_2(struct ctx* ctx, struct opt_9 a) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			struct ctx* _1 = ctx;
			struct ctx* _2 = ctx;
			struct arr_0 _3 = (struct arr_0) {5, constantarr_0_29};
			struct ctx* _4 = ctx;
			struct some_9 _5 = s0;
			uint64_t _6 = _5.value;
			struct arr_0 _7 = to_str_1(_4, _6);
			struct arr_0 _8 = _op_plus_1(_2, _3, _7);
			struct arr_0 _9 = (struct arr_0) {1, constantarr_0_30};
			return _op_plus_1(_1, _8, _9);
		}
		default:
			return (assert(0),(struct arr_0) {0, NULL});
	}
