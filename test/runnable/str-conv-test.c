...
struct comparison compare_305(struct opt_5 a, struct opt_5 b);
struct comparison compare_306(struct none a, struct none b);
struct comparison compare_307(struct some_5 a, struct some_5 b);
...
struct comparison compare_319(struct opt_6 a, struct opt_6 b);
struct comparison compare_320(struct some_6 a, struct some_6 b);
...
int64_t call_w_ctx_324(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0);
...
uint8_t _op_equal_equal_4(struct opt_5 a, struct opt_5 b) {
	struct opt_5 _0 = a;
	struct opt_5 _1 = b;
	struct comparison _2 = compare_305(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
...
int64_t call_8(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0) {
	...
	struct ctx* _1 = ctx;
	uint64_t _2 = p0;
	return call_w_ctx_324(_0, _1, _2);
}
