...
char constantarr_0_532[20] = "test-compare-records";
char constantarr_0_533[9] = "my-record";
char constantarr_0_534[14] = "<=><my-record>";
char constantarr_0_535[26] = "test-compare-byref-records";
char constantarr_0_536[15] = "my-byref-record";
char constantarr_0_537[20] = "<=><my-byref-record>";
char constantarr_0_538[19] = "test-compare-unions";
char constantarr_0_539[12] = "as<my-union>";
char constantarr_0_540[15] = "my-other-record";
char constantarr_0_541[13] = "<=><my-union>";
...
struct comparison compare_386(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_388(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_390(struct my_union a, struct my_union b);
struct comparison compare_391(struct my_other_record a, struct my_other_record b);
...
struct arr_0 get_fun_name_85(uint64_t fun_id) {switch (fun_id) {
		...
		case 384: {
			return (struct arr_0) {20, constantarr_0_532};
		}
		case 385: {
			return (struct arr_0) {6, constantarr_0_219};
		}
		...
		case 387: {
			return (struct arr_0) {26, constantarr_0_535};
		}
		case 388: {
			return (struct arr_0) {0u, NULL};
		}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_386(a0, b1);
	struct arr_0 _1 = to_str_3(ctx, _0);
	print(_1);
	struct comparison _2 = compare_386(a0, c2);
	struct arr_0 _3 = to_str_3(ctx, _2);
	print(_3);
	struct comparison _4 = compare_386(a0, d3);
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_388(a0, b1);
	struct arr_0 _5 = to_str_3(ctx, _4);
	print(_5);
	struct comparison _6 = compare_388(a0, c2);
	struct arr_0 _7 = to_str_3(ctx, _6);
	print(_7);
	struct comparison _8 = compare_388(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_390(a0, b1);
	struct arr_0 _1 = to_str_3(ctx, _0);
	print(_1);
	struct comparison _2 = compare_390(a0, c2);
	struct arr_0 _3 = to_str_3(ctx, _2);
	print(_3);
	struct comparison _4 = compare_390(a0, d3);
	struct arr_0 _5 = to_str_3(ctx, _4);
	return print(_5);
}
