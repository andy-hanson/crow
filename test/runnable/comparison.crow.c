...
char constantarr_0_509[20] = "test-compare-records";
char constantarr_0_510[9] = "my-record";
char constantarr_0_511[14] = "<=><my-record>";
char constantarr_0_512[26] = "test-compare-byref-records";
char constantarr_0_513[15] = "my-byref-record";
char constantarr_0_514[20] = "<=><my-byref-record>";
char constantarr_0_515[19] = "test-compare-unions";
char constantarr_0_516[12] = "as<my-union>";
char constantarr_0_517[15] = "my-other-record";
char constantarr_0_518[13] = "<=><my-union>";
char constantarr_0_519[13] = "resolved<nat>";
...
struct void_ mark_visit_338(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_339(struct mark_ctx* mark_ctx, struct mut_arr value);
...
struct arr_0 to_str_2(struct ctx* ctx, struct comparison a);
struct comparison compare_355(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_357(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_359(struct my_union a, struct my_union b);
struct comparison compare_360(struct my_other_record a, struct my_other_record b);
...
uint8_t* get_fun_ptr_87(uint64_t fun_id) {switch (fun_id) {
		...
		case 359: {
			return (uint8_t*) compare_359;
		}
		case 360: {
			return (uint8_t*) compare_360;
		}
		case 361: {
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 353: {
			return (struct arr_0) {20, constantarr_0_509};
		}
		case 354: {
			return (struct arr_0) {6, constantarr_0_231};
		}
		...
		case 356: {
			return (struct arr_0) {26, constantarr_0_512};
		}
		case 357: {
			return (struct arr_0) {0u, NULL};
		}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_355(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_355(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_355(a0, d3);
	struct arr_0 _5 = to_str_2(ctx, _4);
	return print(_5);
}
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_357(a0, b1);
	struct arr_0 _5 = to_str_2(ctx, _4);
	print(_5);
	struct comparison _6 = compare_357(a0, c2);
	struct arr_0 _7 = to_str_2(ctx, _6);
	print(_7);
	struct comparison _8 = compare_357(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_359(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_359(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_359(a0, d3);
	struct arr_0 _5 = to_str_2(ctx, _4);
	return print(_5);
}
