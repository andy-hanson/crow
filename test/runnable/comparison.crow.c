...
char constantarr_0_530[20] = "test-compare-records";
char constantarr_0_531[9] = "my-record";
char constantarr_0_532[14] = "<=><my-record>";
char constantarr_0_533[26] = "test-compare-byref-records";
char constantarr_0_534[15] = "my-byref-record";
char constantarr_0_535[20] = "<=><my-byref-record>";
char constantarr_0_536[19] = "test-compare-unions";
char constantarr_0_537[12] = "as<my-union>";
char constantarr_0_538[15] = "my-other-record";
char constantarr_0_539[13] = "<=><my-union>";
...
struct comparison compare_385(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_387(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_389(struct my_union a, struct my_union b);
struct comparison compare_390(struct my_other_record a, struct my_other_record b);
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 383: {
			return (struct arr_0) {20, constantarr_0_530};
		}
		case 384: {
			return (struct arr_0) {6, constantarr_0_229};
		}
		...
		case 386: {
			return (struct arr_0) {26, constantarr_0_533};
		}
		case 387: {
			return (struct arr_0) {0u, NULL};
		}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_385(a0, b1);
	struct arr_0 _1 = to_str_3(ctx, _0);
	print(_1);
	struct comparison _2 = compare_385(a0, c2);
	struct arr_0 _3 = to_str_3(ctx, _2);
	print(_3);
	struct comparison _4 = compare_385(a0, d3);
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_387(a0, b1);
	struct arr_0 _5 = to_str_3(ctx, _4);
	print(_5);
	struct comparison _6 = compare_387(a0, c2);
	struct arr_0 _7 = to_str_3(ctx, _6);
	print(_7);
	struct comparison _8 = compare_387(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_389(a0, b1);
	struct arr_0 _1 = to_str_3(ctx, _0);
	print(_1);
	struct comparison _2 = compare_389(a0, c2);
	struct arr_0 _3 = to_str_3(ctx, _2);
	print(_3);
	struct comparison _4 = compare_389(a0, d3);
	struct arr_0 _5 = to_str_3(ctx, _4);
	return print(_5);
}
