...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	uint64_t _0 = 1u;
	uint64_t _1 = 2u;
	m0 = (struct my_record) {_0, _1};
	
	struct ctx* _2 = ctx;
	struct my_record _3 = m0;
	uint64_t _4 = _3.x;
	uint64_t _5 = 1u;
	uint8_t _6 = _op_equal_equal_0(_4, _5);
	assert_0(_2, _6);
	struct ctx* _7 = ctx;
	struct my_record _8 = m0;
	uint64_t _9 = _8.y;
	uint64_t _10 = 2u;
	uint8_t _11 = _op_equal_equal_0(_9, _10);
	assert_0(_7, _11);
	struct ctx* _12 = ctx;
	struct my_record _13 = m0;
	uint64_t _14 = _13.x;
	struct arr_0 _15 = to_str_2(_12, _14);
	print(_15);
	struct ctx* _16 = ctx;
	struct my_record _17 = m0;
	uint64_t _18 = _17.y;
	struct arr_0 _19 = to_str_2(_16, _18);
	print(_19);
	struct ctx* _20 = ctx;
	int32_t _21 = 0;
	return resolved_1(_20, _21);
}
