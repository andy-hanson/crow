...
typedef char (*fun_ptr3_6)(struct ctx_0*, uint8_t*, uint64_t);
struct fut_0;
struct lock_0 {
...
int32_t stdout_fd();
struct arr_0 to_str_1(struct ctx_0* ctx, uint64_t n);
...
struct arr_0 make_arr_1(struct ctx_0* ctx, uint64_t size, struct fun_mut1_6 f);
struct arr_0 freeze_1(struct mut_arr_2* a);
struct arr_0 unsafe_as_arr_1(struct mut_arr_2* a);
struct mut_arr_2* make_mut_arr_1(struct ctx_0* ctx, uint64_t size, struct fun_mut1_6 f);
struct mut_arr_2* new_uninitialized_mut_arr_1(struct ctx_0* ctx, uint64_t size);
char* uninitialized_data_1(struct ctx_0* ctx, uint64_t size);
uint8_t make_mut_arr_worker_1(struct ctx_0* ctx, struct mut_arr_2* m, uint64_t i, struct fun_mut1_6 f);
uint8_t set_at_1(struct ctx_0* ctx, struct mut_arr_2* a, uint64_t index, char value);
uint8_t noctx_set_at_2(struct mut_arr_2* a, uint64_t index, char value);
char call_10(struct ctx_0* ctx, struct fun_mut1_6 f, uint64_t p0);
char call_with_ctx_9(struct ctx_0* c, struct fun_mut1_6 f, uint64_t p0);
...
struct arr_1 map(struct ctx_0* ctx, struct arr_3 a, struct fun_mut1_4 mapper) {
	struct map_0* temp0;
	return make_arr_0(ctx, a.size, (struct fun_mut1_5) {(fun_ptr3_5) map_0, (uint8_t*) (temp0 = (struct map_0*) alloc(ctx, sizeof(struct map_0)), ((*(temp0) = (struct map_0) {mapper, a}, 0), temp0))});
}
struct arr_1 make_arr_0(struct ctx_0* ctx, uint64_t size, struct fun_mut1_5 f) {
...
struct fut_0* main_0(struct ctx_0* ctx, struct arr_1 args) {
	struct my_record_0 m;
	m = (struct my_record_0) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})};
	assert_0(ctx, _op_equal_equal_0(m.x, literal_1(ctx, (struct arr_0) {1, "1"})));
	assert_0(ctx, _op_equal_equal_0(m.y, literal_1(ctx, (struct arr_0) {1, "2"})));
	print_sync(to_str_1(ctx, m.x));
	print_sync(to_str_1(ctx, m.y));
								...
								if (_op_equal_equal_0(n, literal_1(ctx, (struct arr_0) {1, "7"}))) {
									...
									if (_op_equal_equal_0(n, literal_1(ctx, (struct arr_0) {1, "8"}))) {
										...
										if (_op_equal_equal_0(n, literal_1(ctx, (struct arr_0) {1, "9"}))) {
											...
											hi = to_str_1(ctx, _op_div(ctx, n, ten_0()));
											lo = to_str_1(ctx, mod(ctx, n, ten_0()));
...
struct arr_0 _op_plus_1(struct ctx_0* ctx, struct arr_0 a, struct arr_0 b) {
	...
	return make_arr_1(ctx, _op_plus_0(ctx, a.size, b.size), (struct fun_mut1_6) {(fun_ptr3_6) _op_plus_1_0, (uint8_t*) (temp0 = (struct _op_plus_1_0*) alloc(ctx, sizeof(struct _op_plus_1_0)), ((*(temp0) = (struct _op_plus_1_0) {a, b}, 0), temp0))});
}
struct arr_0 make_arr_1(struct ctx_0* ctx, uint64_t size, struct fun_mut1_6 f) {
