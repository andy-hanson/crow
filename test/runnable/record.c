...
char constantarr_0_523[9] = "my-record";
char constantarr_0_524[1] = "x";
char constantarr_0_525[1] = "y";
char constantarr_0_526[1] = "/";
char constantarr_0_527[3] = "mod";
char constantarr_0_528[10] = "unsafe-mod";
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	assert(ctx, _1);
	struct arr_0 _2 = to_str_2(ctx, m0.x);
	print(_2);
	struct arr_0 _3 = to_str_2(ctx, m0.y);
	print(_3);
