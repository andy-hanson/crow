...
char constantarr_0_250[14] = "as<by-val<gc>>";
char constantarr_0_251[14] = "ref-of-val<gc>";
...
char constantarr_0_294[6] = "lk<?a>";
char constantarr_0_295[9] = "state<?a>";
char constantarr_0_296[13] = "set-state<?a>";
char constantarr_0_297[23] = "fut-state-callbacks<?a>";
char constantarr_0_298[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_299[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_300[22] = "call-with-ctx<?r, ?p0>";
char constantarr_0_301[6] = "ok<?a>";
char constantarr_0_302[9] = "value<?a>";
...
char constantarr_0_306[13] = "callback!<?a>";
char constantarr_0_307[21] = "callback!<?a>.lambda0";
char constantarr_0_308[22] = "resolve-or-reject!<?a>";
char constantarr_0_309[24] = "with-lock<fut-state<?a>>";
char constantarr_0_310[22] = "fut-state-resolved<?a>";
char constantarr_0_311[16] = "value<exception>";
char constantarr_0_312[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_313[19] = "call-callbacks!<?a>";
char constantarr_0_314[6] = "cb<?a>";
char constantarr_0_315[8] = "next<?a>";
char constantarr_0_316[30] = "value<fut-state-callbacks<?a>>";
...
char constantarr_0_348[28] = "catch-with-exception-ctx<?a>";
...
char constantarr_0_359[24] = "subscript<?a, exception>";
...
char constantarr_0_375[22] = "then-void<nat>.lambda0";
...
char constantarr_0_382[10] = "empty?<?a>";
...
char constantarr_0_386[18] = "fill-ptr-range<?a>";
char constantarr_0_387[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_388[18] = "subscript<?a, nat>";
...
char constantarr_0_392[16] = "ptr-less-eq?<?a>";
char constantarr_0_393[5] = "-<?a>";
...
char constantarr_0_398[15] = "some<ptr<char>>";
char constantarr_0_399[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_400[16] = "value<ptr<char>>";
char constantarr_0_401[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_402[22] = "add-first-task.lambda0";
char constantarr_0_403[22] = "handle-exceptions<nat>";
char constantarr_0_404[26] = "subscript<void, exception>";
char constantarr_0_405[17] = "exception-handler";
char constantarr_0_406[14] = "get-cur-island";
char constantarr_0_407[30] = "handle-exceptions<nat>.lambda0";
char constantarr_0_408[15] = "do-main.lambda0";
char constantarr_0_409[80] = "call-with-ctx<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>";
char constantarr_0_410[11] = "run-threads";
char constantarr_0_411[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_412[19] = "start-threads-recur";
char constantarr_0_413[22] = "+<by-val<thread-args>>";
char constantarr_0_414[34] = "set-subscript<by-val<thread-args>>";
char constantarr_0_415[11] = "thread-args";
char constantarr_0_416[17] = "create-one-thread";
char constantarr_0_417[14] = "pthread-create";
char constantarr_0_418[9] = "!=<int32>";
char constantarr_0_419[6] = "eagain";
char constantarr_0_420[12] = "as-cell<nat>";
char constantarr_0_421[16] = "as-ref<cell<?a>>";
char constantarr_0_422[36] = "as-any-ptr<ptr<by-val<thread-args>>>";
char constantarr_0_423[10] = "thread-fun";
char constantarr_0_424[19] = "as-ref<thread-args>";
char constantarr_0_425[15] = "thread-function";
char constantarr_0_426[21] = "thread-function-recur";
char constantarr_0_427[10] = "shut-down?";
char constantarr_0_428[18] = "set-n-live-threads";
char constantarr_0_429[14] = "n-live-threads";
char constantarr_0_430[28] = "assert-islands-are-shut-down";
char constantarr_0_431[9] = "needs-gc?";
char constantarr_0_432[17] = "n-threads-running";
char constantarr_0_433[6] = "empty?";
...
char constantarr_0_443[19] = "subscript<timespec>";
...
char constantarr_0_454[9] = "pop-task!";
...
char constantarr_0_459[13] = "contains?<?a>";
char constantarr_0_460[19] = "contains-recur?<?a>";
char constantarr_0_461[15] = "temp-as-arr<?a>";
char constantarr_0_462[9] = "inner<?a>";
char constantarr_0_463[19] = "temp-as-mut-arr<?a>";
char constantarr_0_464[11] = "backing<?a>";
char constantarr_0_465[10] = "pop-recur!";
char constantarr_0_466[11] = "to-opt-time";
char constantarr_0_467[9] = "some<nat>";
char constantarr_0_468[38] = "push-capacity-must-be-sufficient!<nat>";
char constantarr_0_469[12] = "capacity<?a>";
char constantarr_0_470[12] = "set-size<?a>";
char constantarr_0_471[17] = "noctx-set-at!<?a>";
...
char constantarr_0_488[38] = "noctx-must-remove-unordered-recur!<?a>";
char constantarr_0_489[8] = "drop<?a>";
char constantarr_0_490[30] = "noctx-remove-unordered-at!<?a>";
char constantarr_0_491[14] = "noctx-last<?a>";
...
char constantarr_0_516[20] = "subscript<ptr<nat8>>";
...
char constantarr_0_520[18] = "ptr-cast<nat8, ?a>";
char constantarr_0_521[8] = "?<int32>";
char constantarr_0_522[25] = "any-unhandled-exceptions?";
char constantarr_0_523[4] = "main";
char constantarr_0_524[12] = "==<opt<nat>>";
char constantarr_0_525[9] = "parse-nat";
char constantarr_0_526[15] = "parse-nat-recur";
char constantarr_0_527[11] = "char-to-nat";
...
struct comparison compare_354(struct opt_9 a, struct opt_9 b);
struct comparison compare_355(struct none a, struct none b);
struct comparison compare_356(struct some_9 a, struct some_9 b);
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 219: {
			return (struct arr_0) {27, constantarr_0_399};
		}
		case 220: {
		...
		case 223: {
			return (struct arr_0) {26, constantarr_0_404};
		}
		case 224: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 231: {
			return (struct arr_0) {45, constantarr_0_411};
		}
		case 232: {
			return (struct arr_0) {19, constantarr_0_412};
		}
		case 233: {
...
uint8_t _equal_4(struct opt_9 a, struct opt_9 b) {
	struct comparison _0 = compare_354(a, b);
	switch (_0.kind) {
		case 0: {
			return 0;
		}
