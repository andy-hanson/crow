...
char constantarr_0_311[6] = "cb<?t>";
char constantarr_0_312[8] = "next<?t>";
char constantarr_0_313[30] = "value<fut-state-callbacks<?t>>";
char constantarr_0_314[22] = "hard-unreachable<void>";
