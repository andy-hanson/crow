...
struct void_ mark_visit_280(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_281(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_282(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_283(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_284(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
