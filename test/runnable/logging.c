...
char constantarr_0_225[11] = "arr<island>";
...
struct void_ mark_visit_315(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_316(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ mark_visit_319(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
...
struct void_ mark_visit_323(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_324(struct mark_ctx* mark_ctx, struct mut_arr value);
struct void_ mark_arr_325(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct void_ call_w_ctx_341(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct void_ mark_visit_275(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_276(mark_ctx, value.tasks);
	return mark_visit_316(mark_ctx, value.log_handler);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_276(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_277(mark_ctx, value.head);
	return mark_visit_323(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_281(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 4: {
			...
			return mark_visit_319(mark_ctx, value4);
		}
		case 5: {
			struct with_log_handler__lambda1* value5 = _0.as5;
			
			return mark_visit_321(mark_ctx, value5);
		}
		case 6: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_315(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	return mark_visit_316(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_317(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_316(mark_ctx, value.lh);
}
...
struct void_ mark_visit_320(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value) {
	mark_visit_316(mark_ctx, value.handler);
	return mark_visit_281(mark_ctx, value.cb);
}
...
struct void_ mark_visit_323(struct mark_ctx* mark_ctx, struct mut_list value) {
	return mark_visit_324(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat>> (generated) (generated) */
struct void_ mark_visit_324(struct mark_ctx* mark_ctx, struct mut_arr value) {
	return mark_arr_325(mark_ctx, value.arr);
}
