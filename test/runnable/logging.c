...
struct void_ mark_visit_292(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_293(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ mark_visit_296(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_297(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_298(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
struct void_ mark_visit_299(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_300(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_301(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_302(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct void_ call_w_ctx_320(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct void_ call_8(struct ctx* ctx, struct fun1_1 a, struct logged* p0) {
	...
	struct ctx* _1 = ctx;
	struct logged* _2 = p0;
	return call_w_ctx_320(_0, _1, _2);
}
