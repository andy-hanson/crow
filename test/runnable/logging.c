...
struct void_ mark_visit_256(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_257(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_258(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_259(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_260(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_261(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_262(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
