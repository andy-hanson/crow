...
struct void_ mark_visit_286(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_287(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_288(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_289(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_290(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_291(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
...
struct void_ mark_visit_294(struct mark_ctx* mark_ctx, struct mut_arr value);
...
struct void_ call_w_ctx_313(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
