...
struct void_ mark_visit_254(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ call_w_ctx_287(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct void_ call_8(struct ctx* ctx, struct fun1_1 a, struct logged* p0) {
	...
	struct ctx* _1 = ctx;
	struct logged* _2 = p0;
	return call_w_ctx_287(_0, _1, _2);
}
