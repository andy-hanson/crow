...
struct void_ mark_visit_254(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_255(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_256(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_257(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_258(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_259(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_260(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
struct void_ mark_visit_261(struct mark_ctx* mark_ctx, struct mut_bag_node* value);
...
struct void_ call_w_ctx_288(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct void_ drop_3(struct logged* _p0);
...
struct void_ call_8(struct ctx* ctx, struct fun1_1 a, struct logged* p0) {
	...
	struct ctx* _1 = ctx;
	struct logged* _2 = p0;
	return call_w_ctx_288(_0, _1, _2);
}
