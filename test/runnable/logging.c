...
char constantarr_0_216[13] = "tail<arr<?t>>";
char constantarr_0_217[6] = "forbid";
...
char constantarr_0_402[34] = "set-subscript<by-val<thread-args>>";
...
char constantarr_0_432[19] = "subscript<timespec>";
...
char constantarr_0_475[12] = "return-task!";
char constantarr_0_476[33] = "noctx-must-remove-unordered!<nat>";
char constantarr_0_477[38] = "noctx-must-remove-unordered-recur!<?t>";
char constantarr_0_478[8] = "drop<?t>";
char constantarr_0_479[30] = "noctx-remove-unordered-at!<?t>";
...
char constantarr_0_505[20] = "subscript<ptr<nat8>>";
...
char constantarr_0_513[3] = "log";
char constantarr_0_514[23] = "subscript<void, logged>";
char constantarr_0_515[15] = "get-log-handler";
char constantarr_0_516[7] = "handler";
char constantarr_0_517[11] = "get-log-ctx";
char constantarr_0_518[15] = "as-ref<log-ctx>";
char constantarr_0_519[6] = "logged";
char constantarr_0_520[22] = "as<fun1<void, logged>>";
char constantarr_0_521[12] = "main.lambda0";
char constantarr_0_522[22] = "with-log-handler<void>";
char constantarr_0_523[18] = "as<fun-act0<void>>";
char constantarr_0_524[15] = "set-log-handler";
char constantarr_0_525[30] = "with-log-handler<void>.lambda0";
char constantarr_0_526[11] = "finally<?t>";
char constantarr_0_527[19] = "finally<?t>.lambda0";
char constantarr_0_528[30] = "with-log-handler<void>.lambda1";
char constantarr_0_529[12] = "main.lambda1";
char constantarr_0_530[12] = "drop<logged>";
char constantarr_0_531[12] = "main.lambda2";
char constantarr_0_532[12] = "main.lambda3";
char constantarr_0_533[13] = "resolved<nat>";
...
struct void_ mark_visit_334(struct mark_ctx* mark_ctx, struct then_void_0__lambda0* value);
struct void_ mark_visit_335(struct mark_ctx* mark_ctx, struct then_void_1__lambda0 value);
struct void_ mark_visit_336(struct mark_ctx* mark_ctx, struct then_void_1__lambda0* value);
...
struct void_ mark_visit_345(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_346(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ mark_visit_349(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_350(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_351(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
struct void_ mark_visit_352(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct mut_arr value);
struct void_ mark_arr_355(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct void_ call_w_ctx_370(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 369: {
			return (struct arr_0) {23, constantarr_0_514};
		}
		case 370: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 374: {
			return (struct arr_0) {22, constantarr_0_522};
		}
		case 375: {
...
struct void_ mark_visit_290(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_291(mark_ctx, value.tasks);
	return mark_visit_346(mark_ctx, value.log_handler);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_291(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_292(mark_ctx, value.head);
	return mark_visit_353(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_296(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_349(mark_ctx, value6);
		}
		case 7: {
			struct with_log_handler__lambda1* value7 = _0.as7;
			
			return mark_visit_351(mark_ctx, value7);
		}
		case 8: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_345(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	return mark_visit_346(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_347(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_346(mark_ctx, value.lh);
}
...
struct void_ mark_visit_350(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value) {
	mark_visit_346(mark_ctx, value.handler);
	return mark_visit_296(mark_ctx, value.cb);
}
...
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct mut_list value) {
	return mark_visit_354(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat>> (generated) (generated) */
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct mut_arr value) {
	return mark_arr_355(mark_ctx, value.inner);
}
