...
struct arr_7 subscript_17(struct ctx* ctx, struct arr_7 a, struct arrow range);
...
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct some_2 value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_395(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
struct void_ mark_visit_397(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_398(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value);
struct void_ mark_visit_399(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct some_0 value);
...
struct void_ mark_visit_409(struct mark_ctx* mark_ctx, struct some_10 value);
struct void_ mark_visit_410(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_411(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_412(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
struct void_ mark_visit_413(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value);
struct void_ mark_visit_414(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0* value);
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct subscript_10__lambda0__lambda0 value);
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct subscript_10__lambda0__lambda0* value);
struct void_ mark_visit_417(struct mark_ctx* mark_ctx, struct subscript_10__lambda0 value);
struct void_ mark_visit_418(struct mark_ctx* mark_ctx, struct subscript_10__lambda0* value);
struct void_ mark_visit_419(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0 value);
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0* value);
struct void_ mark_visit_421(struct mark_ctx* mark_ctx, struct subscript_15__lambda0 value);
struct void_ mark_visit_422(struct mark_ctx* mark_ctx, struct subscript_15__lambda0* value);
struct void_ mark_visit_423(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_424(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_425(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_426(struct mark_ctx* mark_ctx, struct arr_3 a);
...
char constantarr_0_298[2];
char constantarr_0_299[9];
char constantarr_0_300[24];
char constantarr_0_301[30];
char constantarr_0_302[1];
char constantarr_0_303[1];
...
char constantarr_0_310[9];
char constantarr_0_311[12];
char constantarr_0_312[3];
char constantarr_0_313[24];
char constantarr_0_314[16];
char constantarr_0_315[4];
char constantarr_0_316[13];
char constantarr_0_317[17];
char constantarr_0_318[7];
char constantarr_0_319[21];
char constantarr_0_320[33];
...
char constantarr_0_444[17];
char constantarr_0_445[4];
...
char constantarr_0_484[36];
char constantarr_0_485[25];
...
char constantarr_0_501[84];
char constantarr_0_502[11];
char constantarr_0_503[45];
...
char constantarr_0_596[22];
char constantarr_0_597[16];
...
char constantarr_0_623[1];
char constantarr_0_624[18];
char constantarr_0_625[7];
char constantarr_0_626[19];
char constantarr_0_627[6];
char constantarr_0_628[5];
char constantarr_0_629[7];
char constantarr_0_630[12];
char constantarr_0_631[3];
char constantarr_0_632[17];
...
struct named_val constantarr_5_0[357];
...
char constantarr_0_78[2] = "||";
char constantarr_0_79[7] = "*<bool>";
char constantarr_0_80[15] = "set-deref<bool>";
...
char constantarr_0_262[12] = "subscript<a>";
char constantarr_0_263[16] = "set-subscript<a>";
char constantarr_0_264[12] = "set-deref<a>";
char constantarr_0_265[10] = "partition!";
char constantarr_0_266[9] = "<=><nat8>";
char constantarr_0_267[6] = "<=><a>";
char constantarr_0_268[18] = "<<const-ptr<nat8>>";
char constantarr_0_269[20] = "val<const-ptr<nat8>>";
char constantarr_0_270[6] = "+<sym>";
char constantarr_0_271[10] = "code-names";
char constantarr_0_272[16] = "fill-code-names!";
char constantarr_0_273[7] = "==<sym>";
char constantarr_0_274[8] = "<=><sym>";
char constantarr_0_275[15] = "<<mut-ptr<sym>>";
char constantarr_0_276[14] = "set-deref<sym>";
char constantarr_0_277[12] = "get-fun-name";
char constantarr_0_278[37] = "subscript<named-val<const-ptr<nat8>>>";
char constantarr_0_279[21] = "name<const-ptr<nat8>>";
char constantarr_0_280[18] = "*<const-ptr<nat8>>";
char constantarr_0_281[18] = "+<const-ptr<nat8>>";
char constantarr_0_282[8] = "arr<sym>";
char constantarr_0_283[13] = "as-const<sym>";
char constantarr_0_284[12] = "begin-ptr<a>";
char constantarr_0_285[14] = "set-backing<a>";
char constantarr_0_286[24] = "uninitialized-mut-arr<a>";
char constantarr_0_287[22] = "alloc-uninitialized<a>";
char constantarr_0_288[5] = "alloc";
char constantarr_0_289[8] = "gc-alloc";
char constantarr_0_290[19] = "todo<mut-ptr<nat8>>";
char constantarr_0_291[18] = "copy-data-from!<a>";
char constantarr_0_292[20] = "set-zero-elements<a>";
char constantarr_0_293[18] = "from<nat64, nat64>";
char constantarr_0_294[16] = "to<nat64, nat64>";
char constantarr_0_295[16] = "-><nat64, nat64>";
char constantarr_0_296[11] = "arrow<a, b>";
char constantarr_0_297[1] = "+";
char constantarr_0_298[2] = "&&";
char constantarr_0_299[9] = ">=<nat64>";
char constantarr_0_300[24] = "round-up-to-power-of-two";
char constantarr_0_301[30] = "round-up-to-power-of-two-recur";
char constantarr_0_302[1] = "*";
char constantarr_0_303[1] = "/";
char constantarr_0_304[6] = "forbid";
char constantarr_0_305[11] = "set-size<a>";
char constantarr_0_306[16] = "~=<char>.lambda0";
char constantarr_0_307[8] = "is-empty";
char constantarr_0_308[14] = "is-empty<char>";
char constantarr_0_309[7] = "message";
char constantarr_0_310[9] = "each<sym>";
char constantarr_0_311[12] = "return-stack";
char constantarr_0_312[3] = "str";
char constantarr_0_313[24] = "arr-from-begin-end<char>";
char constantarr_0_314[16] = "<=<const-ptr<a>>";
char constantarr_0_315[4] = "<<a>";
char constantarr_0_316[13] = "find-cstr-end";
char constantarr_0_317[17] = "find-char-in-cstr";
char constantarr_0_318[7] = "to-nat8";
char constantarr_0_319[21] = "some<const-ptr<char>>";
char constantarr_0_320[33] = "hard-unreachable<const-ptr<char>>";
char constantarr_0_321[8] = "to-c-str";
char constantarr_0_322[14] = "to-str.lambda0";
char constantarr_0_323[12] = "move-to-str!";
char constantarr_0_324[18] = "move-to-arr!<char>";
char constantarr_0_325[28] = "set-any-unhandled-exceptions";
char constantarr_0_326[14] = "get-global-ctx";
char constantarr_0_327[18] = "as-ref<global-ctx>";
char constantarr_0_328[8] = "gctx-ptr";
char constantarr_0_329[14] = "island.lambda0";
char constantarr_0_330[19] = "default-log-handler";
char constantarr_0_331[5] = "print";
char constantarr_0_332[16] = "print-no-newline";
char constantarr_0_333[6] = "stdout";
char constantarr_0_334[7] = "~<char>";
char constantarr_0_335[5] = "level";
char constantarr_0_336[14] = "island.lambda1";
char constantarr_0_337[20] = "ptr-cast<bool, nat8>";
char constantarr_0_338[29] = "as-any-mut-ptr<mut-ptr<bool>>";
char constantarr_0_339[14] = "as<by-val<gc>>";
char constantarr_0_340[11] = "validate-gc";
char constantarr_0_341[10] = "data-begin";
char constantarr_0_342[9] = "<=><bool>";
char constantarr_0_343[17] = "<=<mut-ptr<bool>>";
char constantarr_0_344[8] = "mark-end";
char constantarr_0_345[18] = "<=<mut-ptr<nat64>>";
char constantarr_0_346[14] = "ref-of-val<gc>";
char constantarr_0_347[19] = "thread-safe-counter";
char constantarr_0_348[18] = "ref-of-val<island>";
char constantarr_0_349[11] = "set-islands";
char constantarr_0_350[11] = "arr<island>";
char constantarr_0_351[14] = "ptr-to<island>";
char constantarr_0_352[13] = "add-main-task";
char constantarr_0_353[13] = "exception-ctx";
char constantarr_0_354[7] = "log-ctx";
char constantarr_0_355[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_356[8] = "perf-ctx";
char constantarr_0_357[22] = "mut-arr<measure-value>";
char constantarr_0_358[29] = "as-any-mut-ptr<exception-ctx>";
char constantarr_0_359[25] = "ref-of-val<exception-ctx>";
char constantarr_0_360[23] = "as-any-mut-ptr<log-ctx>";
char constantarr_0_361[19] = "ref-of-val<log-ctx>";
char constantarr_0_362[24] = "as-any-mut-ptr<perf-ctx>";
char constantarr_0_363[20] = "ref-of-val<perf-ctx>";
char constantarr_0_364[10] = "print-lock";
char constantarr_0_365[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_366[3] = "ctx";
char constantarr_0_367[12] = "context-head";
char constantarr_0_368[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_369[6] = "set-gc";
char constantarr_0_370[12] = "set-next-ctx";
char constantarr_0_371[16] = "set-context-head";
char constantarr_0_372[8] = "next-ctx";
char constantarr_0_373[11] = "set-handler";
char constantarr_0_374[15] = "as-ref<log-ctx>";
char constantarr_0_375[11] = "log-ctx-ptr";
char constantarr_0_376[11] = "log-handler";
char constantarr_0_377[26] = "ref-of-val<island-gc-root>";
char constantarr_0_378[7] = "gc-root";
char constantarr_0_379[26] = "as-any-mut-ptr<global-ctx>";
char constantarr_0_380[2] = "id";
char constantarr_0_381[22] = "as-any-mut-ptr<gc-ctx>";
char constantarr_0_382[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_383[15] = "ref-of-val<ctx>";
char constantarr_0_384[83] = "as<fun-act2<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_385[14] = "add-first-task";
char constantarr_0_386[16] = "then-void<nat64>";
char constantarr_0_387[15] = "then<out, void>";
char constantarr_0_388[15] = "unresolved<out>";
char constantarr_0_389[6] = "fut<a>";
char constantarr_0_390[22] = "fut-state-no-callbacks";
char constantarr_0_391[13] = "callback!<in>";
char constantarr_0_392[15] = "with-lock<void>";
char constantarr_0_393[16] = "call-with-ctx<r>";
char constantarr_0_394[5] = "lk<a>";
char constantarr_0_395[8] = "state<a>";
char constantarr_0_396[12] = "set-state<a>";
char constantarr_0_397[22] = "fut-state-callbacks<a>";
char constantarr_0_398[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_399[37] = "subscript<void, result<a, exception>>";
char constantarr_0_400[5] = "ok<a>";
char constantarr_0_401[8] = "value<a>";
char constantarr_0_402[14] = "err<exception>";
char constantarr_0_403[21] = "callback!<in>.lambda0";
char constantarr_0_404[16] = "forward-to!<out>";
char constantarr_0_405[12] = "callback!<a>";
char constantarr_0_406[20] = "callback!<a>.lambda0";
char constantarr_0_407[21] = "resolve-or-reject!<a>";
char constantarr_0_408[23] = "with-lock<fut-state<a>>";
char constantarr_0_409[21] = "fut-state-resolved<a>";
char constantarr_0_410[16] = "value<exception>";
char constantarr_0_411[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_412[18] = "call-callbacks!<a>";
char constantarr_0_413[5] = "cb<a>";
char constantarr_0_414[7] = "next<a>";
char constantarr_0_415[24] = "forward-to!<out>.lambda0";
char constantarr_0_416[18] = "subscript<out, in>";
char constantarr_0_417[10] = "get-island";
char constantarr_0_418[17] = "subscript<island>";
char constantarr_0_419[12] = "unsafe-at<a>";
char constantarr_0_420[7] = "islands";
char constantarr_0_421[27] = "island-and-exclusion<r, p0>";
char constantarr_0_422[8] = "add-task";
char constantarr_0_423[15] = "task-queue-node";
char constantarr_0_424[4] = "task";
char constantarr_0_425[10] = "tasks-lock";
char constantarr_0_426[12] = "insert-task!";
char constantarr_0_427[4] = "size";
char constantarr_0_428[10] = "size-recur";
char constantarr_0_429[4] = "next";
char constantarr_0_430[4] = "head";
char constantarr_0_431[8] = "set-head";
char constantarr_0_432[21] = "some<task-queue-node>";
char constantarr_0_433[4] = "time";
char constantarr_0_434[12] = "insert-recur";
char constantarr_0_435[8] = "set-next";
char constantarr_0_436[5] = "tasks";
char constantarr_0_437[22] = "ref-of-val<task-queue>";
char constantarr_0_438[10] = "broadcast!";
char constantarr_0_439[18] = "pthread_mutex_lock";
char constantarr_0_440[22] = "pthread_cond_broadcast";
char constantarr_0_441[12] = "set-sequence";
char constantarr_0_442[8] = "sequence";
char constantarr_0_443[20] = "pthread_mutex_unlock";
char constantarr_0_444[17] = "may-be-work-to-do";
char constantarr_0_445[4] = "gctx";
char constantarr_0_446[12] = "no-timestamp";
char constantarr_0_447[9] = "exclusion";
char constantarr_0_448[11] = "catch<void>";
char constantarr_0_449[27] = "catch-with-exception-ctx<a>";
char constantarr_0_450[16] = "thrown-exception";
char constantarr_0_451[13] = "__jmp_buf_tag";
char constantarr_0_452[4] = "zero";
char constantarr_0_453[7] = "bytes64";
char constantarr_0_454[7] = "bytes32";
char constantarr_0_455[7] = "bytes16";
char constantarr_0_456[8] = "bytes128";
char constantarr_0_457[15] = "set-jmp-buf-ptr";
char constantarr_0_458[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_459[6] = "setjmp";
char constantarr_0_460[23] = "subscript<a, exception>";
char constantarr_0_461[21] = "subscript<fut<r>, p0>";
char constantarr_0_462[10] = "fun<r, p0>";
char constantarr_0_463[34] = "subscript<out, in>.lambda0.lambda0";
char constantarr_0_464[10] = "reject!<r>";
char constantarr_0_465[34] = "subscript<out, in>.lambda0.lambda1";
char constantarr_0_466[26] = "subscript<out, in>.lambda0";
char constantarr_0_467[9] = "value<in>";
char constantarr_0_468[23] = "then<out, void>.lambda0";
char constantarr_0_469[14] = "subscript<out>";
char constantarr_0_470[23] = "island-and-exclusion<r>";
char constantarr_0_471[17] = "subscript<fut<r>>";
char constantarr_0_472[6] = "fun<r>";
char constantarr_0_473[30] = "subscript<out>.lambda0.lambda0";
char constantarr_0_474[30] = "subscript<out>.lambda0.lambda1";
char constantarr_0_475[22] = "subscript<out>.lambda0";
char constantarr_0_476[24] = "then-void<nat64>.lambda0";
char constantarr_0_477[24] = "cur-island-and-exclusion";
char constantarr_0_478[20] = "island-and-exclusion";
char constantarr_0_479[9] = "island-id";
char constantarr_0_480[5] = "delay";
char constantarr_0_481[14] = "resolved<void>";
char constantarr_0_482[21] = "tail<const-ptr<char>>";
char constantarr_0_483[11] = "is-empty<a>";
char constantarr_0_484[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_485[25] = "map<str, const-ptr<char>>";
char constantarr_0_486[13] = "make-arr<out>";
char constantarr_0_487[17] = "fill-ptr-range<a>";
char constantarr_0_488[23] = "fill-ptr-range-recur<a>";
char constantarr_0_489[9] = "!=<nat64>";
char constantarr_0_490[19] = "subscript<a, nat64>";
char constantarr_0_491[13] = "subscript<in>";
char constantarr_0_492[33] = "map<str, const-ptr<char>>.lambda0";
char constantarr_0_493[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_494[22] = "add-first-task.lambda0";
char constantarr_0_495[24] = "handle-exceptions<nat64>";
char constantarr_0_496[26] = "subscript<void, exception>";
char constantarr_0_497[17] = "exception-handler";
char constantarr_0_498[14] = "get-cur-island";
char constantarr_0_499[32] = "handle-exceptions<nat64>.lambda0";
char constantarr_0_500[21] = "add-main-task.lambda0";
char constantarr_0_501[84] = "call-with-ctx<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
char constantarr_0_502[11] = "run-threads";
char constantarr_0_503[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_504[19] = "start-threads-recur";
char constantarr_0_505[22] = "+<by-val<thread-args>>";
char constantarr_0_506[30] = "set-deref<by-val<thread-args>>";
char constantarr_0_507[11] = "thread-args";
char constantarr_0_508[17] = "create-one-thread";
char constantarr_0_509[14] = "pthread_create";
char constantarr_0_510[9] = "!=<int32>";
char constantarr_0_511[6] = "EAGAIN";
char constantarr_0_512[14] = "as-cell<nat64>";
char constantarr_0_513[15] = "as-ref<cell<a>>";
char constantarr_0_514[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
char constantarr_0_515[10] = "thread-fun";
char constantarr_0_516[19] = "as-ref<thread-args>";
char constantarr_0_517[15] = "thread-function";
char constantarr_0_518[21] = "thread-function-recur";
char constantarr_0_519[12] = "is-shut-down";
char constantarr_0_520[18] = "set-n-live-threads";
char constantarr_0_521[14] = "n-live-threads";
char constantarr_0_522[28] = "assert-islands-are-shut-down";
char constantarr_0_523[16] = "noctx-at<island>";
char constantarr_0_524[11] = "hard-forbid";
char constantarr_0_525[8] = "needs-gc";
char constantarr_0_526[17] = "n-threads-running";
char constantarr_0_527[25] = "is-empty<task-queue-node>";
char constantarr_0_528[12] = "get-sequence";
char constantarr_0_529[11] = "choose-task";
char constantarr_0_530[17] = "get-monotime-nsec";
char constantarr_0_531[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_532[14] = "cell<timespec>";
char constantarr_0_533[8] = "timespec";
char constantarr_0_534[13] = "clock_gettime";
char constantarr_0_535[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_536[11] = "*<timespec>";
char constantarr_0_537[14] = "inner-value<a>";
char constantarr_0_538[6] = "tv-sec";
char constantarr_0_539[7] = "tv-nsec";
char constantarr_0_540[11] = "todo<nat64>";
char constantarr_0_541[22] = "as<choose-task-result>";
char constantarr_0_542[17] = "choose-task-recur";
char constantarr_0_543[14] = "no-chosen-task";
char constantarr_0_544[21] = "choose-task-in-island";
char constantarr_0_545[32] = "as<choose-task-in-island-result>";
char constantarr_0_546[7] = "do-a-gc";
char constantarr_0_547[7] = "no-task";
char constantarr_0_548[9] = "pop-task!";
char constantarr_0_549[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_550[28] = "currently-running-exclusions";
char constantarr_0_551[19] = "as<pop-task-result>";
char constantarr_0_552[9] = "in<nat64>";
char constantarr_0_553[5] = "in<a>";
char constantarr_0_554[11] = "in-recur<a>";
char constantarr_0_555[11] = "noctx-at<a>";
char constantarr_0_556[14] = "temp-as-arr<a>";
char constantarr_0_557[18] = "temp-as-mut-arr<a>";
char constantarr_0_558[10] = "pop-recur!";
char constantarr_0_559[11] = "to-opt-time";
char constantarr_0_560[11] = "some<nat64>";
char constantarr_0_561[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_562[10] = "is-no-task";
char constantarr_0_563[21] = "set-n-threads-running";
char constantarr_0_564[11] = "chosen-task";
char constantarr_0_565[9] = "any-tasks";
char constantarr_0_566[8] = "min-time";
char constantarr_0_567[10] = "min<nat64>";
char constantarr_0_568[15] = "first-task-time";
char constantarr_0_569[28] = "no-tasks-and-last-thread-out";
char constantarr_0_570[7] = "do-task";
char constantarr_0_571[11] = "task-island";
char constantarr_0_572[10] = "task-or-gc";
char constantarr_0_573[6] = "action";
char constantarr_0_574[12] = "return-task!";
char constantarr_0_575[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_576[37] = "noctx-must-remove-unordered-recur!<a>";
char constantarr_0_577[7] = "drop<a>";
char constantarr_0_578[29] = "noctx-remove-unordered-at!<a>";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {357, constantarr_5_0}.begin_ptr, (struct arr_5) {357, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {357, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {357, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {357, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_424(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct some_3 value) {
	return mark_visit_423(mark_ctx, value.value);
}
...
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_412(mark_ctx, value0);
		}
		case 1: {
		...
		case 2: {
			...
			return mark_visit_416(mark_ctx, value2);
		}
		case 3: {
			struct subscript_10__lambda0* value3 = _0.as3;
			
			return mark_visit_418(mark_ctx, value3);
		}
		case 4: {
			struct subscript_15__lambda0__lambda0* value4 = _0.as4;
			
			return mark_visit_420(mark_ctx, value4);
		}
		case 5: {
			struct subscript_15__lambda0* value5 = _0.as5;
			
			return mark_visit_422(mark_ctx, value5);
		}
		default:
...
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	mark_visit_411(mark_ctx, value.f);
...
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_410(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_397(mark_ctx, value.res);
}
...
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_387(mark_ctx, value.gc);
	return mark_visit_389(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_384(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct opt_2 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_385(mark_ctx, value1);
		}
		default:
...
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_387(mark_ctx, value.gc);
	return mark_visit_384(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_393(mark_ctx, value.state);
}
...
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_395(mark_ctx, value.cb);
...
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_397(mark_ctx, value.to);
}
...
struct void_ mark_visit_409(struct mark_ctx* mark_ctx, struct some_10 value) {
	return mark_visit_410(mark_ctx, value.value);
}
...
struct void_ mark_visit_413(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	...
	return mark_visit_395(mark_ctx, value.cb);
}
...
struct void_ mark_visit_418(struct mark_ctx* mark_ctx, struct subscript_10__lambda0* value) {
	...
	if (_0) {
		return mark_visit_417(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_424(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_425(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_425(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_426(mark_ctx, value.inner);
}
