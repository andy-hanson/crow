...
struct fut_0* call_w_ctx_279(struct fun_act2 a, struct ctx* ctx, struct arr_7 p0, fun_ptr2 p1);
...
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_355(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_356(struct mark_ctx* mark_ctx, struct some_2 value);
struct void_ mark_visit_357(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_358(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_359(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_360(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_365(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_366(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value);
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_371(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_375(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_376(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_377(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_379(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_380(struct mark_ctx* mark_ctx, struct some_10 value);
struct void_ mark_visit_381(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value);
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0* value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0 value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0* value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct subscript_9__lambda0 value);
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct subscript_9__lambda0* value);
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0 value);
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0* value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct subscript_14__lambda0 value);
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct subscript_14__lambda0* value);
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_395(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_397(struct mark_ctx* mark_ctx, struct arr_3 a);
...
char constantarr_0_383[23];
char constantarr_0_384[29];
char constantarr_0_385[38];
...
char constantarr_0_405[13];
char constantarr_0_406[7];
char constantarr_0_407[29];
...
struct named_val constantarr_5_0[325];
struct sym constantarr_1_0[214];
...
char constantarr_0_59[10] = "cmp<nat64>";
...
char constantarr_0_291[6] = "empty?";
char constantarr_0_292[12] = "empty?<char>";
char constantarr_0_293[7] = "message";
char constantarr_0_294[9] = "each<sym>";
char constantarr_0_295[12] = "return-stack";
char constantarr_0_296[3] = "str";
char constantarr_0_297[24] = "arr-from-begin-end<char>";
char constantarr_0_298[7] = "<=><?a>";
char constantarr_0_299[11] = "<=<ptr<?a>>";
char constantarr_0_300[5] = "<<?a>";
char constantarr_0_301[5] = "-<?a>";
char constantarr_0_302[13] = "find-cstr-end";
char constantarr_0_303[17] = "find-char-in-cstr";
char constantarr_0_304[7] = "to-nat8";
char constantarr_0_305[15] = "some<ptr<char>>";
char constantarr_0_306[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_307[8] = "to-c-str";
char constantarr_0_308[14] = "to-str.lambda0";
char constantarr_0_309[12] = "move-to-str!";
char constantarr_0_310[18] = "move-to-arr!<char>";
...
char constantarr_0_325[14] = "as<by-val<gc>>";
char constantarr_0_326[11] = "validate-gc";
char constantarr_0_327[10] = "data-begin";
char constantarr_0_328[9] = "<=><bool>";
char constantarr_0_329[13] = "<=<ptr<bool>>";
char constantarr_0_330[8] = "mark-end";
char constantarr_0_331[14] = "<=<ptr<nat64>>";
char constantarr_0_332[14] = "ref-of-val<gc>";
char constantarr_0_333[19] = "thread-safe-counter";
char constantarr_0_334[18] = "ref-of-val<island>";
char constantarr_0_335[11] = "set-islands";
char constantarr_0_336[11] = "arr<island>";
char constantarr_0_337[14] = "ptr-to<island>";
char constantarr_0_338[13] = "add-main-task";
char constantarr_0_339[13] = "exception-ctx";
char constantarr_0_340[7] = "log-ctx";
char constantarr_0_341[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_342[8] = "perf-ctx";
char constantarr_0_343[22] = "mut-arr<measure-value>";
char constantarr_0_344[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_345[25] = "ref-of-val<exception-ctx>";
char constantarr_0_346[19] = "as-any-ptr<log-ctx>";
char constantarr_0_347[19] = "ref-of-val<log-ctx>";
char constantarr_0_348[20] = "as-any-ptr<perf-ctx>";
char constantarr_0_349[20] = "ref-of-val<perf-ctx>";
char constantarr_0_350[10] = "print-lock";
char constantarr_0_351[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_352[3] = "ctx";
char constantarr_0_353[12] = "context-head";
char constantarr_0_354[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_355[6] = "set-gc";
char constantarr_0_356[12] = "set-next-ctx";
char constantarr_0_357[16] = "set-context-head";
char constantarr_0_358[8] = "next-ctx";
char constantarr_0_359[11] = "set-handler";
char constantarr_0_360[15] = "as-ref<log-ctx>";
char constantarr_0_361[11] = "log-ctx-ptr";
char constantarr_0_362[11] = "log-handler";
char constantarr_0_363[26] = "ref-of-val<island-gc-root>";
char constantarr_0_364[7] = "gc-root";
char constantarr_0_365[22] = "as-any-ptr<global-ctx>";
char constantarr_0_366[2] = "id";
char constantarr_0_367[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_368[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_369[15] = "ref-of-val<ctx>";
char constantarr_0_370[77] = "as<fun-act2<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_371[14] = "add-first-task";
char constantarr_0_372[16] = "then-void<nat64>";
char constantarr_0_373[16] = "then<?out, void>";
char constantarr_0_374[16] = "unresolved<?out>";
char constantarr_0_375[7] = "fut<?a>";
char constantarr_0_376[22] = "fut-state-no-callbacks";
char constantarr_0_377[14] = "callback!<?in>";
char constantarr_0_378[15] = "with-lock<void>";
char constantarr_0_379[17] = "call-with-ctx<?r>";
char constantarr_0_380[6] = "lk<?a>";
char constantarr_0_381[9] = "state<?a>";
char constantarr_0_382[13] = "set-state<?a>";
char constantarr_0_383[23] = "fut-state-callbacks<?a>";
char constantarr_0_384[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_385[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_386[6] = "ok<?a>";
char constantarr_0_387[9] = "value<?a>";
char constantarr_0_388[14] = "err<exception>";
char constantarr_0_389[22] = "callback!<?in>.lambda0";
char constantarr_0_390[17] = "forward-to!<?out>";
char constantarr_0_391[13] = "callback!<?a>";
char constantarr_0_392[21] = "callback!<?a>.lambda0";
char constantarr_0_393[22] = "resolve-or-reject!<?a>";
char constantarr_0_394[24] = "with-lock<fut-state<?a>>";
char constantarr_0_395[22] = "fut-state-resolved<?a>";
char constantarr_0_396[16] = "value<exception>";
char constantarr_0_397[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_398[19] = "call-callbacks!<?a>";
char constantarr_0_399[6] = "cb<?a>";
char constantarr_0_400[8] = "next<?a>";
char constantarr_0_401[25] = "forward-to!<?out>.lambda0";
char constantarr_0_402[20] = "subscript<?out, ?in>";
char constantarr_0_403[10] = "get-island";
char constantarr_0_404[17] = "subscript<island>";
char constantarr_0_405[13] = "unsafe-at<?a>";
char constantarr_0_406[7] = "islands";
char constantarr_0_407[29] = "island-and-exclusion<?r, ?p0>";
char constantarr_0_408[8] = "add-task";
char constantarr_0_409[15] = "task-queue-node";
char constantarr_0_410[4] = "task";
char constantarr_0_411[10] = "tasks-lock";
char constantarr_0_412[12] = "insert-task!";
char constantarr_0_413[4] = "size";
char constantarr_0_414[10] = "size-recur";
char constantarr_0_415[4] = "next";
char constantarr_0_416[4] = "head";
char constantarr_0_417[8] = "set-head";
char constantarr_0_418[21] = "some<task-queue-node>";
char constantarr_0_419[4] = "time";
...
char constantarr_0_435[28] = "catch-with-exception-ctx<?a>";
char constantarr_0_436[16] = "thrown-exception";
char constantarr_0_437[13] = "__jmp_buf_tag";
char constantarr_0_438[4] = "zero";
char constantarr_0_439[7] = "bytes64";
char constantarr_0_440[7] = "bytes32";
char constantarr_0_441[7] = "bytes16";
char constantarr_0_442[8] = "bytes128";
char constantarr_0_443[15] = "set-jmp-buf-ptr";
char constantarr_0_444[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_445[6] = "setjmp";
char constantarr_0_446[24] = "subscript<?a, exception>";
char constantarr_0_447[23] = "subscript<fut<?r>, ?p0>";
char constantarr_0_448[12] = "fun<?r, ?p0>";
char constantarr_0_449[36] = "subscript<?out, ?in>.lambda0.lambda0";
char constantarr_0_450[11] = "reject!<?r>";
char constantarr_0_451[36] = "subscript<?out, ?in>.lambda0.lambda1";
char constantarr_0_452[28] = "subscript<?out, ?in>.lambda0";
char constantarr_0_453[10] = "value<?in>";
char constantarr_0_454[24] = "then<?out, void>.lambda0";
char constantarr_0_455[15] = "subscript<?out>";
char constantarr_0_456[24] = "island-and-exclusion<?r>";
char constantarr_0_457[18] = "subscript<fut<?r>>";
char constantarr_0_458[7] = "fun<?r>";
char constantarr_0_459[31] = "subscript<?out>.lambda0.lambda0";
char constantarr_0_460[31] = "subscript<?out>.lambda0.lambda1";
char constantarr_0_461[23] = "subscript<?out>.lambda0";
char constantarr_0_462[24] = "then-void<nat64>.lambda0";
...
char constantarr_0_469[10] = "empty?<?a>";
char constantarr_0_470[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_471[19] = "map<str, ptr<char>>";
char constantarr_0_472[14] = "make-arr<?out>";
char constantarr_0_473[18] = "fill-ptr-range<?a>";
char constantarr_0_474[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_475[9] = "!=<nat64>";
char constantarr_0_476[20] = "subscript<?a, nat64>";
char constantarr_0_477[14] = "subscript<?in>";
char constantarr_0_478[27] = "map<str, ptr<char>>.lambda0";
char constantarr_0_479[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_480[22] = "add-first-task.lambda0";
char constantarr_0_481[24] = "handle-exceptions<nat64>";
...
char constantarr_0_485[32] = "handle-exceptions<nat64>.lambda0";
char constantarr_0_486[21] = "add-main-task.lambda0";
char constantarr_0_487[78] = "call-with-ctx<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
...
char constantarr_0_492[34] = "set-subscript<by-val<thread-args>>";
char constantarr_0_493[11] = "thread-args";
char constantarr_0_494[17] = "create-one-thread";
char constantarr_0_495[14] = "pthread_create";
char constantarr_0_496[9] = "!=<int32>";
char constantarr_0_497[6] = "EAGAIN";
char constantarr_0_498[14] = "as-cell<nat64>";
char constantarr_0_499[16] = "as-ref<cell<?a>>";
...
char constantarr_0_509[16] = "noctx-at<island>";
char constantarr_0_510[9] = "needs-gc?";
char constantarr_0_511[17] = "n-threads-running";
char constantarr_0_512[23] = "empty?<task-queue-node>";
char constantarr_0_513[12] = "get-sequence";
...
char constantarr_0_519[13] = "clock_gettime";
...
char constantarr_0_524[11] = "todo<nat64>";
...
char constantarr_0_533[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_534[28] = "currently-running-exclusions";
char constantarr_0_535[19] = "as<pop-task-result>";
char constantarr_0_536[16] = "contains?<nat64>";
char constantarr_0_537[13] = "contains?<?a>";
char constantarr_0_538[19] = "contains-recur?<?a>";
char constantarr_0_539[12] = "noctx-at<?a>";
char constantarr_0_540[15] = "temp-as-arr<?a>";
char constantarr_0_541[19] = "temp-as-mut-arr<?a>";
char constantarr_0_542[10] = "pop-recur!";
char constantarr_0_543[11] = "to-opt-time";
char constantarr_0_544[11] = "some<nat64>";
char constantarr_0_545[40] = "push-capacity-must-be-sufficient!<nat64>";
...
char constantarr_0_551[10] = "min<nat64>";
...
char constantarr_0_559[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_560[38] = "noctx-must-remove-unordered-recur!<?a>";
char constantarr_0_561[8] = "drop<?a>";
char constantarr_0_562[30] = "noctx-remove-unordered-at!<?a>";
...
char constantarr_0_567[12] = "set-gc-count";
char constantarr_0_568[8] = "gc-count";
char constantarr_0_569[20] = "as<by-val<mark-ctx>>";
char constantarr_0_570[8] = "mark-ctx";
char constantarr_0_571[14] = "mark-visit<?a>";
char constantarr_0_572[20] = "ref-of-val<mark-ctx>";
char constantarr_0_573[15] = "clear-free-mem!";
char constantarr_0_574[13] = "!=<ptr<bool>>";
char constantarr_0_575[14] = "set-shut-down?";
char constantarr_0_576[7] = "wait-on";
char constantarr_0_577[17] = "pthread_cond_wait";
char constantarr_0_578[11] = "to-timespec";
char constantarr_0_579[10] = "unsafe-mod";
char constantarr_0_580[22] = "pthread_cond_timedwait";
char constantarr_0_581[16] = "ptr-to<timespec>";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {325, constantarr_5_0}.begin_ptr, (struct arr_5) {325, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {325, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {325, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		struct sym _1 = get_fun_name((*code_ptrs), funs, (struct arr_5) {325, constantarr_5_0}.size);
		*code_names = _1;
...
struct void_ mark_visit_333(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_395(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_338(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_387(mark_ctx, value2);
		}
		case 3: {
			struct subscript_9__lambda0* value3 = _0.as3;
			
			return mark_visit_389(mark_ctx, value3);
		}
		case 4: {
			struct subscript_14__lambda0__lambda0* value4 = _0.as4;
			
			return mark_visit_391(mark_ctx, value4);
		}
		case 5: {
			struct subscript_14__lambda0* value5 = _0.as5;
			
			return mark_visit_393(mark_ctx, value5);
		}
		default:
...
struct void_ mark_visit_341(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_381(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_342(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1 value) {
	...
	return mark_visit_379(mark_ctx, value.next);
}
...
struct void_ mark_visit_343(struct mark_ctx* mark_ctx, struct fun_act1_3 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_378(mark_ctx, value0);
		}
		default:
...
struct void_ mark_visit_344(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_368(mark_ctx, value.res);
}
...
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_358(mark_ctx, value.gc);
	return mark_visit_360(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_355(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_357(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_358(mark_ctx, value.gc);
	return mark_visit_355(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_364(mark_ctx, value.state);
}
...
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_368(mark_ctx, value.to);
}
...
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_374(mark_ctx, value.message);
	return mark_visit_376(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_375(mark_ctx, value.chars);
}
...
struct void_ mark_visit_376(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_377(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	mark_visit_368(mark_ctx, value.f);
	return mark_visit_366(mark_ctx, value.cb);
}
...
struct void_ mark_visit_395(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_396(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_397(mark_ctx, value.inner);
}
