...
struct arrow _arrow(uint64_t from, uint64_t to);
...
struct arr_0 cast_immutable(struct mut_arr_1 a);
struct mut_arr_1 move_to_mut_arr__e(struct mut_list_1* a);
...
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct some_2 value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_395(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_397(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_398(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
struct void_ mark_visit_399(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value);
struct void_ mark_visit_401(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_402(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_403(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_405(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_406(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_407(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_408(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_409(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_410(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_411(struct mark_ctx* mark_ctx, struct some_10 value);
struct void_ mark_visit_412(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_413(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_414(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value);
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0* value);
struct void_ mark_visit_417(struct mark_ctx* mark_ctx, struct subscript_10__lambda0__lambda0 value);
struct void_ mark_visit_418(struct mark_ctx* mark_ctx, struct subscript_10__lambda0__lambda0* value);
struct void_ mark_visit_419(struct mark_ctx* mark_ctx, struct subscript_10__lambda0 value);
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct subscript_10__lambda0* value);
...
struct void_ mark_visit_425(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_426(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_427(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_428(struct mark_ctx* mark_ctx, struct arr_3 a);
...
char constantarr_0_325[17];
char constantarr_0_326[19];
char constantarr_0_327[28];
...
char constantarr_0_400[28];
char constantarr_0_401[37];
...
char constantarr_0_503[84];
char constantarr_0_504[11];
char constantarr_0_505[45];
...
char constantarr_0_598[22];
char constantarr_0_599[16];
char constantarr_0_600[9];
char constantarr_0_601[9];
...
char constantarr_0_609[5];
char constantarr_0_610[16];
char constantarr_0_611[21];
char constantarr_0_612[4];
char constantarr_0_613[35];
char constantarr_0_614[17];
char constantarr_0_615[25];
char constantarr_0_616[21];
char constantarr_0_617[24];
char constantarr_0_618[20];
char constantarr_0_619[24];
char constantarr_0_620[4];
char constantarr_0_621[14];
char constantarr_0_622[14];
char constantarr_0_623[12];
char constantarr_0_624[12];
char constantarr_0_625[1];
char constantarr_0_626[18];
...
struct named_val constantarr_5_0[359];
struct sym constantarr_1_0[218];
...
char constantarr_0_325[17] = "cast-immutable<a>";
char constantarr_0_326[19] = "move-to-mut-arr!<a>";
char constantarr_0_327[28] = "set-any-unhandled-exceptions";
char constantarr_0_328[14] = "get-global-ctx";
char constantarr_0_329[18] = "as-ref<global-ctx>";
char constantarr_0_330[8] = "gctx-ptr";
char constantarr_0_331[14] = "island.lambda0";
char constantarr_0_332[19] = "default-log-handler";
char constantarr_0_333[5] = "print";
char constantarr_0_334[16] = "print-no-newline";
char constantarr_0_335[6] = "stdout";
char constantarr_0_336[7] = "~<char>";
char constantarr_0_337[5] = "level";
char constantarr_0_338[14] = "island.lambda1";
char constantarr_0_339[20] = "ptr-cast<bool, nat8>";
char constantarr_0_340[29] = "as-any-mut-ptr<mut-ptr<bool>>";
char constantarr_0_341[14] = "as<by-val<gc>>";
char constantarr_0_342[11] = "validate-gc";
char constantarr_0_343[10] = "data-begin";
char constantarr_0_344[9] = "<=><bool>";
char constantarr_0_345[17] = "<=<mut-ptr<bool>>";
char constantarr_0_346[8] = "mark-end";
char constantarr_0_347[18] = "<=<mut-ptr<nat64>>";
char constantarr_0_348[14] = "ref-of-val<gc>";
char constantarr_0_349[19] = "thread-safe-counter";
char constantarr_0_350[18] = "ref-of-val<island>";
char constantarr_0_351[11] = "set-islands";
char constantarr_0_352[11] = "arr<island>";
char constantarr_0_353[14] = "ptr-to<island>";
char constantarr_0_354[13] = "add-main-task";
char constantarr_0_355[13] = "exception-ctx";
char constantarr_0_356[7] = "log-ctx";
char constantarr_0_357[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_358[8] = "perf-ctx";
char constantarr_0_359[22] = "mut-arr<measure-value>";
char constantarr_0_360[29] = "as-any-mut-ptr<exception-ctx>";
char constantarr_0_361[25] = "ref-of-val<exception-ctx>";
char constantarr_0_362[23] = "as-any-mut-ptr<log-ctx>";
char constantarr_0_363[19] = "ref-of-val<log-ctx>";
char constantarr_0_364[24] = "as-any-mut-ptr<perf-ctx>";
char constantarr_0_365[20] = "ref-of-val<perf-ctx>";
char constantarr_0_366[10] = "print-lock";
char constantarr_0_367[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_368[3] = "ctx";
char constantarr_0_369[12] = "context-head";
char constantarr_0_370[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_371[6] = "set-gc";
char constantarr_0_372[12] = "set-next-ctx";
char constantarr_0_373[16] = "set-context-head";
char constantarr_0_374[8] = "next-ctx";
char constantarr_0_375[11] = "set-handler";
char constantarr_0_376[15] = "as-ref<log-ctx>";
char constantarr_0_377[11] = "log-ctx-ptr";
char constantarr_0_378[11] = "log-handler";
char constantarr_0_379[26] = "ref-of-val<island-gc-root>";
char constantarr_0_380[7] = "gc-root";
char constantarr_0_381[26] = "as-any-mut-ptr<global-ctx>";
char constantarr_0_382[2] = "id";
char constantarr_0_383[22] = "as-any-mut-ptr<gc-ctx>";
char constantarr_0_384[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_385[15] = "ref-of-val<ctx>";
char constantarr_0_386[83] = "as<fun-act2<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_387[14] = "add-first-task";
char constantarr_0_388[16] = "then-void<nat64>";
char constantarr_0_389[15] = "then<out, void>";
char constantarr_0_390[15] = "unresolved<out>";
char constantarr_0_391[6] = "fut<a>";
char constantarr_0_392[22] = "fut-state-no-callbacks";
char constantarr_0_393[13] = "callback!<in>";
char constantarr_0_394[15] = "with-lock<void>";
char constantarr_0_395[16] = "call-with-ctx<r>";
char constantarr_0_396[5] = "lk<a>";
char constantarr_0_397[8] = "state<a>";
char constantarr_0_398[12] = "set-state<a>";
char constantarr_0_399[22] = "fut-state-callbacks<a>";
char constantarr_0_400[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_401[37] = "subscript<void, result<a, exception>>";
char constantarr_0_402[5] = "ok<a>";
char constantarr_0_403[8] = "value<a>";
char constantarr_0_404[14] = "err<exception>";
char constantarr_0_405[21] = "callback!<in>.lambda0";
char constantarr_0_406[16] = "forward-to!<out>";
char constantarr_0_407[12] = "callback!<a>";
char constantarr_0_408[20] = "callback!<a>.lambda0";
char constantarr_0_409[21] = "resolve-or-reject!<a>";
char constantarr_0_410[23] = "with-lock<fut-state<a>>";
char constantarr_0_411[21] = "fut-state-resolved<a>";
char constantarr_0_412[16] = "value<exception>";
char constantarr_0_413[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_414[18] = "call-callbacks!<a>";
char constantarr_0_415[5] = "cb<a>";
char constantarr_0_416[7] = "next<a>";
char constantarr_0_417[24] = "forward-to!<out>.lambda0";
char constantarr_0_418[18] = "subscript<out, in>";
char constantarr_0_419[10] = "get-island";
char constantarr_0_420[17] = "subscript<island>";
char constantarr_0_421[12] = "unsafe-at<a>";
char constantarr_0_422[7] = "islands";
char constantarr_0_423[27] = "island-and-exclusion<r, p0>";
char constantarr_0_424[8] = "add-task";
char constantarr_0_425[15] = "task-queue-node";
char constantarr_0_426[4] = "task";
char constantarr_0_427[10] = "tasks-lock";
char constantarr_0_428[12] = "insert-task!";
char constantarr_0_429[4] = "size";
char constantarr_0_430[10] = "size-recur";
char constantarr_0_431[4] = "next";
char constantarr_0_432[4] = "head";
char constantarr_0_433[8] = "set-head";
char constantarr_0_434[21] = "some<task-queue-node>";
char constantarr_0_435[4] = "time";
char constantarr_0_436[12] = "insert-recur";
char constantarr_0_437[8] = "set-next";
char constantarr_0_438[5] = "tasks";
char constantarr_0_439[22] = "ref-of-val<task-queue>";
char constantarr_0_440[10] = "broadcast!";
char constantarr_0_441[18] = "pthread_mutex_lock";
char constantarr_0_442[22] = "pthread_cond_broadcast";
char constantarr_0_443[12] = "set-sequence";
char constantarr_0_444[8] = "sequence";
char constantarr_0_445[20] = "pthread_mutex_unlock";
char constantarr_0_446[17] = "may-be-work-to-do";
char constantarr_0_447[4] = "gctx";
char constantarr_0_448[12] = "no-timestamp";
char constantarr_0_449[9] = "exclusion";
char constantarr_0_450[11] = "catch<void>";
char constantarr_0_451[27] = "catch-with-exception-ctx<a>";
char constantarr_0_452[16] = "thrown-exception";
char constantarr_0_453[13] = "__jmp_buf_tag";
char constantarr_0_454[4] = "zero";
char constantarr_0_455[7] = "bytes64";
char constantarr_0_456[7] = "bytes32";
char constantarr_0_457[7] = "bytes16";
char constantarr_0_458[8] = "bytes128";
char constantarr_0_459[15] = "set-jmp-buf-ptr";
char constantarr_0_460[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_461[6] = "setjmp";
char constantarr_0_462[23] = "subscript<a, exception>";
char constantarr_0_463[21] = "subscript<fut<r>, p0>";
char constantarr_0_464[10] = "fun<r, p0>";
char constantarr_0_465[34] = "subscript<out, in>.lambda0.lambda0";
char constantarr_0_466[10] = "reject!<r>";
char constantarr_0_467[34] = "subscript<out, in>.lambda0.lambda1";
char constantarr_0_468[26] = "subscript<out, in>.lambda0";
char constantarr_0_469[9] = "value<in>";
char constantarr_0_470[23] = "then<out, void>.lambda0";
char constantarr_0_471[14] = "subscript<out>";
char constantarr_0_472[23] = "island-and-exclusion<r>";
char constantarr_0_473[17] = "subscript<fut<r>>";
char constantarr_0_474[6] = "fun<r>";
char constantarr_0_475[30] = "subscript<out>.lambda0.lambda0";
char constantarr_0_476[30] = "subscript<out>.lambda0.lambda1";
char constantarr_0_477[22] = "subscript<out>.lambda0";
char constantarr_0_478[24] = "then-void<nat64>.lambda0";
char constantarr_0_479[24] = "cur-island-and-exclusion";
char constantarr_0_480[20] = "island-and-exclusion";
char constantarr_0_481[9] = "island-id";
char constantarr_0_482[5] = "delay";
char constantarr_0_483[14] = "resolved<void>";
char constantarr_0_484[21] = "tail<const-ptr<char>>";
char constantarr_0_485[11] = "is-empty<a>";
char constantarr_0_486[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_487[25] = "map<str, const-ptr<char>>";
char constantarr_0_488[13] = "make-arr<out>";
char constantarr_0_489[17] = "fill-ptr-range<a>";
char constantarr_0_490[23] = "fill-ptr-range-recur<a>";
char constantarr_0_491[9] = "!=<nat64>";
char constantarr_0_492[19] = "subscript<a, nat64>";
char constantarr_0_493[13] = "subscript<in>";
char constantarr_0_494[33] = "map<str, const-ptr<char>>.lambda0";
char constantarr_0_495[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_496[22] = "add-first-task.lambda0";
char constantarr_0_497[24] = "handle-exceptions<nat64>";
char constantarr_0_498[26] = "subscript<void, exception>";
char constantarr_0_499[17] = "exception-handler";
char constantarr_0_500[14] = "get-cur-island";
char constantarr_0_501[32] = "handle-exceptions<nat64>.lambda0";
char constantarr_0_502[21] = "add-main-task.lambda0";
char constantarr_0_503[84] = "call-with-ctx<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
char constantarr_0_504[11] = "run-threads";
char constantarr_0_505[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_506[19] = "start-threads-recur";
char constantarr_0_507[22] = "+<by-val<thread-args>>";
char constantarr_0_508[30] = "set-deref<by-val<thread-args>>";
char constantarr_0_509[11] = "thread-args";
char constantarr_0_510[17] = "create-one-thread";
char constantarr_0_511[14] = "pthread_create";
char constantarr_0_512[9] = "!=<int32>";
char constantarr_0_513[6] = "EAGAIN";
char constantarr_0_514[14] = "as-cell<nat64>";
char constantarr_0_515[15] = "as-ref<cell<a>>";
char constantarr_0_516[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
char constantarr_0_517[10] = "thread-fun";
char constantarr_0_518[19] = "as-ref<thread-args>";
char constantarr_0_519[15] = "thread-function";
char constantarr_0_520[21] = "thread-function-recur";
char constantarr_0_521[12] = "is-shut-down";
char constantarr_0_522[18] = "set-n-live-threads";
char constantarr_0_523[14] = "n-live-threads";
char constantarr_0_524[28] = "assert-islands-are-shut-down";
char constantarr_0_525[16] = "noctx-at<island>";
char constantarr_0_526[11] = "hard-forbid";
char constantarr_0_527[8] = "needs-gc";
char constantarr_0_528[17] = "n-threads-running";
char constantarr_0_529[25] = "is-empty<task-queue-node>";
char constantarr_0_530[12] = "get-sequence";
char constantarr_0_531[11] = "choose-task";
char constantarr_0_532[17] = "get-monotime-nsec";
char constantarr_0_533[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_534[14] = "cell<timespec>";
char constantarr_0_535[8] = "timespec";
char constantarr_0_536[13] = "clock_gettime";
char constantarr_0_537[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_538[11] = "*<timespec>";
char constantarr_0_539[14] = "inner-value<a>";
char constantarr_0_540[6] = "tv-sec";
char constantarr_0_541[7] = "tv-nsec";
char constantarr_0_542[11] = "todo<nat64>";
char constantarr_0_543[22] = "as<choose-task-result>";
char constantarr_0_544[17] = "choose-task-recur";
char constantarr_0_545[14] = "no-chosen-task";
char constantarr_0_546[21] = "choose-task-in-island";
char constantarr_0_547[32] = "as<choose-task-in-island-result>";
char constantarr_0_548[7] = "do-a-gc";
char constantarr_0_549[7] = "no-task";
char constantarr_0_550[9] = "pop-task!";
char constantarr_0_551[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_552[28] = "currently-running-exclusions";
char constantarr_0_553[19] = "as<pop-task-result>";
char constantarr_0_554[9] = "in<nat64>";
char constantarr_0_555[5] = "in<a>";
char constantarr_0_556[11] = "in-recur<a>";
char constantarr_0_557[11] = "noctx-at<a>";
char constantarr_0_558[14] = "temp-as-arr<a>";
char constantarr_0_559[18] = "temp-as-mut-arr<a>";
char constantarr_0_560[10] = "pop-recur!";
char constantarr_0_561[11] = "to-opt-time";
char constantarr_0_562[11] = "some<nat64>";
char constantarr_0_563[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_564[10] = "is-no-task";
char constantarr_0_565[21] = "set-n-threads-running";
char constantarr_0_566[11] = "chosen-task";
char constantarr_0_567[9] = "any-tasks";
char constantarr_0_568[8] = "min-time";
char constantarr_0_569[10] = "min<nat64>";
char constantarr_0_570[15] = "first-task-time";
char constantarr_0_571[28] = "no-tasks-and-last-thread-out";
char constantarr_0_572[7] = "do-task";
char constantarr_0_573[11] = "task-island";
char constantarr_0_574[10] = "task-or-gc";
char constantarr_0_575[6] = "action";
char constantarr_0_576[12] = "return-task!";
char constantarr_0_577[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_578[37] = "noctx-must-remove-unordered-recur!<a>";
char constantarr_0_579[7] = "drop<a>";
char constantarr_0_580[29] = "noctx-remove-unordered-at!<a>";
char constantarr_0_581[10] = "return-ctx";
char constantarr_0_582[13] = "return-gc-ctx";
char constantarr_0_583[12] = "some<gc-ctx>";
char constantarr_0_584[46] = "run-garbage-collection<by-val<island-gc-root>>";
char constantarr_0_585[12] = "set-gc-count";
char constantarr_0_586[8] = "gc-count";
char constantarr_0_587[20] = "as<by-val<mark-ctx>>";
char constantarr_0_588[8] = "mark-ctx";
char constantarr_0_589[13] = "mark-visit<a>";
char constantarr_0_590[20] = "ref-of-val<mark-ctx>";
char constantarr_0_591[15] = "clear-free-mem!";
char constantarr_0_592[17] = "!=<mut-ptr<bool>>";
char constantarr_0_593[16] = "set-is-shut-down";
char constantarr_0_594[7] = "wait-on";
char constantarr_0_595[17] = "pthread_cond_wait";
char constantarr_0_596[11] = "to-timespec";
char constantarr_0_597[10] = "unsafe-mod";
char constantarr_0_598[22] = "pthread_cond_timedwait";
char constantarr_0_599[16] = "ptr-to<timespec>";
char constantarr_0_600[9] = "ETIMEDOUT";
char constantarr_0_601[9] = "thread-id";
char constantarr_0_602[18] = "join-threads-recur";
char constantarr_0_603[15] = "join-one-thread";
char constantarr_0_604[31] = "as<by-val<cell<mut-ptr<nat8>>>>";
char constantarr_0_605[19] = "cell<mut-ptr<nat8>>";
char constantarr_0_606[12] = "pthread_join";
char constantarr_0_607[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_608[6] = "EINVAL";
char constantarr_0_609[5] = "ESRCH";
char constantarr_0_610[16] = "*<mut-ptr<nat8>>";
char constantarr_0_611[21] = "unmanaged-free<nat64>";
char constantarr_0_612[4] = "free";
char constantarr_0_613[35] = "unmanaged-free<by-val<thread-args>>";
char constantarr_0_614[17] = "destroy-condition";
char constantarr_0_615[25] = "pthread_mutexattr_destroy";
char constantarr_0_616[21] = "pthread_mutex_destroy";
char constantarr_0_617[24] = "pthread_condattr_destroy";
char constantarr_0_618[20] = "pthread_cond_destroy";
char constantarr_0_619[24] = "any-unhandled-exceptions";
char constantarr_0_620[4] = "main";
char constantarr_0_621[14] = "set-hard-limit";
char constantarr_0_622[14] = "set-size-words";
char constantarr_0_623[12] = "set-mark-end";
char constantarr_0_624[12] = "set-data-end";
char constantarr_0_625[1] = "r";
char constantarr_0_626[18] = "size-of<by-val<r>>";
char constantarr_0_627[7] = "-<nat8>";
char constantarr_0_628[19] = "as-any-const-ptr<r>";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {359, constantarr_5_0}.begin_ptr, (struct arr_5) {359, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {359, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {359, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {359, constantarr_5_0}.size);
		*code_names = _2;
...
struct arr_0 move_to_arr__e(struct mut_list_1* a) {
	struct mut_arr_1 _0 = move_to_mut_arr__e(a);
...
struct arr_7 tail(struct ctx* ctx, struct arr_7 a) {
	...
	forbid(ctx, _0);
	struct arrow _1 = _arrow(1u, a.size);
...
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_426(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_366(struct mark_ctx* mark_ctx, struct some_3 value) {
	return mark_visit_425(mark_ctx, value.value);
}
...
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_418(mark_ctx, value2);
		}
		case 3: {
			struct subscript_10__lambda0* value3 = _0.as3;
			
			return mark_visit_420(mark_ctx, value3);
		}
		case 4: {
			struct subscript_15__lambda0__lambda0* value4 = _0.as4;
			
			return mark_visit_422(mark_ctx, value4);
		}
		case 5: {
			struct subscript_15__lambda0* value5 = _0.as5;
			
			return mark_visit_424(mark_ctx, value5);
		}
		default:
...
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	mark_visit_413(mark_ctx, value.f);
...
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_412(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
		case 3: {
			...
			return mark_visit_404(mark_ctx, value3);
		}
		default:
...
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_399(mark_ctx, value.res);
}
...
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct fun_act1_4 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_393(mark_ctx, value0);
		}
		default:
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_389(mark_ctx, value.gc);
	return mark_visit_391(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_386(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct some_2 value) {
	return mark_visit_390(mark_ctx, value.value);
}
/* mark-visit<gc-ctx> (generated) (generated) */
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_389(mark_ctx, value.gc);
	return mark_visit_386(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_395(mark_ctx, value.state);
}
...
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_397(mark_ctx, value.cb);
...
struct void_ mark_visit_398(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_399(mark_ctx, value.to);
}
...
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value) {
	...
	if (_0) {
		return mark_visit_398(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_405(mark_ctx, value.message);
	return mark_visit_407(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_405(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_406(mark_ctx, value.chars);
}
...
struct void_ mark_visit_407(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_408(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_411(struct mark_ctx* mark_ctx, struct some_10 value) {
	return mark_visit_412(mark_ctx, value.value);
}
...
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	mark_visit_399(mark_ctx, value.f);
...
struct void_ mark_visit_426(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_427(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_427(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_428(mark_ctx, value.inner);
}
