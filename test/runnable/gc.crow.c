...
char constantarr_0_260[25];
char constantarr_0_261[21];
char constantarr_0_262[24];
char constantarr_0_263[30];
...
char constantarr_0_391[23];
char constantarr_0_392[12];
char constantarr_0_393[36];
char constantarr_0_394[11];
char constantarr_0_395[36];
...
char constantarr_0_414[40];
char constantarr_0_415[25];
...
char constantarr_0_439[80];
char constantarr_0_440[11];
char constantarr_0_441[45];
...
char constantarr_0_101[15] = "begin-ptr<char>";
...
char constantarr_0_221[13] = "begin-ptr<?a>";
...
char constantarr_0_246[5] = "inner";
...
char constantarr_0_252[14] = "each-recur<?a>";
char constantarr_0_253[19] = "subscript<void, ?a>";
char constantarr_0_254[22] = "call-with-ctx<?r, ?p0>";
char constantarr_0_255[11] = "end-ptr<?a>";
char constantarr_0_256[6] = "~=<?a>";
char constantarr_0_257[18] = "incr-capacity!<?a>";
char constantarr_0_258[19] = "ensure-capacity<?a>";
char constantarr_0_259[12] = "capacity<?a>";
char constantarr_0_260[25] = "increase-capacity-to!<?a>";
char constantarr_0_261[21] = "set-zero-elements<?a>";
char constantarr_0_262[24] = "round-up-to-power-of-two";
char constantarr_0_263[30] = "round-up-to-power-of-two-recur";
char constantarr_0_264[1] = "*";
char constantarr_0_265[1] = "/";
char constantarr_0_266[16] = "~=<char>.lambda0";
char constantarr_0_267[6] = "interp";
char constantarr_0_268[14] = "mut-list<char>";
...
char constantarr_0_278[21] = "with-value<log-level>";
char constantarr_0_279[5] = "level";
char constantarr_0_280[14] = "island.lambda1";
char constantarr_0_281[20] = "ptr-cast<bool, nat8>";
char constantarr_0_282[14] = "as<by-val<gc>>";
...
char constantarr_0_289[7] = "do-main";
char constantarr_0_290[13] = "exception-ctx";
char constantarr_0_291[7] = "log-ctx";
char constantarr_0_292[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_293[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_294[18] = "thread-local-stuff";
char constantarr_0_295[25] = "ref-of-val<exception-ctx>";
char constantarr_0_296[19] = "ref-of-val<log-ctx>";
char constantarr_0_297[3] = "ctx";
char constantarr_0_298[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_299[12] = "context-head";
char constantarr_0_300[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_301[6] = "set-gc";
char constantarr_0_302[12] = "set-next-ctx";
char constantarr_0_303[13] = "value<gc-ctx>";
...
char constantarr_0_310[22] = "as-any-ptr<global-ctx>";
char constantarr_0_311[2] = "id";
char constantarr_0_312[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_313[19] = "as-any-ptr<log-ctx>";
char constantarr_0_314[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_315[15] = "ref-of-val<ctx>";
char constantarr_0_316[79] = "as<fun-act2<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>>";
char constantarr_0_317[14] = "add-first-task";
char constantarr_0_318[14] = "then-void<nat>";
char constantarr_0_319[16] = "then<?out, void>";
char constantarr_0_320[16] = "unresolved<?out>";
char constantarr_0_321[7] = "fut<?a>";
char constantarr_0_322[22] = "fut-state-no-callbacks";
char constantarr_0_323[14] = "callback!<?in>";
char constantarr_0_324[15] = "with-lock<void>";
char constantarr_0_325[17] = "call-with-ctx<?r>";
char constantarr_0_326[6] = "lk<?a>";
char constantarr_0_327[9] = "state<?a>";
char constantarr_0_328[13] = "set-state<?a>";
char constantarr_0_329[23] = "fut-state-callbacks<?a>";
char constantarr_0_330[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_331[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_332[6] = "ok<?a>";
char constantarr_0_333[9] = "value<?a>";
char constantarr_0_334[14] = "err<exception>";
char constantarr_0_335[22] = "callback!<?in>.lambda0";
char constantarr_0_336[17] = "forward-to!<?out>";
char constantarr_0_337[13] = "callback!<?a>";
char constantarr_0_338[21] = "callback!<?a>.lambda0";
char constantarr_0_339[22] = "resolve-or-reject!<?a>";
char constantarr_0_340[24] = "with-lock<fut-state<?a>>";
char constantarr_0_341[22] = "fut-state-resolved<?a>";
char constantarr_0_342[16] = "value<exception>";
char constantarr_0_343[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_344[19] = "call-callbacks!<?a>";
char constantarr_0_345[6] = "cb<?a>";
char constantarr_0_346[8] = "next<?a>";
char constantarr_0_347[30] = "value<fut-state-callbacks<?a>>";
...
char constantarr_0_352[7] = "islands";
char constantarr_0_353[29] = "island-and-exclusion<?r, ?p0>";
char constantarr_0_354[8] = "add-task";
char constantarr_0_355[15] = "task-queue-node";
char constantarr_0_356[4] = "task";
char constantarr_0_357[10] = "tasks-lock";
char constantarr_0_358[12] = "insert-task!";
char constantarr_0_359[4] = "size";
char constantarr_0_360[10] = "size-recur";
char constantarr_0_361[4] = "next";
char constantarr_0_362[22] = "value<task-queue-node>";
...
char constantarr_0_372[9] = "set-value";
char constantarr_0_373[21] = "ref-of-val<condition>";
char constantarr_0_374[17] = "may-be-work-to-do";
char constantarr_0_375[4] = "gctx";
char constantarr_0_376[12] = "no-timestamp";
char constantarr_0_377[9] = "exclusion";
char constantarr_0_378[11] = "catch<void>";
char constantarr_0_379[28] = "catch-with-exception-ctx<?a>";
char constantarr_0_380[16] = "thrown-exception";
char constantarr_0_381[11] = "jmp-buf-tag";
char constantarr_0_382[4] = "zero";
char constantarr_0_383[7] = "bytes64";
char constantarr_0_384[7] = "bytes32";
char constantarr_0_385[7] = "bytes16";
char constantarr_0_386[8] = "bytes128";
char constantarr_0_387[15] = "set-jmp-buf-ptr";
char constantarr_0_388[19] = "ptr-to<jmp-buf-tag>";
char constantarr_0_389[6] = "setjmp";
char constantarr_0_390[24] = "subscript<?a, exception>";
char constantarr_0_391[23] = "subscript<fut<?r>, ?p0>";
char constantarr_0_392[12] = "fun<?r, ?p0>";
char constantarr_0_393[36] = "subscript<?out, ?in>.lambda0.lambda0";
char constantarr_0_394[11] = "reject!<?r>";
char constantarr_0_395[36] = "subscript<?out, ?in>.lambda0.lambda1";
char constantarr_0_396[28] = "subscript<?out, ?in>.lambda0";
char constantarr_0_397[10] = "value<?in>";
char constantarr_0_398[24] = "then<?out, void>.lambda0";
char constantarr_0_399[15] = "subscript<?out>";
char constantarr_0_400[24] = "island-and-exclusion<?r>";
char constantarr_0_401[18] = "subscript<fut<?r>>";
char constantarr_0_402[7] = "fun<?r>";
char constantarr_0_403[31] = "subscript<?out>.lambda0.lambda0";
char constantarr_0_404[31] = "subscript<?out>.lambda0.lambda1";
char constantarr_0_405[23] = "subscript<?out>.lambda0";
char constantarr_0_406[22] = "then-void<nat>.lambda0";
char constantarr_0_407[24] = "cur-island-and-exclusion";
char constantarr_0_408[20] = "island-and-exclusion";
char constantarr_0_409[9] = "island-id";
char constantarr_0_410[5] = "delay";
char constantarr_0_411[14] = "resolved<void>";
char constantarr_0_412[15] = "tail<ptr<char>>";
char constantarr_0_413[10] = "empty?<?a>";
char constantarr_0_414[40] = "subscript<fut<nat>, ctx, arr<arr<char>>>";
char constantarr_0_415[25] = "map<arr<char>, ptr<char>>";
char constantarr_0_416[14] = "make-arr<?out>";
char constantarr_0_417[18] = "fill-ptr-range<?a>";
char constantarr_0_418[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_419[18] = "subscript<?a, nat>";
char constantarr_0_420[14] = "subscript<?in>";
char constantarr_0_421[33] = "map<arr<char>, ptr<char>>.lambda0";
char constantarr_0_422[24] = "arr-from-begin-end<char>";
char constantarr_0_423[16] = "ptr-less-eq?<?a>";
char constantarr_0_424[5] = "-<?a>";
char constantarr_0_425[13] = "find-cstr-end";
char constantarr_0_426[17] = "find-char-in-cstr";
char constantarr_0_427[8] = "==<char>";
char constantarr_0_428[15] = "some<ptr<char>>";
char constantarr_0_429[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_430[16] = "value<ptr<char>>";
char constantarr_0_431[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_432[22] = "add-first-task.lambda0";
char constantarr_0_433[22] = "handle-exceptions<nat>";
char constantarr_0_434[26] = "subscript<void, exception>";
char constantarr_0_435[17] = "exception-handler";
char constantarr_0_436[14] = "get-cur-island";
char constantarr_0_437[30] = "handle-exceptions<nat>.lambda0";
char constantarr_0_438[15] = "do-main.lambda0";
char constantarr_0_439[80] = "call-with-ctx<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>";
char constantarr_0_440[11] = "run-threads";
char constantarr_0_441[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_442[19] = "start-threads-recur";
char constantarr_0_443[22] = "+<by-val<thread-args>>";
char constantarr_0_444[34] = "set-subscript<by-val<thread-args>>";
char constantarr_0_445[11] = "thread-args";
char constantarr_0_446[17] = "create-one-thread";
char constantarr_0_447[14] = "pthread-create";
char constantarr_0_448[9] = "!=<int32>";
char constantarr_0_449[6] = "eagain";
char constantarr_0_450[12] = "as-cell<nat>";
char constantarr_0_451[16] = "as-ref<cell<?a>>";
char constantarr_0_452[36] = "as-any-ptr<ptr<by-val<thread-args>>>";
char constantarr_0_453[10] = "thread-fun";
char constantarr_0_454[19] = "as-ref<thread-args>";
char constantarr_0_455[15] = "thread-function";
char constantarr_0_456[21] = "thread-function-recur";
char constantarr_0_457[10] = "shut-down?";
char constantarr_0_458[18] = "set-n-live-threads";
char constantarr_0_459[14] = "n-live-threads";
char constantarr_0_460[28] = "assert-islands-are-shut-down";
char constantarr_0_461[9] = "needs-gc?";
char constantarr_0_462[17] = "n-threads-running";
char constantarr_0_463[6] = "empty?";
char constantarr_0_464[16] = "get-last-checked";
char constantarr_0_465[11] = "choose-task";
char constantarr_0_466[17] = "get-monotime-nsec";
char constantarr_0_467[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_468[14] = "cell<timespec>";
char constantarr_0_469[8] = "timespec";
char constantarr_0_470[13] = "clock-gettime";
char constantarr_0_471[15] = "clock-monotonic";
char constantarr_0_472[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_473[19] = "subscript<timespec>";
char constantarr_0_474[6] = "tv-sec";
char constantarr_0_475[7] = "tv-nsec";
char constantarr_0_476[9] = "todo<nat>";
char constantarr_0_477[22] = "as<choose-task-result>";
char constantarr_0_478[17] = "choose-task-recur";
char constantarr_0_479[14] = "no-chosen-task";
char constantarr_0_480[21] = "choose-task-in-island";
char constantarr_0_481[32] = "as<choose-task-in-island-result>";
char constantarr_0_482[7] = "do-a-gc";
char constantarr_0_483[7] = "no-task";
char constantarr_0_484[9] = "pop-task!";
char constantarr_0_485[25] = "ref-of-val<mut-list<nat>>";
char constantarr_0_486[28] = "currently-running-exclusions";
char constantarr_0_487[19] = "as<pop-task-result>";
char constantarr_0_488[14] = "contains?<nat>";
char constantarr_0_489[13] = "contains?<?a>";
char constantarr_0_490[19] = "contains-recur?<?a>";
char constantarr_0_491[15] = "temp-as-arr<?a>";
char constantarr_0_492[19] = "temp-as-mut-arr<?a>";
char constantarr_0_493[10] = "pop-recur!";
char constantarr_0_494[11] = "to-opt-time";
char constantarr_0_495[9] = "some<nat>";
char constantarr_0_496[38] = "push-capacity-must-be-sufficient!<nat>";
...
char constantarr_0_516[10] = "return-ctx";
char constantarr_0_517[13] = "return-gc-ctx";
char constantarr_0_518[12] = "some<gc-ctx>";
char constantarr_0_519[46] = "run-garbage-collection<by-val<island-gc-root>>";
char constantarr_0_520[13] = "set-needs-gc?";
char constantarr_0_521[12] = "set-gc-count";
char constantarr_0_522[8] = "gc-count";
char constantarr_0_523[20] = "as<by-val<mark-ctx>>";
char constantarr_0_524[8] = "mark-ctx";
char constantarr_0_525[14] = "mark-visit<?a>";
char constantarr_0_526[20] = "ref-of-val<mark-ctx>";
char constantarr_0_527[14] = "clear-free-mem";
char constantarr_0_528[14] = "set-shut-down?";
char constantarr_0_529[7] = "wait-on";
char constantarr_0_530[12] = "before-time?";
char constantarr_0_531[9] = "thread-id";
char constantarr_0_532[18] = "join-threads-recur";
char constantarr_0_533[15] = "join-one-thread";
char constantarr_0_534[27] = "as<by-val<cell<ptr<nat8>>>>";
char constantarr_0_535[15] = "cell<ptr<nat8>>";
char constantarr_0_536[12] = "pthread-join";
char constantarr_0_537[27] = "ref-of-val<cell<ptr<nat8>>>";
char constantarr_0_538[6] = "einval";
char constantarr_0_539[5] = "esrch";
char constantarr_0_540[20] = "subscript<ptr<nat8>>";
char constantarr_0_541[19] = "unmanaged-free<nat>";
char constantarr_0_542[4] = "free";
char constantarr_0_543[35] = "unmanaged-free<by-val<thread-args>>";
char constantarr_0_544[18] = "ptr-cast<nat8, ?a>";
char constantarr_0_545[8] = "?<int32>";
char constantarr_0_546[25] = "any-unhandled-exceptions?";
char constantarr_0_547[4] = "main";
char constantarr_0_548[14] = "set-hard-limit";
char constantarr_0_549[14] = "set-size-words";
char constantarr_0_550[12] = "set-mark-end";
char constantarr_0_551[12] = "set-data-end";
char constantarr_0_552[1] = "r";
char constantarr_0_553[18] = "size-of<by-val<r>>";
char constantarr_0_554[7] = "-<nat8>";
char constantarr_0_555[13] = "as-any-ptr<r>";
char constantarr_0_556[3] = "mod";
char constantarr_0_557[10] = "unsafe-mod";
char constantarr_0_558[15] = "with-value<nat>";
char constantarr_0_559[8] = "cur-word";
char constantarr_0_560[10] = "words-used";
char constantarr_0_561[10] = "words-free";
char constantarr_0_562[11] = "total-words";
char constantarr_0_563[20] = "with-value<gc-stats>";
char constantarr_0_564[9] = "get-stats";
char constantarr_0_565[19] = "words-used-in-range";
char constantarr_0_566[6] = "to-nat";
char constantarr_0_567[8] = "gc-stats";
char constantarr_0_568[1] = "a";
char constantarr_0_569[1] = "b";
char constantarr_0_570[1] = "c";
char constantarr_0_571[13] = "with-value<r>";
char constantarr_0_572[14] = "force-needs-gc";
char constantarr_0_573[13] = "resolved<nat>";
char constantarr_0_574[12] = "main.lambda0";
...
struct fut_0* call_w_ctx_263(struct fun_act2 a, struct ctx* ctx, struct arr_4 p0, fun_ptr2 p1);
...
struct void_ mark_visit_335(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_336(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_337(struct mark_ctx* mark_ctx, struct opt_1 value);
struct void_ mark_visit_338(struct mark_ctx* mark_ctx, struct some_1 value);
struct void_ mark_visit_339(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_340(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_341(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_342(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_343(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_344(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_345(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_346(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_347(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_348(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
...
struct void_ mark_visit_352(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_355(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_arr_356(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_357(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_elems_358(struct mark_ctx* mark_ctx, struct arr_0* cur, struct arr_0* end);
struct void_ mark_arr_359(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_360(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct opt_7 value);
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct some_7 value);
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_365(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
...
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct subscript_11__lambda0__lambda0 value);
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct subscript_11__lambda0__lambda0* value);
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct subscript_11__lambda0 value);
struct void_ mark_visit_371(struct mark_ctx* mark_ctx, struct subscript_11__lambda0* value);
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct subscript_16__lambda0__lambda0 value);
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct subscript_16__lambda0__lambda0* value);
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct subscript_16__lambda0 value);
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct subscript_16__lambda0* value);
struct void_ mark_visit_376(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_379(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 128: {
			return (struct arr_0) {11, constantarr_0_255};
		}
		case 129: {
			return (struct arr_0) {6, constantarr_0_256};
		}
		case 130: {
			return (struct arr_0) {18, constantarr_0_257};
		}
		case 131: {
		...
		case 134: {
			return (struct arr_0) {25, constantarr_0_260};
		}
		case 135: {
			return (struct arr_0) {11, constantarr_0_78};
		}
		case 136: {
			return (struct arr_0) {21, constantarr_0_261};
		}
		case 137: {
			return (struct arr_0) {18, constantarr_0_88};
		}
		...
		case 140: {
			return (struct arr_0) {24, constantarr_0_262};
		}
		case 141: {
			return (struct arr_0) {30, constantarr_0_263};
		}
		case 142: {
		...
		case 145: {
			return (struct arr_0) {16, constantarr_0_266};
		}
		case 146: {
		...
		case 155: {
			return (struct arr_0) {21, constantarr_0_278};
		}
		case 156: {
		...
		case 163: {
			return (struct arr_0) {3, constantarr_0_297};
		}
		case 164: {
			return (struct arr_0) {10, constantarr_0_179};
		}
		...
		case 173: {
			return (struct arr_0) {38, constantarr_0_331};
		}
		case 174: {
			return (struct arr_0) {0u, NULL};
		}
		case 175: {
			return (struct arr_0) {22, constantarr_0_335};
		}
		case 176: {
		...
		case 181: {
			return (struct arr_0) {22, constantarr_0_339};
		}
		case 182: {
			return (struct arr_0) {24, constantarr_0_340};
		}
		case 183: {
			return (struct arr_0) {13, constantarr_0_211};
		}
		...
		case 186: {
			return (struct arr_0) {19, constantarr_0_344};
		}
		case 187: {
		...
		case 193: {
			return (struct arr_0) {8, constantarr_0_354};
		}
		case 194: {
			return (struct arr_0) {8, constantarr_0_354};
		}
		...
		case 196: {
			return (struct arr_0) {12, constantarr_0_358};
		}
		case 197: {
			return (struct arr_0) {4, constantarr_0_359};
		}
		case 198: {
		...
		case 203: {
			return (struct arr_0) {11, constantarr_0_378};
		}
		case 204: {
			return (struct arr_0) {28, constantarr_0_379};
		}
		case 205: {
		...
		case 209: {
			return (struct arr_0) {6, constantarr_0_389};
		}
		case 210: {
		...
		case 212: {
			return (struct arr_0) {23, constantarr_0_391};
		}
		case 213: {
			return (struct arr_0) {0u, NULL};
		}
		case 214: {
			return (struct arr_0) {36, constantarr_0_393};
		}
		case 215: {
			return (struct arr_0) {11, constantarr_0_394};
		}
		case 216: {
			return (struct arr_0) {36, constantarr_0_395};
		}
		case 217: {
			return (struct arr_0) {28, constantarr_0_396};
		}
		case 218: {
		...
		case 220: {
			return (struct arr_0) {18, constantarr_0_401};
		}
		case 221: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 223: {
			return (struct arr_0) {31, constantarr_0_404};
		}
		case 224: {
		...
		case 230: {
			return (struct arr_0) {10, constantarr_0_413};
		}
		case 231: {
			return (struct arr_0) {13, constantarr_0_211};
		}
		case 232: {
			return (struct arr_0) {25, constantarr_0_415};
		}
		case 233: {
			return (struct arr_0) {14, constantarr_0_416};
		}
		case 234: {
			return (struct arr_0) {23, constantarr_0_226};
		}
		...
		case 237: {
			return (struct arr_0) {18, constantarr_0_419};
		}
		case 238: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 244: {
			return (struct arr_0) {33, constantarr_0_421};
		}
		case 245: {
			return (struct arr_0) {6, constantarr_0_247};
		}
		...
		case 253: {
			return (struct arr_0) {27, constantarr_0_429};
		}
		case 254: {
			return (struct arr_0) {30, constantarr_0_431};
		}
		case 255: {
		...
		case 257: {
			return (struct arr_0) {26, constantarr_0_434};
		}
		case 258: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 261: {
			return (struct arr_0) {30, constantarr_0_437};
		}
		case 262: {
		...
		case 265: {
			return (struct arr_0) {45, constantarr_0_441};
		}
		case 266: {
			return (struct arr_0) {19, constantarr_0_442};
		}
		case 267: {
		...
		case 277: {
			return (struct arr_0) {16, constantarr_0_464};
		}
		case 278: {
		...
		case 282: {
			return (struct arr_0) {9, constantarr_0_476};
		}
		case 283: {
			return (struct arr_0) {17, constantarr_0_478};
		}
		case 284: {
			return (struct arr_0) {21, constantarr_0_480};
		}
		case 285: {
		...
		case 296: {
			return (struct arr_0) {10, constantarr_0_493};
		}
		case 297: {
			return (struct arr_0) {11, constantarr_0_494};
		}
		case 298: {
			return (struct arr_0) {38, constantarr_0_496};
		}
		case 299: {
			return (struct arr_0) {12, constantarr_0_259};
		}
		...
		case 311: {
			return (struct arr_0) {10, constantarr_0_516};
		}
		case 312: {
			return (struct arr_0) {13, constantarr_0_517};
		}
		case 313: {
			return (struct arr_0) {46, constantarr_0_519};
		}
		case 314: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 381: {
			return (struct arr_0) {7, constantarr_0_529};
		}
		case 382: {
		...
		case 387: {
			return (struct arr_0) {5, constantarr_0_539};
		}
		case 388: {
			return (struct arr_0) {19, constantarr_0_541};
		}
		case 389: {
			return (struct arr_0) {4, constantarr_0_542};
		}
		case 390: {
			return (struct arr_0) {35, constantarr_0_543};
		}
		case 391: {
			return (struct arr_0) {4, constantarr_0_547};
		}
		case 392: {
			return (struct arr_0) {14, constantarr_0_548};
		}
		case 393: {
		...
		case 396: {
			return (struct arr_0) {3, constantarr_0_556};
		}
		case 397: {
			return (struct arr_0) {15, constantarr_0_558};
		}
		case 398: {
			return (struct arr_0) {10, constantarr_0_561};
		}
		case 399: {
			return (struct arr_0) {20, constantarr_0_563};
		}
		case 400: {
		...
		case 405: {
			return (struct arr_0) {14, constantarr_0_572};
		}
		case 406: {
...
struct void_ increase_capacity_to__e(struct ctx* ctx, struct mut_list_1* a, uint64_t new_capacity) {
	...
	copy_data_from(ctx, _4, old_begin0, a->size);
...
struct void_ mark_visit_315(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_377(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_317(struct mark_ctx* mark_ctx, struct some_2 value) {
	return mark_visit_376(mark_ctx, value.value);
}
...
struct void_ mark_visit_320(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_369(mark_ctx, value2);
		}
		case 3: {
			struct subscript_11__lambda0* value3 = _0.as3;
			
			return mark_visit_371(mark_ctx, value3);
		}
		case 4: {
			struct subscript_16__lambda0__lambda0* value4 = _0.as4;
			
			return mark_visit_373(mark_ctx, value4);
		}
		case 5: {
			struct subscript_16__lambda0* value5 = _0.as5;
			
			return mark_visit_375(mark_ctx, value5);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ mark_visit_321(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	mark_visit_364(mark_ctx, value.f);
...
struct void_ mark_visit_326(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_350(mark_ctx, value.res);
}
...
struct void_ mark_visit_335(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_340(mark_ctx, value.gc);
	return mark_visit_342(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_336(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_337(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_338(struct mark_ctx* mark_ctx, struct some_1 value) {
	return mark_visit_341(mark_ctx, value.value);
}
/* mark-visit<gc-ctx> (generated) (generated) */
struct void_ mark_visit_339(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_340(mark_ctx, value.gc);
	return mark_visit_337(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_345(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_346(mark_ctx, value.state);
}
...
struct void_ mark_visit_347(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_348(mark_ctx, value.cb);
...
struct void_ mark_visit_349(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_350(mark_ctx, value.to);
}
...
struct void_ mark_visit_355(struct mark_ctx* mark_ctx, struct exception value) {
	mark_arr_356(mark_ctx, value.message);
	return mark_visit_357(mark_ctx, value.backtrace);
}
...
struct void_ mark_visit_357(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_359(mark_ctx, value.return_stack);
}
...
struct void_ mark_arr_359(struct mark_ctx* mark_ctx, struct arr_1 a) {
	...
	if (_0) {
		return mark_elems_358(mark_ctx, a.begin_ptr, (a.begin_ptr + a.size));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_378(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat>> (generated) (generated) */
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_379(mark_ctx, value.inner);
}
