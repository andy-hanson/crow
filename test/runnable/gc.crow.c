...
char constantarr_0_301[29];
char constantarr_0_302[38];
...
char constantarr_0_240[29] = "set-any-unhandled-exceptions?";
char constantarr_0_241[14] = "get-global-ctx";
char constantarr_0_242[18] = "as-ref<global-ctx>";
char constantarr_0_243[8] = "gctx-ptr";
char constantarr_0_244[14] = "island.lambda0";
char constantarr_0_245[19] = "default-log-handler";
char constantarr_0_246[5] = "print";
char constantarr_0_247[16] = "print-no-newline";
char constantarr_0_248[6] = "stdout";
char constantarr_0_249[6] = "to-str";
char constantarr_0_250[5] = "level";
char constantarr_0_251[14] = "island.lambda1";
char constantarr_0_252[20] = "ptr-cast<bool, nat8>";
char constantarr_0_253[14] = "as<by-val<gc>>";
...
char constantarr_0_277[11] = "set-handler";
char constantarr_0_278[11] = "log-handler";
char constantarr_0_279[26] = "ref-of-val<island-gc-root>";
char constantarr_0_280[7] = "gc-root";
char constantarr_0_281[22] = "as-any-ptr<global-ctx>";
char constantarr_0_282[2] = "id";
char constantarr_0_283[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_284[19] = "as-any-ptr<log-ctx>";
char constantarr_0_285[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_286[15] = "ref-of-val<ctx>";
char constantarr_0_287[79] = "as<fun-act2<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>>";
char constantarr_0_288[14] = "add-first-task";
char constantarr_0_289[14] = "then-void<nat>";
char constantarr_0_290[16] = "then<?out, void>";
char constantarr_0_291[16] = "unresolved<?out>";
char constantarr_0_292[7] = "fut<?a>";
char constantarr_0_293[22] = "fut-state-no-callbacks";
char constantarr_0_294[14] = "callback!<?in>";
char constantarr_0_295[15] = "with-lock<void>";
char constantarr_0_296[17] = "call-with-ctx<?r>";
char constantarr_0_297[6] = "lk<?a>";
char constantarr_0_298[9] = "state<?a>";
char constantarr_0_299[13] = "set-state<?a>";
char constantarr_0_300[23] = "fut-state-callbacks<?a>";
char constantarr_0_301[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_302[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_303[22] = "call-with-ctx<?r, ?p0>";
char constantarr_0_304[6] = "ok<?a>";
char constantarr_0_305[9] = "value<?a>";
char constantarr_0_306[14] = "err<exception>";
char constantarr_0_307[22] = "callback!<?in>.lambda0";
char constantarr_0_308[17] = "forward-to!<?out>";
char constantarr_0_309[13] = "callback!<?a>";
char constantarr_0_310[21] = "callback!<?a>.lambda0";
char constantarr_0_311[22] = "resolve-or-reject!<?a>";
char constantarr_0_312[24] = "with-lock<fut-state<?a>>";
char constantarr_0_313[22] = "fut-state-resolved<?a>";
char constantarr_0_314[16] = "value<exception>";
char constantarr_0_315[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_316[19] = "call-callbacks!<?a>";
char constantarr_0_317[6] = "cb<?a>";
char constantarr_0_318[8] = "next<?a>";
char constantarr_0_319[30] = "value<fut-state-callbacks<?a>>";
...
char constantarr_0_351[28] = "catch-with-exception-ctx<?a>";
...
char constantarr_0_362[24] = "subscript<?a, exception>";
...
char constantarr_0_378[22] = "then-void<nat>.lambda0";
...
char constantarr_0_385[10] = "empty?<?a>";
...
char constantarr_0_389[18] = "fill-ptr-range<?a>";
char constantarr_0_390[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_391[18] = "subscript<?a, nat>";
...
char constantarr_0_395[16] = "ptr-less-eq?<?a>";
char constantarr_0_396[5] = "-<?a>";
...
char constantarr_0_401[15] = "some<ptr<char>>";
char constantarr_0_402[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_403[16] = "value<ptr<char>>";
...
char constantarr_0_417[34] = "set-subscript<by-val<thread-args>>";
...
char constantarr_0_424[16] = "as-ref<cell<?a>>";
...
char constantarr_0_437[16] = "get-last-checked";
char constantarr_0_438[11] = "choose-task";
char constantarr_0_439[17] = "get-monotime-nsec";
char constantarr_0_440[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_441[14] = "cell<timespec>";
char constantarr_0_442[8] = "timespec";
char constantarr_0_443[13] = "clock-gettime";
char constantarr_0_444[15] = "clock-monotonic";
char constantarr_0_445[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_446[19] = "subscript<timespec>";
char constantarr_0_447[6] = "tv-sec";
char constantarr_0_448[7] = "tv-nsec";
char constantarr_0_449[9] = "todo<nat>";
char constantarr_0_450[22] = "as<choose-task-result>";
char constantarr_0_451[17] = "choose-task-recur";
char constantarr_0_452[14] = "no-chosen-task";
char constantarr_0_453[21] = "choose-task-in-island";
char constantarr_0_454[32] = "as<choose-task-in-island-result>";
char constantarr_0_455[7] = "do-a-gc";
char constantarr_0_456[7] = "no-task";
char constantarr_0_457[9] = "pop-task!";
char constantarr_0_458[25] = "ref-of-val<mut-list<nat>>";
char constantarr_0_459[28] = "currently-running-exclusions";
char constantarr_0_460[19] = "as<pop-task-result>";
char constantarr_0_461[14] = "contains?<nat>";
char constantarr_0_462[13] = "contains?<?a>";
char constantarr_0_463[19] = "contains-recur?<?a>";
char constantarr_0_464[15] = "temp-as-arr<?a>";
char constantarr_0_465[9] = "inner<?a>";
char constantarr_0_466[19] = "temp-as-mut-arr<?a>";
char constantarr_0_467[11] = "backing<?a>";
char constantarr_0_468[10] = "pop-recur!";
char constantarr_0_469[11] = "to-opt-time";
char constantarr_0_470[9] = "some<nat>";
char constantarr_0_471[38] = "push-capacity-must-be-sufficient!<nat>";
char constantarr_0_472[12] = "capacity<?a>";
char constantarr_0_473[12] = "set-size<?a>";
char constantarr_0_474[17] = "noctx-set-at!<?a>";
char constantarr_0_475[11] = "is-no-task?";
char constantarr_0_476[21] = "set-n-threads-running";
char constantarr_0_477[11] = "chosen-task";
char constantarr_0_478[10] = "any-tasks?";
char constantarr_0_479[8] = "min-time";
char constantarr_0_480[8] = "min<nat>";
char constantarr_0_481[5] = "?<?a>";
char constantarr_0_482[10] = "value<nat>";
char constantarr_0_483[15] = "first-task-time";
char constantarr_0_484[29] = "no-tasks-and-last-thread-out?";
char constantarr_0_485[7] = "do-task";
char constantarr_0_486[11] = "task-island";
char constantarr_0_487[10] = "task-or-gc";
char constantarr_0_488[6] = "action";
char constantarr_0_489[12] = "return-task!";
char constantarr_0_490[33] = "noctx-must-remove-unordered!<nat>";
char constantarr_0_491[38] = "noctx-must-remove-unordered-recur!<?a>";
char constantarr_0_492[8] = "drop<?a>";
char constantarr_0_493[30] = "noctx-remove-unordered-at!<?a>";
char constantarr_0_494[14] = "noctx-last<?a>";
char constantarr_0_495[10] = "return-ctx";
char constantarr_0_496[13] = "return-gc-ctx";
char constantarr_0_497[12] = "some<gc-ctx>";
char constantarr_0_498[46] = "run-garbage-collection<by-val<island-gc-root>>";
char constantarr_0_499[13] = "set-needs-gc?";
char constantarr_0_500[12] = "set-gc-count";
char constantarr_0_501[8] = "gc-count";
char constantarr_0_502[20] = "as<by-val<mark-ctx>>";
char constantarr_0_503[8] = "mark-ctx";
char constantarr_0_504[14] = "mark-visit<?a>";
char constantarr_0_505[20] = "ref-of-val<mark-ctx>";
char constantarr_0_506[14] = "clear-free-mem";
char constantarr_0_507[14] = "set-shut-down?";
char constantarr_0_508[7] = "wait-on";
char constantarr_0_509[12] = "before-time?";
char constantarr_0_510[9] = "thread-id";
char constantarr_0_511[18] = "join-threads-recur";
char constantarr_0_512[15] = "join-one-thread";
char constantarr_0_513[27] = "as<by-val<cell<ptr<nat8>>>>";
char constantarr_0_514[15] = "cell<ptr<nat8>>";
char constantarr_0_515[12] = "pthread-join";
char constantarr_0_516[27] = "ref-of-val<cell<ptr<nat8>>>";
char constantarr_0_517[6] = "einval";
char constantarr_0_518[5] = "esrch";
char constantarr_0_519[20] = "subscript<ptr<nat8>>";
char constantarr_0_520[19] = "unmanaged-free<nat>";
char constantarr_0_521[4] = "free";
char constantarr_0_522[35] = "unmanaged-free<by-val<thread-args>>";
char constantarr_0_523[18] = "ptr-cast<nat8, ?a>";
char constantarr_0_524[8] = "?<int32>";
char constantarr_0_525[25] = "any-unhandled-exceptions?";
char constantarr_0_526[4] = "main";
char constantarr_0_527[14] = "set-hard-limit";
char constantarr_0_528[14] = "set-size-words";
char constantarr_0_529[12] = "set-mark-end";
char constantarr_0_530[12] = "set-data-end";
char constantarr_0_531[1] = "r";
char constantarr_0_532[18] = "size-of<by-val<r>>";
char constantarr_0_533[7] = "-<nat8>";
char constantarr_0_534[13] = "as-any-ptr<r>";
char constantarr_0_535[1] = "/";
char constantarr_0_536[3] = "mod";
char constantarr_0_537[10] = "unsafe-mod";
char constantarr_0_538[8] = "cur-word";
char constantarr_0_539[10] = "words-used";
char constantarr_0_540[10] = "words-free";
char constantarr_0_541[11] = "total-words";
char constantarr_0_542[9] = "get-stats";
char constantarr_0_543[19] = "words-used-in-range";
char constantarr_0_544[6] = "to-nat";
char constantarr_0_545[8] = "gc-stats";
char constantarr_0_546[1] = "a";
char constantarr_0_547[1] = "b";
char constantarr_0_548[1] = "c";
char constantarr_0_549[14] = "force-needs-gc";
...
struct void_ mark_visit_305(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_306(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_307(struct mark_ctx* mark_ctx, struct opt_1 value);
struct void_ mark_visit_308(struct mark_ctx* mark_ctx, struct some_1 value);
...
struct void_ mark_visit_312(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_313(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 133: {
			return (struct arr_0) {16, constantarr_0_290};
		}
		case 134: {
		...
		case 136: {
			return (struct arr_0) {15, constantarr_0_295};
		}
		case 137: {
			return (struct arr_0) {13, constantarr_0_211};
		}
		...
		case 139: {
			return (struct arr_0) {38, constantarr_0_302};
		}
		case 140: {
			return (struct arr_0) {0u, NULL};
		}
		case 141: {
			return (struct arr_0) {22, constantarr_0_307};
		}
		case 142: {
		...
		case 219: {
			return (struct arr_0) {27, constantarr_0_402};
		}
		case 220: {
		...
		case 254: {
			return (struct arr_0) {19, constantarr_0_463};
		}
		case 255: {
			return (struct arr_0) {12, constantarr_0_220};
		}
		...
		case 264: {
			return (struct arr_0) {38, constantarr_0_471};
		}
		case 265: {
		...
		case 274: {
			return (struct arr_0) {33, constantarr_0_490};
		}
		case 275: {
			return (struct arr_0) {38, constantarr_0_491};
		}
		case 276: {
			return (struct arr_0) {12, constantarr_0_220};
		}
		...
		case 278: {
			return (struct arr_0) {30, constantarr_0_493};
		}
		case 279: {
		...
		case 283: {
			return (struct arr_0) {46, constantarr_0_498};
		}
		case 284: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 357: {
			return (struct arr_0) {5, constantarr_0_518};
		}
		case 358: {
		...
		case 360: {
			return (struct arr_0) {35, constantarr_0_522};
		}
		case 361: {
		...
		case 367: {
			return (struct arr_0) {3, constantarr_0_536};
		}
		case 368: {
		...
		case 370: {
			return (struct arr_0) {19, constantarr_0_543};
		}
		case 371: {
...
struct void_ mark_visit_305(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_310(mark_ctx, value.gc);
	return mark_visit_312(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_306(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_307(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_307(struct mark_ctx* mark_ctx, struct opt_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_308(mark_ctx, value1);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ mark_visit_309(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_310(mark_ctx, value.gc);
	return mark_visit_307(mark_ctx, value.next_ctx);
}
