...
struct void_ mark_visit_402(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_403(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_405(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_406(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_407(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_408(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_409(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_410(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_411(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_412(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_413(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_414(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_417(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value);
struct void_ mark_visit_418(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_419(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_421(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_422(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_423(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_424(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_425(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_426(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_427(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_428(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_429(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
struct void_ mark_visit_430(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value);
struct void_ mark_visit_431(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0* value);
struct void_ mark_visit_432(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0 value);
struct void_ mark_visit_433(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0* value);
struct void_ mark_visit_434(struct mark_ctx* mark_ctx, struct subscript_15__lambda0 value);
struct void_ mark_visit_435(struct mark_ctx* mark_ctx, struct subscript_15__lambda0* value);
struct void_ mark_visit_436(struct mark_ctx* mark_ctx, struct subscript_20__lambda0__lambda0 value);
struct void_ mark_visit_437(struct mark_ctx* mark_ctx, struct subscript_20__lambda0__lambda0* value);
struct void_ mark_visit_438(struct mark_ctx* mark_ctx, struct subscript_20__lambda0 value);
struct void_ mark_visit_439(struct mark_ctx* mark_ctx, struct subscript_20__lambda0* value);
struct void_ mark_visit_440(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_441(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_visit_442(struct mark_ctx* mark_ctx, struct fix_arr_0 value);
struct void_ mark_arr_443(struct mark_ctx* mark_ctx, struct arr_3 a);
...
char constantarr_0_132[26];
char constantarr_0_133[9];
char constantarr_0_134[25];
...
char constantarr_0_240[28];
char constantarr_0_241[51];
char constantarr_0_242[32];
...
char constantarr_0_253[43];
char constantarr_0_254[6];
char constantarr_0_255[30];
char constantarr_0_256[4];
char constantarr_0_257[37];
char constantarr_0_258[5];
char constantarr_0_259[33];
...
char constantarr_0_84[3] = "new";
char constantarr_0_85[3] = "lbv";
char constantarr_0_86[11] = "lock-by-val";
char constantarr_0_87[22] = "none<dynamic-sym-node>";
char constantarr_0_88[17] = "empty-arr<island>";
char constantarr_0_89[6] = "new<a>";
char constantarr_0_90[7] = "null<a>";
char constantarr_0_91[11] = "as-const<a>";
char constantarr_0_92[16] = "create-condition";
char constantarr_0_93[35] = "zeroed<by-val<pthread_mutexattr_t>>";
char constantarr_0_94[31] = "zeroed<by-val<pthread_mutex_t>>";
char constantarr_0_95[34] = "zeroed<by-val<pthread_condattr_t>>";
char constantarr_0_96[30] = "zeroed<by-val<pthread_cond_t>>";
char constantarr_0_97[23] = "hard-assert-posix-error";
char constantarr_0_98[22] = "pthread_mutexattr_init";
char constantarr_0_99[31] = "ref-of-val<pthread_mutexattr_t>";
char constantarr_0_100[10] = "mutex-attr";
char constantarr_0_101[21] = "ref-of-val<condition>";
char constantarr_0_102[18] = "pthread_mutex_init";
char constantarr_0_103[27] = "ref-of-val<pthread_mutex_t>";
char constantarr_0_104[5] = "mutex";
char constantarr_0_105[21] = "pthread_condattr_init";
char constantarr_0_106[30] = "ref-of-val<pthread_condattr_t>";
char constantarr_0_107[9] = "cond-attr";
char constantarr_0_108[25] = "pthread_condattr_setclock";
char constantarr_0_109[15] = "CLOCK_MONOTONIC";
char constantarr_0_110[17] = "pthread_cond_init";
char constantarr_0_111[26] = "ref-of-val<pthread_cond_t>";
char constantarr_0_112[4] = "cond";
char constantarr_0_113[22] = "ref-of-val<global-ctx>";
char constantarr_0_114[6] = "island";
char constantarr_0_115[21] = "none<task-queue-node>";
char constantarr_0_116[57] = "mut-arr-by-val-with-capacity-from-unmanaged-memory<nat64>";
char constantarr_0_117[12] = "subscript<a>";
char constantarr_0_118[11] = "high<nat64>";
char constantarr_0_119[10] = "low<nat64>";
char constantarr_0_120[4] = "+<a>";
char constantarr_0_121[34] = "unmanaged-alloc-zeroed-elements<a>";
char constantarr_0_122[27] = "unmanaged-alloc-elements<a>";
char constantarr_0_123[21] = "unmanaged-alloc-bytes";
char constantarr_0_124[6] = "malloc";
char constantarr_0_125[8] = "==<nat8>";
char constantarr_0_126[17] = "!=<mut-ptr<nat8>>";
char constantarr_0_127[10] = "null<nat8>";
char constantarr_0_128[8] = "wrap-mul";
char constantarr_0_129[17] = "set-zero-range<a>";
char constantarr_0_130[19] = "drop<mut-ptr<nat8>>";
char constantarr_0_131[6] = "memset";
char constantarr_0_132[26] = "as-any-mut-ptr<mut-ptr<a>>";
char constantarr_0_133[9] = "..<nat64>";
char constantarr_0_134[25] = "default-exception-handler";
char constantarr_0_135[20] = "print-err-no-newline";
char constantarr_0_136[16] = "write-no-newline";
char constantarr_0_137[13] = "size-of<char>";
char constantarr_0_138[13] = "size-of<nat8>";
char constantarr_0_139[5] = "write";
char constantarr_0_140[33] = "as-any-const-ptr<const-ptr<char>>";
char constantarr_0_141[14] = "as-const<nat8>";
char constantarr_0_142[17] = "as-any-mut-ptr<a>";
char constantarr_0_143[15] = "begin-ptr<char>";
char constantarr_0_144[5] = "chars";
char constantarr_0_145[10] = "size-bytes";
char constantarr_0_146[10] = "size<char>";
char constantarr_0_147[9] = "!=<int64>";
char constantarr_0_148[15] = "unsafe-to-int64";
char constantarr_0_149[10] = "todo<void>";
char constantarr_0_150[9] = "zeroed<a>";
char constantarr_0_151[6] = "stderr";
char constantarr_0_152[9] = "print-err";
char constantarr_0_153[6] = "to-str";
char constantarr_0_154[9] = "new<char>";
char constantarr_0_155[13] = "to-mut-arr<a>";
char constantarr_0_156[16] = "empty-fix-arr<a>";
char constantarr_0_157[12] = "empty-arr<a>";
...
char constantarr_0_167[10] = "end-ptr<a>";
...
char constantarr_0_211[9] = "==<nat64>";
char constantarr_0_212[10] = "<=><nat64>";
char constantarr_0_213[10] = "is-less<a>";
char constantarr_0_214[17] = "<<mut-ptr<nat64>>";
char constantarr_0_215[8] = "data-end";
char constantarr_0_216[10] = "range-free";
char constantarr_0_217[8] = "mark-cur";
char constantarr_0_218[12] = "set-mark-cur";
char constantarr_0_219[12] = "set-data-cur";
char constantarr_0_220[19] = "some<mut-ptr<nat8>>";
char constantarr_0_221[21] = "ptr-cast<nat8, nat64>";
char constantarr_0_222[19] = "none<mut-ptr<nat8>>";
char constantarr_0_223[19] = "maybe-set-needs-gc!";
char constantarr_0_224[7] = "-<bool>";
char constantarr_0_225[10] = "mark-begin";
char constantarr_0_226[10] = "size-words";
char constantarr_0_227[12] = "set-needs-gc";
char constantarr_0_228[8] = "release!";
char constantarr_0_229[11] = "must-unset!";
char constantarr_0_230[10] = "try-unset!";
...
char constantarr_0_236[16] = "none<mut-ptr<a>>";
char constantarr_0_237[16] = "some<mut-ptr<a>>";
char constantarr_0_238[17] = "ptr-cast<a, nat8>";
char constantarr_0_239[20] = "none<backtrace-arrs>";
char constantarr_0_240[28] = "try-alloc-uninitialized<sym>";
char constantarr_0_241[51] = "try-alloc-uninitialized<named-val<const-ptr<nat8>>>";
char constantarr_0_242[32] = "size<named-val<const-ptr<nat8>>>";
char constantarr_0_243[8] = "all-funs";
char constantarr_0_244[20] = "some<backtrace-arrs>";
char constantarr_0_245[12] = "as<arr<sym>>";
char constantarr_0_246[8] = "new<sym>";
char constantarr_0_247[15] = "unsafe-to-nat64";
char constantarr_0_248[8] = "to-int64";
char constantarr_0_249[9] = "backtrace";
char constantarr_0_250[9] = "code-ptrs";
char constantarr_0_251[15] = "unsafe-to-int32";
char constantarr_0_252[14] = "code-ptrs-size";
char constantarr_0_253[43] = "copy-data-from!<named-val<const-ptr<nat8>>>";
char constantarr_0_254[6] = "memcpy";
char constantarr_0_255[30] = "as-any-const-ptr<const-ptr<a>>";
char constantarr_0_256[4] = "funs";
char constantarr_0_257[37] = "begin-ptr<named-val<const-ptr<nat8>>>";
char constantarr_0_258[5] = "sort!";
char constantarr_0_259[33] = "swap!<named-val<const-ptr<nat8>>>";
...
char constantarr_0_279[14] = "subscript<sym>";
char constantarr_0_280[12] = "begin-ptr<a>";
char constantarr_0_281[14] = "set-backing<a>";
char constantarr_0_282[24] = "uninitialized-fix-arr<a>";
char constantarr_0_283[22] = "alloc-uninitialized<a>";
char constantarr_0_284[5] = "alloc";
char constantarr_0_285[8] = "gc-alloc";
char constantarr_0_286[19] = "todo<mut-ptr<nat8>>";
char constantarr_0_287[18] = "copy-data-from!<a>";
char constantarr_0_288[20] = "set-zero-elements<a>";
char constantarr_0_289[1] = "+";
char constantarr_0_290[2] = "&&";
char constantarr_0_291[9] = ">=<nat64>";
char constantarr_0_292[24] = "round-up-to-power-of-two";
char constantarr_0_293[30] = "round-up-to-power-of-two-recur";
char constantarr_0_294[1] = "*";
char constantarr_0_295[1] = "/";
char constantarr_0_296[6] = "forbid";
char constantarr_0_297[11] = "set-size<a>";
char constantarr_0_298[13] = "~=<a>.lambda0";
char constantarr_0_299[2] = "~=";
char constantarr_0_300[8] = "is-empty";
char constantarr_0_301[14] = "is-empty<char>";
char constantarr_0_302[7] = "message";
char constantarr_0_303[9] = "each<sym>";
char constantarr_0_304[12] = "return-stack";
char constantarr_0_305[3] = "str";
char constantarr_0_306[24] = "arr-from-begin-end<char>";
char constantarr_0_307[16] = "<=<const-ptr<a>>";
char constantarr_0_308[4] = "<<a>";
char constantarr_0_309[13] = "find-cstr-end";
char constantarr_0_310[17] = "find-char-in-cstr";
char constantarr_0_311[7] = "to-nat8";
char constantarr_0_312[21] = "some<const-ptr<char>>";
char constantarr_0_313[21] = "none<const-ptr<char>>";
char constantarr_0_314[33] = "hard-unreachable<const-ptr<char>>";
char constantarr_0_315[8] = "to-c-str";
char constantarr_0_316[14] = "to-str.lambda0";
char constantarr_0_317[12] = "move-to-str!";
char constantarr_0_318[18] = "move-to-arr!<char>";
char constantarr_0_319[17] = "cast-immutable<a>";
char constantarr_0_320[19] = "move-to-fix-arr!<a>";
char constantarr_0_321[28] = "set-any-unhandled-exceptions";
char constantarr_0_322[14] = "get-global-ctx";
char constantarr_0_323[18] = "as-ref<global-ctx>";
char constantarr_0_324[8] = "gctx-ptr";
char constantarr_0_325[14] = "island.lambda0";
char constantarr_0_326[19] = "default-log-handler";
char constantarr_0_327[5] = "print";
char constantarr_0_328[16] = "print-no-newline";
char constantarr_0_329[6] = "stdout";
char constantarr_0_330[7] = "~<char>";
char constantarr_0_331[5] = "level";
char constantarr_0_332[14] = "island.lambda1";
char constantarr_0_333[20] = "ptr-cast<bool, nat8>";
char constantarr_0_334[29] = "as-any-mut-ptr<mut-ptr<bool>>";
char constantarr_0_335[12] = "none<gc-ctx>";
char constantarr_0_336[11] = "validate-gc";
char constantarr_0_337[10] = "data-begin";
char constantarr_0_338[9] = "<=><bool>";
char constantarr_0_339[17] = "<=<mut-ptr<bool>>";
char constantarr_0_340[8] = "mark-end";
char constantarr_0_341[18] = "<=<mut-ptr<nat64>>";
char constantarr_0_342[14] = "ref-of-val<gc>";
char constantarr_0_343[18] = "ref-of-val<island>";
char constantarr_0_344[11] = "set-islands";
char constantarr_0_345[21] = "arr-of-single<island>";
char constantarr_0_346[14] = "ptr-to<island>";
char constantarr_0_347[13] = "add-main-task";
char constantarr_0_348[13] = "exception-ctx";
char constantarr_0_349[14] = "empty-arr<sym>";
char constantarr_0_350[7] = "log-ctx";
char constantarr_0_351[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_352[8] = "perf-ctx";
char constantarr_0_353[14] = "empty-arr<str>";
char constantarr_0_354[28] = "empty-fix-arr<measure-value>";
...
char constantarr_0_363[12] = "context-head";
char constantarr_0_364[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_365[6] = "set-gc";
char constantarr_0_366[12] = "set-next-ctx";
char constantarr_0_367[16] = "set-context-head";
char constantarr_0_368[8] = "next-ctx";
char constantarr_0_369[11] = "set-handler";
char constantarr_0_370[15] = "as-ref<log-ctx>";
char constantarr_0_371[11] = "log-ctx-ptr";
char constantarr_0_372[11] = "log-handler";
char constantarr_0_373[26] = "ref-of-val<island-gc-root>";
char constantarr_0_374[7] = "gc-root";
char constantarr_0_375[26] = "as-any-mut-ptr<global-ctx>";
char constantarr_0_376[2] = "id";
char constantarr_0_377[22] = "as-any-mut-ptr<gc-ctx>";
char constantarr_0_378[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_379[15] = "ref-of-val<ctx>";
...
char constantarr_0_384[25] = "fut-state-no-callbacks<a>";
char constantarr_0_385[13] = "callback!<in>";
char constantarr_0_386[15] = "with-lock<void>";
char constantarr_0_387[16] = "call-with-ctx<r>";
char constantarr_0_388[5] = "lk<a>";
char constantarr_0_389[8] = "state<a>";
char constantarr_0_390[12] = "set-state<a>";
char constantarr_0_391[22] = "fut-state-callbacks<a>";
char constantarr_0_392[28] = "none<fut-state-callbacks<a>>";
char constantarr_0_393[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_394[37] = "subscript<void, result<a, exception>>";
char constantarr_0_395[16] = "ok<a, exception>";
char constantarr_0_396[17] = "err<a, exception>";
char constantarr_0_397[21] = "callback!<in>.lambda0";
char constantarr_0_398[16] = "forward-to!<out>";
char constantarr_0_399[12] = "callback!<a>";
char constantarr_0_400[20] = "callback!<a>.lambda0";
char constantarr_0_401[21] = "resolve-or-reject!<a>";
char constantarr_0_402[23] = "with-lock<fut-state<a>>";
char constantarr_0_403[21] = "fut-state-resolved<a>";
char constantarr_0_404[22] = "fut-state-exception<a>";
char constantarr_0_405[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_406[18] = "call-callbacks!<a>";
char constantarr_0_407[5] = "cb<a>";
char constantarr_0_408[7] = "next<a>";
char constantarr_0_409[24] = "forward-to!<out>.lambda0";
char constantarr_0_410[18] = "subscript<out, in>";
char constantarr_0_411[10] = "get-island";
char constantarr_0_412[17] = "subscript<island>";
char constantarr_0_413[12] = "unsafe-at<a>";
char constantarr_0_414[7] = "islands";
char constantarr_0_415[27] = "island-and-exclusion<r, p0>";
char constantarr_0_416[8] = "add-task";
char constantarr_0_417[10] = "tasks-lock";
char constantarr_0_418[12] = "insert-task!";
char constantarr_0_419[4] = "size";
char constantarr_0_420[10] = "size-recur";
char constantarr_0_421[4] = "next";
char constantarr_0_422[4] = "head";
char constantarr_0_423[8] = "set-head";
char constantarr_0_424[21] = "some<task-queue-node>";
char constantarr_0_425[4] = "time";
...
char constantarr_0_444[4] = "zero";
char constantarr_0_445[15] = "set-jmp-buf-ptr";
char constantarr_0_446[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_447[6] = "setjmp";
char constantarr_0_448[23] = "subscript<a, exception>";
char constantarr_0_449[21] = "subscript<fut<r>, p0>";
char constantarr_0_450[10] = "fun<r, p0>";
char constantarr_0_451[34] = "subscript<out, in>.lambda0.lambda0";
char constantarr_0_452[10] = "reject!<r>";
char constantarr_0_453[34] = "subscript<out, in>.lambda0.lambda1";
char constantarr_0_454[26] = "subscript<out, in>.lambda0";
...
char constantarr_0_468[21] = "tail<const-ptr<char>>";
char constantarr_0_469[11] = "is-empty<a>";
char constantarr_0_470[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_471[25] = "map<str, const-ptr<char>>";
char constantarr_0_472[13] = "make-arr<out>";
char constantarr_0_473[17] = "fill-ptr-range<a>";
char constantarr_0_474[23] = "fill-ptr-range-recur<a>";
char constantarr_0_475[9] = "!=<nat64>";
char constantarr_0_476[19] = "subscript<a, nat64>";
char constantarr_0_477[13] = "subscript<in>";
char constantarr_0_478[33] = "map<str, const-ptr<char>>.lambda0";
...
char constantarr_0_487[26] = "subscript<const-ptr<char>>";
...
char constantarr_0_493[30] = "set-deref<by-val<thread-args>>";
...
char constantarr_0_499[15] = "as-ref<cell<a>>";
char constantarr_0_500[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
...
char constantarr_0_505[12] = "is-shut-down";
...
char constantarr_0_510[11] = "hard-forbid";
char constantarr_0_511[8] = "needs-gc";
char constantarr_0_512[17] = "n-threads-running";
char constantarr_0_513[25] = "is-empty<task-queue-node>";
char constantarr_0_514[7] = "drop<a>";
char constantarr_0_515[12] = "get-sequence";
char constantarr_0_516[11] = "choose-task";
char constantarr_0_517[17] = "get-monotime-nsec";
char constantarr_0_518[13] = "new<timespec>";
char constantarr_0_519[13] = "clock_gettime";
char constantarr_0_520[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_521[11] = "*<timespec>";
char constantarr_0_522[14] = "inner-value<a>";
...
char constantarr_0_527[19] = "rslt-no-chosen-task";
char constantarr_0_528[21] = "choose-task-in-island";
char constantarr_0_529[7] = "do-a-gc";
char constantarr_0_530[11] = "tii-no-task";
char constantarr_0_531[11] = "none<nat64>";
char constantarr_0_532[9] = "pop-task!";
char constantarr_0_533[26] = "ref-of-val<mut-arr<nat64>>";
char constantarr_0_534[28] = "currently-running-exclusions";
char constantarr_0_535[11] = "ptr-no-task";
char constantarr_0_536[9] = "in<nat64>";
char constantarr_0_537[5] = "in<a>";
char constantarr_0_538[11] = "in-recur<a>";
char constantarr_0_539[11] = "noctx-at<a>";
char constantarr_0_540[14] = "temp-as-arr<a>";
char constantarr_0_541[18] = "temp-as-fix-arr<a>";
char constantarr_0_542[10] = "pop-recur!";
char constantarr_0_543[11] = "to-opt-time";
char constantarr_0_544[11] = "some<nat64>";
char constantarr_0_545[8] = "ptr-task";
char constantarr_0_546[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_547[8] = "tii-task";
char constantarr_0_548[10] = "is-no-task";
char constantarr_0_549[21] = "set-n-threads-running";
char constantarr_0_550[16] = "rslt-chosen-task";
char constantarr_0_551[9] = "togc-task";
char constantarr_0_552[9] = "any-tasks";
char constantarr_0_553[8] = "min-time";
char constantarr_0_554[10] = "min<nat64>";
char constantarr_0_555[15] = "first-task-time";
char constantarr_0_556[28] = "no-tasks-and-last-thread-out";
...
char constantarr_0_562[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_563[37] = "noctx-must-remove-unordered-recur!<a>";
...
char constantarr_0_571[13] = "mark-visit<a>";
char constantarr_0_572[20] = "ref-of-val<mark-ctx>";
char constantarr_0_573[15] = "clear-free-mem!";
char constantarr_0_574[17] = "!=<mut-ptr<bool>>";
char constantarr_0_575[16] = "set-is-shut-down";
...
char constantarr_0_586[18] = "new<mut-ptr<nat8>>";
char constantarr_0_587[12] = "pthread_join";
char constantarr_0_588[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_589[6] = "EINVAL";
char constantarr_0_590[5] = "ESRCH";
char constantarr_0_591[16] = "*<mut-ptr<nat8>>";
...
char constantarr_0_600[24] = "any-unhandled-exceptions";
...
char constantarr_0_606[18] = "size-of<by-val<r>>";
char constantarr_0_607[7] = "-<nat8>";
char constantarr_0_608[19] = "as-any-const-ptr<r>";
char constantarr_0_609[6] = "finish";
char constantarr_0_610[5] = "inner";
char constantarr_0_611[7] = "to-base";
char constantarr_0_612[12] = "digit-to-str";
char constantarr_0_613[3] = "mod";
char constantarr_0_614[17] = "with-value<nat64>";
char constantarr_0_615[8] = "with-str";
char constantarr_0_616[6] = "interp";
char constantarr_0_617[8] = "cur-word";
char constantarr_0_618[10] = "words-used";
char constantarr_0_619[10] = "words-free";
char constantarr_0_620[11] = "total-words";
char constantarr_0_621[20] = "with-value<gc-stats>";
char constantarr_0_622[9] = "get-stats";
char constantarr_0_623[19] = "words-used-in-range";
char constantarr_0_624[8] = "to-nat64";
char constantarr_0_625[13] = "with-value<r>";
char constantarr_0_626[15] = "force-needs-gc!";
char constantarr_0_627[15] = "resolved<nat64>";
char constantarr_0_628[12] = "main.lambda0";
char constantarr_0_629[11] = "static-syms";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_6);
			copy_data_from__e_0(ctx, _matched0->funs, (struct arr_5) {378, constantarr_5_0}.begin_ptr, (struct arr_5) {378, constantarr_5_0}.size);
			sort__e(_matched0->funs, (struct arr_5) {378, constantarr_5_0}.size);
...
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_441(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct opt_3 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_440(mark_ctx, value1);
		}
		default:
...
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	mark_visit_428(mark_ctx, value.f);
...
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_427(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1 value) {
	...
	return mark_visit_426(mark_ctx, value.next);
}
...
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct fun_act1_3 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_425(mark_ctx, value0);
		}
		default:
...
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_416(mark_ctx, value.res);
}
...
struct void_ mark_visit_395(struct mark_ctx* mark_ctx, struct fun_act1_4 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_410(mark_ctx, value0);
		}
		default:
...
struct void_ mark_visit_402(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_406(mark_ctx, value.gc);
	return mark_visit_408(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_403(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_404(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_405(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_406(mark_ctx, value.gc);
	return mark_visit_404(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_411(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_412(mark_ctx, value.state);
}
...
struct void_ mark_visit_413(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_414(mark_ctx, value.cb);
...
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_416(mark_ctx, value.to);
}
...
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_421(mark_ctx, value.message);
	return mark_visit_423(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_421(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_422(mark_ctx, value.chars);
}
...
struct void_ mark_visit_423(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_424(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_430(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	mark_visit_416(mark_ctx, value.f);
	return mark_visit_414(mark_ctx, value.cb);
}
...
struct void_ mark_visit_433(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0* value) {
	...
	if (_0) {
		return mark_visit_432(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_435(struct mark_ctx* mark_ctx, struct subscript_15__lambda0* value) {
	...
	if (_0) {
		return mark_visit_434(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_437(struct mark_ctx* mark_ctx, struct subscript_20__lambda0__lambda0* value) {
	...
	if (_0) {
		return mark_visit_436(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_439(struct mark_ctx* mark_ctx, struct subscript_20__lambda0* value) {
	...
	if (_0) {
		return mark_visit_438(mark_ctx, (*value));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ mark_visit_441(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_visit_442(mark_ctx, value.backing);
}
/* mark-visit<fix-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_442(struct mark_ctx* mark_ctx, struct fix_arr_0 value) {
	return mark_arr_443(mark_ctx, value.inner);
}
