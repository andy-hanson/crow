...
struct mut_arr_1 subscript_6(struct ctx* ctx, struct mut_arr_1 a, struct arrow range);
struct arr_0 subscript_7(struct ctx* ctx, struct arr_0 a, struct arrow range);
...
struct arr_7 subscript_22(struct ctx* ctx, struct arr_7 a, struct arrow range);
...
struct fut_0* call_w_ctx_302(struct fun_act2 a, struct ctx* ctx, struct arr_7 p0, fun_ptr2 p1);
...
struct void_ mark_visit_381(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct some_2 value);
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
...
struct void_ mark_visit_399(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_401(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_402(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_403(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_405(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_406(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_407(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_408(struct mark_ctx* mark_ctx, struct some_10 value);
...
struct void_ mark_visit_414(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0 value);
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0* value);
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct subscript_14__lambda0 value);
struct void_ mark_visit_417(struct mark_ctx* mark_ctx, struct subscript_14__lambda0* value);
...
struct void_ mark_visit_423(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_424(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
...
uint64_t _minus_5(uint8_t* a, uint8_t* b);
uint64_t _minus_6(uint8_t* a, uint8_t* b);
uint8_t* as_any_const_ptr_2(struct r* ref);
...
char constantarr_0_131[26];
char constantarr_0_132[11];
char constantarr_0_133[26];
char constantarr_0_134[14];
char constantarr_0_135[25];
char constantarr_0_136[20];
char constantarr_0_137[16];
char constantarr_0_138[13];
char constantarr_0_139[13];
char constantarr_0_140[5];
char constantarr_0_141[33];
char constantarr_0_142[14];
...
char constantarr_0_164[20];
char constantarr_0_165[7];
...
char constantarr_0_196[40];
char constantarr_0_197[9];
char constantarr_0_198[12];
...
char constantarr_0_225[19];
char constantarr_0_226[21];
...
char constantarr_0_242[28];
char constantarr_0_243[51];
char constantarr_0_244[32];
...
char constantarr_0_255[43];
char constantarr_0_256[6];
char constantarr_0_257[30];
char constantarr_0_258[4];
char constantarr_0_259[37];
char constantarr_0_260[5];
char constantarr_0_261[33];
...
char constantarr_0_276[37];
char constantarr_0_277[21];
char constantarr_0_278[26];
...
char constantarr_0_296[2];
char constantarr_0_297[9];
char constantarr_0_298[24];
char constantarr_0_299[30];
char constantarr_0_300[1];
char constantarr_0_301[1];
...
char constantarr_0_361[20];
char constantarr_0_362[10];
char constantarr_0_363[30];
...
char constantarr_0_497[32];
char constantarr_0_498[21];
char constantarr_0_499[84];
char constantarr_0_500[11];
char constantarr_0_501[45];
char constantarr_0_502[19];
char constantarr_0_503[22];
char constantarr_0_504[34];
...
char constantarr_0_628[3];
char constantarr_0_629[17];
char constantarr_0_630[8];
char constantarr_0_631[6];
...
char constantarr_0_41[5] = "abort";
char constantarr_0_42[15] = "is-word-aligned";
char constantarr_0_43[2] = "==";
char constantarr_0_44[1] = "&";
char constantarr_0_45[14] = "to-nat64<nat8>";
char constantarr_0_46[12] = "as-mut<nat8>";
...
char constantarr_0_53[13] = "as-const<out>";
char constantarr_0_54[17] = "ptr-cast<out, in>";
char constantarr_0_55[8] = "-<nat64>";
char constantarr_0_56[4] = "-<a>";
char constantarr_0_57[8] = "wrap-sub";
char constantarr_0_58[11] = "to-nat64<a>";
char constantarr_0_59[10] = "size-of<a>";
char constantarr_0_60[9] = "as-mut<a>";
char constantarr_0_61[12] = "memory-start";
char constantarr_0_62[3] = "<=>";
char constantarr_0_63[7] = "is-less";
char constantarr_0_64[10] = "cmp<nat64>";
char constantarr_0_65[4] = "less";
char constantarr_0_66[5] = "equal";
char constantarr_0_67[7] = "greater";
char constantarr_0_68[8] = "<<nat64>";
char constantarr_0_69[4] = "true";
char constantarr_0_70[5] = "false";
char constantarr_0_71[17] = "memory-size-words";
char constantarr_0_72[9] = "<=<nat64>";
char constantarr_0_73[1] = "!";
char constantarr_0_74[7] = "+<bool>";
char constantarr_0_75[5] = "marks";
char constantarr_0_76[16] = "mark-range-recur";
char constantarr_0_77[8] = "==<bool>";
char constantarr_0_78[2] = "||";
char constantarr_0_79[15] = "subscript<bool>";
char constantarr_0_80[19] = "set-subscript<bool>";
char constantarr_0_81[8] = "><nat64>";
char constantarr_0_82[7] = "rt-main";
char constantarr_0_83[10] = "get_nprocs";
char constantarr_0_84[22] = "as<by-val<global-ctx>>";
char constantarr_0_85[10] = "global-ctx";
char constantarr_0_86[3] = "lbv";
char constantarr_0_87[11] = "lock-by-val";
char constantarr_0_88[4] = "lock";
char constantarr_0_89[11] = "atomic-bool";
char constantarr_0_90[4] = "none";
char constantarr_0_91[16] = "create-condition";
char constantarr_0_92[21] = "as<by-val<condition>>";
char constantarr_0_93[9] = "condition";
char constantarr_0_94[35] = "zeroed<by-val<pthread_mutexattr_t>>";
char constantarr_0_95[31] = "zeroed<by-val<pthread_mutex_t>>";
char constantarr_0_96[34] = "zeroed<by-val<pthread_condattr_t>>";
char constantarr_0_97[30] = "zeroed<by-val<pthread_cond_t>>";
char constantarr_0_98[23] = "hard-assert-posix-error";
char constantarr_0_99[22] = "pthread_mutexattr_init";
char constantarr_0_100[31] = "ref-of-val<pthread_mutexattr_t>";
char constantarr_0_101[10] = "mutex-attr";
char constantarr_0_102[21] = "ref-of-val<condition>";
char constantarr_0_103[18] = "pthread_mutex_init";
char constantarr_0_104[27] = "ref-of-val<pthread_mutex_t>";
char constantarr_0_105[5] = "mutex";
char constantarr_0_106[21] = "pthread_condattr_init";
char constantarr_0_107[30] = "ref-of-val<pthread_condattr_t>";
char constantarr_0_108[9] = "cond-attr";
char constantarr_0_109[25] = "pthread_condattr_setclock";
char constantarr_0_110[15] = "CLOCK_MONOTONIC";
char constantarr_0_111[17] = "pthread_cond_init";
char constantarr_0_112[26] = "ref-of-val<pthread_cond_t>";
char constantarr_0_113[4] = "cond";
char constantarr_0_114[22] = "ref-of-val<global-ctx>";
char constantarr_0_115[6] = "island";
char constantarr_0_116[10] = "task-queue";
char constantarr_0_117[58] = "mut-list-by-val-with-capacity-from-unmanaged-memory<nat64>";
char constantarr_0_118[10] = "mut-arr<a>";
char constantarr_0_119[6] = "arr<a>";
char constantarr_0_120[34] = "unmanaged-alloc-zeroed-elements<a>";
char constantarr_0_121[27] = "unmanaged-alloc-elements<a>";
char constantarr_0_122[21] = "unmanaged-alloc-bytes";
char constantarr_0_123[6] = "malloc";
char constantarr_0_124[8] = "==<nat8>";
char constantarr_0_125[17] = "!=<mut-ptr<nat8>>";
char constantarr_0_126[10] = "null<nat8>";
char constantarr_0_127[8] = "wrap-mul";
char constantarr_0_128[17] = "set-zero-range<a>";
char constantarr_0_129[19] = "drop<mut-ptr<nat8>>";
char constantarr_0_130[6] = "memset";
char constantarr_0_131[26] = "as-any-mut-ptr<mut-ptr<a>>";
char constantarr_0_132[11] = "mut-list<a>";
char constantarr_0_133[26] = "as<by-val<island-gc-root>>";
char constantarr_0_134[14] = "island-gc-root";
char constantarr_0_135[25] = "default-exception-handler";
char constantarr_0_136[20] = "print-err-no-newline";
char constantarr_0_137[16] = "write-no-newline";
char constantarr_0_138[13] = "size-of<char>";
char constantarr_0_139[13] = "size-of<nat8>";
char constantarr_0_140[5] = "write";
char constantarr_0_141[33] = "as-any-const-ptr<const-ptr<char>>";
char constantarr_0_142[14] = "as-const<nat8>";
char constantarr_0_143[17] = "as-any-mut-ptr<a>";
char constantarr_0_144[15] = "begin-ptr<char>";
char constantarr_0_145[5] = "chars";
char constantarr_0_146[10] = "size-bytes";
char constantarr_0_147[10] = "size<char>";
char constantarr_0_148[9] = "!=<int64>";
char constantarr_0_149[15] = "unsafe-to-int64";
char constantarr_0_150[10] = "todo<void>";
char constantarr_0_151[9] = "zeroed<a>";
char constantarr_0_152[6] = "stderr";
char constantarr_0_153[9] = "print-err";
char constantarr_0_154[6] = "to-str";
char constantarr_0_155[6] = "writer";
char constantarr_0_156[14] = "mut-list<char>";
char constantarr_0_157[2] = "~=";
char constantarr_0_158[8] = "~=<char>";
char constantarr_0_159[7] = "each<a>";
char constantarr_0_160[13] = "each-recur<a>";
char constantarr_0_161[5] = "==<a>";
char constantarr_0_162[16] = "!=<const-ptr<a>>";
char constantarr_0_163[18] = "subscript<void, a>";
char constantarr_0_164[20] = "call-with-ctx<r, p0>";
char constantarr_0_165[7] = "get-ctx";
char constantarr_0_166[12] = "subscript<a>";
char constantarr_0_167[4] = "+<a>";
char constantarr_0_168[11] = "as-const<a>";
char constantarr_0_169[10] = "end-ptr<a>";
char constantarr_0_170[5] = "~=<a>";
char constantarr_0_171[17] = "incr-capacity!<a>";
char constantarr_0_172[18] = "ensure-capacity<a>";
char constantarr_0_173[11] = "capacity<a>";
char constantarr_0_174[7] = "size<a>";
char constantarr_0_175[8] = "inner<a>";
char constantarr_0_176[10] = "backing<a>";
char constantarr_0_177[24] = "increase-capacity-to!<a>";
char constantarr_0_178[6] = "assert";
char constantarr_0_179[11] = "throw<void>";
char constantarr_0_180[8] = "throw<a>";
char constantarr_0_181[17] = "get-exception-ctx";
char constantarr_0_182[21] = "as-ref<exception-ctx>";
char constantarr_0_183[17] = "exception-ctx-ptr";
char constantarr_0_184[18] = "thread-local-stuff";
char constantarr_0_185[17] = "==<__jmp_buf_tag>";
char constantarr_0_186[26] = "!=<mut-ptr<__jmp_buf_tag>>";
char constantarr_0_187[11] = "jmp-buf-ptr";
char constantarr_0_188[19] = "null<__jmp_buf_tag>";
char constantarr_0_189[20] = "set-thrown-exception";
char constantarr_0_190[7] = "longjmp";
char constantarr_0_191[15] = "number-to-throw";
char constantarr_0_192[19] = "hard-unreachable<a>";
char constantarr_0_193[9] = "exception";
char constantarr_0_194[13] = "get-backtrace";
char constantarr_0_195[24] = "try-alloc-backtrace-arrs";
char constantarr_0_196[40] = "try-alloc-uninitialized<const-ptr<nat8>>";
char constantarr_0_197[9] = "try-alloc";
char constantarr_0_198[12] = "try-gc-alloc";
char constantarr_0_199[8] = "acquire!";
char constantarr_0_200[14] = "acquire-recur!";
char constantarr_0_201[12] = "try-acquire!";
char constantarr_0_202[8] = "try-set!";
char constantarr_0_203[11] = "try-change!";
char constantarr_0_204[23] = "compare-exchange-strong";
char constantarr_0_205[12] = "ptr-to<bool>";
char constantarr_0_206[5] = "value";
char constantarr_0_207[23] = "ref-of-val<atomic-bool>";
char constantarr_0_208[9] = "is-locked";
char constantarr_0_209[12] = "yield-thread";
char constantarr_0_210[11] = "sched_yield";
char constantarr_0_211[16] = "ref-of-val<lock>";
char constantarr_0_212[2] = "lk";
char constantarr_0_213[18] = "try-gc-alloc-recur";
char constantarr_0_214[8] = "data-cur";
char constantarr_0_215[8] = "+<nat64>";
char constantarr_0_216[9] = "==<nat64>";
char constantarr_0_217[10] = "<=><nat64>";
char constantarr_0_218[10] = "is-less<a>";
char constantarr_0_219[17] = "<<mut-ptr<nat64>>";
char constantarr_0_220[8] = "data-end";
char constantarr_0_221[10] = "range-free";
char constantarr_0_222[8] = "mark-cur";
char constantarr_0_223[12] = "set-mark-cur";
char constantarr_0_224[12] = "set-data-cur";
char constantarr_0_225[19] = "some<mut-ptr<nat8>>";
char constantarr_0_226[21] = "ptr-cast<nat8, nat64>";
char constantarr_0_227[19] = "maybe-set-needs-gc!";
char constantarr_0_228[7] = "-<bool>";
char constantarr_0_229[10] = "mark-begin";
char constantarr_0_230[10] = "size-words";
char constantarr_0_231[12] = "set-needs-gc";
char constantarr_0_232[8] = "release!";
char constantarr_0_233[11] = "must-unset!";
char constantarr_0_234[10] = "try-unset!";
...
char constantarr_0_240[16] = "some<mut-ptr<a>>";
char constantarr_0_241[17] = "ptr-cast<a, nat8>";
char constantarr_0_242[28] = "try-alloc-uninitialized<sym>";
char constantarr_0_243[51] = "try-alloc-uninitialized<named-val<const-ptr<nat8>>>";
char constantarr_0_244[32] = "size<named-val<const-ptr<nat8>>>";
char constantarr_0_245[8] = "all-funs";
char constantarr_0_246[20] = "some<backtrace-arrs>";
char constantarr_0_247[14] = "backtrace-arrs";
char constantarr_0_248[9] = "backtrace";
char constantarr_0_249[12] = "as<arr<sym>>";
char constantarr_0_250[15] = "unsafe-to-nat64";
char constantarr_0_251[8] = "to-int64";
char constantarr_0_252[9] = "code-ptrs";
char constantarr_0_253[15] = "unsafe-to-int32";
char constantarr_0_254[14] = "code-ptrs-size";
char constantarr_0_255[43] = "copy-data-from!<named-val<const-ptr<nat8>>>";
char constantarr_0_256[6] = "memcpy";
char constantarr_0_257[30] = "as-any-const-ptr<const-ptr<a>>";
char constantarr_0_258[4] = "funs";
char constantarr_0_259[37] = "begin-ptr<named-val<const-ptr<nat8>>>";
char constantarr_0_260[5] = "sort!";
char constantarr_0_261[33] = "swap!<named-val<const-ptr<nat8>>>";
char constantarr_0_262[16] = "set-subscript<a>";
char constantarr_0_263[10] = "partition!";
char constantarr_0_264[9] = "<=><nat8>";
char constantarr_0_265[6] = "<=><a>";
char constantarr_0_266[18] = "<<const-ptr<nat8>>";
char constantarr_0_267[20] = "val<const-ptr<nat8>>";
char constantarr_0_268[6] = "+<sym>";
char constantarr_0_269[10] = "code-names";
char constantarr_0_270[16] = "fill-code-names!";
char constantarr_0_271[7] = "==<sym>";
char constantarr_0_272[8] = "<=><sym>";
char constantarr_0_273[15] = "<<mut-ptr<sym>>";
char constantarr_0_274[18] = "set-subscript<sym>";
char constantarr_0_275[12] = "get-fun-name";
char constantarr_0_276[37] = "subscript<named-val<const-ptr<nat8>>>";
char constantarr_0_277[21] = "name<const-ptr<nat8>>";
char constantarr_0_278[26] = "subscript<const-ptr<nat8>>";
char constantarr_0_279[18] = "+<const-ptr<nat8>>";
char constantarr_0_280[8] = "arr<sym>";
char constantarr_0_281[13] = "as-const<sym>";
char constantarr_0_282[12] = "begin-ptr<a>";
char constantarr_0_283[14] = "set-backing<a>";
char constantarr_0_284[24] = "uninitialized-mut-arr<a>";
char constantarr_0_285[22] = "alloc-uninitialized<a>";
char constantarr_0_286[5] = "alloc";
char constantarr_0_287[8] = "gc-alloc";
char constantarr_0_288[19] = "todo<mut-ptr<nat8>>";
char constantarr_0_289[18] = "copy-data-from!<a>";
char constantarr_0_290[20] = "set-zero-elements<a>";
char constantarr_0_291[18] = "from<nat64, nat64>";
char constantarr_0_292[16] = "to<nat64, nat64>";
char constantarr_0_293[16] = "-><nat64, nat64>";
char constantarr_0_294[11] = "arrow<a, b>";
char constantarr_0_295[1] = "+";
char constantarr_0_296[2] = "&&";
char constantarr_0_297[9] = ">=<nat64>";
char constantarr_0_298[24] = "round-up-to-power-of-two";
char constantarr_0_299[30] = "round-up-to-power-of-two-recur";
char constantarr_0_300[1] = "*";
char constantarr_0_301[1] = "/";
char constantarr_0_302[6] = "forbid";
char constantarr_0_303[11] = "set-size<a>";
char constantarr_0_304[16] = "~=<char>.lambda0";
char constantarr_0_305[8] = "is-empty";
char constantarr_0_306[14] = "is-empty<char>";
char constantarr_0_307[7] = "message";
char constantarr_0_308[9] = "each<sym>";
char constantarr_0_309[12] = "return-stack";
char constantarr_0_310[3] = "str";
char constantarr_0_311[24] = "arr-from-begin-end<char>";
char constantarr_0_312[16] = "<=<const-ptr<a>>";
char constantarr_0_313[4] = "<<a>";
char constantarr_0_314[13] = "find-cstr-end";
char constantarr_0_315[17] = "find-char-in-cstr";
char constantarr_0_316[7] = "to-nat8";
char constantarr_0_317[21] = "some<const-ptr<char>>";
char constantarr_0_318[33] = "hard-unreachable<const-ptr<char>>";
char constantarr_0_319[8] = "to-c-str";
char constantarr_0_320[14] = "to-str.lambda0";
char constantarr_0_321[12] = "move-to-str!";
char constantarr_0_322[18] = "move-to-arr!<char>";
char constantarr_0_323[28] = "set-any-unhandled-exceptions";
char constantarr_0_324[14] = "get-global-ctx";
char constantarr_0_325[18] = "as-ref<global-ctx>";
char constantarr_0_326[8] = "gctx-ptr";
char constantarr_0_327[14] = "island.lambda0";
char constantarr_0_328[19] = "default-log-handler";
char constantarr_0_329[5] = "print";
char constantarr_0_330[16] = "print-no-newline";
char constantarr_0_331[6] = "stdout";
char constantarr_0_332[7] = "~<char>";
char constantarr_0_333[5] = "level";
char constantarr_0_334[14] = "island.lambda1";
char constantarr_0_335[20] = "ptr-cast<bool, nat8>";
char constantarr_0_336[29] = "as-any-mut-ptr<mut-ptr<bool>>";
char constantarr_0_337[14] = "as<by-val<gc>>";
char constantarr_0_338[11] = "validate-gc";
char constantarr_0_339[10] = "data-begin";
char constantarr_0_340[9] = "<=><bool>";
char constantarr_0_341[17] = "<=<mut-ptr<bool>>";
char constantarr_0_342[8] = "mark-end";
char constantarr_0_343[18] = "<=<mut-ptr<nat64>>";
char constantarr_0_344[14] = "ref-of-val<gc>";
char constantarr_0_345[19] = "thread-safe-counter";
char constantarr_0_346[18] = "ref-of-val<island>";
char constantarr_0_347[11] = "set-islands";
char constantarr_0_348[11] = "arr<island>";
char constantarr_0_349[14] = "ptr-to<island>";
char constantarr_0_350[13] = "add-main-task";
char constantarr_0_351[13] = "exception-ctx";
char constantarr_0_352[7] = "log-ctx";
char constantarr_0_353[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_354[8] = "perf-ctx";
char constantarr_0_355[22] = "mut-arr<measure-value>";
char constantarr_0_356[29] = "as-any-mut-ptr<exception-ctx>";
char constantarr_0_357[25] = "ref-of-val<exception-ctx>";
char constantarr_0_358[23] = "as-any-mut-ptr<log-ctx>";
char constantarr_0_359[19] = "ref-of-val<log-ctx>";
char constantarr_0_360[24] = "as-any-mut-ptr<perf-ctx>";
char constantarr_0_361[20] = "ref-of-val<perf-ctx>";
char constantarr_0_362[10] = "print-lock";
char constantarr_0_363[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_364[3] = "ctx";
char constantarr_0_365[12] = "context-head";
char constantarr_0_366[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_367[6] = "set-gc";
char constantarr_0_368[12] = "set-next-ctx";
char constantarr_0_369[16] = "set-context-head";
char constantarr_0_370[8] = "next-ctx";
char constantarr_0_371[11] = "set-handler";
char constantarr_0_372[15] = "as-ref<log-ctx>";
char constantarr_0_373[11] = "log-ctx-ptr";
char constantarr_0_374[11] = "log-handler";
char constantarr_0_375[26] = "ref-of-val<island-gc-root>";
char constantarr_0_376[7] = "gc-root";
char constantarr_0_377[26] = "as-any-mut-ptr<global-ctx>";
char constantarr_0_378[2] = "id";
char constantarr_0_379[22] = "as-any-mut-ptr<gc-ctx>";
char constantarr_0_380[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_381[15] = "ref-of-val<ctx>";
char constantarr_0_382[83] = "as<fun-act2<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_383[14] = "add-first-task";
char constantarr_0_384[16] = "then-void<nat64>";
char constantarr_0_385[15] = "then<out, void>";
char constantarr_0_386[15] = "unresolved<out>";
char constantarr_0_387[6] = "fut<a>";
char constantarr_0_388[22] = "fut-state-no-callbacks";
char constantarr_0_389[13] = "callback!<in>";
char constantarr_0_390[15] = "with-lock<void>";
char constantarr_0_391[16] = "call-with-ctx<r>";
char constantarr_0_392[5] = "lk<a>";
char constantarr_0_393[8] = "state<a>";
char constantarr_0_394[12] = "set-state<a>";
char constantarr_0_395[22] = "fut-state-callbacks<a>";
char constantarr_0_396[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_397[37] = "subscript<void, result<a, exception>>";
char constantarr_0_398[5] = "ok<a>";
char constantarr_0_399[8] = "value<a>";
char constantarr_0_400[14] = "err<exception>";
char constantarr_0_401[21] = "callback!<in>.lambda0";
char constantarr_0_402[16] = "forward-to!<out>";
char constantarr_0_403[12] = "callback!<a>";
char constantarr_0_404[20] = "callback!<a>.lambda0";
char constantarr_0_405[21] = "resolve-or-reject!<a>";
char constantarr_0_406[23] = "with-lock<fut-state<a>>";
char constantarr_0_407[21] = "fut-state-resolved<a>";
char constantarr_0_408[16] = "value<exception>";
char constantarr_0_409[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_410[18] = "call-callbacks!<a>";
char constantarr_0_411[5] = "cb<a>";
char constantarr_0_412[7] = "next<a>";
char constantarr_0_413[24] = "forward-to!<out>.lambda0";
char constantarr_0_414[18] = "subscript<out, in>";
char constantarr_0_415[10] = "get-island";
char constantarr_0_416[17] = "subscript<island>";
char constantarr_0_417[12] = "unsafe-at<a>";
char constantarr_0_418[7] = "islands";
char constantarr_0_419[27] = "island-and-exclusion<r, p0>";
char constantarr_0_420[8] = "add-task";
char constantarr_0_421[15] = "task-queue-node";
char constantarr_0_422[4] = "task";
char constantarr_0_423[10] = "tasks-lock";
char constantarr_0_424[12] = "insert-task!";
char constantarr_0_425[4] = "size";
char constantarr_0_426[10] = "size-recur";
char constantarr_0_427[4] = "next";
char constantarr_0_428[4] = "head";
char constantarr_0_429[8] = "set-head";
char constantarr_0_430[21] = "some<task-queue-node>";
char constantarr_0_431[4] = "time";
char constantarr_0_432[12] = "insert-recur";
char constantarr_0_433[8] = "set-next";
char constantarr_0_434[5] = "tasks";
char constantarr_0_435[22] = "ref-of-val<task-queue>";
char constantarr_0_436[10] = "broadcast!";
char constantarr_0_437[18] = "pthread_mutex_lock";
char constantarr_0_438[22] = "pthread_cond_broadcast";
char constantarr_0_439[12] = "set-sequence";
char constantarr_0_440[8] = "sequence";
char constantarr_0_441[20] = "pthread_mutex_unlock";
char constantarr_0_442[17] = "may-be-work-to-do";
char constantarr_0_443[4] = "gctx";
char constantarr_0_444[12] = "no-timestamp";
char constantarr_0_445[9] = "exclusion";
char constantarr_0_446[11] = "catch<void>";
char constantarr_0_447[27] = "catch-with-exception-ctx<a>";
char constantarr_0_448[16] = "thrown-exception";
char constantarr_0_449[13] = "__jmp_buf_tag";
char constantarr_0_450[4] = "zero";
char constantarr_0_451[7] = "bytes64";
char constantarr_0_452[7] = "bytes32";
char constantarr_0_453[7] = "bytes16";
char constantarr_0_454[8] = "bytes128";
char constantarr_0_455[15] = "set-jmp-buf-ptr";
char constantarr_0_456[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_457[6] = "setjmp";
char constantarr_0_458[23] = "subscript<a, exception>";
char constantarr_0_459[21] = "subscript<fut<r>, p0>";
char constantarr_0_460[10] = "fun<r, p0>";
char constantarr_0_461[34] = "subscript<out, in>.lambda0.lambda0";
char constantarr_0_462[10] = "reject!<r>";
char constantarr_0_463[34] = "subscript<out, in>.lambda0.lambda1";
char constantarr_0_464[26] = "subscript<out, in>.lambda0";
char constantarr_0_465[9] = "value<in>";
char constantarr_0_466[23] = "then<out, void>.lambda0";
char constantarr_0_467[14] = "subscript<out>";
char constantarr_0_468[23] = "island-and-exclusion<r>";
char constantarr_0_469[17] = "subscript<fut<r>>";
char constantarr_0_470[6] = "fun<r>";
char constantarr_0_471[30] = "subscript<out>.lambda0.lambda0";
char constantarr_0_472[30] = "subscript<out>.lambda0.lambda1";
char constantarr_0_473[22] = "subscript<out>.lambda0";
char constantarr_0_474[24] = "then-void<nat64>.lambda0";
char constantarr_0_475[24] = "cur-island-and-exclusion";
char constantarr_0_476[20] = "island-and-exclusion";
char constantarr_0_477[9] = "island-id";
char constantarr_0_478[5] = "delay";
char constantarr_0_479[14] = "resolved<void>";
char constantarr_0_480[21] = "tail<const-ptr<char>>";
char constantarr_0_481[11] = "is-empty<a>";
char constantarr_0_482[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_483[25] = "map<str, const-ptr<char>>";
char constantarr_0_484[13] = "make-arr<out>";
char constantarr_0_485[17] = "fill-ptr-range<a>";
char constantarr_0_486[23] = "fill-ptr-range-recur<a>";
char constantarr_0_487[9] = "!=<nat64>";
char constantarr_0_488[19] = "subscript<a, nat64>";
char constantarr_0_489[13] = "subscript<in>";
char constantarr_0_490[33] = "map<str, const-ptr<char>>.lambda0";
char constantarr_0_491[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_492[22] = "add-first-task.lambda0";
char constantarr_0_493[24] = "handle-exceptions<nat64>";
char constantarr_0_494[26] = "subscript<void, exception>";
char constantarr_0_495[17] = "exception-handler";
char constantarr_0_496[14] = "get-cur-island";
char constantarr_0_497[32] = "handle-exceptions<nat64>.lambda0";
char constantarr_0_498[21] = "add-main-task.lambda0";
char constantarr_0_499[84] = "call-with-ctx<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
char constantarr_0_500[11] = "run-threads";
char constantarr_0_501[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_502[19] = "start-threads-recur";
char constantarr_0_503[22] = "+<by-val<thread-args>>";
char constantarr_0_504[34] = "set-subscript<by-val<thread-args>>";
char constantarr_0_505[11] = "thread-args";
char constantarr_0_506[17] = "create-one-thread";
char constantarr_0_507[14] = "pthread_create";
char constantarr_0_508[9] = "!=<int32>";
char constantarr_0_509[6] = "EAGAIN";
char constantarr_0_510[14] = "as-cell<nat64>";
char constantarr_0_511[15] = "as-ref<cell<a>>";
char constantarr_0_512[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
char constantarr_0_513[10] = "thread-fun";
char constantarr_0_514[19] = "as-ref<thread-args>";
char constantarr_0_515[15] = "thread-function";
char constantarr_0_516[21] = "thread-function-recur";
char constantarr_0_517[12] = "is-shut-down";
char constantarr_0_518[18] = "set-n-live-threads";
char constantarr_0_519[14] = "n-live-threads";
char constantarr_0_520[28] = "assert-islands-are-shut-down";
char constantarr_0_521[16] = "noctx-at<island>";
char constantarr_0_522[11] = "hard-forbid";
char constantarr_0_523[8] = "needs-gc";
char constantarr_0_524[17] = "n-threads-running";
char constantarr_0_525[25] = "is-empty<task-queue-node>";
char constantarr_0_526[12] = "get-sequence";
char constantarr_0_527[11] = "choose-task";
char constantarr_0_528[17] = "get-monotime-nsec";
char constantarr_0_529[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_530[14] = "cell<timespec>";
char constantarr_0_531[8] = "timespec";
char constantarr_0_532[13] = "clock_gettime";
char constantarr_0_533[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_534[19] = "subscript<timespec>";
char constantarr_0_535[6] = "tv-sec";
char constantarr_0_536[7] = "tv-nsec";
char constantarr_0_537[11] = "todo<nat64>";
char constantarr_0_538[22] = "as<choose-task-result>";
char constantarr_0_539[17] = "choose-task-recur";
char constantarr_0_540[14] = "no-chosen-task";
char constantarr_0_541[21] = "choose-task-in-island";
char constantarr_0_542[32] = "as<choose-task-in-island-result>";
char constantarr_0_543[7] = "do-a-gc";
char constantarr_0_544[7] = "no-task";
char constantarr_0_545[9] = "pop-task!";
char constantarr_0_546[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_547[28] = "currently-running-exclusions";
char constantarr_0_548[19] = "as<pop-task-result>";
char constantarr_0_549[9] = "in<nat64>";
char constantarr_0_550[5] = "in<a>";
char constantarr_0_551[11] = "in-recur<a>";
char constantarr_0_552[11] = "noctx-at<a>";
char constantarr_0_553[14] = "temp-as-arr<a>";
char constantarr_0_554[18] = "temp-as-mut-arr<a>";
char constantarr_0_555[10] = "pop-recur!";
char constantarr_0_556[11] = "to-opt-time";
char constantarr_0_557[11] = "some<nat64>";
char constantarr_0_558[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_559[10] = "is-no-task";
char constantarr_0_560[21] = "set-n-threads-running";
char constantarr_0_561[11] = "chosen-task";
char constantarr_0_562[9] = "any-tasks";
char constantarr_0_563[8] = "min-time";
char constantarr_0_564[10] = "min<nat64>";
char constantarr_0_565[15] = "first-task-time";
char constantarr_0_566[28] = "no-tasks-and-last-thread-out";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {355, constantarr_5_0}.begin_ptr, (struct arr_5) {355, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {355, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {355, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {355, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ callback__e_0__lambda0(struct ctx* ctx, struct callback__e_0__lambda0* _closure) {
	...
	switch (_0.kind) {
		...
		case 3: {
			...
			return subscript_11(ctx, _closure->cb, (struct result_1) {1, .as1 = (struct err) {e2}});
		}
		default:
...
struct void_ callback__e_1__lambda0(struct ctx* ctx, struct callback__e_1__lambda0* _closure) {
	...
	switch (_0.kind) {
		...
		case 3: {
			...
			return subscript_12(ctx, _closure->cb, (struct result_0) {1, .as1 = (struct err) {e2}});
		}
		default:
...
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct some_3 value) {
	return mark_visit_422(mark_ctx, value.value);
}
...
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 3: {
			...
			return mark_visit_401(mark_ctx, value3);
		}
		default:
...
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct fun_act0_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_389(mark_ctx, value1);
		}
		default:
...
struct void_ mark_visit_381(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_386(mark_ctx, value.gc);
	return mark_visit_388(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_383(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_386(mark_ctx, value.gc);
	return mark_visit_383(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_401(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_402(mark_ctx, value.message);
	return mark_visit_404(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_402(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_403(mark_ctx, value.chars);
}
...
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_405(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_408(struct mark_ctx* mark_ctx, struct some_10 value) {
	return mark_visit_409(mark_ctx, value.value);
}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_2 _p0) {
	...
	*temp1 = (struct r) {4u, 5u, 6u};
	...
	uint8_t* _2 = as_any_const_ptr_2(b2);
	uint8_t* _3 = as_any_const_ptr_2(a1);
	uint64_t _4 = _minus_5(_2, _3);
	assert(ctx, (_4 == 24u));
	struct interp _5 = interp(ctx);
	struct interp _6 = with_str(ctx, _5, (struct str) {{7, constantarr_0_30}});
	struct gc_stats _7 = get_stats(gc0);
	struct interp _8 = with_value_1(ctx, _6, _7);
	struct str _9 = finish(ctx, _8);
	print(_9);
	struct interp _10 = interp(ctx);
	struct interp _11 = with_str(ctx, _10, (struct str) {{10, constantarr_0_31}});
	struct interp _12 = with_value_0(ctx, _11, gc0->gc_count);
	struct str _13 = finish(ctx, _12);
	print(_13);
	struct interp _14 = interp(ctx);
	struct interp _15 = with_str(ctx, _14, (struct str) {{3, constantarr_0_35}});
	struct interp _16 = with_value_2(ctx, _15, a1);
	struct str _17 = finish(ctx, _16);
	print(_17);
	struct interp _18 = interp(ctx);
	struct interp _19 = with_str(ctx, _18, (struct str) {{21, constantarr_0_36}});
	struct gc_stats _20 = get_stats(gc0);
	struct interp _21 = with_value_1(ctx, _19, _20);
...
/* -<nat8> nat64(a const-ptr<nat8>, b const-ptr<nat8>) */
uint64_t _minus_5(uint8_t* a, uint8_t* b) {
	return _minus_6(((uint8_t*) a), ((uint8_t*) b));
}
/* -<a> nat64(a mut-ptr<nat8>, b mut-ptr<nat8>) */
uint64_t _minus_6(uint8_t* a, uint8_t* b) {
	return ((((uint64_t) a) - ((uint64_t) b)) / sizeof(uint8_t));
}
/* as-any-const-ptr<r> const-ptr<nat8>(ref r) */
uint8_t* as_any_const_ptr_2(struct r* ref) {
	return ((uint8_t*) ((uint8_t*) ref));
}
/* finish str(a interp) */
...
struct str to_str_3(struct ctx* ctx, struct gc_stats a) {
	...
	struct interp _1 = with_str(ctx, _0, (struct str) {{9, constantarr_0_27}});
	struct interp _2 = with_value_0(ctx, _1, a.cur_word);
	struct interp _3 = with_str(ctx, _2, (struct str) {{13, constantarr_0_28}});
	struct interp _4 = with_value_0(ctx, _3, a.words_used);
	struct interp _5 = with_str(ctx, _4, (struct str) {{13, constantarr_0_29}});
...
/* words-used-in-range nat64(acc nat64, cur mut-ptr<bool>, end mut-ptr<bool>) */
uint64_t words_used_in_range(uint64_t acc, uint8_t* cur, uint8_t* end) {
	top:;
	uint8_t _0 = (cur == end);
	if (_0) {
...
struct str to_str_5(struct ctx* ctx, struct r* a) {
	struct interp _0 = interp(ctx);
	struct interp _1 = with_str(ctx, _0, (struct str) {{2, constantarr_0_32}});
	struct interp _2 = with_value_0(ctx, _1, a->a);
	struct interp _3 = with_str(ctx, _2, (struct str) {{4, constantarr_0_33}});
	struct interp _4 = with_value_0(ctx, _3, a->b);
	struct interp _5 = with_str(ctx, _4, (struct str) {{4, constantarr_0_34}});
