...
struct void_ mark_visit_352(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct gc value);
struct void_ mark_visit_354(struct mark_ctx* mark_ctx, struct opt_2 value);
struct void_ mark_visit_355(struct mark_ctx* mark_ctx, struct some_2 value);
struct void_ mark_visit_356(struct mark_ctx* mark_ctx, struct gc_ctx value);
struct void_ mark_visit_357(struct mark_ctx* mark_ctx, struct gc* value);
struct void_ mark_visit_358(struct mark_ctx* mark_ctx, struct gc_ctx* value);
struct void_ mark_visit_359(struct mark_ctx* mark_ctx, struct r* value);
struct void_ mark_visit_360(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_365(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_366(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0* value);
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_371(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_374(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_376(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_379(struct mark_ctx* mark_ctx, struct some_10 value);
struct void_ mark_visit_380(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1* value);
struct void_ mark_visit_381(struct mark_ctx* mark_ctx, struct fut_1* value);
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0* value);
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value);
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0* value);
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0 value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0* value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct subscript_9__lambda0 value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct subscript_9__lambda0* value);
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0 value);
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct subscript_14__lambda0__lambda0* value);
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct subscript_14__lambda0 value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct subscript_14__lambda0* value);
...
struct void_ mark_arr_396(struct mark_ctx* mark_ctx, struct arr_3 a);
...
char constantarr_0_48[25];
char constantarr_0_49[8];
char constantarr_0_50[1];
char constantarr_0_51[21];
...
char constantarr_0_233[45];
char constantarr_0_234[26];
char constantarr_0_235[8];
char constantarr_0_236[20];
...
char constantarr_0_245[37];
char constantarr_0_246[6];
char constantarr_0_247[4];
char constantarr_0_248[31];
char constantarr_0_249[5];
char constantarr_0_250[27];
...
char constantarr_0_345[25];
char constantarr_0_346[25];
char constantarr_0_347[19];
char constantarr_0_348[19];
char constantarr_0_349[20];
char constantarr_0_350[20];
...
char constantarr_0_460[31];
char constantarr_0_461[31];
char constantarr_0_462[23];
char constantarr_0_463[24];
char constantarr_0_464[24];
char constantarr_0_465[20];
...
char constantarr_0_477[20];
char constantarr_0_478[14];
char constantarr_0_479[27];
...
char constantarr_0_486[32];
char constantarr_0_487[21];
char constantarr_0_488[78];
...
char constantarr_0_633[15];
char constantarr_0_634[12];
char constantarr_0_635[11];
struct named_val constantarr_5_0[324];
struct sym constantarr_1_0[213];
...
char constantarr_0_46[14] = "words-of-bytes";
char constantarr_0_47[10] = "unsafe-div";
char constantarr_0_48[25] = "round-up-to-multiple-of-8";
char constantarr_0_49[8] = "wrap-add";
char constantarr_0_50[1] = "~";
char constantarr_0_51[21] = "ptr-cast<nat64, nat8>";
char constantarr_0_52[8] = "-<nat64>";
char constantarr_0_53[8] = "wrap-sub";
char constantarr_0_54[12] = "to-nat64<?a>";
char constantarr_0_55[11] = "size-of<?a>";
char constantarr_0_56[12] = "memory-start";
char constantarr_0_57[3] = "<=>";
char constantarr_0_58[13] = "?<comparison>";
char constantarr_0_59[5] = "less?";
char constantarr_0_60[4] = "less";
char constantarr_0_61[5] = "equal";
char constantarr_0_62[7] = "greater";
char constantarr_0_63[8] = "<<nat64>";
char constantarr_0_64[4] = "true";
char constantarr_0_65[5] = "false";
char constantarr_0_66[17] = "memory-size-words";
char constantarr_0_67[9] = "<=<nat64>";
char constantarr_0_68[1] = "!";
char constantarr_0_69[7] = "+<bool>";
char constantarr_0_70[5] = "marks";
char constantarr_0_71[16] = "mark-range-recur";
char constantarr_0_72[8] = "==<bool>";
char constantarr_0_73[2] = "||";
char constantarr_0_74[15] = "subscript<bool>";
char constantarr_0_75[19] = "set-subscript<bool>";
char constantarr_0_76[8] = "><nat64>";
char constantarr_0_77[7] = "rt-main";
char constantarr_0_78[10] = "get_nprocs";
char constantarr_0_79[22] = "as<by-val<global-ctx>>";
char constantarr_0_80[10] = "global-ctx";
char constantarr_0_81[3] = "lbv";
...
char constantarr_0_87[21] = "as<by-val<condition>>";
char constantarr_0_88[9] = "condition";
char constantarr_0_89[35] = "zeroed<by-val<pthread_mutexattr_t>>";
char constantarr_0_90[31] = "zeroed<by-val<pthread_mutex_t>>";
char constantarr_0_91[34] = "zeroed<by-val<pthread_condattr_t>>";
char constantarr_0_92[30] = "zeroed<by-val<pthread_cond_t>>";
char constantarr_0_93[23] = "hard-assert-posix-error";
char constantarr_0_94[22] = "pthread_mutexattr_init";
char constantarr_0_95[31] = "ref-of-val<pthread_mutexattr_t>";
char constantarr_0_96[10] = "mutex-attr";
char constantarr_0_97[21] = "ref-of-val<condition>";
char constantarr_0_98[18] = "pthread_mutex_init";
char constantarr_0_99[27] = "ref-of-val<pthread_mutex_t>";
char constantarr_0_100[5] = "mutex";
char constantarr_0_101[21] = "pthread_condattr_init";
char constantarr_0_102[30] = "ref-of-val<pthread_condattr_t>";
char constantarr_0_103[9] = "cond-attr";
char constantarr_0_104[25] = "pthread_condattr_setclock";
char constantarr_0_105[15] = "CLOCK_MONOTONIC";
char constantarr_0_106[17] = "pthread_cond_init";
char constantarr_0_107[26] = "ref-of-val<pthread_cond_t>";
char constantarr_0_108[4] = "cond";
char constantarr_0_109[22] = "ref-of-val<global-ctx>";
char constantarr_0_110[6] = "island";
char constantarr_0_111[10] = "task-queue";
...
char constantarr_0_200[11] = "sched_yield";
...
char constantarr_0_232[28] = "try-alloc-uninitialized<sym>";
char constantarr_0_233[45] = "try-alloc-uninitialized<named-val<ptr<nat8>>>";
char constantarr_0_234[26] = "size<named-val<ptr<nat8>>>";
char constantarr_0_235[8] = "all-funs";
char constantarr_0_236[20] = "some<backtrace-arrs>";
char constantarr_0_237[14] = "backtrace-arrs";
char constantarr_0_238[9] = "backtrace";
char constantarr_0_239[12] = "as<arr<sym>>";
char constantarr_0_240[15] = "unsafe-to-nat64";
char constantarr_0_241[8] = "to-int64";
char constantarr_0_242[9] = "code-ptrs";
char constantarr_0_243[15] = "unsafe-to-int32";
char constantarr_0_244[14] = "code-ptrs-size";
char constantarr_0_245[37] = "copy-data-from!<named-val<ptr<nat8>>>";
char constantarr_0_246[6] = "memcpy";
char constantarr_0_247[4] = "funs";
char constantarr_0_248[31] = "begin-ptr<named-val<ptr<nat8>>>";
char constantarr_0_249[5] = "sort!";
char constantarr_0_250[27] = "swap!<named-val<ptr<nat8>>>";
char constantarr_0_251[17] = "set-subscript<?a>";
char constantarr_0_252[10] = "partition!";
char constantarr_0_253[9] = "<=><nat8>";
char constantarr_0_254[12] = "<<ptr<nat8>>";
char constantarr_0_255[14] = "val<ptr<nat8>>";
char constantarr_0_256[6] = "+<sym>";
char constantarr_0_257[10] = "code-names";
char constantarr_0_258[16] = "fill-code-names!";
char constantarr_0_259[7] = "==<sym>";
char constantarr_0_260[8] = "<=><sym>";
char constantarr_0_261[11] = "<<ptr<sym>>";
char constantarr_0_262[18] = "set-subscript<sym>";
char constantarr_0_263[12] = "get-fun-name";
char constantarr_0_264[15] = "name<ptr<nat8>>";
char constantarr_0_265[20] = "subscript<ptr<nat8>>";
char constantarr_0_266[12] = "+<ptr<nat8>>";
char constantarr_0_267[8] = "arr<sym>";
char constantarr_0_268[13] = "begin-ptr<?a>";
char constantarr_0_269[15] = "set-backing<?a>";
char constantarr_0_270[25] = "uninitialized-mut-arr<?a>";
char constantarr_0_271[23] = "alloc-uninitialized<?a>";
char constantarr_0_272[5] = "alloc";
char constantarr_0_273[8] = "gc-alloc";
char constantarr_0_274[15] = "todo<ptr<nat8>>";
char constantarr_0_275[19] = "copy-data-from!<?a>";
char constantarr_0_276[21] = "set-zero-elements<?a>";
char constantarr_0_277[18] = "from<nat64, nat64>";
char constantarr_0_278[16] = "to<nat64, nat64>";
char constantarr_0_279[16] = "-><nat64, nat64>";
char constantarr_0_280[13] = "arrow<?a, ?b>";
char constantarr_0_281[1] = "+";
char constantarr_0_282[2] = "&&";
...
char constantarr_0_289[12] = "set-size<?a>";
char constantarr_0_290[16] = "~=<char>.lambda0";
char constantarr_0_291[6] = "?<str>";
char constantarr_0_292[6] = "empty?";
char constantarr_0_293[12] = "empty?<char>";
char constantarr_0_294[7] = "message";
char constantarr_0_295[9] = "each<sym>";
char constantarr_0_296[12] = "return-stack";
char constantarr_0_297[3] = "str";
char constantarr_0_298[24] = "arr-from-begin-end<char>";
char constantarr_0_299[7] = "<=><?a>";
char constantarr_0_300[11] = "<=<ptr<?a>>";
char constantarr_0_301[5] = "<<?a>";
char constantarr_0_302[5] = "-<?a>";
char constantarr_0_303[13] = "find-cstr-end";
char constantarr_0_304[17] = "find-char-in-cstr";
char constantarr_0_305[7] = "to-nat8";
char constantarr_0_306[15] = "some<ptr<char>>";
char constantarr_0_307[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_308[8] = "to-c-str";
char constantarr_0_309[14] = "to-str.lambda0";
char constantarr_0_310[12] = "move-to-str!";
char constantarr_0_311[18] = "move-to-arr!<char>";
...
char constantarr_0_326[14] = "as<by-val<gc>>";
char constantarr_0_327[11] = "validate-gc";
char constantarr_0_328[10] = "data-begin";
char constantarr_0_329[9] = "<=><bool>";
char constantarr_0_330[13] = "<=<ptr<bool>>";
char constantarr_0_331[8] = "mark-end";
char constantarr_0_332[14] = "<=<ptr<nat64>>";
char constantarr_0_333[14] = "ref-of-val<gc>";
char constantarr_0_334[19] = "thread-safe-counter";
char constantarr_0_335[18] = "ref-of-val<island>";
char constantarr_0_336[11] = "set-islands";
char constantarr_0_337[11] = "arr<island>";
char constantarr_0_338[14] = "ptr-to<island>";
char constantarr_0_339[13] = "add-main-task";
char constantarr_0_340[13] = "exception-ctx";
char constantarr_0_341[7] = "log-ctx";
char constantarr_0_342[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_343[8] = "perf-ctx";
char constantarr_0_344[22] = "mut-arr<measure-value>";
char constantarr_0_345[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_346[25] = "ref-of-val<exception-ctx>";
char constantarr_0_347[19] = "as-any-ptr<log-ctx>";
char constantarr_0_348[19] = "ref-of-val<log-ctx>";
char constantarr_0_349[20] = "as-any-ptr<perf-ctx>";
char constantarr_0_350[20] = "ref-of-val<perf-ctx>";
char constantarr_0_351[10] = "print-lock";
char constantarr_0_352[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_353[3] = "ctx";
char constantarr_0_354[12] = "context-head";
char constantarr_0_355[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_356[6] = "set-gc";
char constantarr_0_357[12] = "set-next-ctx";
char constantarr_0_358[16] = "set-context-head";
char constantarr_0_359[8] = "next-ctx";
char constantarr_0_360[11] = "set-handler";
char constantarr_0_361[15] = "as-ref<log-ctx>";
char constantarr_0_362[11] = "log-ctx-ptr";
char constantarr_0_363[11] = "log-handler";
char constantarr_0_364[26] = "ref-of-val<island-gc-root>";
char constantarr_0_365[7] = "gc-root";
char constantarr_0_366[22] = "as-any-ptr<global-ctx>";
char constantarr_0_367[2] = "id";
char constantarr_0_368[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_369[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_370[15] = "ref-of-val<ctx>";
char constantarr_0_371[77] = "as<fun-act2<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_372[14] = "add-first-task";
char constantarr_0_373[16] = "then-void<nat64>";
char constantarr_0_374[16] = "then<?out, void>";
char constantarr_0_375[16] = "unresolved<?out>";
char constantarr_0_376[7] = "fut<?a>";
char constantarr_0_377[22] = "fut-state-no-callbacks";
char constantarr_0_378[14] = "callback!<?in>";
char constantarr_0_379[15] = "with-lock<void>";
char constantarr_0_380[17] = "call-with-ctx<?r>";
char constantarr_0_381[6] = "lk<?a>";
char constantarr_0_382[9] = "state<?a>";
char constantarr_0_383[13] = "set-state<?a>";
char constantarr_0_384[23] = "fut-state-callbacks<?a>";
char constantarr_0_385[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_386[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_387[6] = "ok<?a>";
char constantarr_0_388[9] = "value<?a>";
char constantarr_0_389[14] = "err<exception>";
char constantarr_0_390[22] = "callback!<?in>.lambda0";
char constantarr_0_391[17] = "forward-to!<?out>";
char constantarr_0_392[13] = "callback!<?a>";
char constantarr_0_393[21] = "callback!<?a>.lambda0";
char constantarr_0_394[22] = "resolve-or-reject!<?a>";
char constantarr_0_395[24] = "with-lock<fut-state<?a>>";
char constantarr_0_396[22] = "fut-state-resolved<?a>";
char constantarr_0_397[16] = "value<exception>";
char constantarr_0_398[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_399[19] = "call-callbacks!<?a>";
char constantarr_0_400[6] = "cb<?a>";
char constantarr_0_401[8] = "next<?a>";
char constantarr_0_402[25] = "forward-to!<?out>.lambda0";
char constantarr_0_403[20] = "subscript<?out, ?in>";
char constantarr_0_404[10] = "get-island";
char constantarr_0_405[17] = "subscript<island>";
char constantarr_0_406[13] = "unsafe-at<?a>";
char constantarr_0_407[7] = "islands";
char constantarr_0_408[29] = "island-and-exclusion<?r, ?p0>";
char constantarr_0_409[8] = "add-task";
char constantarr_0_410[15] = "task-queue-node";
char constantarr_0_411[4] = "task";
char constantarr_0_412[10] = "tasks-lock";
char constantarr_0_413[12] = "insert-task!";
char constantarr_0_414[4] = "size";
char constantarr_0_415[10] = "size-recur";
char constantarr_0_416[4] = "next";
...
char constantarr_0_425[10] = "broadcast!";
char constantarr_0_426[18] = "pthread_mutex_lock";
char constantarr_0_427[22] = "pthread_cond_broadcast";
char constantarr_0_428[12] = "set-sequence";
char constantarr_0_429[8] = "sequence";
char constantarr_0_430[20] = "pthread_mutex_unlock";
char constantarr_0_431[17] = "may-be-work-to-do";
char constantarr_0_432[4] = "gctx";
char constantarr_0_433[12] = "no-timestamp";
char constantarr_0_434[9] = "exclusion";
char constantarr_0_435[11] = "catch<void>";
char constantarr_0_436[28] = "catch-with-exception-ctx<?a>";
char constantarr_0_437[16] = "thrown-exception";
char constantarr_0_438[13] = "__jmp_buf_tag";
char constantarr_0_439[4] = "zero";
char constantarr_0_440[7] = "bytes64";
char constantarr_0_441[7] = "bytes32";
char constantarr_0_442[7] = "bytes16";
char constantarr_0_443[8] = "bytes128";
char constantarr_0_444[15] = "set-jmp-buf-ptr";
char constantarr_0_445[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_446[6] = "setjmp";
char constantarr_0_447[24] = "subscript<?a, exception>";
char constantarr_0_448[23] = "subscript<fut<?r>, ?p0>";
char constantarr_0_449[12] = "fun<?r, ?p0>";
char constantarr_0_450[36] = "subscript<?out, ?in>.lambda0.lambda0";
char constantarr_0_451[11] = "reject!<?r>";
char constantarr_0_452[36] = "subscript<?out, ?in>.lambda0.lambda1";
char constantarr_0_453[28] = "subscript<?out, ?in>.lambda0";
char constantarr_0_454[10] = "value<?in>";
char constantarr_0_455[24] = "then<?out, void>.lambda0";
char constantarr_0_456[15] = "subscript<?out>";
char constantarr_0_457[24] = "island-and-exclusion<?r>";
char constantarr_0_458[18] = "subscript<fut<?r>>";
char constantarr_0_459[7] = "fun<?r>";
char constantarr_0_460[31] = "subscript<?out>.lambda0.lambda0";
char constantarr_0_461[31] = "subscript<?out>.lambda0.lambda1";
char constantarr_0_462[23] = "subscript<?out>.lambda0";
char constantarr_0_463[24] = "then-void<nat64>.lambda0";
char constantarr_0_464[24] = "cur-island-and-exclusion";
char constantarr_0_465[20] = "island-and-exclusion";
char constantarr_0_466[9] = "island-id";
char constantarr_0_467[5] = "delay";
char constantarr_0_468[14] = "resolved<void>";
char constantarr_0_469[15] = "tail<ptr<char>>";
char constantarr_0_470[10] = "empty?<?a>";
char constantarr_0_471[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_472[19] = "map<str, ptr<char>>";
char constantarr_0_473[14] = "make-arr<?out>";
char constantarr_0_474[18] = "fill-ptr-range<?a>";
char constantarr_0_475[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_476[9] = "!=<nat64>";
char constantarr_0_477[20] = "subscript<?a, nat64>";
char constantarr_0_478[14] = "subscript<?in>";
char constantarr_0_479[27] = "map<str, ptr<char>>.lambda0";
char constantarr_0_480[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_481[22] = "add-first-task.lambda0";
char constantarr_0_482[24] = "handle-exceptions<nat64>";
...
char constantarr_0_486[32] = "handle-exceptions<nat64>.lambda0";
char constantarr_0_487[21] = "add-main-task.lambda0";
char constantarr_0_488[78] = "call-with-ctx<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
...
char constantarr_0_496[14] = "pthread_create";
char constantarr_0_497[9] = "!=<int32>";
char constantarr_0_498[6] = "EAGAIN";
char constantarr_0_499[14] = "as-cell<nat64>";
char constantarr_0_500[16] = "as-ref<cell<?a>>";
...
char constantarr_0_510[16] = "noctx-at<island>";
char constantarr_0_511[9] = "needs-gc?";
char constantarr_0_512[17] = "n-threads-running";
char constantarr_0_513[23] = "empty?<task-queue-node>";
char constantarr_0_514[12] = "get-sequence";
char constantarr_0_515[11] = "choose-task";
char constantarr_0_516[17] = "get-monotime-nsec";
char constantarr_0_517[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_518[14] = "cell<timespec>";
char constantarr_0_519[8] = "timespec";
char constantarr_0_520[13] = "clock_gettime";
...
char constantarr_0_525[11] = "todo<nat64>";
...
char constantarr_0_534[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_535[28] = "currently-running-exclusions";
char constantarr_0_536[19] = "as<pop-task-result>";
char constantarr_0_537[16] = "contains?<nat64>";
char constantarr_0_538[13] = "contains?<?a>";
char constantarr_0_539[19] = "contains-recur?<?a>";
char constantarr_0_540[12] = "noctx-at<?a>";
char constantarr_0_541[15] = "temp-as-arr<?a>";
char constantarr_0_542[19] = "temp-as-mut-arr<?a>";
char constantarr_0_543[10] = "pop-recur!";
char constantarr_0_544[11] = "to-opt-time";
char constantarr_0_545[11] = "some<nat64>";
char constantarr_0_546[40] = "push-capacity-must-be-sufficient!<nat64>";
...
char constantarr_0_552[10] = "min<nat64>";
...
char constantarr_0_561[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_562[38] = "noctx-must-remove-unordered-recur!<?a>";
char constantarr_0_563[8] = "drop<?a>";
char constantarr_0_564[30] = "noctx-remove-unordered-at!<?a>";
...
char constantarr_0_575[15] = "clear-free-mem!";
char constantarr_0_576[13] = "!=<ptr<bool>>";
char constantarr_0_577[14] = "set-shut-down?";
char constantarr_0_578[7] = "wait-on";
char constantarr_0_579[17] = "pthread_cond_wait";
char constantarr_0_580[11] = "to-timespec";
char constantarr_0_581[10] = "unsafe-mod";
char constantarr_0_582[22] = "pthread_cond_timedwait";
char constantarr_0_583[16] = "ptr-to<timespec>";
char constantarr_0_584[8] = "?<int32>";
char constantarr_0_585[9] = "ETIMEDOUT";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {324, constantarr_5_0}.begin_ptr, (struct arr_5) {324, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {324, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {324, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		struct sym _1 = get_fun_name((*code_ptrs), funs, (struct arr_5) {324, constantarr_5_0}.size);
		*code_names = _1;
...
struct void_ mark_visit_337(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_386(mark_ctx, value2);
		}
		case 3: {
			struct subscript_9__lambda0* value3 = _0.as3;
			
			return mark_visit_388(mark_ctx, value3);
		}
		case 4: {
			struct subscript_14__lambda0__lambda0* value4 = _0.as4;
			
			return mark_visit_390(mark_ctx, value4);
		}
		case 5: {
			struct subscript_14__lambda0* value5 = _0.as5;
			
			return mark_visit_392(mark_ctx, value5);
		}
		default:
...
struct void_ mark_visit_338(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	mark_visit_381(mark_ctx, value.f);
...
struct void_ mark_visit_341(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1 value) {
	...
	return mark_visit_378(mark_ctx, value.next);
}
...
struct void_ mark_visit_343(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_367(mark_ctx, value.res);
}
...
struct void_ mark_visit_352(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	mark_visit_357(mark_ctx, value.gc);
	return mark_visit_359(mark_ctx, value.a);
}
/* mark-visit<gc> (generated) (generated) */
struct void_ mark_visit_353(struct mark_ctx* mark_ctx, struct gc value) {
	return mark_visit_354(mark_ctx, value.context_head);
}
...
struct void_ mark_visit_356(struct mark_ctx* mark_ctx, struct gc_ctx value) {
	mark_visit_357(mark_ctx, value.gc);
	return mark_visit_354(mark_ctx, value.next_ctx);
}
...
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_363(mark_ctx, value.state);
}
...
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_365(mark_ctx, value.cb);
...
struct void_ mark_visit_366(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_367(mark_ctx, value.to);
}
...
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_373(mark_ctx, value.message);
	return mark_visit_375(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_374(mark_ctx, value.chars);
}
...
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_376(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	mark_visit_367(mark_ctx, value.f);
	return mark_visit_365(mark_ctx, value.cb);
}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_2 _p0) {
	...
	*temp1 = (struct r) {4u, 5u, 6u};
	...
	struct interp _4 = with_str(ctx, _3, (struct str) {{7, constantarr_0_30}});
