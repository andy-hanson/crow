...
struct point point(struct ctx* ctx, double x, double y);
...
struct point create_point(struct ctx* ctx) {
	return point(ctx, literal_1(ctx, (struct arr_0) {1, constantarr_0_14}), literal_1(ctx, (struct arr_0) {1, constantarr_0_15}));
}
struct point point(struct ctx* ctx, double x, double y) {
