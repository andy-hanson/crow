...
struct mut_arr_2* mut_arr_2(struct ctx* ctx, uint8_t frozen__q, uint64_t size, uint64_t capacity, char* data);
...
struct mut_arr_2* new_uninitialized_mut_arr_1(struct ctx* ctx, uint64_t size) {
	return mut_arr_2(ctx, 0, size, size, uninitialized_data_1(ctx, size));
}
struct mut_arr_2* mut_arr_2(struct ctx* ctx, uint8_t frozen__q, uint64_t size, uint64_t capacity, char* data) {
