...
struct arr_0 to_str_3(struct ctx* ctx, uint64_t n) {
	struct arr_0 hi0;
	struct arr_0 lo1;
	if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_13}))) {
		return (struct arr_0) {1, constantarr_0_13};
	} else {
		if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_14}))) {
			return (struct arr_0) {1, constantarr_0_14};
		} else {
			if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_15}))) {
				return (struct arr_0) {1, constantarr_0_15};
			} else {
				if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_16}))) {
					return (struct arr_0) {1, constantarr_0_16};
				} else {
					if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_17}))) {
						return (struct arr_0) {1, constantarr_0_17};
					} else {
						if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_18}))) {
							return (struct arr_0) {1, constantarr_0_18};
						} else {
							if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_19}))) {
								return (struct arr_0) {1, constantarr_0_19};
							} else {
								if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_20}))) {
									return (struct arr_0) {1, constantarr_0_20};
								} else {
									if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_21}))) {
										return (struct arr_0) {1, constantarr_0_21};
									} else {
										if (_op_equal_equal_0(n, literal_2(ctx, (struct arr_0) {1, constantarr_0_22}))) {
