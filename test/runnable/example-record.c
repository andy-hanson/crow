...
struct arr_3 tail(struct ctx_0* ctx, struct arr_3 a);
...
struct arr_3 slice_starting_at(struct ctx_0* ctx, struct arr_3 a, uint64_t begin);
...
struct point_0 create_point(struct ctx_0* ctx);
double literal_1(struct ctx_0* ctx, struct arr_0 a);
uint64_t literal_2(struct ctx_0* ctx, struct arr_0 s);
...
double get_x(struct ctx_0* ctx, struct point_0 a);
uint8_t print_sync(struct arr_0 s);
uint8_t print_sync_no_newline(struct arr_0 s);
int32_t stdout_fd();
struct arr_0 to_str_1(struct ctx_0* ctx, double a);
...
int64_t neg(struct ctx_0* ctx, int64_t i);
...
int64_t two_2();
int64_t neg_one();
uint64_t to_nat(struct ctx_0* ctx, int64_t i);
...
struct point_0 create_point(struct ctx_0* ctx) {
	return (struct point_0) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})};
}
double literal_1(struct ctx_0* ctx, struct arr_0 a) {
