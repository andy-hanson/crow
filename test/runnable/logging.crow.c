...
char constantarr_0_208[13] = "unsafe-to-nat";
char constantarr_0_209[6] = "to-int";
...
char constantarr_0_241[14] = "from<nat, nat>";
char constantarr_0_242[12] = "to<nat, nat>";
char constantarr_0_243[12] = "-><nat, nat>";
char constantarr_0_244[13] = "arrow<?a, ?b>";
char constantarr_0_245[1] = "+";
char constantarr_0_246[3] = "and";
char constantarr_0_247[7] = ">=<nat>";
...
char constantarr_0_325[73] = "as<fun-act2<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<str>>>>";
...
char constantarr_0_425[34] = "subscript<fut<nat>, ctx, arr<str>>";
...
char constantarr_0_443[22] = "handle-exceptions<nat>";
...
char constantarr_0_447[30] = "handle-exceptions<nat>.lambda0";
char constantarr_0_448[21] = "add-main-task.lambda0";
char constantarr_0_449[74] = "call-with-ctx<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<str>>>";
...
char constantarr_0_460[12] = "as-cell<nat>";
...
char constantarr_0_522[33] = "noctx-must-remove-unordered!<nat>";
...
char constantarr_0_567[3] = "log";
char constantarr_0_568[23] = "subscript<void, logged>";
char constantarr_0_569[15] = "get-log-handler";
char constantarr_0_570[7] = "handler";
char constantarr_0_571[11] = "get-log-ctx";
char constantarr_0_572[6] = "logged";
char constantarr_0_573[22] = "as<fun1<void, logged>>";
char constantarr_0_574[12] = "main.lambda0";
char constantarr_0_575[22] = "with-log-handler<void>";
char constantarr_0_576[16] = "as<fun-act0<?a>>";
char constantarr_0_577[15] = "set-log-handler";
...
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
...
struct void_ call_w_ctx_405(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct str get_fun_name_101(uint64_t fun_id) {switch (fun_id) {
		...
		case 124: {
			return (struct str) {{12, constantarr_0_243}};
		}
		case 125: {
			return (struct str) {{1, constantarr_0_245}};
		}
		case 126: {
			return (struct str) {{7, constantarr_0_247}};
		}
		case 127: {
		...
		case 157: {
			return (struct str) {{17, constantarr_0_286}};
		}
		case 158: {
		...
		case 230: {
			return (struct str) {{22, constantarr_0_417}};
		}
		case 231: {
		...
		case 242: {
			return (struct str) {{18, constantarr_0_430}};
		}
		case 243: {
			return (struct str) {{0u, NULL}};
		}
		...
		case 265: {
			return (struct str) {{30, constantarr_0_447}};
		}
		case 266: {
		...
		case 275: {
			return (struct str) {{12, constantarr_0_460}};
		}
		case 276: {
		...
		case 287: {
			return (struct str) {{9, constantarr_0_486}};
		}
		case 288: {
		...
		case 291: {
			return (struct str) {{14, constantarr_0_498}};
		}
		case 292: {
		...
		case 304: {
			return (struct str) {{38, constantarr_0_507}};
		}
		case 305: {
			return (struct str) {{12, constantarr_0_138}};
		}
		...
		case 313: {
			return (struct str) {{33, constantarr_0_522}};
		}
		case 314: {
		...
		case 404: {
			return (struct str) {{23, constantarr_0_568}};
		}
		case 405: {
			return (struct str) {{0u, NULL}};
		}
		...
		case 407: {
			return (struct str) {{11, constantarr_0_571}};
		}
		case 408: {
...
struct void_ mark_visit_320(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_321(mark_ctx, value.tasks);
	return mark_visit_375(mark_ctx, value.log_handler);
}
...
struct void_ mark_visit_326(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_378(mark_ctx, value6);
		}
		case 7: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	mark_visit_375(mark_ctx, value.handler);
	mark_visit_326(mark_ctx, value.cb);
	return mark_visit_375(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_376(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_375(mark_ctx, value.lh);
}
