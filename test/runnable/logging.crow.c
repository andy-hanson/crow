...
struct void_ mark_visit_432(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_433(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_434(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_435(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_436(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_437(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_438(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_visit_439(struct mark_ctx* mark_ctx, struct fix_arr_0 value);
struct void_ mark_arr_440(struct mark_ctx* mark_ctx, struct arr_3 a);
...
struct void_ call_w_ctx_465(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct named_val constantarr_5_0[364];
struct sym constantarr_1_0[209];
...
char constantarr_0_64[6] = "new<a>";
char constantarr_0_65[7] = "null<a>";
char constantarr_0_66[11] = "as-const<a>";
char constantarr_0_67[16] = "create-condition";
...
char constantarr_0_92[12] = "subscript<a>";
char constantarr_0_93[11] = "high<nat64>";
char constantarr_0_94[10] = "low<nat64>";
char constantarr_0_95[4] = "+<a>";
char constantarr_0_96[34] = "unmanaged-alloc-zeroed-elements<a>";
char constantarr_0_97[27] = "unmanaged-alloc-elements<a>";
char constantarr_0_98[21] = "unmanaged-alloc-bytes";
char constantarr_0_99[6] = "malloc";
char constantarr_0_100[8] = "==<nat8>";
char constantarr_0_101[17] = "!=<mut-ptr<nat8>>";
char constantarr_0_102[10] = "null<nat8>";
char constantarr_0_103[8] = "wrap-mul";
char constantarr_0_104[17] = "set-zero-range<a>";
char constantarr_0_105[19] = "drop<mut-ptr<nat8>>";
char constantarr_0_106[6] = "memset";
char constantarr_0_107[26] = "as-any-mut-ptr<mut-ptr<a>>";
char constantarr_0_108[9] = "..<nat64>";
...
char constantarr_0_129[9] = "new<char>";
char constantarr_0_130[13] = "to-mut-arr<a>";
char constantarr_0_131[16] = "empty-fix-arr<a>";
char constantarr_0_132[12] = "empty-arr<a>";
...
char constantarr_0_143[17] = "incr-capacity!<a>";
char constantarr_0_144[18] = "ensure-capacity<a>";
char constantarr_0_145[11] = "capacity<a>";
char constantarr_0_146[7] = "size<a>";
char constantarr_0_147[8] = "inner<a>";
char constantarr_0_148[10] = "backing<a>";
char constantarr_0_149[24] = "increase-capacity-to!<a>";
char constantarr_0_150[6] = "assert";
char constantarr_0_151[11] = "throw<void>";
char constantarr_0_152[8] = "throw<a>";
...
char constantarr_0_157[17] = "==<__jmp_buf_tag>";
char constantarr_0_158[26] = "!=<mut-ptr<__jmp_buf_tag>>";
char constantarr_0_159[11] = "jmp-buf-ptr";
char constantarr_0_160[19] = "null<__jmp_buf_tag>";
char constantarr_0_161[20] = "set-thrown-exception";
char constantarr_0_162[7] = "longjmp";
char constantarr_0_163[15] = "number-to-throw";
char constantarr_0_164[19] = "hard-unreachable<a>";
...
char constantarr_0_186[9] = "==<nat64>";
char constantarr_0_187[10] = "<=><nat64>";
char constantarr_0_188[10] = "is-less<a>";
char constantarr_0_189[17] = "<<mut-ptr<nat64>>";
char constantarr_0_190[8] = "data-end";
char constantarr_0_191[10] = "range-free";
char constantarr_0_192[8] = "mark-cur";
char constantarr_0_193[12] = "set-mark-cur";
char constantarr_0_194[12] = "set-data-cur";
char constantarr_0_195[19] = "some<mut-ptr<nat8>>";
char constantarr_0_196[21] = "ptr-cast<nat8, nat64>";
char constantarr_0_197[19] = "none<mut-ptr<nat8>>";
char constantarr_0_198[19] = "maybe-set-needs-gc!";
char constantarr_0_199[7] = "-<bool>";
char constantarr_0_200[10] = "mark-begin";
char constantarr_0_201[10] = "size-words";
char constantarr_0_202[12] = "set-needs-gc";
...
char constantarr_0_211[16] = "none<mut-ptr<a>>";
char constantarr_0_212[16] = "some<mut-ptr<a>>";
char constantarr_0_213[17] = "ptr-cast<a, nat8>";
char constantarr_0_214[20] = "none<backtrace-arrs>";
...
char constantarr_0_220[12] = "as<arr<sym>>";
char constantarr_0_221[8] = "new<sym>";
char constantarr_0_222[15] = "unsafe-to-nat64";
char constantarr_0_223[8] = "to-int64";
...
char constantarr_0_236[12] = "set-deref<a>";
...
char constantarr_0_248[14] = "set-deref<sym>";
...
char constantarr_0_254[14] = "subscript<sym>";
char constantarr_0_255[12] = "begin-ptr<a>";
char constantarr_0_256[14] = "set-backing<a>";
char constantarr_0_257[24] = "uninitialized-fix-arr<a>";
...
char constantarr_0_264[1] = "+";
char constantarr_0_265[2] = "&&";
char constantarr_0_266[9] = ">=<nat64>";
char constantarr_0_267[24] = "round-up-to-power-of-two";
char constantarr_0_268[30] = "round-up-to-power-of-two-recur";
char constantarr_0_269[1] = "*";
char constantarr_0_270[1] = "/";
char constantarr_0_271[6] = "forbid";
char constantarr_0_272[11] = "set-size<a>";
char constantarr_0_273[13] = "~=<a>.lambda0";
char constantarr_0_274[2] = "~=";
char constantarr_0_275[8] = "is-empty";
char constantarr_0_276[14] = "is-empty<char>";
char constantarr_0_277[7] = "message";
char constantarr_0_278[9] = "each<sym>";
char constantarr_0_279[12] = "return-stack";
char constantarr_0_280[3] = "str";
char constantarr_0_281[24] = "arr-from-begin-end<char>";
char constantarr_0_282[16] = "<=<const-ptr<a>>";
char constantarr_0_283[4] = "<<a>";
char constantarr_0_284[13] = "find-cstr-end";
char constantarr_0_285[17] = "find-char-in-cstr";
char constantarr_0_286[7] = "to-nat8";
char constantarr_0_287[21] = "some<const-ptr<char>>";
char constantarr_0_288[21] = "none<const-ptr<char>>";
char constantarr_0_289[33] = "hard-unreachable<const-ptr<char>>";
char constantarr_0_290[8] = "to-c-str";
char constantarr_0_291[14] = "to-str.lambda0";
char constantarr_0_292[12] = "move-to-str!";
char constantarr_0_293[18] = "move-to-arr!<char>";
char constantarr_0_294[17] = "cast-immutable<a>";
char constantarr_0_295[19] = "move-to-fix-arr!<a>";
...
char constantarr_0_310[12] = "none<gc-ctx>";
...
char constantarr_0_318[18] = "ref-of-val<island>";
char constantarr_0_319[11] = "set-islands";
char constantarr_0_320[21] = "arr-of-single<island>";
char constantarr_0_321[14] = "ptr-to<island>";
char constantarr_0_322[13] = "add-main-task";
char constantarr_0_323[13] = "exception-ctx";
char constantarr_0_324[14] = "empty-arr<sym>";
char constantarr_0_325[7] = "log-ctx";
char constantarr_0_326[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_327[8] = "perf-ctx";
char constantarr_0_328[14] = "empty-arr<str>";
char constantarr_0_329[28] = "empty-fix-arr<measure-value>";
...
char constantarr_0_356[16] = "then-void<nat64>";
char constantarr_0_357[15] = "then<out, void>";
char constantarr_0_358[15] = "unresolved<out>";
char constantarr_0_359[25] = "fut-state-no-callbacks<a>";
char constantarr_0_360[13] = "callback!<in>";
char constantarr_0_361[15] = "with-lock<void>";
char constantarr_0_362[16] = "call-with-ctx<r>";
char constantarr_0_363[5] = "lk<a>";
char constantarr_0_364[8] = "state<a>";
char constantarr_0_365[12] = "set-state<a>";
char constantarr_0_366[22] = "fut-state-callbacks<a>";
char constantarr_0_367[28] = "none<fut-state-callbacks<a>>";
char constantarr_0_368[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_369[37] = "subscript<void, result<a, exception>>";
char constantarr_0_370[16] = "ok<a, exception>";
char constantarr_0_371[17] = "err<a, exception>";
char constantarr_0_372[21] = "callback!<in>.lambda0";
char constantarr_0_373[16] = "forward-to!<out>";
char constantarr_0_374[12] = "callback!<a>";
char constantarr_0_375[20] = "callback!<a>.lambda0";
char constantarr_0_376[21] = "resolve-or-reject!<a>";
char constantarr_0_377[23] = "with-lock<fut-state<a>>";
char constantarr_0_378[21] = "fut-state-resolved<a>";
char constantarr_0_379[22] = "fut-state-exception<a>";
char constantarr_0_380[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_381[18] = "call-callbacks!<a>";
char constantarr_0_382[5] = "cb<a>";
char constantarr_0_383[7] = "next<a>";
char constantarr_0_384[24] = "forward-to!<out>.lambda0";
char constantarr_0_385[18] = "subscript<out, in>";
char constantarr_0_386[10] = "get-island";
char constantarr_0_387[17] = "subscript<island>";
char constantarr_0_388[12] = "unsafe-at<a>";
char constantarr_0_389[7] = "islands";
char constantarr_0_390[27] = "island-and-exclusion<r, p0>";
char constantarr_0_391[8] = "add-task";
...
char constantarr_0_407[18] = "pthread_mutex_lock";
char constantarr_0_408[22] = "pthread_cond_broadcast";
char constantarr_0_409[12] = "set-sequence";
char constantarr_0_410[8] = "sequence";
char constantarr_0_411[20] = "pthread_mutex_unlock";
...
char constantarr_0_417[27] = "catch-with-exception-ctx<a>";
...
char constantarr_0_430[23] = "then<out, void>.lambda0";
char constantarr_0_431[14] = "subscript<out>";
char constantarr_0_432[23] = "island-and-exclusion<r>";
char constantarr_0_433[17] = "subscript<fut<r>>";
char constantarr_0_434[6] = "fun<r>";
char constantarr_0_435[30] = "subscript<out>.lambda0.lambda0";
char constantarr_0_436[30] = "subscript<out>.lambda0.lambda1";
char constantarr_0_437[22] = "subscript<out>.lambda0";
...
char constantarr_0_443[21] = "tail<const-ptr<char>>";
char constantarr_0_444[11] = "is-empty<a>";
char constantarr_0_445[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_446[25] = "map<str, const-ptr<char>>";
char constantarr_0_447[13] = "make-arr<out>";
char constantarr_0_448[17] = "fill-ptr-range<a>";
char constantarr_0_449[23] = "fill-ptr-range-recur<a>";
char constantarr_0_450[9] = "!=<nat64>";
char constantarr_0_451[19] = "subscript<a, nat64>";
char constantarr_0_452[13] = "subscript<in>";
char constantarr_0_453[33] = "map<str, const-ptr<char>>.lambda0";
...
char constantarr_0_462[26] = "subscript<const-ptr<char>>";
char constantarr_0_463[84] = "call-with-ctx<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
...
char constantarr_0_468[30] = "set-deref<by-val<thread-args>>";
...
char constantarr_0_474[15] = "as-ref<cell<a>>";
char constantarr_0_475[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
...
char constantarr_0_489[7] = "drop<a>";
char constantarr_0_490[12] = "get-sequence";
char constantarr_0_491[11] = "choose-task";
char constantarr_0_492[17] = "get-monotime-nsec";
char constantarr_0_493[13] = "new<timespec>";
char constantarr_0_494[13] = "clock_gettime";
char constantarr_0_495[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_496[11] = "*<timespec>";
char constantarr_0_497[14] = "inner-value<a>";
char constantarr_0_498[6] = "tv_sec";
char constantarr_0_499[7] = "tv_nsec";
char constantarr_0_500[11] = "todo<nat64>";
char constantarr_0_501[17] = "choose-task-recur";
char constantarr_0_502[19] = "rslt-no-chosen-task";
char constantarr_0_503[21] = "choose-task-in-island";
char constantarr_0_504[7] = "do-a-gc";
char constantarr_0_505[11] = "tii-no-task";
char constantarr_0_506[11] = "none<nat64>";
char constantarr_0_507[9] = "pop-task!";
char constantarr_0_508[26] = "ref-of-val<mut-arr<nat64>>";
char constantarr_0_509[28] = "currently-running-exclusions";
char constantarr_0_510[11] = "ptr-no-task";
char constantarr_0_511[9] = "in<nat64>";
char constantarr_0_512[5] = "in<a>";
char constantarr_0_513[11] = "in-recur<a>";
char constantarr_0_514[11] = "noctx-at<a>";
char constantarr_0_515[14] = "temp-as-arr<a>";
char constantarr_0_516[18] = "temp-as-fix-arr<a>";
char constantarr_0_517[10] = "pop-recur!";
char constantarr_0_518[11] = "to-opt-time";
char constantarr_0_519[11] = "some<nat64>";
char constantarr_0_520[8] = "ptr-task";
char constantarr_0_521[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_522[8] = "tii-task";
char constantarr_0_523[10] = "is-no-task";
char constantarr_0_524[21] = "set-n-threads-running";
char constantarr_0_525[16] = "rslt-chosen-task";
char constantarr_0_526[9] = "togc-task";
...
char constantarr_0_539[29] = "noctx-remove-unordered-at!<a>";
...
char constantarr_0_546[13] = "mark-visit<a>";
char constantarr_0_547[20] = "ref-of-val<mark-ctx>";
char constantarr_0_548[15] = "clear-free-mem!";
char constantarr_0_549[17] = "!=<mut-ptr<bool>>";
char constantarr_0_550[16] = "set-is-shut-down";
...
char constantarr_0_561[18] = "new<mut-ptr<nat8>>";
char constantarr_0_562[12] = "pthread_join";
char constantarr_0_563[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_564[6] = "EINVAL";
char constantarr_0_565[5] = "ESRCH";
char constantarr_0_566[16] = "*<mut-ptr<nat8>>";
...
char constantarr_0_575[24] = "any-unhandled-exceptions";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_6);
			copy_data_from__e_0(ctx, _matched0->funs, (struct arr_5) {364, constantarr_5_0}.begin_ptr, (struct arr_5) {364, constantarr_5_0}.size);
			sort__e(_matched0->funs, (struct arr_5) {364, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {364, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct void_) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {364, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_383(mark_ctx, value.tasks);
	return mark_visit_433(mark_ctx, value.log_handler);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_384(mark_ctx, value.head);
	return mark_visit_438(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct opt_3 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_437(mark_ctx, value1);
		}
		default:
...
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_436(mark_ctx, value6);
		}
		case 7: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_432(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	mark_visit_433(mark_ctx, value.handler);
	mark_visit_387(mark_ctx, value.cb);
	return mark_visit_433(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_433(struct mark_ctx* mark_ctx, struct fun1_1 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_435(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_434(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_433(mark_ctx, value.lh);
}
...
struct void_ mark_visit_438(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_visit_439(mark_ctx, value.backing);
}
/* mark-visit<fix-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_439(struct mark_ctx* mark_ctx, struct fix_arr_0 value) {
	return mark_arr_440(mark_ctx, value.inner);
}
