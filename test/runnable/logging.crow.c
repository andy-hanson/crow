...
char constantarr_0_92[57] = "mut-arr-by-val-with-capacity-from-unmanaged-memory<nat64>";
char constantarr_0_93[10] = "fix-arr<a>";
...
char constantarr_0_131[13] = "mut-arr<char>";
char constantarr_0_132[2] = "~=";
