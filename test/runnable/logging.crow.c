...
char constantarr_0_66[10] = "to-nat<?a>";
...
char constantarr_0_201[8] = "data<?a>";
...
char constantarr_0_269[14] = "then-void<nat>";
char constantarr_0_270[16] = "then<?out, void>";
char constantarr_0_271[16] = "unresolved<?out>";
char constantarr_0_272[7] = "fut<?a>";
char constantarr_0_273[22] = "fut-state-no-callbacks";
char constantarr_0_274[14] = "callback!<?in>";
char constantarr_0_275[15] = "with-lock<void>";
char constantarr_0_276[17] = "call-with-ctx<?r>";
char constantarr_0_277[6] = "lk<?a>";
char constantarr_0_278[9] = "state<?a>";
char constantarr_0_279[13] = "set-state<?a>";
char constantarr_0_280[23] = "fut-state-callbacks<?a>";
char constantarr_0_281[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_282[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_283[22] = "call-with-ctx<?r, ?p0>";
char constantarr_0_284[6] = "ok<?a>";
char constantarr_0_285[9] = "value<?a>";
...
char constantarr_0_289[13] = "callback!<?a>";
char constantarr_0_290[21] = "callback!<?a>.lambda0";
char constantarr_0_291[22] = "resolve-or-reject!<?a>";
char constantarr_0_292[24] = "with-lock<fut-state<?a>>";
char constantarr_0_293[22] = "fut-state-resolved<?a>";
char constantarr_0_294[16] = "value<exception>";
char constantarr_0_295[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_296[19] = "call-callbacks!<?a>";
char constantarr_0_297[6] = "cb<?a>";
char constantarr_0_298[8] = "next<?a>";
char constantarr_0_299[30] = "value<fut-state-callbacks<?a>>";
...
char constantarr_0_331[28] = "catch-with-exception-ctx<?a>";
...
char constantarr_0_342[24] = "subscript<?a, exception>";
...
char constantarr_0_358[22] = "then-void<nat>.lambda0";
...
char constantarr_0_365[10] = "empty?<?a>";
...
char constantarr_0_369[18] = "fill-ptr-range<?a>";
char constantarr_0_370[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_371[18] = "subscript<?a, nat>";
...
char constantarr_0_375[16] = "ptr-less-eq?<?a>";
char constantarr_0_376[5] = "-<?a>";
...
char constantarr_0_381[15] = "some<ptr<char>>";
char constantarr_0_382[27] = "hard-unreachable<ptr<char>>";
char constantarr_0_383[16] = "value<ptr<char>>";
...
char constantarr_0_404[16] = "as-ref<cell<?a>>";
...
char constantarr_0_442[13] = "contains?<?a>";
char constantarr_0_443[19] = "contains-recur?<?a>";
char constantarr_0_444[15] = "temp-as-arr<?a>";
char constantarr_0_445[9] = "inner<?a>";
char constantarr_0_446[19] = "temp-as-mut-arr<?a>";
char constantarr_0_447[11] = "backing<?a>";
...
char constantarr_0_452[12] = "capacity<?a>";
char constantarr_0_453[12] = "set-size<?a>";
char constantarr_0_454[17] = "noctx-set-at!<?a>";
...
char constantarr_0_471[38] = "noctx-must-remove-unordered-recur!<?a>";
char constantarr_0_472[8] = "drop<?a>";
char constantarr_0_473[30] = "noctx-remove-unordered-at!<?a>";
char constantarr_0_474[14] = "noctx-last<?a>";
...
char constantarr_0_503[18] = "ptr-cast<nat8, ?a>";
...
char constantarr_0_520[11] = "finally<?a>";
char constantarr_0_521[19] = "finally<?a>.lambda0";
...
struct arr_0 get_fun_name_88(uint64_t fun_id) {switch (fun_id) {
		...
		case 147: {
			return (struct arr_0) {24, constantarr_0_292};
		}
		case 148: {
			return (struct arr_0) {13, constantarr_0_191};
		}
		...
		case 150: {
			return (struct arr_0) {30, constantarr_0_295};
		}
		case 151: {
		...
		case 212: {
			return (struct arr_0) {16, constantarr_0_375};
		}
		case 213: {
		...
		case 218: {
			return (struct arr_0) {27, constantarr_0_382};
		}
		case 219: {
