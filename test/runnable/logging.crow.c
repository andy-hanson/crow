...
struct void_ mark_visit_418(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_419(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_421(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
...
struct void_ call_w_ctx_451(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
char constantarr_0_392[7] = "drop<a>";
char constantarr_0_393[15] = "drop<exception>";
...
char constantarr_0_460[21] = "tail<const-ptr<char>>";
char constantarr_0_461[11] = "is-empty<a>";
char constantarr_0_462[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_463[25] = "map<str, const-ptr<char>>";
char constantarr_0_464[13] = "make-arr<out>";
char constantarr_0_465[17] = "fill-ptr-range<a>";
char constantarr_0_466[23] = "fill-ptr-range-recur<a>";
char constantarr_0_467[9] = "!=<nat64>";
char constantarr_0_468[19] = "subscript<a, nat64>";
char constantarr_0_469[13] = "subscript<in>";
char constantarr_0_470[33] = "map<str, const-ptr<char>>.lambda0";
...
char constantarr_0_491[15] = "as-ref<cell<a>>";
char constantarr_0_492[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
...
char constantarr_0_497[12] = "is-shut-down";
...
char constantarr_0_502[11] = "hard-forbid";
char constantarr_0_503[8] = "needs-gc";
char constantarr_0_504[17] = "n-threads-running";
char constantarr_0_505[25] = "is-empty<task-queue-node>";
...
char constantarr_0_519[19] = "rslt-no-chosen-task";
...
char constantarr_0_525[11] = "none<nat64>";
char constantarr_0_526[9] = "pop-task!";
char constantarr_0_527[26] = "ref-of-val<mut-arr<nat64>>";
char constantarr_0_528[28] = "currently-running-exclusions";
char constantarr_0_529[11] = "ptr-no-task";
...
char constantarr_0_535[18] = "temp-as-fix-arr<a>";
char constantarr_0_536[10] = "pop-recur!";
char constantarr_0_537[11] = "to-opt-time";
char constantarr_0_538[11] = "some<nat64>";
char constantarr_0_539[8] = "ptr-task";
char constantarr_0_540[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_541[13] = "drop<no-task>";
char constantarr_0_542[8] = "tii-task";
char constantarr_0_543[10] = "is-no-task";
char constantarr_0_544[10] = "drop<task>";
char constantarr_0_545[21] = "set-n-threads-running";
char constantarr_0_546[16] = "rslt-chosen-task";
char constantarr_0_547[11] = "chosen-task";
char constantarr_0_548[9] = "togc-task";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, _matched0->funs, (struct arr_5) {350, constantarr_5_0}.begin_ptr, (struct arr_5) {350, constantarr_5_0}.size);
			sort__e(_matched0->funs, (struct arr_5) {350, constantarr_5_0}.size);
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {350, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_368(mark_ctx, value.tasks);
	return mark_visit_418(mark_ctx, value.log_handler);
}
...
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_421(mark_ctx, value6);
		}
		case 7: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_417(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	mark_visit_418(mark_ctx, value.handler);
	mark_visit_372(mark_ctx, value.cb);
	return mark_visit_418(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_419(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_418(mark_ctx, value.lh);
}
