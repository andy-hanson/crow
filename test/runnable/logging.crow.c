...
struct void_ mark_visit_420(struct mark_ctx* mark_ctx, struct mut_list_0 value);
...
struct named_val constantarr_5_0[343];
...
char constantarr_0_511[11] = "*<timespec>";
char constantarr_0_512[14] = "inner-value<a>";
...
char constantarr_0_527[9] = "in<nat64>";
char constantarr_0_528[5] = "in<a>";
char constantarr_0_529[11] = "in-recur<a>";
char constantarr_0_530[11] = "noctx-at<a>";
char constantarr_0_531[14] = "temp-as-arr<a>";
char constantarr_0_532[18] = "temp-as-mut-arr<a>";
...
char constantarr_0_551[37] = "noctx-must-remove-unordered-recur!<a>";
char constantarr_0_552[7] = "drop<a>";
char constantarr_0_553[29] = "noctx-remove-unordered-at!<a>";
...
char constantarr_0_562[13] = "mark-visit<a>";
char constantarr_0_563[20] = "ref-of-val<mark-ctx>";
char constantarr_0_564[15] = "clear-free-mem!";
char constantarr_0_565[17] = "!=<mut-ptr<bool>>";
char constantarr_0_566[16] = "set-is-shut-down";
...
char constantarr_0_577[31] = "as<by-val<cell<mut-ptr<nat8>>>>";
char constantarr_0_578[19] = "cell<mut-ptr<nat8>>";
char constantarr_0_579[12] = "pthread_join";
char constantarr_0_580[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_581[6] = "EINVAL";
char constantarr_0_582[5] = "ESRCH";
char constantarr_0_583[16] = "*<mut-ptr<nat8>>";
char constantarr_0_584[21] = "unmanaged-free<nat64>";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {343, constantarr_5_0}.begin_ptr, (struct arr_5) {343, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {343, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {343, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {343, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_362(mark_ctx, value.tasks);
...
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct some_3 value) {
	return mark_visit_419(mark_ctx, value.value);
}
