...
char constantarr_0_577[3] = "log";
char constantarr_0_578[23] = "subscript<void, logged>";
char constantarr_0_579[15] = "get-log-handler";
char constantarr_0_580[7] = "handler";
char constantarr_0_581[11] = "get-log-ctx";
char constantarr_0_582[6] = "logged";
char constantarr_0_583[22] = "as<fun1<void, logged>>";
char constantarr_0_584[12] = "main.lambda0";
char constantarr_0_585[22] = "with-log-handler<void>";
char constantarr_0_586[16] = "as<fun-act0<?a>>";
char constantarr_0_587[15] = "set-log-handler";
char constantarr_0_588[30] = "with-log-handler<void>.lambda0";
char constantarr_0_589[30] = "with-log-handler<void>.lambda1";
char constantarr_0_590[12] = "main.lambda1";
char constantarr_0_591[12] = "main.lambda2";
char constantarr_0_592[12] = "main.lambda3";
char constantarr_0_593[15] = "resolved<nat64>";
...
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_388(struct mark_ctx* mark_ctx, struct fun1_1 value);
...
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_395(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct void_ call_w_ctx_419(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct str get_fun_name_105(uint64_t fun_id) {switch (fun_id) {
		...
		case 423: {
			return (struct str) {{22, constantarr_0_585}};
		}
		case 424: {
			return (struct str) {{15, constantarr_0_587}};
		}
		case 425: {
			return (struct str) {{30, constantarr_0_588}};
		}
		case 426: {
		...
		case 430: {
			return (struct str) {{15, constantarr_0_593}};
		}
		default:
...
struct void_ mark_visit_333(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_334(mark_ctx, value.tasks);
	return mark_visit_388(mark_ctx, value.log_handler);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_334(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_335(mark_ctx, value.head);
	return mark_visit_393(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_339(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_391(mark_ctx, value6);
		}
		case 7: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	mark_visit_388(mark_ctx, value.handler);
	mark_visit_339(mark_ctx, value.cb);
	return mark_visit_388(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_389(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_388(mark_ctx, value.lh);
}
...
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_394(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_395(mark_ctx, value.inner);
}
