...
char constantarr_0_176[11] = "sched_yield";
...
char constantarr_0_546[15] = "clear-free-mem!";
...
struct str get_fun_name_106(uint64_t fun_id) {switch (fun_id) {
		...
		case 85: {
			return (struct str) {{11, constantarr_0_176}};
		}
		case 86: {
		...
		case 397: {
			return (struct str) {{15, constantarr_0_546}};
		}
		case 398: {
