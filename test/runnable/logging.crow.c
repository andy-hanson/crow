...
struct void_ mark_visit_422(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value);
struct void_ mark_visit_423(struct mark_ctx* mark_ctx, struct fun1_1 value);
struct void_ mark_visit_424(struct mark_ctx* mark_ctx, struct main_0__lambda0 value);
struct void_ mark_visit_425(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_426(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0* value);
struct void_ mark_visit_427(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_428(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_visit_429(struct mark_ctx* mark_ctx, struct fix_arr_0 value);
struct void_ mark_arr_430(struct mark_ctx* mark_ctx, struct arr_3 a);
...
struct void_ call_w_ctx_455(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
char constantarr_0_586[11];
struct named_val constantarr_5_0[354];
...
char constantarr_0_218[8] = "new<sym>";
char constantarr_0_219[15] = "unsafe-to-nat64";
char constantarr_0_220[8] = "to-int64";
char constantarr_0_221[9] = "backtrace";
char constantarr_0_222[9] = "code-ptrs";
char constantarr_0_223[15] = "unsafe-to-int32";
char constantarr_0_224[14] = "code-ptrs-size";
char constantarr_0_225[43] = "copy-data-from!<named-val<const-ptr<nat8>>>";
char constantarr_0_226[6] = "memcpy";
char constantarr_0_227[30] = "as-any-const-ptr<const-ptr<a>>";
char constantarr_0_228[4] = "funs";
char constantarr_0_229[37] = "begin-ptr<named-val<const-ptr<nat8>>>";
char constantarr_0_230[5] = "sort!";
char constantarr_0_231[33] = "swap!<named-val<const-ptr<nat8>>>";
char constantarr_0_232[16] = "set-subscript<a>";
char constantarr_0_233[12] = "set-deref<a>";
char constantarr_0_234[10] = "partition!";
char constantarr_0_235[9] = "<=><nat8>";
char constantarr_0_236[6] = "<=><a>";
char constantarr_0_237[18] = "<<const-ptr<nat8>>";
char constantarr_0_238[20] = "val<const-ptr<nat8>>";
char constantarr_0_239[6] = "+<sym>";
char constantarr_0_240[10] = "code-names";
char constantarr_0_241[16] = "fill-code-names!";
char constantarr_0_242[7] = "==<sym>";
char constantarr_0_243[8] = "<=><sym>";
char constantarr_0_244[15] = "<<mut-ptr<sym>>";
char constantarr_0_245[14] = "set-deref<sym>";
char constantarr_0_246[12] = "get-fun-name";
char constantarr_0_247[37] = "subscript<named-val<const-ptr<nat8>>>";
char constantarr_0_248[21] = "name<const-ptr<nat8>>";
char constantarr_0_249[18] = "*<const-ptr<nat8>>";
char constantarr_0_250[18] = "+<const-ptr<nat8>>";
char constantarr_0_251[14] = "subscript<sym>";
char constantarr_0_252[12] = "begin-ptr<a>";
char constantarr_0_253[14] = "set-backing<a>";
char constantarr_0_254[24] = "uninitialized-fix-arr<a>";
char constantarr_0_255[22] = "alloc-uninitialized<a>";
char constantarr_0_256[5] = "alloc";
char constantarr_0_257[8] = "gc-alloc";
char constantarr_0_258[19] = "todo<mut-ptr<nat8>>";
char constantarr_0_259[18] = "copy-data-from!<a>";
char constantarr_0_260[20] = "set-zero-elements<a>";
char constantarr_0_261[1] = "+";
char constantarr_0_262[2] = "&&";
char constantarr_0_263[9] = ">=<nat64>";
...
char constantarr_0_269[11] = "set-size<a>";
char constantarr_0_270[16] = "~=<char>.lambda0";
char constantarr_0_271[8] = "is-empty";
char constantarr_0_272[14] = "is-empty<char>";
char constantarr_0_273[7] = "message";
char constantarr_0_274[9] = "each<sym>";
char constantarr_0_275[12] = "return-stack";
char constantarr_0_276[3] = "str";
char constantarr_0_277[24] = "arr-from-begin-end<char>";
char constantarr_0_278[16] = "<=<const-ptr<a>>";
char constantarr_0_279[4] = "<<a>";
char constantarr_0_280[13] = "find-cstr-end";
char constantarr_0_281[17] = "find-char-in-cstr";
char constantarr_0_282[7] = "to-nat8";
char constantarr_0_283[21] = "some<const-ptr<char>>";
char constantarr_0_284[21] = "none<const-ptr<char>>";
char constantarr_0_285[33] = "hard-unreachable<const-ptr<char>>";
char constantarr_0_286[8] = "to-c-str";
char constantarr_0_287[14] = "to-str.lambda0";
char constantarr_0_288[12] = "move-to-str!";
char constantarr_0_289[18] = "move-to-arr!<char>";
char constantarr_0_290[17] = "cast-immutable<a>";
char constantarr_0_291[19] = "move-to-fix-arr!<a>";
char constantarr_0_292[28] = "set-any-unhandled-exceptions";
char constantarr_0_293[14] = "get-global-ctx";
char constantarr_0_294[18] = "as-ref<global-ctx>";
char constantarr_0_295[8] = "gctx-ptr";
char constantarr_0_296[14] = "island.lambda0";
char constantarr_0_297[19] = "default-log-handler";
char constantarr_0_298[5] = "print";
...
char constantarr_0_305[29] = "as-any-mut-ptr<mut-ptr<bool>>";
char constantarr_0_306[12] = "none<gc-ctx>";
char constantarr_0_307[11] = "validate-gc";
char constantarr_0_308[10] = "data-begin";
char constantarr_0_309[9] = "<=><bool>";
char constantarr_0_310[17] = "<=<mut-ptr<bool>>";
char constantarr_0_311[8] = "mark-end";
char constantarr_0_312[18] = "<=<mut-ptr<nat64>>";
char constantarr_0_313[14] = "ref-of-val<gc>";
char constantarr_0_314[18] = "ref-of-val<island>";
char constantarr_0_315[11] = "set-islands";
char constantarr_0_316[21] = "arr-of-single<island>";
...
char constantarr_0_323[8] = "new<str>";
char constantarr_0_324[18] = "new<measure-value>";
char constantarr_0_325[29] = "as-any-mut-ptr<exception-ctx>";
char constantarr_0_326[25] = "ref-of-val<exception-ctx>";
char constantarr_0_327[23] = "as-any-mut-ptr<log-ctx>";
char constantarr_0_328[19] = "ref-of-val<log-ctx>";
char constantarr_0_329[24] = "as-any-mut-ptr<perf-ctx>";
...
char constantarr_0_345[26] = "as-any-mut-ptr<global-ctx>";
char constantarr_0_346[2] = "id";
char constantarr_0_347[22] = "as-any-mut-ptr<gc-ctx>";
...
char constantarr_0_352[15] = "then<out, void>";
char constantarr_0_353[15] = "unresolved<out>";
char constantarr_0_354[25] = "fut-state-no-callbacks<a>";
char constantarr_0_355[13] = "callback!<in>";
char constantarr_0_356[15] = "with-lock<void>";
char constantarr_0_357[16] = "call-with-ctx<r>";
char constantarr_0_358[5] = "lk<a>";
char constantarr_0_359[8] = "state<a>";
char constantarr_0_360[12] = "set-state<a>";
char constantarr_0_361[22] = "fut-state-callbacks<a>";
char constantarr_0_362[28] = "none<fut-state-callbacks<a>>";
char constantarr_0_363[28] = "some<fut-state-callbacks<a>>";
char constantarr_0_364[37] = "subscript<void, result<a, exception>>";
char constantarr_0_365[16] = "ok<a, exception>";
char constantarr_0_366[17] = "err<a, exception>";
char constantarr_0_367[21] = "callback!<in>.lambda0";
char constantarr_0_368[16] = "forward-to!<out>";
char constantarr_0_369[12] = "callback!<a>";
char constantarr_0_370[20] = "callback!<a>.lambda0";
char constantarr_0_371[21] = "resolve-or-reject!<a>";
char constantarr_0_372[23] = "with-lock<fut-state<a>>";
char constantarr_0_373[21] = "fut-state-resolved<a>";
char constantarr_0_374[22] = "fut-state-exception<a>";
char constantarr_0_375[29] = "resolve-or-reject!<a>.lambda0";
char constantarr_0_376[18] = "call-callbacks!<a>";
char constantarr_0_377[5] = "cb<a>";
char constantarr_0_378[7] = "next<a>";
char constantarr_0_379[24] = "forward-to!<out>.lambda0";
char constantarr_0_380[18] = "subscript<out, in>";
char constantarr_0_381[10] = "get-island";
char constantarr_0_382[17] = "subscript<island>";
char constantarr_0_383[12] = "unsafe-at<a>";
char constantarr_0_384[7] = "islands";
char constantarr_0_385[27] = "island-and-exclusion<r, p0>";
...
char constantarr_0_418[23] = "subscript<a, exception>";
char constantarr_0_419[21] = "subscript<fut<r>, p0>";
char constantarr_0_420[10] = "fun<r, p0>";
char constantarr_0_421[34] = "subscript<out, in>.lambda0.lambda0";
char constantarr_0_422[10] = "reject!<r>";
char constantarr_0_423[34] = "subscript<out, in>.lambda0.lambda1";
char constantarr_0_424[26] = "subscript<out, in>.lambda0";
char constantarr_0_425[23] = "then<out, void>.lambda0";
char constantarr_0_426[14] = "subscript<out>";
char constantarr_0_427[23] = "island-and-exclusion<r>";
char constantarr_0_428[17] = "subscript<fut<r>>";
char constantarr_0_429[6] = "fun<r>";
char constantarr_0_430[30] = "subscript<out>.lambda0.lambda0";
char constantarr_0_431[30] = "subscript<out>.lambda0.lambda1";
char constantarr_0_432[22] = "subscript<out>.lambda0";
char constantarr_0_433[24] = "then-void<nat64>.lambda0";
...
char constantarr_0_438[21] = "tail<const-ptr<char>>";
char constantarr_0_439[11] = "is-empty<a>";
char constantarr_0_440[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_441[25] = "map<str, const-ptr<char>>";
char constantarr_0_442[13] = "make-arr<out>";
char constantarr_0_443[17] = "fill-ptr-range<a>";
char constantarr_0_444[23] = "fill-ptr-range-recur<a>";
char constantarr_0_445[9] = "!=<nat64>";
char constantarr_0_446[19] = "subscript<a, nat64>";
char constantarr_0_447[13] = "subscript<in>";
char constantarr_0_448[33] = "map<str, const-ptr<char>>.lambda0";
...
char constantarr_0_457[26] = "subscript<const-ptr<char>>";
char constantarr_0_458[84] = "call-with-ctx<fut<nat64>, arr<const-ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
...
char constantarr_0_463[30] = "set-deref<by-val<thread-args>>";
...
char constantarr_0_469[15] = "as-ref<cell<a>>";
char constantarr_0_470[44] = "as-any-mut-ptr<mut-ptr<by-val<thread-args>>>";
...
char constantarr_0_475[12] = "is-shut-down";
...
char constantarr_0_480[11] = "hard-forbid";
char constantarr_0_481[8] = "needs-gc";
char constantarr_0_482[17] = "n-threads-running";
char constantarr_0_483[25] = "is-empty<task-queue-node>";
char constantarr_0_484[7] = "drop<a>";
char constantarr_0_485[12] = "get-sequence";
char constantarr_0_486[11] = "choose-task";
char constantarr_0_487[17] = "get-monotime-nsec";
char constantarr_0_488[13] = "new<timespec>";
char constantarr_0_489[13] = "clock_gettime";
char constantarr_0_490[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_491[11] = "*<timespec>";
char constantarr_0_492[14] = "inner-value<a>";
...
char constantarr_0_497[19] = "rslt-no-chosen-task";
char constantarr_0_498[21] = "choose-task-in-island";
char constantarr_0_499[7] = "do-a-gc";
char constantarr_0_500[11] = "tii-no-task";
char constantarr_0_501[11] = "none<nat64>";
char constantarr_0_502[9] = "pop-task!";
char constantarr_0_503[26] = "ref-of-val<mut-arr<nat64>>";
char constantarr_0_504[28] = "currently-running-exclusions";
char constantarr_0_505[11] = "ptr-no-task";
char constantarr_0_506[9] = "in<nat64>";
char constantarr_0_507[5] = "in<a>";
char constantarr_0_508[11] = "in-recur<a>";
char constantarr_0_509[11] = "noctx-at<a>";
char constantarr_0_510[14] = "temp-as-arr<a>";
char constantarr_0_511[18] = "temp-as-fix-arr<a>";
char constantarr_0_512[10] = "pop-recur!";
char constantarr_0_513[11] = "to-opt-time";
char constantarr_0_514[11] = "some<nat64>";
char constantarr_0_515[8] = "ptr-task";
char constantarr_0_516[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_517[8] = "tii-task";
char constantarr_0_518[10] = "is-no-task";
char constantarr_0_519[21] = "set-n-threads-running";
char constantarr_0_520[16] = "rslt-chosen-task";
char constantarr_0_521[9] = "togc-task";
char constantarr_0_522[9] = "any-tasks";
char constantarr_0_523[8] = "min-time";
char constantarr_0_524[10] = "min<nat64>";
char constantarr_0_525[15] = "first-task-time";
char constantarr_0_526[28] = "no-tasks-and-last-thread-out";
...
char constantarr_0_533[37] = "noctx-must-remove-unordered-recur!<a>";
char constantarr_0_534[29] = "noctx-remove-unordered-at!<a>";
...
char constantarr_0_541[13] = "mark-visit<a>";
char constantarr_0_542[20] = "ref-of-val<mark-ctx>";
char constantarr_0_543[15] = "clear-free-mem!";
char constantarr_0_544[17] = "!=<mut-ptr<bool>>";
char constantarr_0_545[16] = "set-is-shut-down";
...
char constantarr_0_556[18] = "new<mut-ptr<nat8>>";
char constantarr_0_557[12] = "pthread_join";
char constantarr_0_558[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_559[6] = "EINVAL";
char constantarr_0_560[5] = "ESRCH";
char constantarr_0_561[16] = "*<mut-ptr<nat8>>";
char constantarr_0_562[21] = "unmanaged-free<nat64>";
...
char constantarr_0_566[25] = "pthread_mutexattr_destroy";
char constantarr_0_567[21] = "pthread_mutex_destroy";
char constantarr_0_568[24] = "pthread_condattr_destroy";
char constantarr_0_569[20] = "pthread_cond_destroy";
char constantarr_0_570[24] = "any-unhandled-exceptions";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_5);
			copy_data_from__e_0(ctx, _matched0->funs, (struct arr_5) {354, constantarr_5_0}.begin_ptr, (struct arr_5) {354, constantarr_5_0}.size);
			sort__e(_matched0->funs, (struct arr_5) {354, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {354, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct void_) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {354, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	mark_visit_373(mark_ctx, value.tasks);
	return mark_visit_423(mark_ctx, value.log_handler);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_374(mark_ctx, value.head);
	return mark_visit_428(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 6: {
			...
			return mark_visit_426(mark_ctx, value6);
		}
		case 7: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_422(struct mark_ctx* mark_ctx, struct with_log_handler__lambda0 value) {
	mark_visit_423(mark_ctx, value.handler);
	mark_visit_377(mark_ctx, value.cb);
	return mark_visit_423(mark_ctx, value.original_handler);
}
...
struct void_ mark_visit_424(struct mark_ctx* mark_ctx, struct main_0__lambda0 value) {
	return mark_visit_423(mark_ctx, value.lh);
}
...
struct void_ mark_visit_428(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_visit_429(mark_ctx, value.backing);
}
/* mark-visit<fix-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_429(struct mark_ctx* mark_ctx, struct fix_arr_0 value) {
	return mark_arr_430(mark_ctx, value.inner);
}
...
struct void_ subscript_31(struct ctx* ctx, struct fun1_1 a, struct logged* p0) {
	return call_w_ctx_455(a, ctx, p0);
}
