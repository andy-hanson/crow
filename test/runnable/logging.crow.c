...
char constantarr_0_236[8] = "tail<?a>";
...
char constantarr_0_478[17] = "noctx-set-at!<?a>";
...
char constantarr_0_498[14] = "noctx-last<?a>";
...
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1 value);
struct void_ mark_visit_379(struct mark_ctx* mark_ctx, struct with_log_handler__lambda1* value);
...
struct void_ subscript_27(struct ctx* ctx, struct fun1_1 a, struct logged* p0);
struct void_ call_w_ctx_398(struct fun1_1 a, struct ctx* ctx, struct logged* p0);
...
struct void_ mark_visit_326(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 7: {
			...
			return mark_visit_379(mark_ctx, value7);
		}
		case 8: {
			return (struct void_) {};
		}
...
struct void_ log(struct ctx* ctx, struct log_level level, struct arr_0 message) {
	...
	*temp0 = (struct logged) {level, message};
	return subscript_27(ctx, _0, temp0);
}
...
struct void_ main_0__lambda0(struct ctx* ctx, struct main_0__lambda0* _closure, struct logged* logged) {
	subscript_27(ctx, _closure->lh, logged);
	return subscript_27(ctx, _closure->lh, logged);
}
...
struct void_ finally(struct ctx* ctx, struct fun_act0_0 after, struct fun_act0_0 try) {
	...
	*temp0 = (struct finally__lambda0) {after};
	...
	subscript_9(ctx, after);
	return res0;
}
/* finally<?a>.lambda0 void(err exception) */
struct void_ finally__lambda0(struct ctx* ctx, struct finally__lambda0* _closure, struct exception err) {
	subscript_9(ctx, _closure->after);
