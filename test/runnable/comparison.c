...
struct comparison compare_297(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_299(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_301(struct my_union a, struct my_union b);
struct comparison compare_302(struct my_other_record a, struct my_other_record b);
