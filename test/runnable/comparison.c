...
char constantarr_0_15[4] = "less";
char constantarr_0_16[5] = "equal";
char constantarr_0_17[7] = "greater";
...
struct void_ mark_visit_270(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_271(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_272(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_273(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_274(struct mark_ctx* mark_ctx, struct fut_callback_node_0 value);
struct void_ mark_visit_275(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_276(struct mark_ctx* mark_ctx, struct forward_to__lambda0 value);
struct void_ mark_visit_277(struct mark_ctx* mark_ctx, struct fut_0* value);
struct void_ mark_visit_278(struct mark_ctx* mark_ctx, struct forward_to__lambda0* value);
struct void_ mark_visit_279(struct mark_ctx* mark_ctx, struct fut_callback_node_0* value);
struct void_ mark_visit_280(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_arr_281(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_282(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0__lambda0* value);
struct void_ mark_visit_283(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0 value);
struct void_ mark_visit_284(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0* value);
struct void_ mark_visit_285(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda0 value);
struct void_ mark_visit_286(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda0* value);
struct void_ mark_visit_287(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0 value);
...
struct void_ mark_visit_290(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_291(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_292(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct arr_0 to_str_2(struct ctx* ctx, struct comparison c);
struct comparison compare_310(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_312(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_314(struct my_union a, struct my_union b);
struct comparison compare_315(struct my_other_record a, struct my_other_record b);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	struct ctx* _0 = ctx;
	test_compare_records(_0);
	struct ctx* _1 = ctx;
	test_compare_byref_records(_1);
	struct ctx* _2 = ctx;
	test_compare_unions(_2);
	struct ctx* _3 = ctx;
	int32_t _4 = 0;
	return resolved_1(_3, _4);
}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	uint64_t _0 = 1u;
	uint64_t _1 = 2u;
	a0 = (struct my_record) {_0, _1};
	
	struct my_record b1;
	uint64_t _2 = 1u;
	uint64_t _3 = 3u;
	b1 = (struct my_record) {_2, _3};
	
	struct my_record c2;
	uint64_t _4 = 1u;
	uint64_t _5 = 2u;
	c2 = (struct my_record) {_4, _5};
	
	struct my_record d3;
	uint64_t _6 = 0u;
	uint64_t _7 = 3u;
	d3 = (struct my_record) {_6, _7};
	
	struct ctx* _8 = ctx;
	struct my_record _9 = a0;
	struct my_record _10 = b1;
	struct comparison _11 = compare_310(_9, _10);
	struct arr_0 _12 = to_str_2(_8, _11);
	print(_12);
	struct ctx* _13 = ctx;
	struct my_record _14 = a0;
	struct my_record _15 = c2;
	struct comparison _16 = compare_310(_14, _15);
	struct arr_0 _17 = to_str_2(_13, _16);
	print(_17);
	struct ctx* _18 = ctx;
	struct my_record _19 = a0;
	struct my_record _20 = d3;
	struct comparison _21 = compare_310(_19, _20);
	struct arr_0 _22 = to_str_2(_18, _21);
	return print(_22);
}
/* to-str arr<char>(c comparison) */
struct arr_0 to_str_2(struct ctx* ctx, struct comparison c) {
	struct comparison _0 = c;
	switch (_0.kind) {
		case 0: {
			return (struct arr_0) {4, constantarr_0_15};
		}
		case 1: {
			return (struct arr_0) {5, constantarr_0_16};
		}
		case 2: {
...
struct comparison compare_310(struct my_record a, struct my_record b) {
	struct my_record _0 = a;
	uint64_t _1 = _0.x;
	struct my_record _2 = b;
	uint64_t _3 = _2.x;
	...
	switch (_4.kind) {
		...
		case 1: {
			struct my_record _6 = a;
			uint64_t _7 = _6.y;
			struct my_record _8 = b;
			uint64_t _9 = _8.y;
			struct comparison _10 = compare_5(_7, _9);
			switch (_10.kind) {
				case 0: {
					struct less _11 = (struct less) {};
					return (struct comparison) {0, .as0 = _11};
				}
				case 1: {
					struct equal _12 = (struct equal) {};
					return (struct comparison) {1, .as1 = _12};
				}
				case 2: {
					struct greater _13 = (struct greater) {};
					return (struct comparison) {2, .as2 = _13};
				}
				default:
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	struct ctx* _0 = ctx;
	uint64_t _1 = sizeof(struct my_byref_record);
	uint8_t* _2 = alloc(_0, _1);
	temp0 = (struct my_byref_record*) _2;
	
	struct my_byref_record* _3 = temp0;
	uint64_t _4 = 1u;
	uint64_t _5 = 2u;
	struct my_byref_record _6 = (struct my_byref_record) {_4, _5};
	*_3 = _6;
	a0 = temp0;
	...
	struct ctx* _7 = ctx;
	uint64_t _8 = sizeof(struct my_byref_record);
	uint8_t* _9 = alloc(_7, _8);
	temp1 = (struct my_byref_record*) _9;
	
	struct my_byref_record* _10 = temp1;
	uint64_t _11 = 1u;
	uint64_t _12 = 3u;
	struct my_byref_record _13 = (struct my_byref_record) {_11, _12};
	*_10 = _13;
	b1 = temp1;
	...
	struct ctx* _14 = ctx;
	uint64_t _15 = sizeof(struct my_byref_record);
	uint8_t* _16 = alloc(_14, _15);
	temp2 = (struct my_byref_record*) _16;
	
	struct my_byref_record* _17 = temp2;
	uint64_t _18 = 1u;
	uint64_t _19 = 2u;
	struct my_byref_record _20 = (struct my_byref_record) {_18, _19};
	*_17 = _20;
	c2 = temp2;
	...
	struct ctx* _21 = ctx;
	uint64_t _22 = sizeof(struct my_byref_record);
	uint8_t* _23 = alloc(_21, _22);
	temp3 = (struct my_byref_record*) _23;
	
	struct my_byref_record* _24 = temp3;
	uint64_t _25 = 0u;
	uint64_t _26 = 3u;
	struct my_byref_record _27 = (struct my_byref_record) {_25, _26};
	*_24 = _27;
	d3 = temp3;
	
	struct ctx* _28 = ctx;
	struct my_byref_record* _29 = a0;
	struct my_byref_record* _30 = b1;
	struct comparison _31 = compare_312(_29, _30);
	struct arr_0 _32 = to_str_2(_28, _31);
	print(_32);
	struct ctx* _33 = ctx;
	struct my_byref_record* _34 = a0;
	struct my_byref_record* _35 = c2;
	struct comparison _36 = compare_312(_34, _35);
	struct arr_0 _37 = to_str_2(_33, _36);
	print(_37);
	struct ctx* _38 = ctx;
	struct my_byref_record* _39 = a0;
	struct my_byref_record* _40 = d3;
	struct comparison _41 = compare_312(_39, _40);
	struct arr_0 _42 = to_str_2(_38, _41);
	return print(_42);
}
/* compare<gc-ptr(my-byref-record)> (generated) (generated) */
struct comparison compare_312(struct my_byref_record* a, struct my_byref_record* b) {
	struct my_byref_record* _0 = a;
	uint64_t _1 = _0->x;
	struct my_byref_record* _2 = b;
	uint64_t _3 = _2->x;
	struct comparison _4 = compare_5(_1, _3);
	switch (_4.kind) {
		case 0: {
		...
		case 1: {
			struct my_byref_record* _6 = a;
			uint64_t _7 = _6->y;
			struct my_byref_record* _8 = b;
			uint64_t _9 = _8->y;
			struct comparison _10 = compare_5(_7, _9);
			switch (_10.kind) {
				case 0: {
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	uint64_t _0 = 1u;
	uint64_t _1 = 2u;
	struct my_record _2 = (struct my_record) {_0, _1};
	a0 = (struct my_union) {0, .as0 = _2};
	
	struct my_union b1;
	struct my_other_record _3 = (struct my_other_record) {};
	b1 = (struct my_union) {1, .as1 = _3};
	
	struct my_union c2;
	uint64_t _4 = 1u;
	uint64_t _5 = 2u;
	struct my_record _6 = (struct my_record) {_4, _5};
	c2 = (struct my_union) {0, .as0 = _6};
	
	struct my_union d3;
	uint64_t _7 = 1u;
	uint64_t _8 = 1u;
	struct my_record _9 = (struct my_record) {_7, _8};
	d3 = (struct my_union) {0, .as0 = _9};
	
	struct ctx* _10 = ctx;
	struct my_union _11 = a0;
	struct my_union _12 = b1;
	struct comparison _13 = compare_314(_11, _12);
	struct arr_0 _14 = to_str_2(_10, _13);
	print(_14);
	struct ctx* _15 = ctx;
	struct my_union _16 = a0;
	struct my_union _17 = c2;
	struct comparison _18 = compare_314(_16, _17);
	struct arr_0 _19 = to_str_2(_15, _18);
	print(_19);
	struct ctx* _20 = ctx;
	struct my_union _21 = a0;
	struct my_union _22 = d3;
	struct comparison _23 = compare_314(_21, _22);
	struct arr_0 _24 = to_str_2(_20, _23);
	return print(_24);
}
	...
	switch (_0.kind) {
		case 0: {
			...
			switch (_1.kind) {
				case 0: {
					...
					struct my_record _2 = a0;
					struct my_record _3 = b0;
					return compare_310(_2, _3);
				}
				case 1: {
		...
		case 1: {
			...
			switch (_5.kind) {
				...
				case 1: {
					struct my_other_record b1 = _5.as1;
					
					struct my_other_record _7 = a1;
					struct my_other_record _8 = b1;
					return compare_315(_7, _8);
				}
				default:
					return (assert(0),(struct comparison) {0});
			}
