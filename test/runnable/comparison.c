...
char constantarr_0_521[20] = "test-compare-records";
char constantarr_0_522[9] = "my-record";
char constantarr_0_523[14] = "<=><my-record>";
char constantarr_0_524[26] = "test-compare-byref-records";
char constantarr_0_525[15] = "my-byref-record";
char constantarr_0_526[20] = "<=><my-byref-record>";
char constantarr_0_527[19] = "test-compare-unions";
char constantarr_0_528[12] = "as<my-union>";
char constantarr_0_529[15] = "my-other-record";
char constantarr_0_530[13] = "<=><my-union>";
...
struct comparison compare_335(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_337(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_339(struct my_union a, struct my_union b);
struct comparison compare_340(struct my_other_record a, struct my_other_record b);
...
uint8_t* get_fun_ptr_86(uint64_t fun_id) {switch (fun_id) {
		...
		case 335: {
			return (uint8_t*) compare_335;
		}
		case 336: {
			return (uint8_t*) test_compare_byref_records;
		}
		case 337: {
			return (uint8_t*) compare_337;
		}
		case 338: {
			return (uint8_t*) test_compare_unions;
		}
		case 339: {
			return (uint8_t*) compare_339;
		}
		case 340: {
			return (uint8_t*) compare_340;
		}
		case 341: {
...
struct arr_0 get_fun_name_87(uint64_t fun_id) {switch (fun_id) {
		...
		case 333: {
			return (struct arr_0) {20, constantarr_0_521};
		}
		case 334: {
			return (struct arr_0) {6, constantarr_0_238};
		}
		...
		case 336: {
			return (struct arr_0) {26, constantarr_0_524};
		}
		case 337: {
			return (struct arr_0) {0u, NULL};
		}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_335(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_335(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_335(a0, d3);
...
struct comparison compare_335(struct my_record a, struct my_record b) {
	struct comparison _0 = compare_7(a.x, b.x);
	switch (_0.kind) {
		case 0: {
			return (struct comparison) {0, .as0 = (struct less) {}};
		}
		case 1: {
			struct comparison _1 = compare_7(a.y, b.y);
			switch (_1.kind) {
				case 0: {
					return (struct comparison) {0, .as0 = (struct less) {}};
				}
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_337(a0, b1);
	struct arr_0 _5 = to_str_2(ctx, _4);
	print(_5);
	struct comparison _6 = compare_337(a0, c2);
	struct arr_0 _7 = to_str_2(ctx, _6);
	print(_7);
	struct comparison _8 = compare_337(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_339(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_339(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_339(a0, d3);
	struct arr_0 _5 = to_str_2(ctx, _4);
	return print(_5);
}
