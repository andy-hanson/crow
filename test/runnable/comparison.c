...
uint8_t test_compare_records(struct ctx* ctx) {
	...
	struct my_record c;
	struct my_record d;
	a = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})};
	b = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "3"})};
	c = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})};
	d = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "0"}), literal_1(ctx, (struct arr_0) {1, "3"})};
...
uint8_t test_compare_byref_records(struct ctx* ctx) {
	...
	a = (temp0 = (struct my_byref_record*) alloc(ctx, sizeof(struct my_byref_record)), ((*(temp0) = (struct my_byref_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})}, 0), temp0));
	b = (temp1 = (struct my_byref_record*) alloc(ctx, sizeof(struct my_byref_record)), ((*(temp1) = (struct my_byref_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "3"})}, 0), temp1));
	c = (temp2 = (struct my_byref_record*) alloc(ctx, sizeof(struct my_byref_record)), ((*(temp2) = (struct my_byref_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})}, 0), temp2));
	d = (temp3 = (struct my_byref_record*) alloc(ctx, sizeof(struct my_byref_record)), ((*(temp3) = (struct my_byref_record) {literal_1(ctx, (struct arr_0) {1, "0"}), literal_1(ctx, (struct arr_0) {1, "3"})}, 0), temp3));
...
uint8_t test_compare_unions(struct ctx* ctx) {
	...
	struct my_union c;
	struct my_union d;
	a = (struct my_union) {0, .as0 = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})}};
	b = (struct my_union) {1, .as1 = (struct my_other_record) {0}};
	c = (struct my_union) {0, .as0 = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "2"})}};
	d = (struct my_union) {0, .as0 = (struct my_record) {literal_1(ctx, (struct arr_0) {1, "1"}), literal_1(ctx, (struct arr_0) {1, "1"})}};
