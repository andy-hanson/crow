...
char constantarr_0_519[20] = "test-compare-records";
char constantarr_0_520[9] = "my-record";
char constantarr_0_521[14] = "<=><my-record>";
char constantarr_0_522[26] = "test-compare-byref-records";
char constantarr_0_523[15] = "my-byref-record";
char constantarr_0_524[20] = "<=><my-byref-record>";
char constantarr_0_525[19] = "test-compare-unions";
char constantarr_0_526[12] = "as<my-union>";
char constantarr_0_527[15] = "my-other-record";
char constantarr_0_528[13] = "<=><my-union>";
...
struct comparison compare_333(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_335(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_337(struct my_union a, struct my_union b);
struct comparison compare_338(struct my_other_record a, struct my_other_record b);
...
struct arr_0 get_fun_name_73(uint64_t fun_id) {switch (fun_id) {
		...
		case 331: {
			return (struct arr_0) {20, constantarr_0_519};
		}
		case 332: {
			return (struct arr_0) {6, constantarr_0_219};
		}
		...
		case 334: {
			return (struct arr_0) {26, constantarr_0_522};
		}
		case 335: {
			return (struct arr_0) {0u, NULL};
		}
...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_333(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_333(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_333(a0, d3);
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_335(a0, b1);
	struct arr_0 _5 = to_str_2(ctx, _4);
	print(_5);
	struct comparison _6 = compare_335(a0, c2);
	struct arr_0 _7 = to_str_2(ctx, _6);
	print(_7);
	struct comparison _8 = compare_335(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_337(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_337(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_337(a0, d3);
	struct arr_0 _5 = to_str_2(ctx, _4);
	return print(_5);
}
