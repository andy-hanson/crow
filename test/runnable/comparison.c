...
struct void_ mark_visit_293(struct mark_ctx* mark_ctx, struct mut_list value);
...
struct comparison compare_313(struct my_record a, struct my_record b);
struct void_ test_compare_byref_records(struct ctx* ctx);
struct comparison compare_315(struct my_byref_record* a, struct my_byref_record* b);
struct void_ test_compare_unions(struct ctx* ctx);
struct comparison compare_317(struct my_union a, struct my_union b);
struct comparison compare_318(struct my_other_record a, struct my_other_record b);
