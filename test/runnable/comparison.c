...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _11 = compare_274(_9, _10);
	struct arr_0 _12 = to_str_1(_8, _11);
	print(_12);
	struct ctx* _13 = ctx;
	struct my_record _14 = a0;
	struct my_record _15 = c2;
	struct comparison _16 = compare_274(_14, _15);
	struct arr_0 _17 = to_str_1(_13, _16);
	print(_17);
	struct ctx* _18 = ctx;
	struct my_record _19 = a0;
	struct my_record _20 = d3;
	struct comparison _21 = compare_274(_19, _20);
	struct arr_0 _22 = to_str_1(_18, _21);
	return print(_22);
}
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*_24 = _27;
	...
	struct comparison _31 = compare_276(_29, _30);
	struct arr_0 _32 = to_str_1(_28, _31);
	print(_32);
	struct ctx* _33 = ctx;
	struct my_byref_record* _34 = a0;
	struct my_byref_record* _35 = c2;
	struct comparison _36 = compare_276(_34, _35);
	struct arr_0 _37 = to_str_1(_33, _36);
	print(_37);
	struct ctx* _38 = ctx;
	struct my_byref_record* _39 = a0;
	struct my_byref_record* _40 = d3;
	struct comparison _41 = compare_276(_39, _40);
	struct arr_0 _42 = to_str_1(_38, _41);
	return print(_42);
}
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _13 = compare_278(_11, _12);
	struct arr_0 _14 = to_str_1(_10, _13);
	print(_14);
	struct ctx* _15 = ctx;
	struct my_union _16 = a0;
	struct my_union _17 = c2;
	struct comparison _18 = compare_278(_16, _17);
	struct arr_0 _19 = to_str_1(_15, _18);
	print(_19);
	struct ctx* _20 = ctx;
	struct my_union _21 = a0;
	struct my_union _22 = d3;
	struct comparison _23 = compare_278(_21, _22);
	struct arr_0 _24 = to_str_1(_20, _23);
	return print(_24);
}
