...
struct void_ test_compare_records(struct ctx* ctx) {
	...
	struct comparison _0 = compare_302(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_302(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_302(a0, d3);
...
struct void_ test_compare_byref_records(struct ctx* ctx) {
	...
	*temp3 = (struct my_byref_record) {0u, 3u};
	...
	struct comparison _4 = compare_304(a0, b1);
	struct arr_0 _5 = to_str_2(ctx, _4);
	print(_5);
	struct comparison _6 = compare_304(a0, c2);
	struct arr_0 _7 = to_str_2(ctx, _6);
	print(_7);
	struct comparison _8 = compare_304(a0, d3);
...
struct void_ test_compare_unions(struct ctx* ctx) {
	...
	struct comparison _0 = compare_306(a0, b1);
	struct arr_0 _1 = to_str_2(ctx, _0);
	print(_1);
	struct comparison _2 = compare_306(a0, c2);
	struct arr_0 _3 = to_str_2(ctx, _2);
	print(_3);
	struct comparison _4 = compare_306(a0, d3);
	struct arr_0 _5 = to_str_2(ctx, _4);
	return print(_5);
}
