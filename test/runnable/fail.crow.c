...
char constantarr_0_134[8] = "data-cur";
char constantarr_0_135[6] = "+<nat>";
char constantarr_0_136[14] = "ptr-less?<nat>";
char constantarr_0_137[8] = "data-end";
char constantarr_0_138[11] = "range-free?";
char constantarr_0_139[8] = "mark-cur";
char constantarr_0_140[12] = "set-mark-cur";
char constantarr_0_141[12] = "set-data-cur";
char constantarr_0_142[15] = "some<ptr<nat8>>";
char constantarr_0_143[19] = "ptr-cast<nat8, nat>";
char constantarr_0_144[8] = "release!";
char constantarr_0_145[11] = "must-unset!";
char constantarr_0_146[10] = "try-unset!";
...
char constantarr_0_152[13] = "some<ptr<?a>>";
char constantarr_0_153[18] = "ptr-cast<?a, nat8>";
...
char constantarr_0_162[18] = "as<arr<arr<char>>>";
...
char constantarr_0_171[24] = "set-subscript<ptr<nat8>>";
char constantarr_0_172[17] = "set-subscript<?a>";
char constantarr_0_173[5] = "+<?a>";
char constantarr_0_174[11] = "get-fun-ptr";
char constantarr_0_175[24] = "set-subscript<arr<char>>";
...
char constantarr_0_181[13] = "subscript<?a>";
...
char constantarr_0_210[6] = "finish";
char constantarr_0_211[18] = "move-to-arr!<char>";
char constantarr_0_212[9] = "inner<?a>";
char constantarr_0_213[11] = "backing<?a>";
char constantarr_0_214[15] = "set-backing<?a>";
char constantarr_0_215[12] = "set-size<?a>";
char constantarr_0_216[5] = "inner";
char constantarr_0_217[6] = "to-str";
char constantarr_0_218[21] = "with-value<arr<char>>";
char constantarr_0_219[8] = "with-str";
...
char constantarr_0_226[11] = "end-ptr<?a>";
char constantarr_0_227[6] = "~=<?a>";
char constantarr_0_228[18] = "incr-capacity!<?a>";
char constantarr_0_229[19] = "ensure-capacity<?a>";
char constantarr_0_230[12] = "capacity<?a>";
char constantarr_0_231[25] = "increase-capacity-to!<?a>";
char constantarr_0_232[25] = "uninitialized-mut-arr<?a>";
char constantarr_0_233[21] = "set-zero-elements<?a>";
char constantarr_0_234[24] = "round-up-to-power-of-two";
char constantarr_0_235[30] = "round-up-to-power-of-two-recur";
char constantarr_0_236[1] = "*";
char constantarr_0_237[1] = "/";
char constantarr_0_238[16] = "~=<char>.lambda0";
char constantarr_0_239[6] = "interp";
char constantarr_0_240[14] = "mut-list<char>";
...
char constantarr_0_250[21] = "with-value<log-level>";
...
char constantarr_0_255[14] = "as<by-val<gc>>";
char constantarr_0_256[11] = "validate-gc";
char constantarr_0_257[10] = "mark-begin";
char constantarr_0_258[10] = "data-begin";
char constantarr_0_259[18] = "ptr-less-eq?<bool>";
char constantarr_0_260[13] = "ptr-less?<?a>";
char constantarr_0_261[8] = "mark-end";
char constantarr_0_262[17] = "ptr-less-eq?<nat>";
char constantarr_0_263[7] = "-<bool>";
char constantarr_0_264[10] = "size-words";
...
char constantarr_0_530[3] = "foo";
char constantarr_0_531[3] = "bar";
...
struct arr_0 get_fun_name_85(uint64_t fun_id) {switch (fun_id) {
		...
		case 82: {
			return (struct arr_0) {24, constantarr_0_171};
		}
		case 83: {
			return (struct arr_0) {0u, NULL};
		}
		case 84: {
			return (struct arr_0) {24, constantarr_0_175};
		}
		case 85: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 138: {
			return (struct arr_0) {30, constantarr_0_235};
		}
		case 139: {
		...
		case 141: {
			return (struct arr_0) {17, constantarr_0_172};
		}
		case 142: {
		...
		case 157: {
			return (struct arr_0) {17, constantarr_0_262};
		}
		case 158: {
