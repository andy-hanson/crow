...
char constantarr_0_294[6] = "cb<?t>";
char constantarr_0_295[8] = "next<?t>";
char constantarr_0_296[30] = "value<fut-state-callbacks<?t>>";
char constantarr_0_297[22] = "hard-unreachable<void>";
