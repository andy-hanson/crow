...
char constantarr_0_502[7] = "drop<a>";
...
char constantarr_0_543[9] = "togc-task";
char constantarr_0_544[9] = "any-tasks";
char constantarr_0_545[8] = "min-time";
char constantarr_0_546[10] = "min<nat64>";
char constantarr_0_547[15] = "first-task-time";
char constantarr_0_548[28] = "no-tasks-and-last-thread-out";
...
char constantarr_0_555[37] = "noctx-must-remove-unordered-recur!<a>";
...
char constantarr_0_579[19] = "cell<mut-ptr<nat8>>";
...
char constantarr_0_595[3] = "foo";
char constantarr_0_596[3] = "bar";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, _matched0->funs, (struct arr_5) {341, constantarr_5_0}.begin_ptr, (struct arr_5) {341, constantarr_5_0}.size);
			sort__e(_matched0->funs, (struct arr_5) {341, constantarr_5_0}.size);
