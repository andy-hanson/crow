...
char constantarr_0_510[11] = "*<timespec>";
char constantarr_0_511[14] = "inner-value<a>";
...
char constantarr_0_582[16] = "*<mut-ptr<nat8>>";
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {337, constantarr_5_0}.size);
		*code_names = _2;
