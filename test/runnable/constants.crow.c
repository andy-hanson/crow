...
char constantarr_0_25[8] = "bits-not";
...
char constantarr_0_182[13] = "ptr-less?<?a>";
...
struct str get_fun_name_105(uint64_t fun_id) {switch (fun_id) {
		...
		case 10: {
			return (struct str) {{3, constantarr_0_43}};
		}
		case 11: {
