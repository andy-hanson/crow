...
char constantarr_0_21[4] = "void";
char constantarr_0_22[6] = "abort!";
char constantarr_0_23[7] = "==<nat>";
char constantarr_0_24[7] = "<=><?t>";
char constantarr_0_25[5] = "false";
char constantarr_0_26[4] = "true";
...
struct arr_0 get_fun_name_87(uint64_t fun_id) {switch (fun_id) {
		...
		case 4: {
			return (struct arr_0) {6, constantarr_0_22};
		}
		case 5: {
			return (struct arr_0) {7, constantarr_0_23};
		}
		case 6: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 10: {
			return (struct arr_0) {3, constantarr_0_35};
		}
		case 11: {
