...
struct named_val constantarr_5_0[310];
...
char constantarr_0_46[3] = "<=>";
char constantarr_0_47[5] = "less?";
char constantarr_0_48[10] = "cmp<nat64>";
...
char constantarr_0_287[7] = "<=><?a>";
char constantarr_0_288[11] = "<=<ptr<?a>>";
char constantarr_0_289[5] = "<<?a>";
...
char constantarr_0_294[15] = "some<ptr<char>>";
char constantarr_0_295[27] = "hard-unreachable<ptr<char>>";
...
char constantarr_0_313[21] = "as-any-ptr<ptr<bool>>";
...
char constantarr_0_318[13] = "<=<ptr<bool>>";
...
char constantarr_0_465[20] = "subscript<?a, nat64>";
char constantarr_0_466[14] = "subscript<?in>";
char constantarr_0_467[27] = "map<str, ptr<char>>.lambda0";
...
char constantarr_0_476[78] = "call-with-ctx<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>";
...
char constantarr_0_499[9] = "needs-gc?";
char constantarr_0_500[17] = "n-threads-running";
char constantarr_0_501[23] = "empty?<task-queue-node>";
...
char constantarr_0_525[16] = "contains?<nat64>";
char constantarr_0_526[13] = "contains?<?a>";
char constantarr_0_527[19] = "contains-recur?<?a>";
char constantarr_0_528[12] = "noctx-at<?a>";
char constantarr_0_529[15] = "temp-as-arr<?a>";
char constantarr_0_530[19] = "temp-as-mut-arr<?a>";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {310, constantarr_5_0}.begin_ptr, (struct arr_5) {310, constantarr_5_0}.size);
			sort__e(arrs1->funs, (struct arr_5) {310, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {310, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		struct sym _1 = get_fun_name((*code_ptrs), funs, (struct arr_5) {310, constantarr_5_0}.size);
		*code_names = _1;
