...
char constantarr_0_356[17];
char constantarr_0_357[6];
char constantarr_0_358[9];
char constantarr_0_359[13];
char constantarr_0_360[23];
char constantarr_0_361[29];
char constantarr_0_362[38];
...
char constantarr_0_296[7] = "~<char>";
char constantarr_0_297[5] = "level";
char constantarr_0_298[14] = "island.lambda1";
char constantarr_0_299[20] = "ptr-cast<bool, nat8>";
char constantarr_0_300[21] = "as-any-ptr<ptr<bool>>";
char constantarr_0_301[14] = "as<by-val<gc>>";
char constantarr_0_302[11] = "validate-gc";
char constantarr_0_303[10] = "data-begin";
char constantarr_0_304[9] = "<=><bool>";
char constantarr_0_305[13] = "<=<ptr<bool>>";
char constantarr_0_306[5] = "<<?a>";
char constantarr_0_307[8] = "mark-end";
char constantarr_0_308[14] = "<=<ptr<nat64>>";
char constantarr_0_309[14] = "ref-of-val<gc>";
...
char constantarr_0_315[13] = "add-main-task";
char constantarr_0_316[13] = "exception-ctx";
char constantarr_0_317[7] = "log-ctx";
char constantarr_0_318[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_319[8] = "perf-ctx";
char constantarr_0_320[22] = "mut-arr<measure-value>";
char constantarr_0_321[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_322[25] = "ref-of-val<exception-ctx>";
char constantarr_0_323[19] = "as-any-ptr<log-ctx>";
char constantarr_0_324[19] = "ref-of-val<log-ctx>";
char constantarr_0_325[20] = "as-any-ptr<perf-ctx>";
char constantarr_0_326[20] = "ref-of-val<perf-ctx>";
char constantarr_0_327[10] = "print-lock";
char constantarr_0_328[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_329[3] = "ctx";
char constantarr_0_330[12] = "context-head";
char constantarr_0_331[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_332[6] = "set-gc";
char constantarr_0_333[12] = "set-next-ctx";
char constantarr_0_334[16] = "set-context-head";
char constantarr_0_335[8] = "next-ctx";
char constantarr_0_336[11] = "set-handler";
char constantarr_0_337[15] = "as-ref<log-ctx>";
char constantarr_0_338[11] = "log-ctx-ptr";
char constantarr_0_339[11] = "log-handler";
char constantarr_0_340[26] = "ref-of-val<island-gc-root>";
char constantarr_0_341[7] = "gc-root";
char constantarr_0_342[22] = "as-any-ptr<global-ctx>";
char constantarr_0_343[2] = "id";
char constantarr_0_344[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_345[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_346[15] = "ref-of-val<ctx>";
char constantarr_0_347[77] = "as<fun-act2<fut<nat64>, arr<ptr<char>>, fun-ptr2<fut<nat64>, ctx, arr<str>>>>";
char constantarr_0_348[14] = "add-first-task";
char constantarr_0_349[16] = "then-void<nat64>";
char constantarr_0_350[16] = "then<?out, void>";
char constantarr_0_351[16] = "unresolved<?out>";
char constantarr_0_352[7] = "fut<?a>";
char constantarr_0_353[22] = "fut-state-no-callbacks";
char constantarr_0_354[14] = "callback!<?in>";
char constantarr_0_355[15] = "with-lock<void>";
char constantarr_0_356[17] = "call-with-ctx<?r>";
char constantarr_0_357[6] = "lk<?a>";
char constantarr_0_358[9] = "state<?a>";
char constantarr_0_359[13] = "set-state<?a>";
char constantarr_0_360[23] = "fut-state-callbacks<?a>";
char constantarr_0_361[29] = "some<fut-state-callbacks<?a>>";
char constantarr_0_362[38] = "subscript<void, result<?a, exception>>";
char constantarr_0_363[6] = "ok<?a>";
char constantarr_0_364[9] = "value<?a>";
char constantarr_0_365[14] = "err<exception>";
char constantarr_0_366[22] = "callback!<?in>.lambda0";
char constantarr_0_367[17] = "forward-to!<?out>";
char constantarr_0_368[13] = "callback!<?a>";
char constantarr_0_369[21] = "callback!<?a>.lambda0";
char constantarr_0_370[22] = "resolve-or-reject!<?a>";
char constantarr_0_371[24] = "with-lock<fut-state<?a>>";
char constantarr_0_372[22] = "fut-state-resolved<?a>";
char constantarr_0_373[16] = "value<exception>";
char constantarr_0_374[30] = "resolve-or-reject!<?a>.lambda0";
char constantarr_0_375[19] = "call-callbacks!<?a>";
char constantarr_0_376[6] = "cb<?a>";
char constantarr_0_377[8] = "next<?a>";
char constantarr_0_378[25] = "forward-to!<?out>.lambda0";
char constantarr_0_379[20] = "subscript<?out, ?in>";
char constantarr_0_380[10] = "get-island";
char constantarr_0_381[17] = "subscript<island>";
char constantarr_0_382[13] = "unsafe-at<?a>";
char constantarr_0_383[7] = "islands";
char constantarr_0_384[29] = "island-and-exclusion<?r, ?p0>";
char constantarr_0_385[8] = "add-task";
char constantarr_0_386[15] = "task-queue-node";
char constantarr_0_387[4] = "task";
char constantarr_0_388[10] = "tasks-lock";
char constantarr_0_389[12] = "insert-task!";
char constantarr_0_390[4] = "size";
char constantarr_0_391[10] = "size-recur";
char constantarr_0_392[4] = "next";
char constantarr_0_393[4] = "head";
char constantarr_0_394[8] = "set-head";
char constantarr_0_395[21] = "some<task-queue-node>";
char constantarr_0_396[4] = "time";
char constantarr_0_397[12] = "insert-recur";
char constantarr_0_398[8] = "set-next";
char constantarr_0_399[5] = "tasks";
char constantarr_0_400[22] = "ref-of-val<task-queue>";
char constantarr_0_401[10] = "broadcast!";
char constantarr_0_402[18] = "pthread_mutex_lock";
char constantarr_0_403[22] = "pthread_cond_broadcast";
char constantarr_0_404[12] = "set-sequence";
char constantarr_0_405[8] = "sequence";
char constantarr_0_406[20] = "pthread_mutex_unlock";
char constantarr_0_407[17] = "may-be-work-to-do";
char constantarr_0_408[4] = "gctx";
char constantarr_0_409[12] = "no-timestamp";
char constantarr_0_410[9] = "exclusion";
char constantarr_0_411[11] = "catch<void>";
char constantarr_0_412[28] = "catch-with-exception-ctx<?a>";
char constantarr_0_413[16] = "thrown-exception";
char constantarr_0_414[13] = "__jmp_buf_tag";
char constantarr_0_415[4] = "zero";
char constantarr_0_416[7] = "bytes64";
char constantarr_0_417[7] = "bytes32";
char constantarr_0_418[7] = "bytes16";
char constantarr_0_419[8] = "bytes128";
char constantarr_0_420[15] = "set-jmp-buf-ptr";
char constantarr_0_421[21] = "ptr-to<__jmp_buf_tag>";
char constantarr_0_422[6] = "setjmp";
char constantarr_0_423[24] = "subscript<?a, exception>";
char constantarr_0_424[23] = "subscript<fut<?r>, ?p0>";
char constantarr_0_425[12] = "fun<?r, ?p0>";
char constantarr_0_426[36] = "subscript<?out, ?in>.lambda0.lambda0";
char constantarr_0_427[11] = "reject!<?r>";
char constantarr_0_428[36] = "subscript<?out, ?in>.lambda0.lambda1";
char constantarr_0_429[28] = "subscript<?out, ?in>.lambda0";
char constantarr_0_430[10] = "value<?in>";
char constantarr_0_431[24] = "then<?out, void>.lambda0";
char constantarr_0_432[15] = "subscript<?out>";
char constantarr_0_433[24] = "island-and-exclusion<?r>";
char constantarr_0_434[18] = "subscript<fut<?r>>";
char constantarr_0_435[7] = "fun<?r>";
char constantarr_0_436[31] = "subscript<?out>.lambda0.lambda0";
char constantarr_0_437[31] = "subscript<?out>.lambda0.lambda1";
char constantarr_0_438[23] = "subscript<?out>.lambda0";
char constantarr_0_439[24] = "then-void<nat64>.lambda0";
char constantarr_0_440[24] = "cur-island-and-exclusion";
char constantarr_0_441[20] = "island-and-exclusion";
char constantarr_0_442[9] = "island-id";
char constantarr_0_443[5] = "delay";
char constantarr_0_444[14] = "resolved<void>";
char constantarr_0_445[15] = "tail<ptr<char>>";
char constantarr_0_446[10] = "empty?<?a>";
char constantarr_0_447[36] = "subscript<fut<nat64>, ctx, arr<str>>";
char constantarr_0_448[19] = "map<str, ptr<char>>";
char constantarr_0_449[14] = "make-arr<?out>";
char constantarr_0_450[18] = "fill-ptr-range<?a>";
char constantarr_0_451[24] = "fill-ptr-range-recur<?a>";
char constantarr_0_452[20] = "subscript<?a, nat64>";
char constantarr_0_453[14] = "subscript<?in>";
char constantarr_0_454[27] = "map<str, ptr<char>>.lambda0";
char constantarr_0_455[24] = "arr-from-begin-end<char>";
char constantarr_0_456[7] = "<=><?a>";
char constantarr_0_457[11] = "<=<ptr<?a>>";
...
char constantarr_0_575[12] = "pthread_join";
...
char constantarr_0_580[21] = "unmanaged-free<nat64>";
...
char constantarr_0_585[25] = "pthread_mutexattr_destroy";
char constantarr_0_586[21] = "pthread_mutex_destroy";
char constantarr_0_587[24] = "pthread_condattr_destroy";
char constantarr_0_588[20] = "pthread_cond_destroy";
char constantarr_0_589[25] = "any-unhandled-exceptions?";
char constantarr_0_590[4] = "main";
char constantarr_0_591[9] = "my-record";
char constantarr_0_592[1] = "x";
char constantarr_0_593[1] = "y";
char constantarr_0_594[7] = "to-base";
char constantarr_0_595[12] = "digit-to-str";
char constantarr_0_596[3] = "mod";
char constantarr_0_597[15] = "resolved<nat64>";
...
struct str get_fun_name_105(uint64_t fun_id) {switch (fun_id) {
		...
		case 162: {
			return (struct str) {{14, constantarr_0_298}};
		}
		case 163: {
			return (struct str) {{2, constantarr_0_215}};
		}
		case 164: {
			return (struct str) {{11, constantarr_0_302}};
		}
		case 165: {
			return (struct str) {{9, constantarr_0_304}};
		}
		case 166: {
			return (struct str) {{13, constantarr_0_305}};
		}
		case 167: {
			return (struct str) {{5, constantarr_0_306}};
		}
		case 168: {
			return (struct str) {{14, constantarr_0_308}};
		}
		case 169: {
			return (struct str) {{19, constantarr_0_310}};
		}
		case 170: {
			return (struct str) {{19, constantarr_0_310}};
		}
		case 171: {
			return (struct str) {{13, constantarr_0_315}};
		}
		case 172: {
			return (struct str) {{13, constantarr_0_316}};
		}
		case 173: {
			return (struct str) {{7, constantarr_0_317}};
		}
		case 174: {
			return (struct str) {{8, constantarr_0_319}};
		}
		case 175: {
			return (struct str) {{22, constantarr_0_320}};
		}
		case 176: {
			return (struct str) {{3, constantarr_0_329}};
		}
		case 177: {
			return (struct str) {{10, constantarr_0_216}};
		}
		case 178: {
			return (struct str) {{14, constantarr_0_348}};
		}
		case 179: {
			return (struct str) {{16, constantarr_0_349}};
		}
		case 180: {
		...
		case 182: {
			return (struct str) {{14, constantarr_0_354}};
		}
		case 183: {
			return (struct str) {{15, constantarr_0_355}};
		}
		case 184: {
			return (struct str) {{13, constantarr_0_148}};
		}
		...
		case 186: {
			return (struct str) {{38, constantarr_0_362}};
		}
		case 187: {
			return (struct str) {{0u, NULL}};
		}
		case 188: {
			return (struct str) {{22, constantarr_0_366}};
		}
		case 189: {
			return (struct str) {{17, constantarr_0_367}};
		}
		case 190: {
			return (struct str) {{13, constantarr_0_368}};
		}
		case 191: {
			return (struct str) {{38, constantarr_0_362}};
		}
		...
		case 193: {
			return (struct str) {{21, constantarr_0_369}};
		}
		case 194: {
			return (struct str) {{22, constantarr_0_370}};
		}
		case 195: {
			return (struct str) {{24, constantarr_0_371}};
		}
		case 196: {
			return (struct str) {{13, constantarr_0_148}};
		}
		...
		case 198: {
			return (struct str) {{30, constantarr_0_374}};
		}
		case 199: {
			return (struct str) {{19, constantarr_0_375}};
		}
		case 200: {
			return (struct str) {{25, constantarr_0_378}};
		}
		case 201: {
			return (struct str) {{20, constantarr_0_379}};
		}
		case 202: {
			return (struct str) {{10, constantarr_0_380}};
		}
		case 203: {
			return (struct str) {{17, constantarr_0_381}};
		}
		case 204: {
			return (struct str) {{13, constantarr_0_382}};
		}
		case 205: {
			return (struct str) {{13, constantarr_0_148}};
		}
		case 206: {
			return (struct str) {{8, constantarr_0_385}};
		}
		case 207: {
			return (struct str) {{8, constantarr_0_385}};
		}
		case 208: {
			return (struct str) {{15, constantarr_0_386}};
		}
		case 209: {
			return (struct str) {{12, constantarr_0_389}};
		}
		case 210: {
			return (struct str) {{4, constantarr_0_390}};
		}
		case 211: {
		...
		case 213: {
			return (struct str) {{5, constantarr_0_399}};
		}
		case 214: {
			return (struct str) {{10, constantarr_0_401}};
		}
		case 215: {
			return (struct str) {{18, constantarr_0_402}};
		}
		case 216: {
			return (struct str) {{22, constantarr_0_403}};
		}
		case 217: {
			return (struct str) {{20, constantarr_0_406}};
		}
		case 218: {
			return (struct str) {{12, constantarr_0_409}};
		}
		case 219: {
			return (struct str) {{11, constantarr_0_411}};
		}
		case 220: {
			return (struct str) {{28, constantarr_0_412}};
		}
		case 221: {
			return (struct str) {{4, constantarr_0_415}};
		}
		case 222: {
			return (struct str) {{4, constantarr_0_415}};
		}
		...
		case 225: {
			return (struct str) {{6, constantarr_0_422}};
		}
		case 226: {
			return (struct str) {{24, constantarr_0_423}};
		}
		case 227: {
			return (struct str) {{0u, NULL}};
		}
		case 228: {
			return (struct str) {{23, constantarr_0_424}};
		}
		case 229: {
			return (struct str) {{0u, NULL}};
		}
		case 230: {
			return (struct str) {{36, constantarr_0_426}};
		}
		case 231: {
			return (struct str) {{11, constantarr_0_427}};
		}
		case 232: {
			return (struct str) {{36, constantarr_0_428}};
		}
		case 233: {
			return (struct str) {{28, constantarr_0_429}};
		}
		case 234: {
		...
		case 236: {
			return (struct str) {{18, constantarr_0_434}};
		}
		case 237: {
			return (struct str) {{0u, NULL}};
		}
		case 238: {
			return (struct str) {{31, constantarr_0_436}};
		}
		case 239: {
			return (struct str) {{31, constantarr_0_437}};
		}
		case 240: {
			return (struct str) {{23, constantarr_0_438}};
		}
		case 241: {
		...
		case 245: {
			return (struct str) {{15, constantarr_0_445}};
		}
		case 246: {
			return (struct str) {{10, constantarr_0_446}};
		}
		case 247: {
			return (struct str) {{13, constantarr_0_148}};
		}
		...
		case 249: {
			return (struct str) {{14, constantarr_0_449}};
		}
		case 250: {
			return (struct str) {{23, constantarr_0_256}};
		}
		case 251: {
			return (struct str) {{18, constantarr_0_450}};
		}
		case 252: {
			return (struct str) {{24, constantarr_0_451}};
		}
		case 253: {
			return (struct str) {{20, constantarr_0_452}};
		}
		case 254: {
			return (struct str) {{0u, NULL}};
		}
		...
		case 260: {
			return (struct str) {{27, constantarr_0_454}};
		}
		case 261: {
			return (struct str) {{6, constantarr_0_137}};
		}
		...
		case 263: {
			return (struct str) {{7, constantarr_0_456}};
		}
		case 264: {
			return (struct str) {{11, constantarr_0_457}};
		}
		case 265: {
			return (struct str) {{5, constantarr_0_306}};
		}
		...
		case 392: {
			return (struct str) {{13, constantarr_0_560}};
		}
		case 393: {
		...
		case 413: {
			return (struct str) {{7, constantarr_0_594}};
		}
		case 414: {
			return (struct str) {{12, constantarr_0_595}};
		}
		case 415: {
			return (struct str) {{3, constantarr_0_596}};
		}
		case 416: {
			return (struct str) {{15, constantarr_0_597}};
		}
		default:
