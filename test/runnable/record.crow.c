...
char constantarr_0_587[1];
char constantarr_0_588[1];
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	assert(ctx, (m0.x == 1u));
	assert(ctx, (m0.y == 2u));
	struct arr_0 _0 = to_str_4(ctx, m0.x);
	print(_0);
	struct arr_0 _1 = to_str_4(ctx, m0.y);
	print(_1);
