...
char constantarr_0_538[3] = "mod";
char constantarr_0_539[10] = "unsafe-mod";
char constantarr_0_540[13] = "resolved<nat>";
...
struct arr_0 get_fun_name_89(uint64_t fun_id) {switch (fun_id) {
		...
		case 390: {
			return (struct arr_0) {3, constantarr_0_538};
		}
		case 391: {
