...
char constantarr_0_589[7] = "to-base";
char constantarr_0_590[12] = "digit-to-str";
char constantarr_0_591[22] = "unreachable<arr<char>>";
char constantarr_0_592[8] = "fail<?a>";
...
struct arr_0 get_fun_name_92(uint64_t fun_id) {switch (fun_id) {
		...
		case 406: {
			return (struct arr_0) {7, constantarr_0_589};
		}
		case 407: {
			return (struct arr_0) {12, constantarr_0_590};
		}
		case 408: {
			return (struct arr_0) {22, constantarr_0_591};
		}
		case 409: {
			return (struct arr_0) {8, constantarr_0_592};
		}
		case 410: {
			return (struct arr_0) {9, constantarr_0_139};
		}
		...
		case 412: {
			return (struct arr_0) {3, constantarr_0_593};
		}
		case 413: {
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	struct arr_0 _2 = to_str_3(ctx, _1);
	print(_2);
