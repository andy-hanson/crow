...
char constantarr_0_582[7] = "to-base";
char constantarr_0_583[12] = "digit-to-str";
char constantarr_0_584[3] = "mod";
char constantarr_0_585[15] = "resolved<nat64>";
...
struct str get_fun_name_102(uint64_t fun_id) {switch (fun_id) {
		...
		case 400: {
			return (struct str) {{7, constantarr_0_582}};
		}
		case 401: {
			return (struct str) {{12, constantarr_0_583}};
		}
		case 402: {
			return (struct str) {{3, constantarr_0_584}};
		}
		case 403: {
