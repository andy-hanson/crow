...
char constantarr_0_591[7] = "to-base";
char constantarr_0_592[12] = "digit-to-str";
char constantarr_0_593[3] = "mod";
...
struct str get_fun_name_105(uint64_t fun_id) {switch (fun_id) {
		...
		case 413: {
			return (struct str) {{7, constantarr_0_591}};
		}
		case 414: {
			return (struct str) {{12, constantarr_0_592}};
		}
		case 415: {
			return (struct str) {{3, constantarr_0_593}};
		}
		case 416: {
