...
char constantarr_0_592[7] = "to-base";
char constantarr_0_593[12] = "digit-to-str";
char constantarr_0_594[3] = "mod";
char constantarr_0_595[15] = "resolved<nat64>";
char constantarr_0_596[11] = "static-syms";
...
struct str get_fun_name_106(uint64_t fun_id) {switch (fun_id) {
		...
		case 414: {
			return (struct str) {{7, constantarr_0_592}};
		}
		case 415: {
			return (struct str) {{12, constantarr_0_593}};
		}
		case 416: {
			return (struct str) {{3, constantarr_0_594}};
		}
		case 417: {
			return (struct str) {{15, constantarr_0_595}};
		}
		default:
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	uint64_t _0 = _plus(ctx, 2u, 3u);
	uint64_t _1 = _times(ctx, 1u, _0);
	struct str _2 = to_str_3(ctx, _1);
	print(_2);
	uint64_t _3 = _times(ctx, 2u, 3u);
	uint64_t _4 = _plus(ctx, 1u, _3);
	struct str _5 = to_str_3(ctx, _4);
	print(_5);
