...
char constantarr_0_358[13] = "subscript<?t>";
...
char constantarr_0_384[42] = "subscript<fut<int32>, ctx, arr<arr<char>>>";
...
char constantarr_0_527[1] = "*";
char constantarr_0_528[15] = "resolved<int32>";
...
uint64_t _op_times(struct ctx* ctx, uint64_t a, uint64_t b);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	uint64_t _0 = _op_plus_1(ctx, 2u, 3u);
	uint64_t _1 = _op_times(ctx, 1u, _0);
	struct arr_0 _2 = to_str_2(ctx, _1);
	print(_2);
	uint64_t _3 = _op_times(ctx, 2u, 3u);
	uint64_t _4 = _op_plus_1(ctx, 1u, _3);
