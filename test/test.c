...
struct fut_0* then2(struct ctx* ctx, struct fut_1* f, struct fun_ref0 cb) {
	...
	return then_0(ctx, f, (struct fun_ref1) {cur_island_and_exclusion(ctx), (struct fun_mut1_3) {0, .as0 = (temp0 = (struct then2__lambda0*) alloc(ctx, sizeof(struct then2__lambda0)), ((*(temp0) = (struct then2__lambda0) {cb}, (struct void_) {}), temp0))}});
}
...
struct fut_0* then_0(struct ctx* ctx, struct fut_1* f, struct fun_ref1 cb) {
	...
	then_void_0(ctx, f, (struct fun_mut1_2) {0, .as0 = (temp0 = (struct then_0__lambda0*) alloc(ctx, sizeof(struct then_0__lambda0)), ((*(temp0) = (struct then_0__lambda0) {cb, res0}, (struct void_) {}), temp0))});
	return res0;
}
...
struct arr_1 map_0(struct ctx* ctx, struct arr_3 a, struct fun_mut1_4 mapper) {
	...
	return make_arr_0(ctx, a.size, (struct fun_mut1_5) {0, .as0 = (temp0 = (struct map_0__lambda0*) alloc(ctx, sizeof(struct map_0__lambda0)), ((*(temp0) = (struct map_0__lambda0) {mapper, a}, (struct void_) {}), temp0))});
}
...
struct fut_0* add_first_task__lambda0(struct ctx* ctx, struct add_first_task__lambda0* _closure) {
	...
	return _closure->main_ptr(ctx, map_0(ctx, args0, (struct fun_mut1_4) {0, .as0 = (struct void_) {}}));
}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	struct opt_9 temp0;
	struct some_9 s1;
	options0 = parse_cmd_line_args(ctx, args, (struct arr_1) {3, constantarr_1_0}, (struct fun1) {0, .as0 = (struct void_) {}});
...
struct opt_9 parse_cmd_line_args(struct ctx* ctx, struct arr_1 args, struct arr_1 t_names, struct fun1 make_t) {
	...
	values1 = fill_mut_arr(ctx, t_names.size, (struct opt_10) {0, .as0 = (struct none) {}});
	help2 = (temp0 = (struct cell_2*) alloc(ctx, sizeof(struct cell_2)), ((*(temp0) = (struct cell_2) {0}, (struct void_) {}), temp0));
	each_0(ctx, parsed0->named, (struct fun_mut2_0) {0, .as0 = (temp1 = (struct parse_cmd_line_args__lambda0*) alloc(ctx, sizeof(struct parse_cmd_line_args__lambda0)), ((*(temp1) = (struct parse_cmd_line_args__lambda0) {t_names, help2, values1}, (struct void_) {}), temp1))});
	if (get_2(help2)) {
		return (struct opt_9) {0, .as0 = (struct none) {}};
	} else {
		return (struct opt_9) {1, .as1 = (struct some_9) {call_11(ctx, make_t, freeze_3(values1))}};
	}
}
...
struct parsed_cmd_line_args* parse_cmd_line_args_dynamic(struct ctx* ctx, struct arr_1 args) {
	...
	temp0 = find_index(ctx, args, (struct fun_mut1_6) {0, .as0 = (struct void_) {}});
	switch (temp0.kind) {
		case 0:
			temp1 = (struct parsed_cmd_line_args*) alloc(ctx, sizeof(struct parsed_cmd_line_args));
			(*(temp1) = (struct parsed_cmd_line_args) {args, empty_dict(ctx), empty_arr_1()}, (struct void_) {});
			return temp1;
		case 1:
			s0 = temp0.as1;
			...
			temp2 = find_index(ctx, rest3, (struct fun_mut1_6) {1, .as1 = (struct void_) {}});
			switch (temp2.kind) {
				case 0:
					temp3 = (struct parsed_cmd_line_args*) alloc(ctx, sizeof(struct parsed_cmd_line_args));
					(*(temp3) = (struct parsed_cmd_line_args) {nameless2, parse_named_args(ctx, rest3), empty_arr_1()}, (struct void_) {});
					return temp3;
				case 1:
					s24 = temp2.as1;
					...
					(*(temp4) = (struct parsed_cmd_line_args) {nameless2, named_args6, slice_after_0(ctx, rest3, sep_index5)}, (struct void_) {});
					return temp4;
				default:
					return (assert(0),NULL);
			}
...
uint8_t call_w_ctx_274(struct fun_mut1_6 a, struct ctx* ctx, struct arr_0 p0) {
	...
	struct void_ closure0;
	struct void_ closure1;
	struct void_ closure2;
	struct index_of__lambda0* closure3;
	struct void_ closure4;
	struct excluded_from_lint__q__lambda0* closure5;
	struct void_ closure6;
	match_fun7 = a;
...
struct dict_0* empty_dict(struct ctx* ctx) {
	...
	(*(temp0) = (struct dict_0) {empty_arr_1(), empty_arr_2()}, (struct void_) {});
	return temp0;
}
...
struct comparison compare_293(struct arr_0 a, struct arr_0 b) {
	...
	if ((a.size == 0u)) {
		...
		if ((b.size == 0u)) {
			...
			temp0 = compare_20((*(a.data)), (*(b.data)));
			switch (temp0.kind) {
				case 0:
					return (struct comparison) {0, .as0 = (struct less) {}};
				case 1:
...
struct mut_arr_1* new_mut_arr_0(struct ctx* ctx) {
	struct mut_arr_1* temp0;
	temp0 = (struct mut_arr_1*) alloc(ctx, sizeof(struct mut_arr_1));
	(*(temp0) = (struct mut_arr_1) {0, 0u, 0u, NULL}, (struct void_) {});
	return temp0;
}
...
struct mut_arr_2* new_mut_arr_1(struct ctx* ctx) {
	...
	(*(temp0) = (struct mut_arr_2) {0, 0u, 0u, NULL}, (struct void_) {});
	return temp0;
}
...
struct void_ parse_named_args_recur(struct ctx* ctx, struct arr_1 args, struct mut_dict_0 builder) {
	...
	tl1 = tail_2(ctx, args);
	temp0 = find_index(ctx, tl1, (struct fun_mut1_6) {2, .as2 = (struct void_) {}});
	switch (temp0.kind) {
		case 0:
...
struct dict_0* unsafe_as_dict_0(struct ctx* ctx, struct mut_dict_0 m) {
	struct dict_0* temp0;
	temp0 = (struct dict_0*) alloc(ctx, sizeof(struct dict_0));
	(*(temp0) = (struct dict_0) {unsafe_as_arr_0(m.keys), unsafe_as_arr_1(m.values)}, (struct void_) {});
	return temp0;
}
...
struct void_ push_0(struct ctx* ctx, struct mut_arr_1* a, struct arr_0 value) {
	...
	(*((a->data + a->size)) = value, (struct void_) {});
	return (a->size = incr_3(ctx, a->size), (struct void_) {});
}
...
struct void_ increase_capacity_to_0(struct ctx* ctx, struct mut_arr_1* a, uint64_t new_capacity) {
	...
	old_data0 = a->data;
	(a->capacity = new_capacity, (struct void_) {});
	(a->data = uninitialized_data_0(ctx, new_capacity), (struct void_) {});
...
struct void_ increase_capacity_to_1(struct ctx* ctx, struct mut_arr_2* a, uint64_t new_capacity) {
	...
	old_data0 = a->data;
	(a->capacity = new_capacity, (struct void_) {});
	(a->data = uninitialized_data_1(ctx, new_capacity), (struct void_) {});
...
struct dict_0* freeze_1(struct ctx* ctx, struct mut_dict_0 m) {
	struct dict_0* temp0;
	temp0 = (struct dict_0*) alloc(ctx, sizeof(struct dict_0));
	(*(temp0) = (struct dict_0) {freeze_0(m.keys), freeze_2(m.values)}, (struct void_) {});
	return temp0;
}
...
struct mut_arr_3* fill_mut_arr(struct ctx* ctx, uint64_t size, struct opt_10 value) {
	...
	return make_mut_arr_1(ctx, size, (struct fun_mut1_7) {0, .as0 = (temp0 = (struct fill_mut_arr__lambda0*) alloc(ctx, sizeof(struct fill_mut_arr__lambda0)), ((*(temp0) = (struct fill_mut_arr__lambda0) {value}, (struct void_) {}), temp0))});
}
...
struct mut_arr_3* new_uninitialized_mut_arr_1(struct ctx* ctx, uint64_t size) {
	...
	(*(temp0) = (struct mut_arr_3) {0, size, size, uninitialized_data_2(ctx, size)}, (struct void_) {});
	return temp0;
}
...
struct void_ each_0(struct ctx* ctx, struct dict_0* d, struct fun_mut2_0 f) {
	...
	if (!empty__q_8(ctx, d)) {
		...
		_tailCalld = (temp0 = (struct dict_0*) alloc(ctx, sizeof(struct dict_0)), ((*(temp0) = (struct dict_0) {tail_2(ctx, d->keys), tail_3(ctx, d->values)}, (struct void_) {}), temp0));
		_tailCallf = f;
		d = _tailCalld;
		f = _tailCallf;
		goto top;
...
struct void_ call_10(struct ctx* ctx, struct fun_mut2_0 a, struct arr_0 p0, struct arr_1 p1) {
	return call_w_ctx_356(a, ctx, p0, p1);
}
...
struct opt_11 index_of(struct ctx* ctx, struct arr_1 a, struct arr_0 value) {
	...
	return find_index(ctx, a, (struct fun_mut1_6) {3, .as3 = (temp0 = (struct index_of__lambda0*) alloc(ctx, sizeof(struct index_of__lambda0)), ((*(temp0) = (struct index_of__lambda0) {value}, (struct void_) {}), temp0))});
}
...
struct arr_0 _op_plus_1(struct ctx* ctx, struct arr_0 a, struct arr_0 b) {
	...
	res1 = uninitialized_data_3(ctx, res_size0);
	copy_data_from_2(ctx, res1, a.data, a.size);
	copy_data_from_2(ctx, (res1 + a.size), b.data, b.size);
...
struct void_ copy_data_from_small_2(struct ctx* ctx, char* to, char* from, uint64_t len) {
	if (_op_bang_equal_1(len, 0u)) {
		(*(to) = (*(from)), (struct void_) {});
		return copy_data_from_2(ctx, incr_1(to), incr_1(from), decr(ctx, len));
	} else {
		return (struct void_) {};
	}
}
...
struct test_options call_11(struct ctx* ctx, struct fun1 a, struct arr_5 p0) {
	return call_w_ctx_374(a, ctx, p0);
}
...
int32_t do_test(struct ctx* ctx, struct test_options options) {
	...
	noze_failures4 = first_failures(ctx, run_noze_tests(ctx, child_path(ctx, test_path0, (struct arr_0) {12, constantarr_0_74}), noze_exe2, env3, options), (struct fun0) {1, .as1 = (temp0 = (struct do_test__lambda0*) alloc(ctx, sizeof(struct do_test__lambda0)), ((*(temp0) = (struct do_test__lambda0) {test_path0, noze_exe2, env3, options}, (struct void_) {}), temp0))});
	all_failures5 = first_failures(ctx, noze_failures4, (struct fun0) {2, .as2 = (temp1 = (struct do_test__lambda1*) alloc(ctx, sizeof(struct do_test__lambda1)), ((*(temp1) = (struct do_test__lambda1) {noze_path1, options}, (struct void_) {}), temp1))});
...
struct opt_11 r_index_of(struct ctx* ctx, struct arr_0 a, char value) {
	...
	return find_rindex(ctx, a, (struct fun_mut1_8) {0, .as0 = (temp0 = (struct r_index_of__lambda0*) alloc(ctx, sizeof(struct r_index_of__lambda0)), ((*(temp0) = (struct r_index_of__lambda0) {value}, (struct void_) {}), temp0))});
}
...
struct opt_11 find_rindex_recur(struct ctx* ctx, struct arr_0 a, uint64_t index, struct fun_mut1_8 pred) {
	struct arr_0 _tailCalla;
	uint64_t _tailCallindex;
	struct fun_mut1_8 _tailCallpred;
	top:
	if (call_12(ctx, pred, at_3(ctx, a, index))) {
		return (struct opt_11) {1, .as1 = (struct some_11) {index}};
	} else {
...
struct arr_0 read_link(struct ctx* ctx, struct arr_0 path) {
	...
	return slice_up_to_1(ctx, freeze_4(buff0), to_nat_0(ctx, size1));
}
...
struct mut_arr_4* new_uninitialized_mut_arr_2(struct ctx* ctx, uint64_t size) {
	...
	(*(temp0) = (struct mut_arr_4) {0, size, size, uninitialized_data_3(ctx, size)}, (struct void_) {});
	return temp0;
}
...
struct dict_1* unsafe_as_dict_1(struct ctx* ctx, struct mut_dict_1 m) {
	...
	(*(temp0) = (struct dict_1) {unsafe_as_arr_0(m.keys), unsafe_as_arr_0(m.values)}, (struct void_) {});
	return temp0;
}
...
struct key_value_pair* parse_environ_entry(struct ctx* ctx, char* entry) {
	...
	(*(temp0) = (struct key_value_pair) {key1, value4}, (struct void_) {});
	return temp0;
}
...
struct dict_1* freeze_5(struct ctx* ctx, struct mut_dict_1 m) {
	struct dict_1* temp0;
	temp0 = (struct dict_1*) alloc(ctx, sizeof(struct dict_1));
	(*(temp0) = (struct dict_1) {freeze_0(m.keys), freeze_0(m.values)}, (struct void_) {});
	return temp0;
}
...
struct result_3 first_failures(struct ctx* ctx, struct result_3 a, struct fun0 b) {
	...
	return then_1(ctx, a, (struct fun_mut1_9) {1, .as1 = (temp0 = (struct first_failures__lambda0*) alloc(ctx, sizeof(struct first_failures__lambda0)), ((*(temp0) = (struct first_failures__lambda0) {b}, (struct void_) {}), temp0))});
}
...
struct result_3 first_failures__lambda0(struct ctx* ctx, struct first_failures__lambda0* _closure, struct arr_0 a_descr) {
	...
	return then_1(ctx, call_14(ctx, _closure->b), (struct fun_mut1_9) {0, .as0 = (temp0 = (struct first_failures__lambda0__lambda0*) alloc(ctx, sizeof(struct first_failures__lambda0__lambda0)), ((*(temp0) = (struct first_failures__lambda0__lambda0) {a_descr}, (struct void_) {}), temp0))});
}
...
struct result_3 run_noze_tests(struct ctx* ctx, struct arr_0 path, struct arr_0 path_to_noze, struct dict_1* env, struct test_options options) {
	...
	failures1 = flat_map_with_max_size(ctx, tests0, options.max_failures, (struct fun_mut1_11) {0, .as0 = (temp0 = (struct run_noze_tests__lambda0*) alloc(ctx, sizeof(struct run_noze_tests__lambda0)), ((*(temp0) = (struct run_noze_tests__lambda0) {path_to_noze, env, options}, (struct void_) {}), temp0))});
...
struct arr_1 list_tests(struct ctx* ctx, struct arr_0 path) {
	...
	filter1 = (struct fun_mut1_6) {4, .as4 = (struct void_) {}};
	each_child_recursive(ctx, path, filter1, (struct fun_mut1_10) {1, .as1 = (temp0 = (struct list_tests__lambda1*) alloc(ctx, sizeof(struct list_tests__lambda1)), ((*(temp0) = (struct list_tests__lambda1) {res0}, (struct void_) {}), temp0))});
...
struct void_ each_child_recursive(struct ctx* ctx, struct arr_0 path, struct fun_mut1_6 filter, struct fun_mut1_10 f) {
	...
	if (is_dir__q_0(ctx, path)) {
		return each_1(ctx, read_dir_0(ctx, path), (struct fun_mut1_10) {0, .as0 = (temp0 = (struct each_child_recursive__lambda0*) alloc(ctx, sizeof(struct each_child_recursive__lambda0)), ((*(temp0) = (struct each_child_recursive__lambda0) {filter, path, f}, (struct void_) {}), temp0))});
	} else {
...
struct stat_t* empty_stat(struct ctx* ctx) {
	...
	(*(temp0) = (struct stat_t) {0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u}, (struct void_) {});
	return temp0;
}
/* enoent int32() */
int32_t enoent(void) {
...
struct void_ each_1(struct ctx* ctx, struct arr_1 a, struct fun_mut1_10 f) {
	struct arr_1 _tailCalla;
	struct fun_mut1_10 _tailCallf;
	top:
	if (!empty__q_6(a)) {
		call_15(ctx, f, first_1(ctx, a));
...
struct void_ call_15(struct ctx* ctx, struct fun_mut1_10 a, struct arr_0 p0) {
	return call_w_ctx_459(a, ctx, p0);
}
/* call-w-ctx<void, arr<char>> (generated) (generated) */
struct void_ call_w_ctx_459(struct fun_mut1_10 a, struct ctx* ctx, struct arr_0 p0) {
	struct fun_mut1_10 match_fun4;
...
struct void_ read_dir_recur(struct ctx* ctx, uint8_t* dirp, struct mut_arr_1* res) {
	...
	top:
	entry0 = (temp0 = (struct dirent*) alloc(ctx, sizeof(struct dirent)), ((*(temp0) = (struct dirent) {0u, 0, 0u, 0u, zero_4()}, (struct void_) {}), temp0));
	result1 = (temp1 = (struct cell_3*) alloc(ctx, sizeof(struct cell_3)), ((*(temp1) = (struct cell_3) {entry0}, (struct void_) {}), temp1));
...
struct mut_arr_1* to_mut_arr(struct ctx* ctx, struct arr_1 a) {
	...
	return make_mut_arr_0(ctx, a.size, (struct fun_mut1_5) {1, .as1 = (temp0 = (struct to_mut_arr__lambda0*) alloc(ctx, sizeof(struct to_mut_arr__lambda0)), ((*(temp0) = (struct to_mut_arr__lambda0) {a}, (struct void_) {}), temp0))});
}
...
struct void_ swap_0(struct ctx* ctx, struct mut_slice* a, uint64_t lo, uint64_t hi) {
	...
	set_at_2(ctx, a, lo, at_7(ctx, a, hi));
	return set_at_2(ctx, a, hi, old_lo0);
}
...
struct mut_slice* slice_4(struct ctx* ctx, struct mut_slice* a, uint64_t lo, uint64_t size) {
	...
	(*(temp0) = (struct mut_slice) {a->backing, size, _op_plus_0(ctx, a->begin, lo)}, (struct void_) {});
	return temp0;
}
...
struct mut_slice* to_mut_slice(struct ctx* ctx, struct mut_arr_1* a) {
	...
	temp0 = (struct mut_slice*) alloc(ctx, sizeof(struct mut_slice));
	(*(temp0) = (struct mut_slice) {a, a->size, 0u}, (struct void_) {});
	return temp0;
}
...
struct arr_7 flat_map_with_max_size(struct ctx* ctx, struct arr_1 a, uint64_t max_size, struct fun_mut1_11 mapper) {
	...
	each_1(ctx, a, (struct fun_mut1_10) {2, .as2 = (temp0 = (struct flat_map_with_max_size__lambda0*) alloc(ctx, sizeof(struct flat_map_with_max_size__lambda0)), ((*(temp0) = (struct flat_map_with_max_size__lambda0) {res0, max_size, mapper}, (struct void_) {}), temp0))});
...
struct mut_arr_5* new_mut_arr_2(struct ctx* ctx) {
	...
	(*(temp0) = (struct mut_arr_5) {0, 0u, 0u, NULL}, (struct void_) {});
	return temp0;
}
/* push-all<?out> void(a mut-arr<failure>, values arr<failure>) */
struct void_ push_all(struct ctx* ctx, struct mut_arr_5* a, struct arr_7 values) {
	struct push_all__lambda0* temp0;
	return each_2(ctx, values, (struct fun_mut1_12) {0, .as0 = (temp0 = (struct push_all__lambda0*) alloc(ctx, sizeof(struct push_all__lambda0)), ((*(temp0) = (struct push_all__lambda0) {a}, (struct void_) {}), temp0))});
}
/* each<?t> void(a arr<failure>, f fun-mut1<void, failure>) */
struct void_ each_2(struct ctx* ctx, struct arr_7 a, struct fun_mut1_12 f) {
	struct arr_7 _tailCalla;
	struct fun_mut1_12 _tailCallf;
	top:
	if (!empty__q_11(a)) {
		call_16(ctx, f, first_3(ctx, a));
...
struct void_ increase_capacity_to_2(struct ctx* ctx, struct mut_arr_5* a, uint64_t new_capacity) {
	...
	old_data0 = a->data;
	(a->capacity = new_capacity, (struct void_) {});
	(a->data = uninitialized_data_4(ctx, new_capacity), (struct void_) {});
...
struct void_ copy_data_from_small_3(struct ctx* ctx, struct failure** to, struct failure** from, uint64_t len) {
	if (_op_bang_equal_1(len, 0u)) {
		(*(to) = (*(from)), (struct void_) {});
		return copy_data_from_3(ctx, incr_7(to), incr_7(from), decr(ctx, len));
	} else {
		return (struct void_) {};
	}
}
...
struct void_ flat_map_with_max_size__lambda0(struct ctx* ctx, struct flat_map_with_max_size__lambda0* _closure, struct arr_0 x) {
	if (_op_less_0(_closure->res->size, _closure->max_size)) {
		push_all(ctx, _closure->res, call_17(ctx, _closure->mapper, x));
...
struct arr_7 run_single_noze_test(struct ctx* ctx, struct arr_0 path_to_noze, struct dict_1* env, struct arr_0 path, struct test_options options) {
	...
	struct some_14 s2;
	op0 = first_some(ctx, (struct arr_1) {4, constantarr_1_1}, (struct fun_mut1_13) {0, .as0 = (temp0 = (struct run_single_noze_test__lambda0*) alloc(ctx, sizeof(struct run_single_noze_test__lambda0)), ((*(temp0) = (struct run_single_noze_test__lambda0) {options, path, path_to_noze, env}, (struct void_) {}), temp0))});
	temp1 = op0;
	switch (temp1.kind) {
		case 0:
...
struct opt_14 first_some(struct ctx* ctx, struct arr_1 a, struct fun_mut1_13 cb) {
	...
	struct some_14 s0;
	struct arr_1 _tailCalla;
	struct fun_mut1_13 _tailCallcb;
	top:
	if (empty__q_6(a)) {
		return (struct opt_14) {0, .as0 = (struct none) {}};
	} else {
		temp0 = call_18(ctx, cb, first_1(ctx, a));
		switch (temp0.kind) {
			case 0:
				_tailCalla = tail_2(ctx, a);
				_tailCallcb = cb;
...
struct print_test_result* run_print_test(struct ctx* ctx, struct arr_0 print_kind, struct arr_0 path_to_noze, struct dict_1* env, struct arr_0 path, uint8_t overwrite_output__q) {
	...
	res0 = spawn_and_wait_result_0(ctx, path_to_noze, (temp0 = (struct arr_0*) alloc(ctx, (sizeof(struct arr_0) * 3u)), ((*((temp0 + 0u)) = (struct arr_0) {5, constantarr_0_54}, (struct void_) {}), ((*((temp0 + 1u)) = print_kind, (struct void_) {}), ((*((temp0 + 2u)) = path, (struct void_) {}), (struct arr_1) {3u, temp0})))), env);
	...
	if (!empty__q_11(output_failures2)) {
		...
		(*(temp1) = (struct print_test_result) {1, output_failures2}, (struct void_) {});
		return temp1;
	} else {
		if (_op_equal_equal_3(res0->exit_code, 0)) {
			...
			(*(temp2) = (struct print_test_result) {0, empty_arr_3()}, (struct void_) {});
			return temp2;
		} else {
			if (_op_equal_equal_3(res0->exit_code, 1)) {
				...
				(*(temp3) = (struct print_test_result) {1, handle_output(ctx, path, _op_plus_1(ctx, output_path1, (struct arr_0) {4, constantarr_0_63}), stderr_no_color3, overwrite_output__q)}, (struct void_) {});
				return temp3;
			} else {
				...
				(*(temp6) = (struct print_test_result) {1, (temp4 = (struct failure**) alloc(ctx, (sizeof(struct failure*) * 1u)), ((*((temp4 + 0u)) = (temp5 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp5) = (struct failure) {path, message4}, (struct void_) {}), temp5)), (struct void_) {}), (struct arr_7) {1u, temp4}))}, (struct void_) {});
				return temp6;
			}
		}
	}
...
struct process_result* spawn_and_wait_result_0(struct ctx* ctx, struct arr_0 exe, struct arr_1 args, struct dict_1* environ) {
	char* exe_c_str0;
	print(fold(ctx, _op_plus_1(ctx, (struct arr_0) {23, constantarr_0_38}, exe), args, (struct fun_mut2_1) {0, .as0 = (struct void_) {}}));
...
struct arr_0 fold(struct ctx* ctx, struct arr_0 val, struct arr_1 a, struct fun_mut2_1 combine) {
	...
	if (empty__q_6(a)) {
		...
		_tailCallval = call_19(ctx, combine, val, first_1(ctx, a));
		_tailCalla = tail_2(ctx, a);
...
struct arr_0 call_19(struct ctx* ctx, struct fun_mut2_1 a, struct arr_0 p0, struct arr_0 p1) {
	return call_w_ctx_528(a, ctx, p0, p1);
}
...
struct process_result* spawn_and_wait_result_1(struct ctx* ctx, char* exe, char** args, char** environ) {
	...
	actions2 = (temp0 = (struct posix_spawn_file_actions_t*) alloc(ctx, sizeof(struct posix_spawn_file_actions_t)), ((*(temp0) = (struct posix_spawn_file_actions_t) {0, 0, NULL, zero_0()}, (struct void_) {}), temp0));
	...
	pid_cell3 = (temp1 = (struct cell_4*) alloc(ctx, sizeof(struct cell_4)), ((*(temp1) = (struct cell_4) {0}, (struct void_) {}), temp1));
	...
	(*(temp2) = (struct process_result) {exit_code7, freeze_4(stdout_builder5), freeze_4(stderr_builder6)}, (struct void_) {});
	return temp2;
}
/* make-pipes pipes() */
struct pipes* make_pipes(struct ctx* ctx) {
	struct pipes* res0;
	struct pipes* temp0;
	res0 = (temp0 = (struct pipes*) alloc(ctx, sizeof(struct pipes)), ((*(temp0) = (struct pipes) {0, 0}, (struct void_) {}), temp0));
...
struct mut_arr_4* new_mut_arr_3(struct ctx* ctx) {
	struct mut_arr_4* temp0;
	temp0 = (struct mut_arr_4*) alloc(ctx, sizeof(struct mut_arr_4));
	(*(temp0) = (struct mut_arr_4) {0, 0u, 0u, NULL}, (struct void_) {});
	return temp0;
}
...
struct void_ keep_polling(struct ctx* ctx, int32_t stdout_pipe, int32_t stderr_pipe, struct mut_arr_4* stdout_builder, struct mut_arr_4* stderr_builder) {
	...
	top:
	poll_fds0 = (temp0 = (struct pollfd*) alloc(ctx, (sizeof(struct pollfd) * 2u)), ((*((temp0 + 0u)) = (struct pollfd) {stdout_pipe, pollin(ctx), 0}, (struct void_) {}), ((*((temp0 + 1u)) = (struct pollfd) {stderr_pipe, pollin(ctx), 0}, (struct void_) {}), (struct arr_8) {2u, temp0})));
	...
	if (_op_equal_equal_3(n_pollfds_with_events3, 0)) {
		...
		assert_0(ctx, _op_equal_equal_0(_op_plus_0(ctx, to_nat_1(any__q(ctx, a4)), to_nat_1(any__q(ctx, b5))), to_nat_2(ctx, n_pollfds_with_events3)));
...
struct void_ increase_capacity_to_3(struct ctx* ctx, struct mut_arr_4* a, uint64_t new_capacity) {
	...
	old_data0 = a->data;
	(a->capacity = new_capacity, (struct void_) {});
	(a->data = uninitialized_data_3(ctx, new_capacity), (struct void_) {});
...
int32_t wait_and_get_exit_code(struct ctx* ctx, int32_t pid) {
	...
	int32_t signal3;
	wait_status_cell0 = (temp0 = (struct cell_4*) alloc(ctx, sizeof(struct cell_4)), ((*(temp0) = (struct cell_4) {0}, (struct void_) {}), temp0));
...
char** convert_args(struct ctx* ctx, char* exe_c_str, struct arr_1 args) {
	return prepend(ctx, exe_c_str, append(ctx, map_1(ctx, args, (struct fun_mut1_14) {0, .as0 = (struct void_) {}}), NULL)).data;
}
/* prepend<ptr<char>> arr<ptr<char>>(a ptr<char>, b arr<ptr<char>>) */
struct arr_3 prepend(struct ctx* ctx, char* a, struct arr_3 b) {
	char** temp0;
	return _op_plus_2(ctx, (temp0 = (char**) alloc(ctx, (sizeof(char*) * 1u)), ((*((temp0 + 0u)) = a, (struct void_) {}), (struct arr_3) {1u, temp0})), b);
}
...
struct arr_3 _op_plus_2(struct ctx* ctx, struct arr_3 a, struct arr_3 b) {
	...
	return (struct arr_3) {res_size0, res1};
}
...
struct arr_3 append(struct ctx* ctx, struct arr_3 a, char* b) {
	char** temp0;
	return _op_plus_2(ctx, a, (temp0 = (char**) alloc(ctx, (sizeof(char*) * 1u)), ((*((temp0 + 0u)) = b, (struct void_) {}), (struct arr_3) {1u, temp0})));
}
/* map<ptr<char>, arr<char>> arr<ptr<char>>(a arr<arr<char>>, mapper fun-mut1<ptr<char>, arr<char>>) */
struct arr_3 map_1(struct ctx* ctx, struct arr_1 a, struct fun_mut1_14 mapper) {
	struct map_1__lambda0* temp0;
	return make_arr_1(ctx, a.size, (struct fun_mut1_15) {0, .as0 = (temp0 = (struct map_1__lambda0*) alloc(ctx, sizeof(struct map_1__lambda0)), ((*(temp0) = (struct map_1__lambda0) {mapper, a}, (struct void_) {}), temp0))});
}
/* make-arr<?out> arr<ptr<char>>(size nat, f fun-mut1<ptr<char>, nat>) */
struct arr_3 make_arr_1(struct ctx* ctx, uint64_t size, struct fun_mut1_15 f) {
	return freeze_7(make_mut_arr_2(ctx, size, f));
}
...
struct mut_arr_6* new_uninitialized_mut_arr_3(struct ctx* ctx, uint64_t size) {
	...
	(*(temp0) = (struct mut_arr_6) {0, size, size, uninitialized_data_5(ctx, size)}, (struct void_) {});
	return temp0;
}
...
struct void_ make_mut_arr_worker_2(struct ctx* ctx, struct mut_arr_6* m, uint64_t i, struct fun_mut1_15 f) {
	...
	top:
	if (_op_bang_equal_1(i, m->size)) {
		set_at_3(ctx, m, i, call_20(ctx, f, i));
		_tailCallm = m;
		_tailCalli = incr_3(ctx, i);
		_tailCallf = f;
		m = _tailCallm;
...
char* call_w_ctx_607(struct fun_mut1_15 a, struct ctx* ctx, uint64_t p0) {
	struct fun_mut1_15 match_fun1;
	struct map_1__lambda0* closure0;
	match_fun1 = a;
	switch (match_fun1.kind) {
		case 0:
			closure0 = match_fun1.as0;
...
char* map_1__lambda0(struct ctx* ctx, struct map_1__lambda0* _closure, uint64_t i) {
	return call_21(ctx, _closure->mapper, at_2(ctx, _closure->a, i));
}
...
char** convert_environ(struct ctx* ctx, struct dict_1* environ) {
	...
	each_3(ctx, environ, (struct fun_mut2_2) {0, .as0 = (temp0 = (struct convert_environ__lambda0*) alloc(ctx, sizeof(struct convert_environ__lambda0)), ((*(temp0) = (struct convert_environ__lambda0) {res0}, (struct void_) {}), temp0))});
...
struct mut_arr_6* new_mut_arr_4(struct ctx* ctx) {
	struct mut_arr_6* temp0;
	temp0 = (struct mut_arr_6*) alloc(ctx, sizeof(struct mut_arr_6));
	(*(temp0) = (struct mut_arr_6) {0, 0u, 0u, NULL}, (struct void_) {});
	return temp0;
}
...
struct void_ each_3(struct ctx* ctx, struct dict_1* d, struct fun_mut2_2 f) {
	...
	if (!empty__q_12(ctx, d)) {
		call_22(ctx, f, first_1(ctx, d->keys), first_1(ctx, d->values));
		_tailCalld = (temp0 = (struct dict_1*) alloc(ctx, sizeof(struct dict_1)), ((*(temp0) = (struct dict_1) {tail_2(ctx, d->keys), tail_2(ctx, d->values)}, (struct void_) {}), temp0));
		_tailCallf = f;
		d = _tailCalld;
		f = _tailCallf;
		goto top;
...
struct void_ call_22(struct ctx* ctx, struct fun_mut2_2 a, struct arr_0 p0, struct arr_0 p1) {
	return call_w_ctx_617(a, ctx, p0, p1);
}
...
struct void_ increase_capacity_to_4(struct ctx* ctx, struct mut_arr_6* a, uint64_t new_capacity) {
	...
	old_data0 = a->data;
	(a->capacity = new_capacity, (struct void_) {});
	(a->data = uninitialized_data_5(ctx, new_capacity), (struct void_) {});
	...
	switch (temp0.kind) {
		case 0:
			if (overwrite_output__q) {
				...
				(*((temp1 + 0u)) = (temp2 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp2) = (struct failure) {original_path, _op_plus_1(ctx, _op_plus_1(ctx, base_name(ctx, output_path), (struct arr_0) {29, constantarr_0_61}), actual)}, (struct void_) {}), temp2)), (struct void_) {});
		...
		case 1:
			...
			if (_op_equal_equal_4(s0.value, actual)) {
				...
				if (overwrite_output__q) {
					...
					(*((temp3 + 0u)) = (temp4 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp4) = (struct failure) {original_path, message1}, (struct void_) {}), temp4)), (struct void_) {});
...
struct opt_12 try_read_file_1(struct ctx* ctx, char* path) {
	...
	if (is_file__q_1(ctx, path)) {
		...
		if (_op_equal_equal_3(fd0, -1)) {
			...
			return (struct opt_12) {1, .as1 = (struct some_12) {freeze_4(res4)}};
		}
	} else {
		return (struct opt_12) {0, .as0 = (struct none) {}};
	}
...
struct void_ write_file_1(struct ctx* ctx, char* path, struct arr_0 content) {
	...
	if (_op_equal_equal_3(fd4, -1)) {
		...
		if (_op_bang_equal_0(wrote_bytes5, to_int(ctx, content.size))) {
...
struct arr_7 run_single_runnable_test(struct ctx* ctx, struct arr_0 path_to_noze, struct dict_1* env, struct arr_0 path, uint8_t interpret__q, uint8_t overwrite_output__q) {
	...
	struct failure** temp2;
	struct failure* temp3;
	args0 = (interpret__q ? (temp0 = (struct arr_0*) alloc(ctx, (sizeof(struct arr_0) * 3u)), ((*((temp0 + 0u)) = (struct arr_0) {3, constantarr_0_66}, (struct void_) {}), ((*((temp0 + 1u)) = path, (struct void_) {}), ((*((temp0 + 2u)) = (struct arr_0) {11, constantarr_0_67}, (struct void_) {}), (struct arr_1) {3u, temp0})))) : (temp1 = (struct arr_0*) alloc(ctx, (sizeof(struct arr_0) * 2u)), ((*((temp1 + 0u)) = (struct arr_0) {3, constantarr_0_66}, (struct void_) {}), ((*((temp1 + 1u)) = path, (struct void_) {}), (struct arr_1) {2u, temp1}))));
	...
	if ((_op_equal_equal_3(res1->exit_code, 0) && _op_equal_equal_4(res1->stderr, (struct arr_0) {0u, NULL}))) {
		...
		(*((temp2 + 0u)) = (temp3 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp3) = (struct failure) {path, message2}, (struct void_) {}), temp3)), (struct void_) {});
...
struct result_3 lint(struct ctx* ctx, struct arr_0 path, struct test_options options) {
	...
	failures1 = flat_map_with_max_size(ctx, files0, options.max_failures, (struct fun_mut1_11) {1, .as1 = (temp0 = (struct lint__lambda0*) alloc(ctx, sizeof(struct lint__lambda0)), ((*(temp0) = (struct lint__lambda0) {options}, (struct void_) {}), temp0))});
	if (has__q_6(failures1)) {
		return (struct result_3) {1, .as1 = (struct err_2) {failures1}};
	} else {
...
struct arr_7 lint_file(struct ctx* ctx, struct arr_0 path) {
	...
	each_with_index_0(ctx, lines(ctx, text0), (struct fun_mut2_3) {0, .as0 = (temp0 = (struct lint_file__lambda0*) alloc(ctx, sizeof(struct lint_file__lambda0)), ((*(temp0) = (struct lint_file__lambda0) {err_file__q2, res1, path}, (struct void_) {}), temp0))});
...
struct void_ each_with_index_recur_0(struct ctx* ctx, struct arr_1 a, struct fun_mut2_3 f, uint64_t n) {
	...
	uint64_t _tailCalln;
	top:
	if (_op_bang_equal_1(n, a.size)) {
		call_23(ctx, f, at_2(ctx, a, n), n);
		_tailCalla = a;
		_tailCallf = f;
...
struct void_ call_23(struct ctx* ctx, struct fun_mut2_3 a, struct arr_0 p0, uint64_t p1) {
	return call_w_ctx_673(a, ctx, p0, p1);
}
...
struct arr_1 lines(struct ctx* ctx, struct arr_0 s) {
	...
	res0 = new_mut_arr_0(ctx);
	last_nl1 = (temp0 = (struct cell_0*) alloc(ctx, sizeof(struct cell_0)), ((*(temp0) = (struct cell_0) {0u}, (struct void_) {}), temp0));
	each_with_index_1(ctx, s, (struct fun_mut2_4) {0, .as0 = (temp1 = (struct lines__lambda0*) alloc(ctx, sizeof(struct lines__lambda0)), ((*(temp1) = (struct lines__lambda0) {res0, s, last_nl1}, (struct void_) {}), temp1))});
...
struct void_ lint_file__lambda0(struct ctx* ctx, struct lint_file__lambda0* _closure, struct arr_0 line, uint64_t line_num) {
	...
	if ((!_closure->err_file__q && contains_subsequence__q(ctx, lstrip(ctx, line), (struct arr_0) {2, constantarr_0_93}))) {
		...
		push_2(ctx, _closure->res, (temp0 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp0) = (struct failure) {_closure->path, message1}, (struct void_) {}), temp0)));
	} else {
		(struct void_) {};
	}
	...
	if (_op_greater(width2, max_line_length(ctx))) {
		...
		return push_2(ctx, _closure->res, (temp1 = (struct failure*) alloc(ctx, sizeof(struct failure)), ((*(temp1) = (struct failure) {_closure->path, message3}, (struct void_) {}), temp1)));
	} else {
		return (struct void_) {};
	}
}
...
int32_t print_failures(struct ctx* ctx, struct result_3 failures, struct test_options options) {
	...
	switch (temp0.kind) {
		...
		case 1:
			e1 = temp0.as1;
			each_2(ctx, e1.value, (struct fun_mut1_12) {1, .as1 = (struct void_) {}});
