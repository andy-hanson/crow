...
struct comparison compare_39(int64_t a, int64_t b);
uint8_t todo_1();
int32_t stderr_fd();
int32_t two_0();
...
struct comparison compare_74(int32_t a, int32_t b);
...
struct comparison compare_269(struct arr_0 a, struct arr_0 b);
...
uint8_t then_void_0(struct ctx* ctx, struct fut_1* f, struct fun_mut1_2 cb) {
	...
	switch (_matched3.kind) {
		case 0:
			cbs0 = _matched3.as0;
			(f->state = (struct fut_state_1) {0, .as0 = (struct fut_state_callbacks_1) {(struct opt_3) {1, .as1 = some_0((temp0 = (struct fut_callback_node_1*) alloc(ctx, sizeof(struct fut_callback_node_1)), ((*(temp0) = (struct fut_callback_node_1) {cb, cbs0.head}, 0), temp0)))}}}, 0);
			break;
		case 1:
			r1 = _matched3.as1;
...
uint8_t then_void_1(struct ctx* ctx, struct fut_0* f, struct fun_mut1_0 cb) {
	...
	switch (_matched3.kind) {
		case 0:
			cbs0 = _matched3.as0;
			(f->state = (struct fut_state_0) {0, .as0 = (struct fut_state_callbacks_0) {(struct opt_0) {1, .as1 = some_1((temp0 = (struct fut_callback_node_0*) alloc(ctx, sizeof(struct fut_callback_node_0)), ((*(temp0) = (struct fut_callback_node_0) {cb, cbs0.head}, 0), temp0)))}}}, 0);
			break;
		case 1:
			r1 = _matched3.as1;
...
struct opt_5 choose_task_recur(struct arr_2 vats, uint64_t i) {
	...
	if (_op_equal_equal_1(i, vats.size)) {
		...
		switch (_matched2.kind) {
			...
			case 1:
				s1 = _matched2.as1;
				return (struct opt_5) {1, .as1 = some_6((struct chosen_task) {vat0, s1.value})};
			default:
...
struct opt_7 find_and_remove_first_doable_task_recur(struct vat* vat, struct opt_2 opt_node) {
	...
	switch (_matched8.kind) {
		...
		case 1:
			...
			if (task_ok4) {
				return (struct opt_7) {1, .as1 = some_4((struct task_and_nodes) {task2, node1->next_node})};
			} else {
				...
				switch (_matched7.kind) {
					...
					case 1:
						...
						return (struct opt_7) {1, .as1 = some_4((struct task_and_nodes) {tn6.task, (struct opt_2) {1, .as1 = some_2(node1)}})};
					default:
...
struct opt_8 parse_cmd_line_args(struct ctx* ctx, struct arr_1 args, struct arr_1 t_names, struct fun1 make_t) {
	...
	values1 = fill_mut_arr(ctx, t_names.size, (struct opt_9) {0, .as0 = none()});
	...
	if (get_2(help2)) {
		...
		return (struct opt_8) {1, .as1 = some_11(call_14(ctx, make_t, freeze_4(values1)))};
	}
}
struct parsed_cmd_line_args* parse_cmd_line_args_dynamic(struct ctx* ctx, struct arr_1 args) {
	struct some_10 s0;
...
struct opt_11 try_remove_start(struct ctx* ctx, struct arr_0 a, struct arr_0 start) {
	if (starts_with__q(ctx, a, start)) {
		return (struct opt_11) {1, .as1 = some_9(slice_starting_at_1(ctx, a, start.size))};
	} else {
...
uint8_t parse_cmd_line_args__lambda0(struct ctx* ctx, struct parse_cmd_line_args__lambda0* _closure, struct arr_0 key, struct arr_1 value) {
	...
	switch (_matched2.kind) {
		...
		case 1:
			...
			return set_at_1(ctx, _closure->values, idx1, (struct opt_9) {1, .as1 = some_10(value)});
		default:
			return (assert(0),0);
	}
}
...
struct test_options main_0__lambda0(struct ctx* ctx, uint8_t* _closure, struct arr_5 values) {
	...
	max_failures10 = (_matched9 = max_failures_strs2, _matched9.kind == 0 ? literal_1(ctx, (struct arr_0) {3, "100"}) : _matched9.kind == 1 ? (s7 = _matched9.as1, (strs8 = s7.value, (assert_0(ctx, _op_equal_equal_1(strs8.size, literal_1(ctx, (struct arr_0) {1, "1"}))), literal_1(ctx, first_1(ctx, strs8))))) : (assert(0),0));
...
struct opt_11 get_extension(struct ctx* ctx, struct arr_0 name) {
	...
	switch (_matched1.kind) {
		...
		case 1:
			s0 = _matched1.as1;
			return (struct opt_11) {1, .as1 = some_9(slice_after_1(ctx, name, s0.value))};
		default:
...
struct print_test_result* run_print_test(struct ctx* ctx, struct arr_0 print_kind, struct arr_0 path_to_noze, struct dict_1* env, struct arr_0 path, uint8_t overwrite_output__q) {
	...
	if (!empty__q_11(output_failures3)) {
		...
		if (_op_equal_equal_3(res1->exit_code, literal_2(ctx, (struct arr_0) {1, "0"}))) {
			...
			if (_op_equal_equal_3(res1->exit_code, literal_2(ctx, (struct arr_0) {1, "1"}))) {
...
struct arr_0 to_str_3(struct ctx* ctx, uint64_t n) {
	struct arr_0 hi0;
	struct arr_0 lo1;
	if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "0"}))) {
		return (struct arr_0) {1, "0"};
	} else {
		if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "1"}))) {
			return (struct arr_0) {1, "1"};
		} else {
			if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "2"}))) {
				return (struct arr_0) {1, "2"};
			} else {
				if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "3"}))) {
					return (struct arr_0) {1, "3"};
				} else {
					if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "4"}))) {
						return (struct arr_0) {1, "4"};
					} else {
						if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "5"}))) {
							return (struct arr_0) {1, "5"};
						} else {
							if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "6"}))) {
								return (struct arr_0) {1, "6"};
							} else {
								if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "7"}))) {
									return (struct arr_0) {1, "7"};
								} else {
									if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "8"}))) {
										return (struct arr_0) {1, "8"};
									} else {
										if (_op_equal_equal_1(n, literal_1(ctx, (struct arr_0) {1, "9"}))) {
...
uint8_t write_file_1(struct ctx* ctx, char* path, struct arr_0 content) {
	...
	if (_op_equal_equal_3(fd4, neg_one_1())) {
		...
		if (_op_equal_equal_2(wrote_bytes6, to_int(ctx, content.size))) {
			...
			if (_op_equal_equal_2(wrote_bytes6, literal_3(ctx, (struct arr_0) {2, "-1"}))) {
				todo_1();
			} else {
				todo_1();
			}
...
uint8_t remove_colors_recur(struct ctx* ctx, struct arr_0 s, struct mut_arr_4* out) {
	...
	if (empty__q_0(s)) {
		...
		if (_op_equal_equal_0(first_0(ctx, s), literal_0((struct arr_0) {1, "\x1b"}))) {
...
uint8_t remove_colors_recur_2(struct ctx* ctx, struct arr_0 s, struct mut_arr_4* out) {
	...
	if (empty__q_0(s)) {
		...
		if (_op_equal_equal_0(first_0(ctx, s), literal_0((struct arr_0) {1, "m"}))) {
...
struct opt_13 run_single_noze_test__lambda0(struct ctx* ctx, struct run_single_noze_test__lambda0* _closure, struct arr_0 print_kind) {
	...
	if (res0->should_stop__q) {
		return (struct opt_13) {1, .as1 = some_13(res0->failures)};
	} else {
		return (struct opt_13) {0, .as0 = none()};
	}
}
struct arr_7 run_single_runnable_test(struct ctx* ctx, struct arr_0 path_to_noze, struct dict_1* env, struct arr_0 path, uint8_t interpret__q, uint8_t overwrite_output__q) {
	...
	if ((_op_equal_equal_3(res3->exit_code, literal_2(ctx, (struct arr_0) {1, "0"})) && _op_equal_equal_4(res3->stderr, (struct arr_0) {0, ""}))) {
...
uint8_t lines__lambda0(struct ctx* ctx, struct lines__lambda0* _closure, char c, uint64_t index) {
	if (_op_equal_equal_0(c, literal_0((struct arr_0) {1, "\n"}))) {
...
struct arr_0 lstrip(struct ctx* ctx, struct arr_0 a) {
	struct arr_0 _tailCalla;
	top:
	if ((has__q_7(a) && _op_equal_equal_0(first_0(ctx, a), literal_0((struct arr_0) {1, " "})))) {
		_tailCalla = tail_1(ctx, a);
		a = _tailCalla;
		goto top;
	} else {
...
uint64_t line_len(struct ctx* ctx, struct arr_0 line) {
	return _op_plus_0(ctx, _op_times_0(ctx, n_tabs(ctx, line), _op_minus_1(ctx, tab_size(ctx), literal_1(ctx, (struct arr_0) {1, "1"}))), line.size);
}
uint64_t n_tabs(struct ctx* ctx, struct arr_0 line) {
	if ((!empty__q_0(line) && _op_equal_equal_0(first_0(ctx, line), literal_0((struct arr_0) {1, "\t"})))) {
...
int32_t print_failures(struct ctx* ctx, struct result_3 failures, struct test_options options) {
	...
	switch (_matched3.kind) {
		...
		case 1:
			...
			print_sync((_op_equal_equal_1(n_failures2, options.max_failures) ? _op_plus_1(ctx, _op_plus_1(ctx, (struct arr_0) {15, "hit maximum of "}, to_str_3(ctx, options.max_failures)), (struct arr_0) {9, " failures"}) : _op_plus_1(ctx, to_str_3(ctx, n_failures2), (struct arr_0) {9, " failures"})));
