...
struct comparison compare_176(char a, char b);
...
struct comparison compare_268(struct arr_0 a, struct arr_0 b);
...
struct comparison compare_268(struct arr_0 a, struct arr_0 b) {
	...
	if ((a.size == 0)) {
		...
		if ((b.size == 0)) {
			...
			temp0 = compare_176((*(a.data)), (*(b.data)));
			switch (temp0.kind) {
				case 0:
					return (struct comparison) {0, .as0 = (struct less) {0}};
				case 1:
