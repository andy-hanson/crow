...
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct island_gc_root value);
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct task_queue value);
struct void_ mark_visit_363(struct mark_ctx* mark_ctx, struct opt_3 value);
struct void_ mark_visit_364(struct mark_ctx* mark_ctx, struct some_3 value);
struct void_ mark_visit_365(struct mark_ctx* mark_ctx, struct task_queue_node value);
struct void_ mark_visit_366(struct mark_ctx* mark_ctx, struct task value);
struct void_ mark_visit_367(struct mark_ctx* mark_ctx, struct fun_act0_0 value);
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value);
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct fut_1 value);
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct fut_state_1 value);
struct void_ mark_visit_371(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1 value);
struct void_ mark_visit_372(struct mark_ctx* mark_ctx, struct fun_act1_3 value);
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct then__lambda0 value);
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct fun_ref1 value);
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct fun_act1_4 value);
struct void_ mark_visit_376(struct mark_ctx* mark_ctx, struct then_void__lambda0 value);
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct fun_ref0 value);
struct void_ mark_visit_378(struct mark_ctx* mark_ctx, struct fun_act0_1 value);
struct void_ mark_visit_379(struct mark_ctx* mark_ctx, struct add_first_task__lambda0 value);
struct void_ mark_arr_380(struct mark_ctx* mark_ctx, struct arr_7 a);
struct void_ mark_visit_381(struct mark_ctx* mark_ctx, struct add_first_task__lambda0* value);
struct void_ mark_visit_382(struct mark_ctx* mark_ctx, struct then_void__lambda0* value);
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct fut_0 value);
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct fut_state_0 value);
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value);
struct void_ mark_visit_386(struct mark_ctx* mark_ctx, struct fun_act1_0 value);
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value);
...
struct void_ mark_visit_390(struct mark_ctx* mark_ctx, struct opt_0 value);
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct some_0 value);
struct void_ mark_visit_392(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0* value);
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct str value);
struct void_ mark_arr_395(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_arr_397(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_398(struct mark_ctx* mark_ctx, struct then__lambda0* value);
struct void_ mark_visit_399(struct mark_ctx* mark_ctx, struct opt_10 value);
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct some_10 value);
...
struct void_ mark_visit_414(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct mut_list_0 value);
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct mut_arr_0 value);
struct void_ mark_arr_417(struct mark_ctx* mark_ctx, struct arr_3 a);
...
uint8_t call_w_ctx_446(struct fun_act1_8 a, struct ctx* ctx, struct str p0);
...
struct arrow_2 call_w_ctx_477(struct fun_act1_10 a, struct ctx* ctx, uint64_t p0);
...
struct comparison call_w_ctx_493(struct fun_act2_1 a, struct ctx* ctx, struct arrow_2 p0, struct arrow_2 p1);
...
struct str call_w_ctx_497(struct fun_act1_9 a, struct ctx* ctx, struct arrow_2 p0);
...
struct comparison call_w_ctx_528(struct fun_act1_11 a, struct ctx* ctx, struct arrow_1 p0);
...
uint8_t call_w_ctx_572(struct fun_act1_12 a, struct ctx* ctx, struct arrow_1 p0);
...
struct unique_comparison call_w_ctx_581(struct fun_act2_2 a, struct ctx* ctx, struct arrow_1 p0, struct arrow_1 p1);
...
struct arrow_2 call_w_ctx_606(struct fun_act1_13 a, struct ctx* ctx, struct arrow_1 p0);
...
struct arrow_2 call_w_ctx_609(struct fun_act2_3 a, struct ctx* ctx, struct str p0, struct arr_2 p1);
...
struct opt_12 call_w_ctx_630(struct fun_act1_14 a, struct ctx* ctx, uint64_t p0);
...
struct void_ call_w_ctx_647(struct fun_act3_0 a, struct ctx* ctx, struct void_ p0, struct str p1, struct arr_2 p2);
...
struct str call_w_ctx_656(struct fun_act2_5 a, struct ctx* ctx, struct str p0, struct arr_9 p1);
...
struct void_ call_w_ctx_681(struct fun_act2_4 a, struct ctx* ctx, struct str p0, struct arr_2 p1);
...
struct opt_11 call_w_ctx_719(struct fun_act1_15 a, struct ctx* ctx, struct reader* p0);
...
uint8_t call_w_ctx_735(struct fun_act1_16 a, struct ctx* ctx, char p0);
...
struct comparison call_w_ctx_761(struct fun_act1_17 a, struct ctx* ctx, struct arrow_3 p0);
...
uint8_t call_w_ctx_802(struct fun_act1_18 a, struct ctx* ctx, struct arrow_3 p0);
...
struct unique_comparison call_w_ctx_811(struct fun_act2_6 a, struct ctx* ctx, struct arrow_3 p0, struct arrow_3 p1);
...
struct arrow_4 call_w_ctx_839(struct fun_act1_20 a, struct ctx* ctx, uint64_t p0);
...
struct comparison call_w_ctx_854(struct fun_act2_7 a, struct ctx* ctx, struct arrow_4 p0, struct arrow_4 p1);
...
struct str call_w_ctx_858(struct fun_act1_19 a, struct ctx* ctx, struct arrow_4 p0);
...
struct arrow_4 call_w_ctx_866(struct fun_act1_21 a, struct ctx* ctx, struct arrow_3 p0);
...
struct arrow_4 call_w_ctx_869(struct fun_act2_8 a, struct ctx* ctx, struct str p0, struct str p1);
...
struct result_2 call_w_ctx_875(struct fun0 a, struct ctx* ctx);
...
struct void_ call_w_ctx_903(struct fun_act1_22 a, struct ctx* ctx, struct str p0);
...
struct comparison call_w_ctx_945(struct fun_act2_9 a, struct ctx* ctx, struct str p0, struct str p1);
...
struct void_ call_w_ctx_973(struct fun_act1_24 a, struct ctx* ctx, struct failure* p0);
...
struct arr_14 call_w_ctx_997(struct fun_act1_23 a, struct ctx* ctx, struct str p0);
...
struct opt_22 call_w_ctx_1010(struct fun_act1_25 a, struct ctx* ctx, struct str p0);
...
struct str call_w_ctx_1017(struct fun_act2_10 a, struct ctx* ctx, struct str p0, struct str p1);
...
struct pollfd call_w_ctx_1042(struct fun_act1_26 a, struct ctx* ctx, uint64_t p0);
...
char* call_w_ctx_1113(struct fun_act1_28 a, struct ctx* ctx, uint64_t p0);
char* subscript_92(struct ctx* ctx, struct fun_act1_27 a, struct str p0);
char* call_w_ctx_1115(struct fun_act1_27 a, struct ctx* ctx, struct str p0);
...
struct void_ call_w_ctx_1135(struct fun_act3_1 a, struct ctx* ctx, struct void_ p0, struct str p1, struct str p2);
...
struct str call_w_ctx_1144(struct fun_act2_12 a, struct ctx* ctx, struct str p0, struct arr_12 p1);
...
struct void_ call_w_ctx_1168(struct fun_act2_11 a, struct ctx* ctx, struct str p0, struct str p1);
...
struct void_ call_w_ctx_1245(struct fun_act2_13 a, struct ctx* ctx, struct str p0, uint64_t p1);
...
struct void_ call_w_ctx_1250(struct fun_act2_14 a, struct ctx* ctx, char p0, uint64_t p1);
...
char constantarr_0_618[6];
char constantarr_0_619[7];
char constantarr_0_620[11];
char constantarr_0_621[22];
char constantarr_0_622[17];
char constantarr_0_623[14];
char constantarr_0_624[21];
char constantarr_0_625[32];
char constantarr_0_626[7];
char constantarr_0_627[7];
char constantarr_0_628[9];
char constantarr_0_629[27];
char constantarr_0_630[28];
char constantarr_0_631[19];
char constantarr_0_632[9];
char constantarr_0_633[5];
...
char constantarr_0_641[40];
char constantarr_0_642[10];
char constantarr_0_643[21];
char constantarr_0_644[11];
char constantarr_0_645[9];
char constantarr_0_646[8];
char constantarr_0_647[10];
char constantarr_0_648[15];
char constantarr_0_649[28];
char constantarr_0_650[7];
...
char constantarr_0_656[37];
char constantarr_0_657[7];
char constantarr_0_658[29];
char constantarr_0_659[10];
char constantarr_0_660[13];
char constantarr_0_661[12];
char constantarr_0_662[46];
...
char constantarr_0_672[7];
char constantarr_0_673[17];
char constantarr_0_674[11];
char constantarr_0_675[10];
char constantarr_0_676[22];
...
char constantarr_0_742[12];
char constantarr_0_743[9];
char constantarr_0_744[9];
char constantarr_0_745[30];
char constantarr_0_746[28];
char constantarr_0_747[42];
...
char constantarr_0_762[27];
char constantarr_0_763[13];
char constantarr_0_764[7];
char constantarr_0_765[10];
char constantarr_0_766[4];
char constantarr_0_767[19];
char constantarr_0_768[15];
char constantarr_0_769[26];
char constantarr_0_770[20];
char constantarr_0_771[10];
char constantarr_0_772[20];
char constantarr_0_773[27];
char constantarr_0_774[17];
char constantarr_0_775[31];
char constantarr_0_776[4];
char constantarr_0_777[14];
char constantarr_0_778[20];
char constantarr_0_779[24];
char constantarr_0_780[22];
char constantarr_0_781[28];
char constantarr_0_782[14];
char constantarr_0_783[25];
char constantarr_0_784[16];
char constantarr_0_785[22];
char constantarr_0_786[38];
char constantarr_0_787[8];
...
char constantarr_0_849[22];
char constantarr_0_850[33];
char constantarr_0_851[32];
char constantarr_0_852[27];
char constantarr_0_853[14];
char constantarr_0_854[20];
char constantarr_0_855[14];
char constantarr_0_856[22];
char constantarr_0_857[36];
char constantarr_0_858[17];
char constantarr_0_859[9];
char constantarr_0_860[21];
...
char constantarr_0_867[9];
char constantarr_0_868[15];
char constantarr_0_869[18];
char constantarr_0_870[18];
char constantarr_0_871[6];
char constantarr_0_872[5];
char constantarr_0_873[15];
char constantarr_0_874[8];
char constantarr_0_875[6];
char constantarr_0_876[24];
char constantarr_0_877[28];
char constantarr_0_878[24];
...
char constantarr_0_1050[3];
char constantarr_0_1051[10];
char constantarr_0_1052[7];
char constantarr_0_1053[22];
char constantarr_0_1054[7];
char constantarr_0_1055[9];
char constantarr_0_1056[8];
char constantarr_0_1057[11];
char constantarr_0_1058[2];
char constantarr_0_1059[10];
char constantarr_0_1060[8];
char constantarr_0_1061[11];
char constantarr_0_1062[22];
char constantarr_0_1063[11];
char constantarr_0_1064[7];
char constantarr_0_1065[12];
char constantarr_0_1066[3];
char constantarr_0_1067[3];
char constantarr_0_1068[17];
char constantarr_0_1069[10];
char constantarr_0_1070[12];
char constantarr_0_1071[14];
char constantarr_0_1072[12];
char constantarr_0_1073[18];
char constantarr_0_1074[25];
char constantarr_0_1075[33];
char constantarr_0_1076[20];
char constantarr_0_1077[15];
char constantarr_0_1078[25];
char constantarr_0_1079[14];
char constantarr_0_1080[22];
char constantarr_0_1081[19];
char constantarr_0_1082[23];
char constantarr_0_1083[19];
char constantarr_0_1084[29];
char constantarr_0_1085[21];
char constantarr_0_1086[9];
char constantarr_0_1087[16];
char constantarr_0_1088[13];
char constantarr_0_1089[13];
char constantarr_0_1090[4];
char constantarr_0_1091[8];
char constantarr_0_1092[14];
char constantarr_0_1093[5];
char constantarr_0_1094[8];
char constantarr_0_1095[8];
char constantarr_0_1096[20];
...
char constantarr_0_1111[7];
char constantarr_0_1112[17];
char constantarr_0_1113[17];
char constantarr_0_1114[13];
char constantarr_0_1115[20];
char constantarr_0_1116[10];
char constantarr_0_1117[22];
char constantarr_0_1118[11];
char constantarr_0_1119[18];
char constantarr_0_1120[8];
char constantarr_0_1121[28];
char constantarr_0_1122[24];
char constantarr_0_1123[10];
char constantarr_0_1124[22];
char constantarr_0_1125[17];
char constantarr_0_1126[17];
char constantarr_0_1127[23];
char constantarr_0_1128[15];
char constantarr_0_1129[4];
char constantarr_0_1130[19];
char constantarr_0_1131[18];
char constantarr_0_1132[7];
char constantarr_0_1133[11];
char constantarr_0_1134[9];
char constantarr_0_1135[15];
char constantarr_0_1136[26];
char constantarr_0_1137[27];
char constantarr_0_1138[31];
char constantarr_0_1139[23];
char constantarr_0_1140[18];
char constantarr_0_1141[27];
char constantarr_0_1142[9];
char constantarr_0_1143[9];
char constantarr_0_1144[20];
char constantarr_0_1145[24];
char constantarr_0_1146[25];
char constantarr_0_1147[5];
char constantarr_0_1148[11];
char constantarr_0_1149[21];
char constantarr_0_1150[11];
char constantarr_0_1151[13];
char constantarr_0_1152[8];
char constantarr_0_1153[6];
char constantarr_0_1154[8];
char constantarr_0_1155[15];
char constantarr_0_1156[17];
char constantarr_0_1157[12];
char constantarr_0_1158[15];
char constantarr_0_1159[14];
char constantarr_0_1160[19];
char constantarr_0_1161[13];
char constantarr_0_1162[10];
char constantarr_0_1163[4];
char constantarr_0_1164[11];
char constantarr_0_1165[22];
char constantarr_0_1166[12];
char constantarr_0_1167[11];
...
struct named_val constantarr_5_0[1093];
struct sym constantarr_1_0[397];
...
char constantarr_0_616[11] = "*<timespec>";
char constantarr_0_617[14] = "inner-value<a>";
char constantarr_0_618[6] = "tv-sec";
char constantarr_0_619[7] = "tv-nsec";
char constantarr_0_620[11] = "todo<nat64>";
char constantarr_0_621[22] = "as<choose-task-result>";
char constantarr_0_622[17] = "choose-task-recur";
char constantarr_0_623[14] = "no-chosen-task";
char constantarr_0_624[21] = "choose-task-in-island";
char constantarr_0_625[32] = "as<choose-task-in-island-result>";
char constantarr_0_626[7] = "do-a-gc";
char constantarr_0_627[7] = "no-task";
char constantarr_0_628[9] = "pop-task!";
char constantarr_0_629[27] = "ref-of-val<mut-list<nat64>>";
char constantarr_0_630[28] = "currently-running-exclusions";
char constantarr_0_631[19] = "as<pop-task-result>";
char constantarr_0_632[9] = "in<nat64>";
char constantarr_0_633[5] = "in<a>";
char constantarr_0_634[11] = "in-recur<a>";
char constantarr_0_635[11] = "noctx-at<a>";
char constantarr_0_636[14] = "temp-as-arr<a>";
char constantarr_0_637[18] = "temp-as-mut-arr<a>";
char constantarr_0_638[10] = "pop-recur!";
char constantarr_0_639[11] = "to-opt-time";
char constantarr_0_640[11] = "some<nat64>";
char constantarr_0_641[40] = "push-capacity-must-be-sufficient!<nat64>";
char constantarr_0_642[10] = "is-no-task";
char constantarr_0_643[21] = "set-n-threads-running";
char constantarr_0_644[11] = "chosen-task";
char constantarr_0_645[9] = "any-tasks";
char constantarr_0_646[8] = "min-time";
char constantarr_0_647[10] = "min<nat64>";
char constantarr_0_648[15] = "first-task-time";
char constantarr_0_649[28] = "no-tasks-and-last-thread-out";
char constantarr_0_650[7] = "do-task";
char constantarr_0_651[11] = "task-island";
char constantarr_0_652[10] = "task-or-gc";
char constantarr_0_653[6] = "action";
char constantarr_0_654[12] = "return-task!";
char constantarr_0_655[35] = "noctx-must-remove-unordered!<nat64>";
char constantarr_0_656[37] = "noctx-must-remove-unordered-recur!<a>";
char constantarr_0_657[7] = "drop<a>";
char constantarr_0_658[29] = "noctx-remove-unordered-at!<a>";
char constantarr_0_659[10] = "return-ctx";
char constantarr_0_660[13] = "return-gc-ctx";
char constantarr_0_661[12] = "some<gc-ctx>";
char constantarr_0_662[46] = "run-garbage-collection<by-val<island-gc-root>>";
char constantarr_0_663[12] = "set-gc-count";
char constantarr_0_664[8] = "gc-count";
char constantarr_0_665[20] = "as<by-val<mark-ctx>>";
char constantarr_0_666[8] = "mark-ctx";
char constantarr_0_667[13] = "mark-visit<a>";
char constantarr_0_668[20] = "ref-of-val<mark-ctx>";
char constantarr_0_669[15] = "clear-free-mem!";
char constantarr_0_670[17] = "!=<mut-ptr<bool>>";
char constantarr_0_671[16] = "set-is-shut-down";
char constantarr_0_672[7] = "wait-on";
char constantarr_0_673[17] = "pthread_cond_wait";
char constantarr_0_674[11] = "to-timespec";
char constantarr_0_675[10] = "unsafe-mod";
char constantarr_0_676[22] = "pthread_cond_timedwait";
char constantarr_0_677[16] = "ptr-to<timespec>";
char constantarr_0_678[9] = "ETIMEDOUT";
char constantarr_0_679[9] = "thread-id";
char constantarr_0_680[18] = "join-threads-recur";
char constantarr_0_681[15] = "join-one-thread";
char constantarr_0_682[31] = "as<by-val<cell<mut-ptr<nat8>>>>";
char constantarr_0_683[19] = "cell<mut-ptr<nat8>>";
char constantarr_0_684[12] = "pthread_join";
char constantarr_0_685[31] = "ref-of-val<cell<mut-ptr<nat8>>>";
char constantarr_0_686[6] = "EINVAL";
char constantarr_0_687[5] = "ESRCH";
char constantarr_0_688[16] = "*<mut-ptr<nat8>>";
char constantarr_0_689[21] = "unmanaged-free<nat64>";
char constantarr_0_690[4] = "free";
char constantarr_0_691[35] = "unmanaged-free<by-val<thread-args>>";
char constantarr_0_692[17] = "destroy-condition";
char constantarr_0_693[25] = "pthread_mutexattr_destroy";
char constantarr_0_694[21] = "pthread_mutex_destroy";
char constantarr_0_695[24] = "pthread_condattr_destroy";
char constantarr_0_696[20] = "pthread_cond_destroy";
char constantarr_0_697[24] = "any-unhandled-exceptions";
char constantarr_0_698[4] = "main";
char constantarr_0_699[15] = "resolved<nat64>";
char constantarr_0_700[16] = "parse-named-args";
char constantarr_0_701[21] = "parse-command-dynamic";
char constantarr_0_702[15] = "find-index<str>";
char constantarr_0_703[19] = "find-index-recur<a>";
char constantarr_0_704[18] = "subscript<bool, a>";
char constantarr_0_705[11] = "starts-with";
char constantarr_0_706[15] = "arr-equal<char>";
char constantarr_0_707[14] = "equal-recur<a>";
char constantarr_0_708[17] = "starts-with<char>";
char constantarr_0_709[29] = "parse-command-dynamic.lambda0";
char constantarr_0_710[14] = "parsed-command";
char constantarr_0_711[9] = "cmp<nat8>";
char constantarr_0_712[17] = "arr-compare<char>";
char constantarr_0_713[16] = "compare-recur<a>";
char constantarr_0_714[19] = "dict<str, arr<str>>";
char constantarr_0_715[10] = "dict<k, v>";
char constantarr_0_716[14] = "end-node<k, v>";
char constantarr_0_717[23] = "sort-by<arrow<k, v>, k>";
char constantarr_0_718[7] = "sort<a>";
char constantarr_0_719[15] = "make-mut-arr<a>";
char constantarr_0_720[18] = "mut-arr<a>.lambda0";
char constantarr_0_721[8] = "sort!<a>";
char constantarr_0_722[24] = "insertion-sort-recur!<a>";
char constantarr_0_723[14] = "!=<mut-ptr<a>>";
char constantarr_0_724[10] = "insert!<a>";
char constantarr_0_725[27] = "subscript<comparison, a, a>";
char constantarr_0_726[24] = "call-with-ctx<r, p0, p1>";
char constantarr_0_727[17] = "cast-immutable<a>";
char constantarr_0_728[15] = "subscript<b, a>";
char constantarr_0_729[31] = "sort-by<arrow<k, v>, k>.lambda0";
char constantarr_0_730[10] = "from<k, v>";
char constantarr_0_731[27] = "dict<str, arr<str>>.lambda0";
char constantarr_0_732[14] = "subscript<str>";
char constantarr_0_733[29] = "parse-command-dynamic.lambda1";
char constantarr_0_734[23] = "mut-dict<str, arr<str>>";
char constantarr_0_735[14] = "mut-dict<k, v>";
char constantarr_0_736[26] = "mut-list<arrow<k, opt<v>>>";
char constantarr_0_737[22] = "parse-named-args-recur";
char constantarr_0_738[10] = "force<str>";
char constantarr_0_739[8] = "force<a>";
char constantarr_0_740[16] = "try-remove-start";
char constantarr_0_741[22] = "try-remove-start<char>";
char constantarr_0_742[12] = "some<arr<a>>";
char constantarr_0_743[9] = "some<str>";
char constantarr_0_744[9] = "tail<str>";
char constantarr_0_745[30] = "parse-named-args-recur.lambda0";
char constantarr_0_746[28] = "set-subscript<str, arr<str>>";
char constantarr_0_747[42] = "insert-into-key-match-or-empty-slot!<k, v>";
char constantarr_0_748[21] = "find-insert-ptr<k, v>";
char constantarr_0_749[42] = "binary-search-insert-ptr<arrow<k, opt<v>>>";
char constantarr_0_750[27] = "binary-search-insert-ptr<a>";
char constantarr_0_751[30] = "binary-search-compare-recur<a>";
char constantarr_0_752[24] = "subscript<comparison, a>";
char constantarr_0_753[11] = "pairs<k, v>";
char constantarr_0_754[15] = "from<k, opt<v>>";
char constantarr_0_755[29] = "find-insert-ptr<k, v>.lambda0";
char constantarr_0_756[29] = "!=<mut-ptr<arrow<k, opt<v>>>>";
char constantarr_0_757[25] = "end-ptr<arrow<k, opt<v>>>";
char constantarr_0_758[11] = "is-empty<v>";
char constantarr_0_759[13] = "to<k, opt<v>>";
char constantarr_0_760[19] = "set-node-size<k, v>";
char constantarr_0_761[15] = "node-size<k, v>";
char constantarr_0_762[27] = "set-deref<arrow<k, opt<v>>>";
char constantarr_0_763[13] = "-><k, opt<v>>";
char constantarr_0_764[7] = "some<v>";
char constantarr_0_765[10] = "next<k, v>";
char constantarr_0_766[4] = "<<k>";
char constantarr_0_767[19] = "-<arrow<k, opt<v>>>";
char constantarr_0_768[15] = "add-pair!<k, v>";
char constantarr_0_769[26] = "is-empty<arrow<k, opt<v>>>";
char constantarr_0_770[20] = "~=<arrow<k, opt<v>>>";
char constantarr_0_771[10] = "as<opt<v>>";
char constantarr_0_772[20] = "insert-linear!<k, v>";
char constantarr_0_773[27] = "subscript<arrow<k, opt<v>>>";
char constantarr_0_774[17] = "move-right!<k, v>";
char constantarr_0_775[31] = "set-subscript<arrow<k, opt<v>>>";
char constantarr_0_776[4] = "><k>";
char constantarr_0_777[14] = "set-next<k, v>";
char constantarr_0_778[20] = "some<mut-dict<k, v>>";
char constantarr_0_779[24] = "compact-if-needed!<k, v>";
char constantarr_0_780[22] = "total-pairs-size<k, v>";
char constantarr_0_781[28] = "total-pairs-size-recur<k, v>";
char constantarr_0_782[14] = "compact!<k, v>";
char constantarr_0_783[25] = "filter!<arrow<k, opt<v>>>";
char constantarr_0_784[16] = "filter-recur!<a>";
char constantarr_0_785[22] = "compact!<k, v>.lambda0";
char constantarr_0_786[38] = "merge-no-duplicates!<arrow<k, opt<v>>>";
char constantarr_0_787[8] = "swap!<a>";
char constantarr_0_788[19] = "unsafe-set-size!<a>";
char constantarr_0_789[10] = "reserve<a>";
char constantarr_0_790[23] = "merge-reverse-recur!<a>";
char constantarr_0_791[34] = "subscript<unique-comparison, a, a>";
char constantarr_0_792[25] = "mut-arr-from-begin-end<a>";
char constantarr_0_793[14] = "<=<mut-ptr<a>>";
char constantarr_0_794[21] = "arr-from-begin-end<a>";
char constantarr_0_795[13] = "copy-from!<a>";
char constantarr_0_796[9] = "empty!<a>";
char constantarr_0_797[9] = "pop-n!<a>";
char constantarr_0_798[27] = "assert-comparison-not-equal";
char constantarr_0_799[30] = "unreachable<unique-comparison>";
char constantarr_0_800[22] = "compact!<k, v>.lambda1";
char constantarr_0_801[28] = "move-to-dict!<str, arr<str>>";
char constantarr_0_802[18] = "move-to-arr!<k, v>";
char constantarr_0_803[29] = "map-to-arr<arrow<k, v>, k, v>";
char constantarr_0_804[33] = "map-to-arr<out, arrow<k, opt<v>>>";
char constantarr_0_805[23] = "map-to-mut-arr<out, in>";
char constantarr_0_806[31] = "map-to-mut-arr<out, in>.lambda0";
char constantarr_0_807[20] = "subscript<out, k, v>";
char constantarr_0_808[8] = "force<v>";
char constantarr_0_809[37] = "map-to-arr<arrow<k, v>, k, v>.lambda0";
char constantarr_0_810[8] = "-><k, v>";
char constantarr_0_811[26] = "move-to-arr!<k, v>.lambda0";
char constantarr_0_812[12] = "empty!<k, v>";
char constantarr_0_813[8] = "nameless";
char constantarr_0_814[5] = "after";
char constantarr_0_815[28] = "fill-mut-list<opt<arr<str>>>";
char constantarr_0_816[15] = "fill-mut-arr<a>";
char constantarr_0_817[23] = "fill-mut-arr<a>.lambda0";
char constantarr_0_818[10] = "cell<bool>";
char constantarr_0_819[19] = "each<str, arr<str>>";
char constantarr_0_820[16] = "fold<void, k, v>";
char constantarr_0_821[16] = "init-iters<k, v>";
char constantarr_0_822[44] = "uninitialized-mut-arr<arr<arrow<k, opt<v>>>>";
char constantarr_0_823[19] = "overlay-count<k, v>";
char constantarr_0_824[10] = "prev<k, v>";
char constantarr_0_825[10] = "impl<k, v>";
char constantarr_0_826[31] = "init-overlay-iters-recur!<k, v>";
char constantarr_0_827[32] = "set-deref<arr<arrow<k, opt<v>>>>";
char constantarr_0_828[24] = "+<arr<arrow<k, opt<v>>>>";
char constantarr_0_829[32] = "begin-ptr<arr<arrow<k, opt<v>>>>";
char constantarr_0_830[11] = "iters<k, v>";
char constantarr_0_831[19] = "fold-recur<a, k, v>";
char constantarr_0_832[31] = "is-empty<arr<arrow<k, opt<v>>>>";
char constantarr_0_833[21] = "is-empty<arrow<k, v>>";
char constantarr_0_834[21] = "subscript<a, a, k, v>";
char constantarr_0_835[28] = "call-with-ctx<r, p0, p1, p2>";
char constantarr_0_836[8] = "to<k, v>";
char constantarr_0_837[17] = "tail<arrow<k, v>>";
char constantarr_0_838[25] = "find-least-key<k, opt<v>>";
char constantarr_0_839[25] = "fold<k, arr<arrow<k, v>>>";
char constantarr_0_840[10] = "fold<a, b>";
char constantarr_0_841[16] = "fold-recur<a, b>";
char constantarr_0_842[5] = "==<b>";
char constantarr_0_843[18] = "subscript<a, a, b>";
char constantarr_0_844[4] = "*<b>";
char constantarr_0_845[4] = "+<b>";
char constantarr_0_846[10] = "end-ptr<b>";
char constantarr_0_847[14] = "temp-as-arr<b>";
char constantarr_0_848[6] = "min<k>";
char constantarr_0_849[22] = "subscript<arrow<k, v>>";
char constantarr_0_850[33] = "find-least-key<k, opt<v>>.lambda0";
char constantarr_0_851[32] = "subscript<arr<arrow<k, opt<v>>>>";
char constantarr_0_852[27] = "tail<arr<arrow<k, opt<v>>>>";
char constantarr_0_853[14] = "take-key<k, v>";
char constantarr_0_854[20] = "take-key-recur<k, v>";
char constantarr_0_855[14] = "took-key<k, v>";
char constantarr_0_856[22] = "tail<arrow<k, opt<v>>>";
char constantarr_0_857[36] = "set-subscript<arr<arrow<k, opt<v>>>>";
char constantarr_0_858[17] = "unsafe-set-at!<a>";
char constantarr_0_859[9] = "opt-or<v>";
char constantarr_0_860[21] = "rightmost-value<k, v>";
char constantarr_0_861[14] = "overlays<k, v>";
char constantarr_0_862[15] = "end-pairs<k, v>";
char constantarr_0_863[21] = "subscript<void, k, v>";
char constantarr_0_864[27] = "each<str, arr<str>>.lambda0";
char constantarr_0_865[5] = "named";
char constantarr_0_866[13] = "index-of<str>";
char constantarr_0_867[9] = "ptr-of<a>";
char constantarr_0_868[15] = "ptr-of-recur<a>";
char constantarr_0_869[18] = "some<const-ptr<a>>";
char constantarr_0_870[18] = "set-inner-value<a>";
char constantarr_0_871[6] = "finish";
char constantarr_0_872[5] = "inner";
char constantarr_0_873[15] = "with-value<str>";
char constantarr_0_874[8] = "with-str";
char constantarr_0_875[6] = "interp";
char constantarr_0_876[24] = "subscript<opt<arr<str>>>";
char constantarr_0_877[28] = "set-subscript<opt<arr<str>>>";
char constantarr_0_878[24] = "parse-named-args.lambda0";
...
char constantarr_0_1017[23] = "mut-arr<by-val<pollfd>>";
char constantarr_0_1018[31] = "mut-arr<by-val<pollfd>>.lambda0";
char constantarr_0_1019[23] = "as<arr<by-val<pollfd>>>";
char constantarr_0_1020[6] = "pollfd";
char constantarr_0_1021[6] = "POLLIN";
char constantarr_0_1022[21] = "ref-of-val-at<pollfd>";
char constantarr_0_1023[15] = "size<by-val<a>>";
char constantarr_0_1024[13] = "ref-of-ptr<a>";
char constantarr_0_1025[13] = "ref-of-val<a>";
char constantarr_0_1026[4] = "poll";
char constantarr_0_1027[14] = "handle-revents";
char constantarr_0_1028[7] = "revents";
char constantarr_0_1029[10] = "has-POLLIN";
char constantarr_0_1030[14] = "bits-intersect";
char constantarr_0_1031[9] = "!=<int16>";
char constantarr_0_1032[24] = "read-to-buffer-until-eof";
char constantarr_0_1033[22] = "unsafe-set-size!<char>";
char constantarr_0_1034[4] = "read";
char constantarr_0_1035[8] = "to-nat64";
char constantarr_0_1036[10] = "cmp<int64>";
char constantarr_0_1037[8] = "<<int64>";
char constantarr_0_1038[2] = "fd";
char constantarr_0_1039[11] = "has-POLLHUP";
char constantarr_0_1040[7] = "POLLHUP";
char constantarr_0_1041[11] = "has-POLLPRI";
char constantarr_0_1042[7] = "POLLPRI";
char constantarr_0_1043[11] = "has-POLLOUT";
char constantarr_0_1044[7] = "POLLOUT";
char constantarr_0_1045[11] = "has-POLLERR";
char constantarr_0_1046[7] = "POLLERR";
char constantarr_0_1047[12] = "has-POLLNVAL";
char constantarr_0_1048[8] = "POLLNVAL";
char constantarr_0_1049[21] = "handle-revents-result";
char constantarr_0_1050[3] = "any";
char constantarr_0_1051[10] = "had-POLLIN";
char constantarr_0_1052[7] = "hung-up";
char constantarr_0_1053[22] = "wait-and-get-exit-code";
char constantarr_0_1054[7] = "waitpid";
char constantarr_0_1055[9] = "WIFEXITED";
char constantarr_0_1056[8] = "WTERMSIG";
char constantarr_0_1057[11] = "WEXITSTATUS";
char constantarr_0_1058[2] = ">>";
char constantarr_0_1059[10] = "cmp<int32>";
char constantarr_0_1060[8] = "<<int32>";
char constantarr_0_1061[11] = "todo<int32>";
char constantarr_0_1062[22] = "unsafe-bit-shift-right";
char constantarr_0_1063[11] = "WIFSIGNALED";
char constantarr_0_1064[7] = "to-base";
char constantarr_0_1065[12] = "digit-to-str";
char constantarr_0_1066[3] = "mod";
char constantarr_0_1067[3] = "abs";
char constantarr_0_1068[17] = "with-value<int32>";
char constantarr_0_1069[10] = "WIFSTOPPED";
char constantarr_0_1070[12] = "WIFCONTINUED";
char constantarr_0_1071[14] = "process-result";
char constantarr_0_1072[12] = "convert-args";
char constantarr_0_1073[18] = "~<const-ptr<char>>";
char constantarr_0_1074[25] = "map<const-ptr<char>, str>";
char constantarr_0_1075[33] = "map<const-ptr<char>, str>.lambda0";
char constantarr_0_1076[20] = "convert-args.lambda0";
char constantarr_0_1077[15] = "convert-environ";
char constantarr_0_1078[25] = "mut-list<const-ptr<char>>";
char constantarr_0_1079[14] = "each<str, str>";
char constantarr_0_1080[22] = "each<str, str>.lambda0";
char constantarr_0_1081[19] = "~=<const-ptr<char>>";
char constantarr_0_1082[23] = "convert-environ.lambda0";
char constantarr_0_1083[19] = "as<const-ptr<char>>";
char constantarr_0_1084[29] = "move-to-arr!<const-ptr<char>>";
char constantarr_0_1085[21] = "throw<process-result>";
char constantarr_0_1086[9] = "exit-code";
char constantarr_0_1087[16] = "as<arr<failure>>";
char constantarr_0_1088[13] = "handle-output";
char constantarr_0_1089[13] = "try-read-file";
char constantarr_0_1090[4] = "open";
char constantarr_0_1091[8] = "O_RDONLY";
char constantarr_0_1092[14] = "todo<opt<str>>";
char constantarr_0_1093[5] = "lseek";
char constantarr_0_1094[8] = "seek-end";
char constantarr_0_1095[8] = "seek-set";
char constantarr_0_1096[20] = "ptr-cast<nat8, char>";
char constantarr_0_1097[20] = "cast-immutable<char>";
char constantarr_0_1098[10] = "write-file";
char constantarr_0_1099[9] = "as<nat32>";
char constantarr_0_1100[1] = "|";
char constantarr_0_1101[2] = "<<";
...
char constantarr_0_1111[7] = "failure";
char constantarr_0_1112[17] = "is-empty<failure>";
char constantarr_0_1113[17] = "print-test-result";
char constantarr_0_1114[13] = "remove-colors";
char constantarr_0_1115[20] = "remove-colors-recur!";
char constantarr_0_1116[10] = "tail<char>";
char constantarr_0_1117[22] = "remove-colors-recur-2!";
char constantarr_0_1118[11] = "should-stop";
char constantarr_0_1119[18] = "some<arr<failure>>";
char constantarr_0_1120[8] = "failures";
char constantarr_0_1121[28] = "run-single-crow-test.lambda0";
char constantarr_0_1122[24] = "run-single-runnable-test";
char constantarr_0_1123[10] = "~<failure>";
char constantarr_0_1124[22] = "run-crow-tests.lambda0";
char constantarr_0_1125[17] = "with-value<nat64>";
char constantarr_0_1126[17] = "err<arr<failure>>";
char constantarr_0_1127[23] = "do-test.lambda0.lambda0";
char constantarr_0_1128[15] = "do-test.lambda0";
char constantarr_0_1129[4] = "lint";
char constantarr_0_1130[19] = "list-lintable-files";
char constantarr_0_1131[18] = "excluded-from-lint";
char constantarr_0_1132[7] = "in<str>";
char constantarr_0_1133[11] = "exists<str>";
char constantarr_0_1134[9] = "ends-with";
char constantarr_0_1135[15] = "ends-with<char>";
char constantarr_0_1136[26] = "excluded-from-lint.lambda0";
char constantarr_0_1137[27] = "list-lintable-files.lambda0";
char constantarr_0_1138[31] = "should-ignore-extension-of-name";
char constantarr_0_1139[23] = "should-ignore-extension";
char constantarr_0_1140[18] = "ignored-extensions";
char constantarr_0_1141[27] = "list-lintable-files.lambda1";
char constantarr_0_1142[9] = "lint-file";
char constantarr_0_1143[9] = "read-file";
char constantarr_0_1144[20] = "each-with-index<str>";
char constantarr_0_1145[24] = "each-with-index-recur<a>";
char constantarr_0_1146[25] = "subscript<void, a, nat64>";
char constantarr_0_1147[5] = "lines";
char constantarr_0_1148[11] = "cell<nat64>";
char constantarr_0_1149[21] = "each-with-index<char>";
char constantarr_0_1150[11] = "swap<nat64>";
char constantarr_0_1151[13] = "lines.lambda0";
char constantarr_0_1152[8] = "line-len";
char constantarr_0_1153[6] = "n-tabs";
char constantarr_0_1154[8] = "tab-size";
char constantarr_0_1155[15] = "max-line-length";
char constantarr_0_1156[17] = "lint-file.lambda0";
char constantarr_0_1157[12] = "lint.lambda0";
char constantarr_0_1158[15] = "do-test.lambda1";
char constantarr_0_1159[14] = "print-failures";
char constantarr_0_1160[19] = "value<arr<failure>>";
char constantarr_0_1161[13] = "print-failure";
char constantarr_0_1162[10] = "print-bold";
char constantarr_0_1163[4] = "path";
char constantarr_0_1164[11] = "print-reset";
char constantarr_0_1165[22] = "print-failures.lambda0";
char constantarr_0_1166[12] = "test-options";
char constantarr_0_1167[11] = "static-syms";
...
struct backtrace get_backtrace(struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			hard_assert(_4);
			copy_data_from__e_0(ctx, arrs1->funs, (struct arr_5) {1093, constantarr_5_0}.begin_ptr, (struct arr_5) {1093, constantarr_5_0}.size);
			sort__e_0(arrs1->funs, (struct arr_5) {1093, constantarr_5_0}.size);
		...
		case 1: {
			...
			switch (_1.kind) {
				...
				case 1: {
					...
					struct opt_8 _2 = try_alloc_uninitialized_2(ctx, (struct arr_5) {1093, constantarr_5_0}.size);
					switch (_2.kind) {
						case 0: {
							return (struct opt_4) {0, .as0 = (struct none) {}};
						}
...
struct void_ fill_code_names__e(struct ctx* ctx, struct sym* code_names, struct sym* end_code_names, uint8_t** code_ptrs, struct named_val* funs) {
	...
	if (_0) {
		...
		struct sym _2 = get_fun_name(_1, funs, (struct arr_5) {1093, constantarr_5_0}.size);
		*code_names = _2;
...
struct void_ run_garbage_collection(struct gc* gc, struct island_gc_root gc_root) {
	...
	mark_visit_361((&mark_ctx0), gc_root);
...
struct void_ mark_visit_361(struct mark_ctx* mark_ctx, struct island_gc_root value) {
	return mark_visit_362(mark_ctx, value.tasks);
}
/* mark-visit<task-queue> (generated) (generated) */
struct void_ mark_visit_362(struct mark_ctx* mark_ctx, struct task_queue value) {
	mark_visit_363(mark_ctx, value.head);
	return mark_visit_415(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_368(struct mark_ctx* mark_ctx, struct callback__e_0__lambda0 value) {
	...
	return mark_visit_372(mark_ctx, value.cb);
}
/* mark-visit<fut<void>> (generated) (generated) */
struct void_ mark_visit_369(struct mark_ctx* mark_ctx, struct fut_1 value) {
	return mark_visit_370(mark_ctx, value.state);
}
...
struct void_ mark_visit_370(struct mark_ctx* mark_ctx, struct fut_state_1 value) {
	...
	switch (_0.kind) {
		...
		case 3: {
			...
			return mark_visit_393(mark_ctx, value3);
		}
		default:
...
struct void_ mark_visit_371(struct mark_ctx* mark_ctx, struct fut_state_callbacks_1 value) {
	mark_visit_372(mark_ctx, value.cb);
	return mark_visit_399(mark_ctx, value.next);
}
...
struct void_ mark_visit_373(struct mark_ctx* mark_ctx, struct then__lambda0 value) {
	...
	return mark_visit_388(mark_ctx, value.res);
}
/* mark-visit<fun-ref1<nat64, void>> (generated) (generated) */
struct void_ mark_visit_374(struct mark_ctx* mark_ctx, struct fun_ref1 value) {
	return mark_visit_375(mark_ctx, value.fun);
}
...
struct void_ mark_visit_375(struct mark_ctx* mark_ctx, struct fun_act1_4 value) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return mark_visit_382(mark_ctx, value0);
		}
		default:
...
struct void_ mark_visit_377(struct mark_ctx* mark_ctx, struct fun_ref0 value) {
	return mark_visit_378(mark_ctx, value.fun);
}
...
struct void_ mark_visit_379(struct mark_ctx* mark_ctx, struct add_first_task__lambda0 value) {
	return mark_arr_380(mark_ctx, value.all_args);
}
...
struct void_ mark_visit_383(struct mark_ctx* mark_ctx, struct fut_0 value) {
	return mark_visit_384(mark_ctx, value.state);
}
...
struct void_ mark_visit_384(struct mark_ctx* mark_ctx, struct fut_state_0 value) {
	...
	switch (_0.kind) {
		...
		case 1: {
			...
			return mark_visit_392(mark_ctx, value1);
		}
		case 2: {
			return (struct void_) {};
		}
...
struct void_ mark_visit_385(struct mark_ctx* mark_ctx, struct fut_state_callbacks_0 value) {
	mark_visit_386(mark_ctx, value.cb);
	return mark_visit_390(mark_ctx, value.next);
}
...
struct void_ mark_visit_387(struct mark_ctx* mark_ctx, struct forward_to__e__lambda0 value) {
	return mark_visit_388(mark_ctx, value.to);
}
...
struct void_ mark_visit_391(struct mark_ctx* mark_ctx, struct some_0 value) {
	return mark_visit_392(mark_ctx, value.value);
}
...
struct void_ mark_visit_393(struct mark_ctx* mark_ctx, struct exception value) {
	mark_visit_394(mark_ctx, value.message);
	return mark_visit_396(mark_ctx, value.backtrace);
}
/* mark-visit<str> (generated) (generated) */
struct void_ mark_visit_394(struct mark_ctx* mark_ctx, struct str value) {
	return mark_arr_395(mark_ctx, value.chars);
}
...
struct void_ mark_visit_396(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_397(mark_ctx, value.return_stack);
}
...
struct void_ mark_visit_400(struct mark_ctx* mark_ctx, struct some_10 value) {
	return mark_visit_401(mark_ctx, value.value);
}
...
struct void_ mark_visit_404(struct mark_ctx* mark_ctx, struct callback__e_1__lambda0 value) {
	mark_visit_388(mark_ctx, value.f);
	return mark_visit_386(mark_ctx, value.cb);
}
...
struct void_ mark_visit_410(struct mark_ctx* mark_ctx, struct subscript_15__lambda0__lambda0 value) {
	mark_visit_377(mark_ctx, value.f);
	return mark_visit_388(mark_ctx, value.res);
}
...
struct void_ mark_visit_415(struct mark_ctx* mark_ctx, struct mut_list_0 value) {
	return mark_visit_416(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat64>> (generated) (generated) */
struct void_ mark_visit_416(struct mark_ctx* mark_ctx, struct mut_arr_0 value) {
	return mark_arr_417(mark_ctx, value.inner);
}
...
struct comparison subscript_34(struct ctx* ctx, struct fun_act1_11 a, struct arrow_1 p0) {
	return call_w_ctx_528(a, ctx, p0);
}
...
struct arrow_2 subscript_41(struct ctx* ctx, struct fun_act1_13 a, struct arrow_1 p0) {
	return call_w_ctx_606(a, ctx, p0);
}
...
struct arrow_2 subscript_42(struct ctx* ctx, struct fun_act2_3 a, struct str p0, struct arr_2 p1) {
	return call_w_ctx_609(a, ctx, p0, p1);
}
...
struct void_ subscript_44(struct ctx* ctx, struct fun_act3_0 a, struct void_ p0, struct str p1, struct arr_2 p2) {
	return call_w_ctx_647(a, ctx, p0, p1, p2);
}
...
struct str subscript_46(struct ctx* ctx, struct fun_act2_5 a, struct str p0, struct arr_9 p1) {
	return call_w_ctx_656(a, ctx, p0, p1);
}
...
struct void_ subscript_53(struct ctx* ctx, struct fun_act2_4 a, struct str p0, struct arr_2 p1) {
	return call_w_ctx_681(a, ctx, p0, p1);
}
...
struct comparison subscript_72(struct ctx* ctx, struct fun_act2_7 a, struct arrow_4 p0, struct arrow_4 p1) {
	return call_w_ctx_854(a, ctx, p0, p1);
}
...
struct str subscript_73(struct ctx* ctx, struct fun_act1_19 a, struct arrow_4 p0) {
	return call_w_ctx_858(a, ctx, p0);
}
...
struct arrow_4 subscript_74(struct ctx* ctx, struct fun_act1_21 a, struct arrow_3 p0) {
	return call_w_ctx_866(a, ctx, p0);
}
...
struct comparison subscript_79(struct ctx* ctx, struct fun_act2_9 a, struct str p0, struct str p1) {
	return call_w_ctx_945(a, ctx, p0, p1);
}
...
struct opt_22 subscript_86(struct ctx* ctx, struct fun_act1_25 a, struct str p0) {
	return call_w_ctx_1010(a, ctx, p0);
}
...
struct str subscript_87(struct ctx* ctx, struct fun_act2_10 a, struct str p0, struct str p1) {
	return call_w_ctx_1017(a, ctx, p0, p1);
}
...
struct pollfd subscript_88(struct ctx* ctx, struct fun_act1_26 a, uint64_t p0) {
	return call_w_ctx_1042(a, ctx, p0);
}
...
char* subscript_91(struct ctx* ctx, struct fun_act1_28 a, uint64_t p0) {
	return call_w_ctx_1113(a, ctx, p0);
}
...
char* subscript_92(struct ctx* ctx, struct fun_act1_27 a, struct str p0) {
	return call_w_ctx_1115(a, ctx, p0);
}
...
struct void_ subscript_93(struct ctx* ctx, struct fun_act3_1 a, struct void_ p0, struct str p1, struct str p2) {
	return call_w_ctx_1135(a, ctx, p0, p1, p2);
}
...
struct void_ subscript_102(struct ctx* ctx, struct fun_act2_11 a, struct str p0, struct str p1) {
	return call_w_ctx_1168(a, ctx, p0, p1);
}
...
struct void_ subscript_104(struct ctx* ctx, struct fun_act2_13 a, struct str p0, uint64_t p1) {
	return call_w_ctx_1245(a, ctx, p0, p1);
}
...
struct arr_2 lines(struct ctx* ctx, struct str s) {
	...
	*temp1 = (struct lines__lambda0) {last_nl1, res0, s};
	...
	struct arrow_0 _4 = _arrow_0(ctx, _2, _3);
...
struct void_ subscript_105(struct ctx* ctx, struct fun_act2_14 a, char p0, uint64_t p1) {
	return call_w_ctx_1250(a, ctx, p0, p1);
}
