...
struct comparison compare_287(uint32_t a, uint32_t b);
...
struct comparison compare_308(uint8_t a, uint8_t b);
...
uint8_t _op_less_1(uint32_t a, uint32_t b) {
	uint32_t _0 = a;
	uint32_t _1 = b;
	struct comparison _2 = compare_287(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 1;
		}
...
uint8_t _op_equal_equal_4(uint8_t a, uint8_t b) {
	uint8_t _0 = a;
	uint8_t _1 = b;
	struct comparison _2 = compare_308(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
