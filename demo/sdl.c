...
struct void_ mark_visit_254(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_255(struct mark_ctx* mark_ctx, struct mut_bag_node* value);
...
struct comparison compare_288(uint32_t a, uint32_t b);
...
uint8_t _op_less_1(uint32_t a, uint32_t b) {
	uint32_t _0 = a;
	uint32_t _1 = b;
	struct comparison _2 = compare_288(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 1;
		}
