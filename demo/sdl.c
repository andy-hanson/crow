...
struct void_ mark_visit_285(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
struct void_ mark_visit_286(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_287(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_288(struct mark_ctx* mark_ctx, struct mut_arr value);
struct void_ mark_arr_289(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct comparison compare_313(uint32_t a, uint32_t b);
...
struct comparison compare_334(uint8_t a, uint8_t b);
...
uint8_t _op_equal_equal_4(uint8_t a, uint8_t b) {
	uint8_t _0 = a;
	uint8_t _1 = b;
	struct comparison _2 = compare_334(_0, _1);
	switch (_2.kind) {
		case 0: {
			return 0;
		}
