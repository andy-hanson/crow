...
uint8_t mark_visit_239(struct mark_ctx* mark_ctx, struct main_0__lambda0* value);
uint8_t mark_visit_240(struct mark_ctx* mark_ctx, struct mut_bag_node* value);
uint8_t mark_visit_241(struct mark_ctx* mark_ctx, struct fun_mut1_1 value);
uint8_t mark_visit_242(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0__lambda1 value);
uint8_t mark_visit_243(struct mark_ctx* mark_ctx, struct call_ref_0__lambda0__lambda1* value);
uint8_t mark_visit_244(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda1 value);
uint8_t mark_visit_245(struct mark_ctx* mark_ctx, struct call_ref_1__lambda0__lambda1* value);
...
char call_8(struct ctx* ctx, struct fun_mut1_6 a, uint64_t p0);
char call_w_ctx_283(struct fun_mut1_6 a, struct ctx* ctx, uint64_t p0);
...
struct comparison compare_293(uint32_t a, uint32_t b);
...
struct comparison compare_319(uint8_t a, uint8_t b);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	repeat(ctx, 20u, (struct fun_mut0_0) {4, .as4 = (temp0 = (struct main_0__lambda0*) alloc(ctx, sizeof(struct main_0__lambda0)), ((*(temp0) = (struct main_0__lambda0) {renderer1, texture2}, 0), temp0))});
...
struct arr_0 _op_plus_1(struct ctx* ctx, struct arr_0 a, struct arr_0 b) {
	...
	return make_arr_1(ctx, _op_plus_0(ctx, a.size, b.size), (struct fun_mut1_6) {0, .as0 = (temp0 = (struct _op_plus_1__lambda0*) alloc(ctx, sizeof(struct _op_plus_1__lambda0)), ((*(temp0) = (struct _op_plus_1__lambda0) {a, b}, 0), temp0))});
}
...
uint8_t make_mut_arr_worker_1(struct ctx* ctx, struct mut_arr_2* m, uint64_t i, struct fun_mut1_6 f) {
	...
	top:
	if (_op_bang_equal_0(i, m->size)) {
		set_at_1(ctx, m, i, call_8(ctx, f, i));
		_tailCallm = m;
		_tailCalli = incr_3(ctx, i);
		_tailCallf = f;
		m = _tailCallm;
...
char call_8(struct ctx* ctx, struct fun_mut1_6 a, uint64_t p0) {
	return call_w_ctx_283(a, ctx, p0);
}
/* call-w-ctx<char, nat-64> (generated) (generated) */
char call_w_ctx_283(struct fun_mut1_6 a, struct ctx* ctx, uint64_t p0) {
	struct fun_mut1_6 match_fun1;
