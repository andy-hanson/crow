...
struct comparison compare_247(uint32_t a, uint32_t b);
...
struct comparison compare_273(uint8_t a, uint8_t b);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	...
	repeat(ctx, 20u, (struct fun_mut0_0) {(fun_ptr2_1) main_0__lambda0, (uint8_t*) (temp0 = (struct main_0__lambda0*) alloc(ctx, sizeof(struct main_0__lambda0)), ((*(temp0) = (struct main_0__lambda0) {renderer1, texture2}, 0), temp0))});
