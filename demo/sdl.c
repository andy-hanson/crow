...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 args) {
	struct ctx* _0 = ctx;
	struct arr_0 _1 = (struct arr_0) {14, constantarr_0_14};
	struct ctx* _2 = ctx;
	...
	struct ctx* _5 = ctx;
	struct arr_0 _6 = (struct arr_0) {12, constantarr_0_16};
	...
	if (_16) {
		struct ctx* _17 = ctx;
		struct arr_0 _18 = (struct arr_0) {17, constantarr_0_17};
	...
	*_28 = _31;
	...
	struct arr_0 _37 = (struct arr_0) {7, constantarr_0_27};
	print(_37);
	struct ctx* _38 = ctx;
	int32_t _39 = 0;
...
struct void_ fail_sdl_error(struct ctx* ctx, struct arr_0 operation) {
	...
	struct ctx* _2 = ctx;
	struct ctx* _3 = ctx;
	struct arr_0 _4 = (struct arr_0) {13, constantarr_0_12};
	struct arr_0 _5 = operation;
	struct arr_0 _6 = _op_plus_1(_3, _4, _5);
	struct arr_0 _7 = (struct arr_0) {1, constantarr_0_13};
	struct arr_0 _8 = _op_plus_1(_2, _6, _7);
	char* _9 = SDL_GetError();
	struct arr_0 _10 = to_str(_9);
	struct arr_0 _11 = _op_plus_1(_1, _8, _10);
	fail(_0, _11);
...
char* to_c_str(struct ctx* ctx, struct arr_0 a) {
	struct ctx* _0 = ctx;
	struct arr_0 _1 = a;
	struct arr_0 _2 = (struct arr_0) {1, constantarr_0_15};
...
struct sdl_renderer* new_renderer(struct ctx* ctx, struct sdl_window* window) {
	...
	if (_9) {
		struct ctx* _10 = ctx;
		struct arr_0 _11 = (struct arr_0) {19, constantarr_0_18};
...
struct sdl_texture* create_texture(struct ctx* ctx, struct sdl_renderer* renderer) {
	...
	struct ctx* _0 = ctx;
	struct arr_0 _1 = (struct arr_0) {14, constantarr_0_19};
	...
	if (_4) {
		struct ctx* _5 = ctx;
		struct arr_0 _6 = (struct arr_0) {17, constantarr_0_21};
	...
	if (_12) {
		struct ctx* _13 = ctx;
		struct arr_0 _14 = (struct arr_0) {31, constantarr_0_22};
...
struct sdl_surface* sdl_load_bmp(struct ctx* ctx, struct arr_0 file) {
	...
	struct ctx* _3 = ctx;
	struct arr_0 _4 = (struct arr_0) {2, constantarr_0_20};
...
struct void_ main_loop(struct ctx* ctx, struct sdl_renderer* renderer, struct sdl_texture* texture) {
	...
	if (_11) {
		_12 = (struct arr_0) {9, constantarr_0_23};
	} else {
		_12 = (struct arr_0) {17, constantarr_0_24};
	}
	print(_12);
	struct ctx* _13 = ctx;
	struct arr_0 _14 = (struct arr_0) {16, constantarr_0_25};
	struct sdl_renderer* _15 = renderer;
	int64_t _16 = SDL_RenderClear(_15);
	handle_sdl_error(_13, _14, _16);
	struct ctx* _17 = ctx;
	struct arr_0 _18 = (struct arr_0) {15, constantarr_0_26};
