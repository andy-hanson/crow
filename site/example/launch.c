...
struct launch__lambda0;
struct fun_ref2;
struct join_1__lambda0;
struct join_1__lambda0__lambda0;
struct subscript_17__lambda0;
struct subscript_17__lambda0__lambda0;
struct subscript_17__lambda0__lambda1 {
	struct fut_0* res;
};
struct join_1__lambda1;
struct join_1__lambda2;
struct comparison {
	uint64_t kind;
	union {
		struct less as0;
...
struct fun_act1_0 {
	...
	union {
		...
		struct void_ as1;
		struct join_1__lambda1* as2;
		struct join_1__lambda2* as3;
	};
};
struct opt_0 {
	uint64_t kind;
...
struct fun_act0_0 {
	...
	union {
		...
		struct launch__lambda0* as4;
		struct subscript_17__lambda0__lambda0* as5;
		struct subscript_17__lambda0* as6;
		struct join_1__lambda0__lambda0* as7;
		struct join_1__lambda0* as8;
	};
};
struct opt_2 {
	uint64_t kind;
...
struct fun_act1_3 {
	...
	union {
		...
		struct subscript_17__lambda0__lambda1* as2;
	};
};
struct fun_act1_4 {
	uint64_t kind;
...
struct fun_ref2 {
	struct island_and_exclusion island_and_exclusion;
	struct fun_act2_1 fun;
};
struct join_1__lambda0 {
	struct lock* lock;
	struct cell_0* remaining;
	struct fut_0* res;
	struct fut_0* a;
	struct fut_0* b;
	struct fun_ref2 f;
...
struct join_1__lambda1 {
	struct fun_act0_0 decr_remaining;
};
struct join_1__lambda2 {
	struct fun_act0_0 decr_remaining;
};
...
_Static_assert(sizeof(struct launch__lambda0) == 16, "");
_Static_assert(sizeof(struct fun_ref2) == 24, "");
_Static_assert(sizeof(struct join_1__lambda0) == 64, "");
_Static_assert(sizeof(struct join_1__lambda0__lambda0) == 56, "");
_Static_assert(sizeof(struct subscript_17__lambda0) == 48, "");
_Static_assert(sizeof(struct subscript_17__lambda0__lambda0) == 48, "");
_Static_assert(sizeof(struct subscript_17__lambda0__lambda1) == 8, "");
_Static_assert(sizeof(struct join_1__lambda1) == 16, "");
_Static_assert(sizeof(struct join_1__lambda2) == 16, "");
...
_Static_assert(sizeof(struct fun0) == 8, "");
...
char constantarr_0_42[12];
char constantarr_0_43[6];
char constantarr_0_44[17];
char constantarr_0_45[7];
char constantarr_0_46[7];
char constantarr_0_47[5];
char constantarr_0_48[16];
char constantarr_0_49[13];
char constantarr_0_50[2];
...
char constantarr_0_125[9];
char constantarr_0_126[13];
char constantarr_0_127[24];
char constantarr_0_128[34];
char constantarr_0_129[9];
char constantarr_0_130[12];
...
char constantarr_0_136[23];
char constantarr_0_137[12];
char constantarr_0_138[5];
char constantarr_0_139[23];
...
char constantarr_0_219[1];
char constantarr_0_220[3];
...
char constantarr_0_282[26];
char constantarr_0_283[7];
char constantarr_0_284[3];
char constantarr_0_285[22];
char constantarr_0_286[2];
char constantarr_0_287[25];
char constantarr_0_288[19];
char constantarr_0_289[30];
char constantarr_0_290[15];
char constantarr_0_291[79];
char constantarr_0_292[14];
char constantarr_0_293[10];
char constantarr_0_294[16];
char constantarr_0_295[24];
...
char constantarr_0_368[36];
char constantarr_0_369[11];
char constantarr_0_370[36];
char constantarr_0_371[28];
char constantarr_0_372[10];
...
char constantarr_0_378[31];
char constantarr_0_379[31];
char constantarr_0_380[23];
...
char constantarr_0_413[80];
char constantarr_0_414[11];
char constantarr_0_415[45];
...
char constantarr_0_471[11];
char constantarr_0_472[9];
char constantarr_0_473[38];
char constantarr_0_474[12];
char constantarr_0_475[12];
...
char constantarr_0_501[46];
char constantarr_0_502[13];
char constantarr_0_503[12];
char constantarr_0_504[8];
char constantarr_0_505[20];
char constantarr_0_506[8];
char constantarr_0_507[14];
char constantarr_0_508[20];
...
char constantarr_0_543[18];
char constantarr_0_544[15];
char constantarr_0_545[8];
char constantarr_0_546[13];
char constantarr_0_547[8];
char constantarr_0_548[30];
char constantarr_0_549[22];
char constantarr_0_550[27];
char constantarr_0_551[34];
char constantarr_0_552[28];
char constantarr_0_553[27];
char constantarr_0_554[17];
char constantarr_0_555[43];
char constantarr_0_556[43];
char constantarr_0_557[35];
char constantarr_0_558[35];
char constantarr_0_559[27];
char constantarr_0_560[27];
char constantarr_0_561[27];
char constantarr_0_562[1];
char constantarr_0_563[3];
...
char constantarr_0_9[2] = ": ";
char constantarr_0_10[12] = "Hello from a";
char constantarr_0_11[12] = "Hello from b";
...
char constantarr_0_22[4] = "mark";
char constantarr_0_23[14] = "words-of-bytes";
char constantarr_0_24[10] = "unsafe-div";
char constantarr_0_25[25] = "round-up-to-multiple-of-8";
char constantarr_0_26[8] = "bits-and";
char constantarr_0_27[8] = "wrap-add";
char constantarr_0_28[8] = "bits-not";
char constantarr_0_29[12] = "as<ptr<nat>>";
char constantarr_0_30[19] = "ptr-cast<nat, nat8>";
char constantarr_0_31[11] = "hard-assert";
char constantarr_0_32[3] = "not";
char constantarr_0_33[5] = "false";
char constantarr_0_34[4] = "true";
char constantarr_0_35[6] = "abort!";
char constantarr_0_36[7] = "==<nat>";
char constantarr_0_37[7] = "<=><?t>";
char constantarr_0_38[11] = "to-nat<nat>";
char constantarr_0_39[6] = "-<nat>";
char constantarr_0_40[8] = "wrap-sub";
char constantarr_0_41[11] = "size-of<?t>";
char constantarr_0_42[12] = "memory-start";
char constantarr_0_43[6] = "<<nat>";
char constantarr_0_44[17] = "memory-size-words";
char constantarr_0_45[7] = "<=<nat>";
char constantarr_0_46[7] = "+<bool>";
char constantarr_0_47[5] = "marks";
char constantarr_0_48[16] = "mark-range-recur";
char constantarr_0_49[13] = "ptr-eq?<bool>";
char constantarr_0_50[2] = "or";
char constantarr_0_51[11] = "deref<bool>";
char constantarr_0_52[9] = "set<bool>";
char constantarr_0_53[10] = "incr<bool>";
char constantarr_0_54[6] = "><nat>";
char constantarr_0_55[7] = "rt-main";
char constantarr_0_56[10] = "get-nprocs";
char constantarr_0_57[22] = "as<by-val<global-ctx>>";
char constantarr_0_58[10] = "global-ctx";
char constantarr_0_59[15] = "new-lock-by-val";
char constantarr_0_60[4] = "lock";
char constantarr_0_61[15] = "new-atomic-bool";
char constantarr_0_62[11] = "atomic-bool";
char constantarr_0_63[13] = "new-condition";
char constantarr_0_64[9] = "condition";
char constantarr_0_65[22] = "ref-of-val<global-ctx>";
char constantarr_0_66[10] = "new-island";
char constantarr_0_67[14] = "new-task-queue";
char constantarr_0_68[10] = "task-queue";
char constantarr_0_69[4] = "none";
char constantarr_0_70[60] = "new-mut-list-by-val-with-capacity-from-unmanaged-memory<nat>";
char constantarr_0_71[11] = "mut-arr<?t>";
char constantarr_0_72[4] = "void";
char constantarr_0_73[7] = "arr<?t>";
char constantarr_0_74[35] = "unmanaged-alloc-zeroed-elements<?t>";
char constantarr_0_75[28] = "unmanaged-alloc-elements<?t>";
char constantarr_0_76[21] = "unmanaged-alloc-bytes";
char constantarr_0_77[6] = "malloc";
char constantarr_0_78[11] = "hard-forbid";
char constantarr_0_79[11] = "null?<nat8>";
char constantarr_0_80[10] = "to-nat<?t>";
char constantarr_0_81[8] = "null<?t>";
char constantarr_0_82[8] = "wrap-mul";
char constantarr_0_83[18] = "set-zero-range<?t>";
char constantarr_0_84[6] = "memset";
char constantarr_0_85[19] = "as-any-ptr<ptr<?t>>";
char constantarr_0_86[12] = "mut-list<?t>";
char constantarr_0_87[26] = "as<by-val<island-gc-root>>";
char constantarr_0_88[14] = "island-gc-root";
char constantarr_0_89[25] = "default-exception-handler";
char constantarr_0_90[20] = "print-err-no-newline";
char constantarr_0_91[16] = "write-no-newline";
char constantarr_0_92[13] = "size-of<char>";
char constantarr_0_93[13] = "size-of<nat8>";
char constantarr_0_94[5] = "write";
char constantarr_0_95[21] = "as-any-ptr<ptr<char>>";
char constantarr_0_96[10] = "data<char>";
char constantarr_0_97[10] = "size<char>";
char constantarr_0_98[7] = "!=<int>";
char constantarr_0_99[6] = "==<?t>";
char constantarr_0_100[13] = "unsafe-to-int";
char constantarr_0_101[10] = "todo<void>";
char constantarr_0_102[10] = "zeroed<?t>";
char constantarr_0_103[6] = "stderr";
char constantarr_0_104[9] = "print-err";
char constantarr_0_105[14] = "show-exception";
char constantarr_0_106[12] = "?<arr<char>>";
char constantarr_0_107[12] = "empty?<char>";
char constantarr_0_108[7] = "message";
char constantarr_0_109[10] = "join<char>";
char constantarr_0_110[15] = "empty?<arr<?t>>";
char constantarr_0_111[8] = "size<?t>";
char constantarr_0_112[18] = "subscript<arr<?t>>";
char constantarr_0_113[6] = "assert";
char constantarr_0_114[10] = "fail<void>";
char constantarr_0_115[9] = "throw<?t>";
char constantarr_0_116[17] = "get-exception-ctx";
char constantarr_0_117[21] = "as-ref<exception-ctx>";
char constantarr_0_118[17] = "exception-ctx-ptr";
char constantarr_0_119[7] = "get-ctx";
char constantarr_0_120[18] = "null?<jmp-buf-tag>";
char constantarr_0_121[11] = "jmp-buf-ptr";
char constantarr_0_122[20] = "set-thrown-exception";
char constantarr_0_123[7] = "longjmp";
char constantarr_0_124[15] = "number-to-throw";
char constantarr_0_125[9] = "exception";
char constantarr_0_126[13] = "get-backtrace";
char constantarr_0_127[24] = "try-alloc-backtrace-arrs";
char constantarr_0_128[34] = "try-alloc-uninitialized<ptr<nat8>>";
char constantarr_0_129[9] = "try-alloc";
char constantarr_0_130[12] = "try-gc-alloc";
char constantarr_0_131[12] = "acquire-lock";
char constantarr_0_132[18] = "acquire-lock-recur";
char constantarr_0_133[16] = "try-acquire-lock";
char constantarr_0_134[7] = "try-set";
char constantarr_0_135[10] = "try-change";
char constantarr_0_136[23] = "compare-exchange-strong";
char constantarr_0_137[12] = "ptr-to<bool>";
char constantarr_0_138[5] = "value";
char constantarr_0_139[23] = "ref-of-val<atomic-bool>";
char constantarr_0_140[9] = "is-locked";
char constantarr_0_141[12] = "yield-thread";
char constantarr_0_142[13] = "pthread-yield";
char constantarr_0_143[9] = "==<int32>";
char constantarr_0_144[10] = "noctx-incr";
char constantarr_0_145[16] = "ref-of-val<lock>";
char constantarr_0_146[2] = "lk";
char constantarr_0_147[18] = "try-gc-alloc-recur";
...
char constantarr_0_168[12] = "release-lock";
char constantarr_0_169[10] = "must-unset";
char constantarr_0_170[9] = "try-unset";
...
char constantarr_0_176[13] = "some<ptr<?t>>";
char constantarr_0_177[18] = "ptr-cast<?t, nat8>";
char constantarr_0_178[16] = "value<ptr<nat8>>";
char constantarr_0_179[34] = "try-alloc-uninitialized<arr<char>>";
char constantarr_0_180[10] = "funs-count";
char constantarr_0_181[20] = "some<backtrace-arrs>";
char constantarr_0_182[14] = "backtrace-arrs";
char constantarr_0_183[21] = "value<ptr<ptr<nat8>>>";
char constantarr_0_184[21] = "value<ptr<arr<char>>>";
char constantarr_0_185[9] = "backtrace";
char constantarr_0_186[18] = "as<arr<arr<char>>>";
char constantarr_0_187[21] = "value<backtrace-arrs>";
char constantarr_0_188[13] = "unsafe-to-nat";
char constantarr_0_189[6] = "to-int";
char constantarr_0_190[9] = "code-ptrs";
char constantarr_0_191[15] = "unsafe-to-int32";
char constantarr_0_192[14] = "code-ptrs-size";
char constantarr_0_193[25] = "fill-fun-ptrs-names-recur";
char constantarr_0_194[7] = "!=<nat>";
char constantarr_0_195[14] = "set<ptr<nat8>>";
char constantarr_0_196[12] = "+<ptr<nat8>>";
char constantarr_0_197[11] = "get-fun-ptr";
char constantarr_0_198[14] = "set<arr<char>>";
char constantarr_0_199[12] = "+<arr<char>>";
char constantarr_0_200[12] = "get-fun-name";
char constantarr_0_201[8] = "fun-ptrs";
char constantarr_0_202[9] = "fun-names";
char constantarr_0_203[13] = "sort-together";
char constantarr_0_204[15] = "swap<ptr<nat8>>";
char constantarr_0_205[9] = "deref<?t>";
char constantarr_0_206[15] = "swap<arr<char>>";
char constantarr_0_207[24] = "partition-recur-together";
char constantarr_0_208[15] = "ptr-less?<nat8>";
char constantarr_0_209[10] = "noctx-decr";
char constantarr_0_210[10] = "code-names";
char constantarr_0_211[21] = "fill-code-names-recur";
char constantarr_0_212[20] = "ptr-less?<arr<char>>";
char constantarr_0_213[15] = "incr<ptr<nat8>>";
char constantarr_0_214[15] = "incr<arr<char>>";
char constantarr_0_215[14] = "arr<arr<char>>";
char constantarr_0_216[12] = "noctx-at<?t>";
char constantarr_0_217[8] = "data<?t>";
char constantarr_0_218[5] = "~<?t>";
char constantarr_0_219[1] = "+";
char constantarr_0_220[3] = "and";
char constantarr_0_221[7] = ">=<nat>";
char constantarr_0_222[23] = "alloc-uninitialized<?t>";
char constantarr_0_223[5] = "alloc";
char constantarr_0_224[8] = "gc-alloc";
char constantarr_0_225[15] = "todo<ptr<nat8>>";
char constantarr_0_226[18] = "copy-data-from<?t>";
char constantarr_0_227[6] = "memcpy";
char constantarr_0_228[5] = "+<?t>";
char constantarr_0_229[13] = "tail<arr<?t>>";
char constantarr_0_230[6] = "forbid";
char constantarr_0_231[13] = "subscript<?t>";
char constantarr_0_232[14] = "from<nat, nat>";
char constantarr_0_233[12] = "to<nat, nat>";
char constantarr_0_234[1] = "-";
char constantarr_0_235[12] = "-><nat, nat>";
char constantarr_0_236[13] = "arrow<?a, ?b>";
char constantarr_0_237[12] = "return-stack";
char constantarr_0_238[29] = "set-any-unhandled-exceptions?";
char constantarr_0_239[14] = "get-global-ctx";
char constantarr_0_240[18] = "as-ref<global-ctx>";
char constantarr_0_241[8] = "gctx-ptr";
char constantarr_0_242[18] = "new-island.lambda0";
char constantarr_0_243[19] = "default-log-handler";
char constantarr_0_244[5] = "print";
char constantarr_0_245[16] = "print-no-newline";
char constantarr_0_246[6] = "stdout";
char constantarr_0_247[6] = "to-str";
char constantarr_0_248[5] = "level";
char constantarr_0_249[18] = "new-island.lambda1";
char constantarr_0_250[6] = "island";
char constantarr_0_251[6] = "new-gc";
char constantarr_0_252[20] = "ptr-cast<bool, nat8>";
char constantarr_0_253[21] = "as-any-ptr<ptr<bool>>";
char constantarr_0_254[23] = "new-thread-safe-counter";
char constantarr_0_255[19] = "thread-safe-counter";
char constantarr_0_256[18] = "ref-of-val<island>";
char constantarr_0_257[11] = "set-islands";
char constantarr_0_258[11] = "arr<island>";
char constantarr_0_259[14] = "ptr-to<island>";
char constantarr_0_260[7] = "do-main";
char constantarr_0_261[17] = "new-exception-ctx";
char constantarr_0_262[13] = "exception-ctx";
char constantarr_0_263[11] = "new-log-ctx";
char constantarr_0_264[7] = "log-ctx";
char constantarr_0_265[26] = "zeroed<fun1<void, logged>>";
char constantarr_0_266[30] = "as<by-val<thread-local-stuff>>";
char constantarr_0_267[18] = "thread-local-stuff";
char constantarr_0_268[25] = "ref-of-val<exception-ctx>";
char constantarr_0_269[19] = "ref-of-val<log-ctx>";
char constantarr_0_270[7] = "new-ctx";
char constantarr_0_271[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_272[12] = "context-head";
char constantarr_0_273[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_274[6] = "set-gc";
char constantarr_0_275[12] = "set-next-ctx";
char constantarr_0_276[13] = "value<gc-ctx>";
char constantarr_0_277[16] = "set-context-head";
char constantarr_0_278[8] = "next-ctx";
char constantarr_0_279[14] = "ref-of-val<gc>";
char constantarr_0_280[11] = "set-handler";
char constantarr_0_281[11] = "log-handler";
char constantarr_0_282[26] = "ref-of-val<island-gc-root>";
char constantarr_0_283[7] = "gc-root";
char constantarr_0_284[3] = "ctx";
char constantarr_0_285[22] = "as-any-ptr<global-ctx>";
char constantarr_0_286[2] = "id";
char constantarr_0_287[25] = "as-any-ptr<exception-ctx>";
char constantarr_0_288[19] = "as-any-ptr<log-ctx>";
char constantarr_0_289[30] = "ref-of-val<thread-local-stuff>";
char constantarr_0_290[15] = "ref-of-val<ctx>";
char constantarr_0_291[79] = "as<fun-act2<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>>";
char constantarr_0_292[14] = "add-first-task";
char constantarr_0_293[10] = "then2<nat>";
char constantarr_0_294[16] = "then<?out, void>";
char constantarr_0_295[24] = "new-unresolved-fut<?out>";
char constantarr_0_296[7] = "fut<?t>";
char constantarr_0_297[23] = "fut-state-callbacks<?t>";
char constantarr_0_298[14] = "then-void<?in>";
char constantarr_0_299[6] = "lk<?t>";
char constantarr_0_300[9] = "state<?t>";
char constantarr_0_301[13] = "set-state<?t>";
char constantarr_0_302[27] = "some<fut-callback-node<?t>>";
char constantarr_0_303[21] = "fut-callback-node<?t>";
char constantarr_0_304[8] = "head<?t>";
char constantarr_0_305[38] = "subscript<void, result<?t, exception>>";
char constantarr_0_306[22] = "call-with-ctx<?r, ?p0>";
char constantarr_0_307[6] = "ok<?t>";
char constantarr_0_308[9] = "value<?t>";
char constantarr_0_309[14] = "err<exception>";
char constantarr_0_310[17] = "forward-to!<?out>";
char constantarr_0_311[13] = "then-void<?t>";
char constantarr_0_312[22] = "resolve-or-reject!<?t>";
char constantarr_0_313[29] = "todo<fut-state-callbacks<?t>>";
char constantarr_0_314[22] = "fut-state-resolved<?t>";
char constantarr_0_315[16] = "value<exception>";
char constantarr_0_316[19] = "call-callbacks!<?t>";
char constantarr_0_317[10] = "drop<void>";
char constantarr_0_318[6] = "cb<?t>";
char constantarr_0_319[28] = "value<fut-callback-node<?t>>";
char constantarr_0_320[13] = "next-node<?t>";
char constantarr_0_321[25] = "forward-to!<?out>.lambda0";
char constantarr_0_322[20] = "subscript<?out, ?in>";
char constantarr_0_323[10] = "get-island";
char constantarr_0_324[17] = "subscript<island>";
char constantarr_0_325[7] = "islands";
char constantarr_0_326[29] = "island-and-exclusion<?r, ?p0>";
char constantarr_0_327[8] = "add-task";
char constantarr_0_328[19] = "new-task-queue-node";
char constantarr_0_329[15] = "task-queue-node";
char constantarr_0_330[4] = "task";
char constantarr_0_331[10] = "tasks-lock";
char constantarr_0_332[12] = "insert-task!";
char constantarr_0_333[4] = "size";
char constantarr_0_334[10] = "size-recur";
char constantarr_0_335[4] = "next";
char constantarr_0_336[22] = "value<task-queue-node>";
char constantarr_0_337[4] = "head";
char constantarr_0_338[8] = "set-head";
char constantarr_0_339[21] = "some<task-queue-node>";
char constantarr_0_340[4] = "time";
char constantarr_0_341[12] = "insert-recur";
char constantarr_0_342[8] = "set-next";
char constantarr_0_343[5] = "tasks";
char constantarr_0_344[22] = "ref-of-val<task-queue>";
char constantarr_0_345[9] = "broadcast";
char constantarr_0_346[9] = "set-value";
char constantarr_0_347[21] = "ref-of-val<condition>";
char constantarr_0_348[17] = "may-be-work-to-do";
char constantarr_0_349[4] = "gctx";
char constantarr_0_350[12] = "no-timestamp";
char constantarr_0_351[9] = "exclusion";
char constantarr_0_352[11] = "catch<void>";
char constantarr_0_353[28] = "catch-with-exception-ctx<?t>";
char constantarr_0_354[16] = "thrown-exception";
char constantarr_0_355[11] = "jmp-buf-tag";
char constantarr_0_356[4] = "zero";
char constantarr_0_357[7] = "bytes64";
char constantarr_0_358[7] = "bytes32";
char constantarr_0_359[7] = "bytes16";
char constantarr_0_360[8] = "bytes128";
char constantarr_0_361[15] = "set-jmp-buf-ptr";
char constantarr_0_362[19] = "ptr-to<jmp-buf-tag>";
char constantarr_0_363[6] = "setjmp";
char constantarr_0_364[17] = "call-with-ctx<?r>";
char constantarr_0_365[24] = "subscript<?t, exception>";
char constantarr_0_366[23] = "subscript<fut<?r>, ?p0>";
char constantarr_0_367[12] = "fun<?r, ?p0>";
char constantarr_0_368[36] = "subscript<?out, ?in>.lambda0.lambda0";
char constantarr_0_369[11] = "reject!<?r>";
char constantarr_0_370[36] = "subscript<?out, ?in>.lambda0.lambda1";
char constantarr_0_371[28] = "subscript<?out, ?in>.lambda0";
char constantarr_0_372[10] = "value<?in>";
char constantarr_0_373[24] = "then<?out, void>.lambda0";
char constantarr_0_374[15] = "subscript<?out>";
char constantarr_0_375[24] = "island-and-exclusion<?r>";
char constantarr_0_376[18] = "subscript<fut<?r>>";
char constantarr_0_377[7] = "fun<?r>";
char constantarr_0_378[31] = "subscript<?out>.lambda0.lambda0";
char constantarr_0_379[31] = "subscript<?out>.lambda0.lambda1";
char constantarr_0_380[23] = "subscript<?out>.lambda0";
char constantarr_0_381[18] = "then2<nat>.lambda0";
char constantarr_0_382[24] = "cur-island-and-exclusion";
char constantarr_0_383[20] = "island-and-exclusion";
char constantarr_0_384[9] = "island-id";
char constantarr_0_385[5] = "delay";
char constantarr_0_386[14] = "resolved<void>";
char constantarr_0_387[15] = "tail<ptr<char>>";
char constantarr_0_388[10] = "empty?<?t>";
char constantarr_0_389[40] = "subscript<fut<nat>, ctx, arr<arr<char>>>";
char constantarr_0_390[25] = "map<arr<char>, ptr<char>>";
char constantarr_0_391[14] = "make-arr<?out>";
char constantarr_0_392[18] = "fill-ptr-range<?t>";
char constantarr_0_393[24] = "fill-ptr-range-recur<?t>";
char constantarr_0_394[18] = "subscript<?t, nat>";
char constantarr_0_395[14] = "subscript<?in>";
char constantarr_0_396[33] = "map<arr<char>, ptr<char>>.lambda0";
char constantarr_0_397[24] = "arr-from-begin-end<char>";
char constantarr_0_398[5] = "-<?t>";
char constantarr_0_399[13] = "find-cstr-end";
char constantarr_0_400[17] = "find-char-in-cstr";
char constantarr_0_401[8] = "==<char>";
char constantarr_0_402[11] = "deref<char>";
char constantarr_0_403[15] = "todo<ptr<char>>";
char constantarr_0_404[10] = "incr<char>";
char constantarr_0_405[30] = "add-first-task.lambda0.lambda0";
char constantarr_0_406[22] = "add-first-task.lambda0";
char constantarr_0_407[22] = "handle-exceptions<nat>";
char constantarr_0_408[26] = "subscript<void, exception>";
char constantarr_0_409[17] = "exception-handler";
char constantarr_0_410[14] = "get-cur-island";
char constantarr_0_411[30] = "handle-exceptions<nat>.lambda0";
char constantarr_0_412[15] = "do-main.lambda0";
char constantarr_0_413[80] = "call-with-ctx<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>";
char constantarr_0_414[11] = "run-threads";
char constantarr_0_415[45] = "unmanaged-alloc-elements<by-val<thread-args>>";
char constantarr_0_416[19] = "start-threads-recur";
char constantarr_0_417[22] = "+<by-val<thread-args>>";
char constantarr_0_418[24] = "set<by-val<thread-args>>";
char constantarr_0_419[11] = "thread-args";
char constantarr_0_420[17] = "create-one-thread";
char constantarr_0_421[14] = "pthread-create";
char constantarr_0_422[9] = "!=<int32>";
char constantarr_0_423[6] = "eagain";
char constantarr_0_424[12] = "as-cell<nat>";
char constantarr_0_425[16] = "as-ref<cell<?t>>";
char constantarr_0_426[36] = "as-any-ptr<ptr<by-val<thread-args>>>";
char constantarr_0_427[10] = "thread-fun";
char constantarr_0_428[19] = "as-ref<thread-args>";
char constantarr_0_429[15] = "thread-function";
char constantarr_0_430[21] = "thread-function-recur";
char constantarr_0_431[10] = "shut-down?";
char constantarr_0_432[18] = "set-n-live-threads";
char constantarr_0_433[14] = "n-live-threads";
char constantarr_0_434[28] = "assert-islands-are-shut-down";
char constantarr_0_435[9] = "needs-gc?";
char constantarr_0_436[17] = "n-threads-running";
char constantarr_0_437[6] = "empty?";
char constantarr_0_438[21] = "has?<task-queue-node>";
char constantarr_0_439[16] = "get-last-checked";
char constantarr_0_440[11] = "choose-task";
char constantarr_0_441[17] = "get-monotime-nsec";
char constantarr_0_442[26] = "as<by-val<cell<timespec>>>";
char constantarr_0_443[14] = "cell<timespec>";
char constantarr_0_444[8] = "timespec";
char constantarr_0_445[13] = "clock-gettime";
char constantarr_0_446[15] = "clock-monotonic";
char constantarr_0_447[26] = "ref-of-val<cell<timespec>>";
char constantarr_0_448[13] = "get<timespec>";
char constantarr_0_449[6] = "tv-sec";
char constantarr_0_450[7] = "tv-nsec";
char constantarr_0_451[9] = "todo<nat>";
char constantarr_0_452[22] = "as<choose-task-result>";
char constantarr_0_453[17] = "choose-task-recur";
char constantarr_0_454[14] = "no-chosen-task";
char constantarr_0_455[21] = "choose-task-in-island";
char constantarr_0_456[32] = "as<choose-task-in-island-result>";
char constantarr_0_457[7] = "do-a-gc";
char constantarr_0_458[7] = "no-task";
char constantarr_0_459[9] = "pop-task!";
char constantarr_0_460[25] = "ref-of-val<mut-list<nat>>";
char constantarr_0_461[28] = "currently-running-exclusions";
char constantarr_0_462[19] = "as<pop-task-result>";
char constantarr_0_463[14] = "contains?<nat>";
char constantarr_0_464[13] = "contains?<?t>";
char constantarr_0_465[19] = "contains-recur?<?t>";
char constantarr_0_466[15] = "temp-as-arr<?t>";
char constantarr_0_467[9] = "inner<?t>";
char constantarr_0_468[19] = "temp-as-mut-arr<?t>";
char constantarr_0_469[11] = "backing<?t>";
char constantarr_0_470[9] = "pop-recur";
char constantarr_0_471[11] = "to-opt-time";
char constantarr_0_472[9] = "some<nat>";
char constantarr_0_473[38] = "push-capacity-must-be-sufficient!<nat>";
char constantarr_0_474[12] = "capacity<?t>";
char constantarr_0_475[12] = "set-size<?t>";
char constantarr_0_476[17] = "noctx-set-at!<?t>";
char constantarr_0_477[7] = "set<?t>";
...
char constantarr_0_494[38] = "noctx-must-remove-unordered-recur!<?t>";
char constantarr_0_495[8] = "drop<?t>";
char constantarr_0_496[30] = "noctx-remove-unordered-at!<?t>";
char constantarr_0_497[14] = "noctx-last<?t>";
char constantarr_0_498[10] = "return-ctx";
char constantarr_0_499[13] = "return-gc-ctx";
char constantarr_0_500[12] = "some<gc-ctx>";
char constantarr_0_501[46] = "run-garbage-collection<by-val<island-gc-root>>";
char constantarr_0_502[13] = "set-needs-gc?";
char constantarr_0_503[12] = "set-gc-count";
char constantarr_0_504[8] = "gc-count";
char constantarr_0_505[20] = "as<by-val<mark-ctx>>";
char constantarr_0_506[8] = "mark-ctx";
char constantarr_0_507[14] = "mark-visit<?a>";
char constantarr_0_508[20] = "ref-of-val<mark-ctx>";
char constantarr_0_509[14] = "clear-free-mem";
char constantarr_0_510[14] = "set-shut-down?";
char constantarr_0_511[7] = "wait-on";
char constantarr_0_512[12] = "before-time?";
char constantarr_0_513[9] = "thread-id";
char constantarr_0_514[18] = "join-threads-recur";
char constantarr_0_515[15] = "join-one-thread";
char constantarr_0_516[27] = "as<by-val<cell<ptr<nat8>>>>";
char constantarr_0_517[15] = "cell<ptr<nat8>>";
char constantarr_0_518[12] = "pthread-join";
char constantarr_0_519[27] = "ref-of-val<cell<ptr<nat8>>>";
char constantarr_0_520[6] = "einval";
char constantarr_0_521[5] = "esrch";
char constantarr_0_522[14] = "get<ptr<nat8>>";
char constantarr_0_523[19] = "unmanaged-free<nat>";
char constantarr_0_524[4] = "free";
char constantarr_0_525[35] = "unmanaged-free<by-val<thread-args>>";
char constantarr_0_526[18] = "ptr-cast<nat8, ?t>";
char constantarr_0_527[8] = "?<int32>";
char constantarr_0_528[25] = "any-unhandled-exceptions?";
char constantarr_0_529[4] = "main";
char constantarr_0_530[11] = "launch<nat>";
char constantarr_0_531[13] = "new-exclusion";
char constantarr_0_532[18] = "get-and-increment!";
char constantarr_0_533[31] = "ref-of-val<thread-safe-counter>";
char constantarr_0_534[14] = "next-exclusion";
char constantarr_0_535[18] = "subscript<fut<?t>>";
char constantarr_0_536[19] = "launch<nat>.lambda0";
char constantarr_0_537[13] = "resolved<nat>";
char constantarr_0_538[12] = "main.lambda0";
char constantarr_0_539[12] = "main.lambda1";
char constantarr_0_540[19] = "join<nat, nat, nat>";
char constantarr_0_541[8] = "new-lock";
char constantarr_0_542[9] = "cell<nat>";
char constantarr_0_543[18] = "as<fun-act0<void>>";
char constantarr_0_544[15] = "with-lock<void>";
char constantarr_0_545[8] = "set<nat>";
char constantarr_0_546[13] = "set-value<?t>";
char constantarr_0_547[8] = "get<nat>";
char constantarr_0_548[30] = "finish-join!<?out, ?in0, ?in1>";
char constantarr_0_549[22] = "hard-unreachable<void>";
char constantarr_0_550[27] = "subscript<?out, ?in0, ?in1>";
char constantarr_0_551[34] = "island-and-exclusion<?r, ?p0, ?p1>";
char constantarr_0_552[28] = "subscript<fut<?r>, ?p0, ?p1>";
char constantarr_0_553[27] = "call-with-ctx<?r, ?p0, ?p1>";
char constantarr_0_554[17] = "fun<?r, ?p0, ?p1>";
char constantarr_0_555[43] = "subscript<?out, ?in0, ?in1>.lambda0.lambda0";
char constantarr_0_556[43] = "subscript<?out, ?in0, ?in1>.lambda0.lambda1";
char constantarr_0_557[35] = "subscript<?out, ?in0, ?in1>.lambda0";
char constantarr_0_558[35] = "join<nat, nat, nat>.lambda0.lambda0";
char constantarr_0_559[27] = "join<nat, nat, nat>.lambda0";
char constantarr_0_560[27] = "join<nat, nat, nat>.lambda1";
char constantarr_0_561[27] = "join<nat, nat, nat>.lambda2";
char constantarr_0_562[1] = "/";
char constantarr_0_563[3] = "mod";
char constantarr_0_564[10] = "unsafe-mod";
char constantarr_0_565[12] = "main.lambda2";
...
struct arr_0 join_0(struct ctx* ctx, struct arr_1 a, struct arr_0 joiner);
...
struct void_ mark_visit_303(struct mark_ctx* mark_ctx, struct join_1__lambda1 value);
struct void_ mark_visit_304(struct mark_ctx* mark_ctx, struct join_1__lambda1* value);
struct void_ mark_visit_305(struct mark_ctx* mark_ctx, struct join_1__lambda2 value);
struct void_ mark_visit_306(struct mark_ctx* mark_ctx, struct join_1__lambda2* value);
struct void_ mark_visit_307(struct mark_ctx* mark_ctx, struct fut_callback_node_0* value);
struct void_ mark_visit_308(struct mark_ctx* mark_ctx, struct exception value);
struct void_ mark_arr_309(struct mark_ctx* mark_ctx, struct arr_0 a);
struct void_ mark_visit_310(struct mark_ctx* mark_ctx, struct backtrace value);
struct void_ mark_elems_311(struct mark_ctx* mark_ctx, struct arr_0* cur, struct arr_0* end);
struct void_ mark_arr_312(struct mark_ctx* mark_ctx, struct arr_1 a);
struct void_ mark_visit_313(struct mark_ctx* mark_ctx, struct subscript_4__lambda0__lambda0* value);
struct void_ mark_visit_314(struct mark_ctx* mark_ctx, struct subscript_4__lambda0 value);
struct void_ mark_visit_315(struct mark_ctx* mark_ctx, struct subscript_4__lambda0* value);
struct void_ mark_visit_316(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0 value);
struct void_ mark_visit_317(struct mark_ctx* mark_ctx, struct subscript_9__lambda0__lambda0* value);
struct void_ mark_visit_318(struct mark_ctx* mark_ctx, struct subscript_9__lambda0 value);
struct void_ mark_visit_319(struct mark_ctx* mark_ctx, struct subscript_9__lambda0* value);
struct void_ mark_visit_320(struct mark_ctx* mark_ctx, struct launch__lambda0 value);
struct void_ mark_visit_321(struct mark_ctx* mark_ctx, struct launch__lambda0* value);
struct void_ mark_visit_322(struct mark_ctx* mark_ctx, struct subscript_17__lambda0__lambda0 value);
struct void_ mark_visit_323(struct mark_ctx* mark_ctx, struct subscript_17__lambda0__lambda0* value);
struct void_ mark_visit_324(struct mark_ctx* mark_ctx, struct subscript_17__lambda0 value);
struct void_ mark_visit_325(struct mark_ctx* mark_ctx, struct subscript_17__lambda0* value);
struct void_ mark_visit_326(struct mark_ctx* mark_ctx, struct join_1__lambda0__lambda0 value);
struct void_ mark_visit_327(struct mark_ctx* mark_ctx, struct cell_0* value);
struct void_ mark_visit_328(struct mark_ctx* mark_ctx, struct join_1__lambda0__lambda0* value);
struct void_ mark_visit_329(struct mark_ctx* mark_ctx, struct join_1__lambda0 value);
struct void_ mark_visit_330(struct mark_ctx* mark_ctx, struct lock* value);
struct void_ mark_visit_331(struct mark_ctx* mark_ctx, struct join_1__lambda0* value);
struct void_ mark_visit_332(struct mark_ctx* mark_ctx, struct task_queue_node* value);
struct void_ mark_visit_333(struct mark_ctx* mark_ctx, struct mut_list value);
struct void_ mark_visit_334(struct mark_ctx* mark_ctx, struct mut_arr value);
struct void_ mark_arr_335(struct mark_ctx* mark_ctx, struct arr_2 a);
...
struct fut_0* launch(struct ctx* ctx, struct fun0 f);
uint64_t new_exclusion(struct island* v);
uint64_t get_and_increment__e(struct thread_safe_counter* t);
struct fut_0* subscript_16(struct ctx* ctx, struct fun0 a);
struct fut_0* call_w_ctx_353(struct fun0 a, struct ctx* ctx);
struct void_ launch__lambda0(struct ctx* ctx, struct launch__lambda0* _closure);
struct fut_0* resolved_1(struct ctx* ctx, uint64_t value);
struct fut_0* main_0__lambda0(struct ctx* ctx, struct void_ _closure);
struct fut_0* main_0__lambda1(struct ctx* ctx, struct void_ _closure);
struct fut_0* join_1(struct ctx* ctx, struct fut_0* a, struct fut_0* b, struct fun_ref2 f);
struct lock* new_lock(struct ctx* ctx);
struct void_ with_lock(struct ctx* ctx, struct lock* l, struct fun_act0_0 f);
struct void_ set(struct cell_0* c, uint64_t v);
uint64_t get_2(struct cell_0* c);
struct void_ finish_join__e(struct ctx* ctx, struct fut_0* res, struct fut_0* a, struct fut_0* b, struct fun_ref2 f);
struct void_ hard_unreachable(void);
struct fut_0* subscript_17(struct ctx* ctx, struct fun_ref2 f, uint64_t p0, uint64_t p1);
struct fut_0* subscript_18(struct ctx* ctx, struct fun_act2_1 a, uint64_t p0, uint64_t p1);
struct fut_0* call_w_ctx_367(struct fun_act2_1 a, struct ctx* ctx, uint64_t p0, uint64_t p1);
struct void_ subscript_17__lambda0__lambda0(struct ctx* ctx, struct subscript_17__lambda0__lambda0* _closure);
struct void_ subscript_17__lambda0__lambda1(struct ctx* ctx, struct subscript_17__lambda0__lambda1* _closure, struct exception it);
struct void_ subscript_17__lambda0(struct ctx* ctx, struct subscript_17__lambda0* _closure);
struct void_ join_1__lambda0__lambda0(struct ctx* ctx, struct join_1__lambda0__lambda0* _closure);
struct void_ join_1__lambda0(struct ctx* ctx, struct join_1__lambda0* _closure);
struct void_ join_1__lambda1(struct ctx* ctx, struct join_1__lambda1* _closure, struct result_0 ignore);
struct void_ join_1__lambda2(struct ctx* ctx, struct join_1__lambda2* _closure, struct result_0 ignore);
...
struct fut_0* main_0__lambda2(struct ctx* ctx, struct void_ _closure, uint64_t a, uint64_t b);
...
struct arr_0 show_exception(struct ctx* ctx, struct exception a) {
	...
	struct arr_0 bt1;
	bt1 = join_0(ctx, a.backtrace.return_stack, (struct arr_0) {5, constantarr_0_6});
...
struct arr_0 join_0(struct ctx* ctx, struct arr_1 a, struct arr_0 joiner) {
	...
	if (_0) {
		...
		if (_1) {
			...
			struct arr_0 _5 = join_0(ctx, _4, joiner);
...
uint8_t* get_fun_ptr_86(uint64_t fun_id) {switch (fun_id) {
		...
		case 353: {
			return (uint8_t*) call_w_ctx_353;
		}
		case 354: {
			return (uint8_t*) launch__lambda0;
		}
		case 355: {
		...
		case 358: {
			return (uint8_t*) join_1;
		}
		case 359: {
			return (uint8_t*) new_lock;
		}
		case 360: {
			return (uint8_t*) with_lock;
		}
		case 361: {
			return (uint8_t*) set;
		}
		...
		case 368: {
			return (uint8_t*) subscript_17__lambda0__lambda0;
		}
		case 369: {
			return (uint8_t*) subscript_17__lambda0__lambda1;
		}
		case 370: {
			return (uint8_t*) subscript_17__lambda0;
		}
		case 371: {
			return (uint8_t*) join_1__lambda0__lambda0;
		}
		case 372: {
			return (uint8_t*) join_1__lambda0;
		}
		case 373: {
			return (uint8_t*) join_1__lambda1;
		}
		case 374: {
			return (uint8_t*) join_1__lambda2;
		}
		case 375: {
...
struct arr_0 get_fun_name_87(uint64_t fun_id) {switch (fun_id) {
		case 0: {
			return (struct arr_0) {4, constantarr_0_22};
		}
		case 1: {
			return (struct arr_0) {14, constantarr_0_23};
		}
		case 2: {
			return (struct arr_0) {25, constantarr_0_25};
		}
		case 3: {
			return (struct arr_0) {11, constantarr_0_31};
		}
		case 4: {
			return (struct arr_0) {3, constantarr_0_32};
		}
		case 5: {
			return (struct arr_0) {6, constantarr_0_35};
		}
		case 6: {
			return (struct arr_0) {7, constantarr_0_36};
		}
		case 7: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 11: {
			return (struct arr_0) {16, constantarr_0_48};
		}
		case 12: {
			return (struct arr_0) {10, constantarr_0_53};
		}
		case 13: {
			return (struct arr_0) {6, constantarr_0_54};
		}
		case 14: {
			return (struct arr_0) {7, constantarr_0_55};
		}
		case 15: {
			return (struct arr_0) {10, constantarr_0_56};
		}
		case 16: {
			return (struct arr_0) {15, constantarr_0_59};
		}
		case 17: {
			return (struct arr_0) {15, constantarr_0_61};
		}
		case 18: {
			return (struct arr_0) {13, constantarr_0_63};
		}
		case 19: {
			return (struct arr_0) {10, constantarr_0_66};
		}
		case 20: {
			return (struct arr_0) {14, constantarr_0_67};
		}
		case 21: {
			return (struct arr_0) {60, constantarr_0_70};
		}
		case 22: {
			return (struct arr_0) {11, constantarr_0_71};
		}
		case 23: {
			return (struct arr_0) {35, constantarr_0_74};
		}
		case 24: {
			return (struct arr_0) {28, constantarr_0_75};
		}
		case 25: {
			return (struct arr_0) {21, constantarr_0_76};
		}
		case 26: {
			return (struct arr_0) {6, constantarr_0_77};
		}
		case 27: {
		...
		case 29: {
			return (struct arr_0) {18, constantarr_0_83};
		}
		case 30: {
			return (struct arr_0) {6, constantarr_0_84};
		}
		case 31: {
			return (struct arr_0) {25, constantarr_0_89};
		}
		case 32: {
			return (struct arr_0) {20, constantarr_0_90};
		}
		case 33: {
			return (struct arr_0) {16, constantarr_0_91};
		}
		case 34: {
			return (struct arr_0) {5, constantarr_0_94};
		}
		case 35: {
			return (struct arr_0) {7, constantarr_0_98};
		}
		case 36: {
			return (struct arr_0) {6, constantarr_0_99};
		}
		case 37: {
			return (struct arr_0) {0u, NULL};
		}
		case 38: {
			return (struct arr_0) {10, constantarr_0_101};
		}
		case 39: {
		...
		case 42: {
			return (struct arr_0) {12, constantarr_0_107};
		}
		case 43: {
			return (struct arr_0) {10, constantarr_0_109};
		}
		case 44: {
			return (struct arr_0) {15, constantarr_0_110};
		}
		case 45: {
			return (struct arr_0) {18, constantarr_0_112};
		}
		case 46: {
		...
		case 49: {
			return (struct arr_0) {17, constantarr_0_116};
		}
		case 50: {
			return (struct arr_0) {18, constantarr_0_120};
		}
		case 51: {
		...
		case 53: {
			return (struct arr_0) {13, constantarr_0_126};
		}
		case 54: {
			return (struct arr_0) {24, constantarr_0_127};
		}
		case 55: {
			return (struct arr_0) {34, constantarr_0_128};
		}
		case 56: {
			return (struct arr_0) {9, constantarr_0_129};
		}
		case 57: {
			return (struct arr_0) {12, constantarr_0_130};
		}
		case 58: {
		...
		case 63: {
			return (struct arr_0) {12, constantarr_0_141};
		}
		case 64: {
			return (struct arr_0) {13, constantarr_0_142};
		}
		case 65: {
		...
		case 70: {
			return (struct arr_0) {18, constantarr_0_149};
		}
		case 71: {
			return (struct arr_0) {17, constantarr_0_154};
		}
		case 72: {
		...
		case 74: {
			return (struct arr_0) {9, constantarr_0_167};
		}
		case 75: {
			return (struct arr_0) {12, constantarr_0_168};
		}
		case 76: {
			return (struct arr_0) {10, constantarr_0_169};
		}
		case 77: {
			return (struct arr_0) {9, constantarr_0_170};
		}
		case 78: {
		...
		case 80: {
			return (struct arr_0) {34, constantarr_0_179};
		}
		case 81: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 84: {
			return (struct arr_0) {25, constantarr_0_193};
		}
		case 85: {
			return (struct arr_0) {7, constantarr_0_194};
		}
		case 86: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 92: {
			return (struct arr_0) {10, constantarr_0_209};
		}
		case 93: {
			return (struct arr_0) {21, constantarr_0_211};
		}
		case 94: {
		...
		case 99: {
			return (struct arr_0) {1, constantarr_0_219};
		}
		case 100: {
			return (struct arr_0) {7, constantarr_0_221};
		}
		case 101: {
			return (struct arr_0) {23, constantarr_0_222};
		}
		case 102: {
			return (struct arr_0) {5, constantarr_0_223};
		}
		case 103: {
			return (struct arr_0) {8, constantarr_0_224};
		}
		case 104: {
			return (struct arr_0) {15, constantarr_0_225};
		}
		case 105: {
		...
		case 111: {
			return (struct arr_0) {1, constantarr_0_234};
		}
		case 112: {
			return (struct arr_0) {12, constantarr_0_235};
		}
		case 113: {
			return (struct arr_0) {14, constantarr_0_239};
		}
		case 114: {
			return (struct arr_0) {18, constantarr_0_242};
		}
		case 115: {
			return (struct arr_0) {19, constantarr_0_243};
		}
		case 116: {
			return (struct arr_0) {5, constantarr_0_244};
		}
		case 117: {
		...
		case 120: {
			return (struct arr_0) {18, constantarr_0_249};
		}
		case 121: {
			return (struct arr_0) {6, constantarr_0_251};
		}
		case 122: {
			return (struct arr_0) {23, constantarr_0_254};
		}
		case 123: {
			return (struct arr_0) {23, constantarr_0_254};
		}
		...
		case 125: {
			return (struct arr_0) {17, constantarr_0_261};
		}
		case 126: {
			return (struct arr_0) {11, constantarr_0_263};
		}
		case 127: {
		...
		case 132: {
			return (struct arr_0) {24, constantarr_0_295};
		}
		case 133: {
			return (struct arr_0) {14, constantarr_0_298};
		}
		case 134: {
			return (struct arr_0) {38, constantarr_0_305};
		}
		case 135: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 137: {
			return (struct arr_0) {13, constantarr_0_311};
		}
		case 138: {
			return (struct arr_0) {38, constantarr_0_305};
		}
		...
		case 140: {
			return (struct arr_0) {22, constantarr_0_312};
		}
		case 141: {
			return (struct arr_0) {29, constantarr_0_313};
		}
		case 142: {
		...
		case 144: {
			return (struct arr_0) {25, constantarr_0_321};
		}
		case 145: {
			return (struct arr_0) {20, constantarr_0_322};
		}
		case 146: {
			return (struct arr_0) {10, constantarr_0_323};
		}
		case 147: {
			return (struct arr_0) {17, constantarr_0_324};
		}
		case 148: {
			return (struct arr_0) {12, constantarr_0_216};
		}
		...
		case 153: {
			return (struct arr_0) {4, constantarr_0_333};
		}
		case 154: {
			return (struct arr_0) {10, constantarr_0_334};
		}
		case 155: {
			return (struct arr_0) {12, constantarr_0_341};
		}
		case 156: {
			return (struct arr_0) {5, constantarr_0_343};
		}
		case 157: {
			return (struct arr_0) {9, constantarr_0_345};
		}
		case 158: {
			return (struct arr_0) {12, constantarr_0_350};
		}
		case 159: {
			return (struct arr_0) {11, constantarr_0_352};
		}
		case 160: {
			return (struct arr_0) {28, constantarr_0_353};
		}
		case 161: {
			return (struct arr_0) {4, constantarr_0_356};
		}
		case 162: {
			return (struct arr_0) {4, constantarr_0_356};
		}
		...
		case 170: {
			return (struct arr_0) {23, constantarr_0_366};
		}
		case 171: {
			return (struct arr_0) {0u, NULL};
		}
		case 172: {
			return (struct arr_0) {36, constantarr_0_368};
		}
		case 173: {
			return (struct arr_0) {11, constantarr_0_369};
		}
		case 174: {
			return (struct arr_0) {36, constantarr_0_370};
		}
		case 175: {
			return (struct arr_0) {28, constantarr_0_371};
		}
		case 176: {
		...
		case 180: {
			return (struct arr_0) {31, constantarr_0_378};
		}
		case 181: {
			return (struct arr_0) {31, constantarr_0_379};
		}
		case 182: {
			return (struct arr_0) {23, constantarr_0_380};
		}
		case 183: {
		...
		case 187: {
			return (struct arr_0) {15, constantarr_0_387};
		}
		case 188: {
		...
		case 190: {
			return (struct arr_0) {25, constantarr_0_390};
		}
		case 191: {
		...
		case 193: {
			return (struct arr_0) {18, constantarr_0_392};
		}
		case 194: {
			return (struct arr_0) {24, constantarr_0_393};
		}
		case 195: {
			return (struct arr_0) {18, constantarr_0_394};
		}
		case 196: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 201: {
			return (struct arr_0) {33, constantarr_0_396};
		}
		case 202: {
			return (struct arr_0) {6, constantarr_0_247};
		}
		case 203: {
			return (struct arr_0) {24, constantarr_0_397};
		}
		case 204: {
			return (struct arr_0) {5, constantarr_0_398};
		}
		case 205: {
			return (struct arr_0) {13, constantarr_0_399};
		}
		case 206: {
		...
		case 214: {
			return (struct arr_0) {26, constantarr_0_408};
		}
		case 215: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 217: {
			return (struct arr_0) {14, constantarr_0_410};
		}
		case 218: {
			return (struct arr_0) {30, constantarr_0_411};
		}
		case 219: {
			return (struct arr_0) {15, constantarr_0_412};
		}
		case 220: {
			return (struct arr_0) {0u, NULL};
		}
		case 221: {
			return (struct arr_0) {11, constantarr_0_414};
		}
		case 222: {
			return (struct arr_0) {45, constantarr_0_415};
		}
		case 223: {
			return (struct arr_0) {19, constantarr_0_416};
		}
		case 224: {
			return (struct arr_0) {17, constantarr_0_420};
		}
		case 225: {
			return (struct arr_0) {14, constantarr_0_421};
		}
		case 226: {
			return (struct arr_0) {9, constantarr_0_422};
		}
		case 227: {
			return (struct arr_0) {6, constantarr_0_423};
		}
		case 228: {
			return (struct arr_0) {12, constantarr_0_424};
		}
		case 229: {
			return (struct arr_0) {10, constantarr_0_427};
		}
		case 230: {
			return (struct arr_0) {15, constantarr_0_429};
		}
		case 231: {
			return (struct arr_0) {21, constantarr_0_430};
		}
		case 232: {
			return (struct arr_0) {28, constantarr_0_434};
		}
		case 233: {
			return (struct arr_0) {6, constantarr_0_437};
		}
		case 234: {
			return (struct arr_0) {21, constantarr_0_438};
		}
		case 235: {
			return (struct arr_0) {10, constantarr_0_388};
		}
		case 236: {
			return (struct arr_0) {16, constantarr_0_439};
		}
		case 237: {
		...
		case 239: {
			return (struct arr_0) {13, constantarr_0_445};
		}
		case 240: {
		...
		case 242: {
			return (struct arr_0) {9, constantarr_0_451};
		}
		case 243: {
			return (struct arr_0) {17, constantarr_0_453};
		}
		case 244: {
			return (struct arr_0) {21, constantarr_0_455};
		}
		case 245: {
			return (struct arr_0) {9, constantarr_0_459};
		}
		case 246: {
			return (struct arr_0) {14, constantarr_0_463};
		}
		case 247: {
			return (struct arr_0) {13, constantarr_0_464};
		}
		case 248: {
		...
		case 252: {
			return (struct arr_0) {19, constantarr_0_468};
		}
		case 253: {
		...
		case 255: {
			return (struct arr_0) {9, constantarr_0_470};
		}
		case 256: {
			return (struct arr_0) {11, constantarr_0_471};
		}
		case 257: {
			return (struct arr_0) {38, constantarr_0_473};
		}
		case 258: {
			return (struct arr_0) {12, constantarr_0_474};
		}
		case 259: {
			return (struct arr_0) {8, constantarr_0_111};
		}
		case 260: {
		...
		case 274: {
			return (struct arr_0) {13, constantarr_0_499};
		}
		case 275: {
			return (struct arr_0) {46, constantarr_0_501};
		}
		case 276: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 337: {
			return (struct arr_0) {7, constantarr_0_511};
		}
		case 338: {
			return (struct arr_0) {12, constantarr_0_512};
		}
		case 339: {
		...
		case 341: {
			return (struct arr_0) {12, constantarr_0_518};
		}
		case 342: {
			return (struct arr_0) {6, constantarr_0_520};
		}
		case 343: {
			return (struct arr_0) {5, constantarr_0_521};
		}
		case 344: {
		...
		case 346: {
			return (struct arr_0) {4, constantarr_0_524};
		}
		case 347: {
			return (struct arr_0) {35, constantarr_0_525};
		}
		case 348: {
		...
		case 352: {
			return (struct arr_0) {18, constantarr_0_535};
		}
		case 353: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 356: {
			return (struct arr_0) {12, constantarr_0_538};
		}
		case 357: {
			return (struct arr_0) {12, constantarr_0_539};
		}
		case 358: {
		...
		case 361: {
			return (struct arr_0) {8, constantarr_0_545};
		}
		case 362: {
			return (struct arr_0) {8, constantarr_0_547};
		}
		case 363: {
			return (struct arr_0) {30, constantarr_0_548};
		}
		case 364: {
			return (struct arr_0) {22, constantarr_0_549};
		}
		case 365: {
			return (struct arr_0) {27, constantarr_0_550};
		}
		case 366: {
			return (struct arr_0) {28, constantarr_0_552};
		}
		case 367: {
			return (struct arr_0) {0u, NULL};
		}
		case 368: {
			return (struct arr_0) {43, constantarr_0_555};
		}
		case 369: {
			return (struct arr_0) {43, constantarr_0_556};
		}
		case 370: {
			return (struct arr_0) {35, constantarr_0_557};
		}
		case 371: {
			return (struct arr_0) {35, constantarr_0_558};
		}
		case 372: {
			return (struct arr_0) {27, constantarr_0_559};
		}
		case 373: {
			return (struct arr_0) {27, constantarr_0_560};
		}
		case 374: {
			return (struct arr_0) {27, constantarr_0_561};
		}
		case 375: {
			return (struct arr_0) {6, constantarr_0_247};
		}
		case 376: {
			return (struct arr_0) {1, constantarr_0_562};
		}
		case 377: {
			return (struct arr_0) {3, constantarr_0_563};
		}
		case 378: {
...
struct void_ call_w_ctx_139(struct fun_act1_0 a, struct ctx* ctx, struct result_0 p0) {
	...
	switch (_0.kind) {
		...
		case 2: {
			struct join_1__lambda1* closure2 = _0.as2;
			
			return join_1__lambda1(ctx, closure2, p0);
		}
		case 3: {
			struct join_1__lambda2* closure3 = _0.as3;
			
			return join_1__lambda2(ctx, closure3, p0);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ call_w_ctx_167(struct fun_act0_0 a, struct ctx* ctx) {
	...
	switch (_0.kind) {
		...
		case 4: {
			struct launch__lambda0* closure4 = _0.as4;
			
			return launch__lambda0(ctx, closure4);
		}
		case 5: {
			struct subscript_17__lambda0__lambda0* closure5 = _0.as5;
			
			return subscript_17__lambda0__lambda0(ctx, closure5);
		}
		case 6: {
			struct subscript_17__lambda0* closure6 = _0.as6;
			
			return subscript_17__lambda0(ctx, closure6);
		}
		case 7: {
			struct join_1__lambda0__lambda0* closure7 = _0.as7;
			
			return join_1__lambda0__lambda0(ctx, closure7);
		}
		case 8: {
			struct join_1__lambda0* closure8 = _0.as8;
			
			return join_1__lambda0(ctx, closure8);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ call_w_ctx_169(struct fun_act1_3 a, struct ctx* ctx, struct exception p0) {
	...
	switch (_0.kind) {
		...
		case 2: {
			struct subscript_17__lambda0__lambda1* closure2 = _0.as2;
			
			return subscript_17__lambda0__lambda1(ctx, closure2, p0);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ mark_visit_277(struct mark_ctx* mark_ctx, struct task_queue value) {
	...
	return mark_visit_333(mark_ctx, value.currently_running_exclusions);
}
...
struct void_ mark_visit_282(struct mark_ctx* mark_ctx, struct fun_act0_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_317(mark_ctx, value2);
		}
		case 3: {
			struct subscript_9__lambda0* value3 = _0.as3;
			
			return mark_visit_319(mark_ctx, value3);
		}
		case 4: {
			struct launch__lambda0* value4 = _0.as4;
			
			return mark_visit_321(mark_ctx, value4);
		}
		case 5: {
			struct subscript_17__lambda0__lambda0* value5 = _0.as5;
			
			return mark_visit_323(mark_ctx, value5);
		}
		case 6: {
			struct subscript_17__lambda0* value6 = _0.as6;
			
			return mark_visit_325(mark_ctx, value6);
		}
		case 7: {
			struct join_1__lambda0__lambda0* value7 = _0.as7;
			
			return mark_visit_328(mark_ctx, value7);
		}
		case 8: {
			struct join_1__lambda0* value8 = _0.as8;
			
			return mark_visit_331(mark_ctx, value8);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ mark_visit_294(struct mark_ctx* mark_ctx, struct fut_state_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return mark_visit_308(mark_ctx, value2);
		}
		default:
			return (struct void_) {};
	}
...
struct void_ mark_visit_297(struct mark_ctx* mark_ctx, struct some_0 value) {
	return mark_visit_307(mark_ctx, value.value);
}
...
struct void_ mark_visit_299(struct mark_ctx* mark_ctx, struct fun_act1_0 value) {
	...
	switch (_0.kind) {
		...
		case 2: {
			struct join_1__lambda1* value2 = _0.as2;
			
			return mark_visit_304(mark_ctx, value2);
		}
		case 3: {
			struct join_1__lambda2* value3 = _0.as3;
			
			return mark_visit_306(mark_ctx, value3);
		}
		default:
			return (struct void_) {};
	}
...
/* mark-visit<join<nat, nat, nat>.lambda1> (generated) (generated) */
struct void_ mark_visit_303(struct mark_ctx* mark_ctx, struct join_1__lambda1 value) {
	return mark_visit_282(mark_ctx, value.decr_remaining);
}
/* mark-visit<gc-ptr(join<nat, nat, nat>.lambda1)> (generated) (generated) */
struct void_ mark_visit_304(struct mark_ctx* mark_ctx, struct join_1__lambda1* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct join_1__lambda1));
	if (_0) {
...
/* mark-visit<join<nat, nat, nat>.lambda2> (generated) (generated) */
struct void_ mark_visit_305(struct mark_ctx* mark_ctx, struct join_1__lambda2 value) {
	return mark_visit_282(mark_ctx, value.decr_remaining);
}
/* mark-visit<gc-ptr(join<nat, nat, nat>.lambda2)> (generated) (generated) */
struct void_ mark_visit_306(struct mark_ctx* mark_ctx, struct join_1__lambda2* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct join_1__lambda2));
	if (_0) {
...
struct void_ mark_visit_308(struct mark_ctx* mark_ctx, struct exception value) {
	mark_arr_309(mark_ctx, value.message);
	return mark_visit_310(mark_ctx, value.backtrace);
}
...
struct void_ mark_visit_310(struct mark_ctx* mark_ctx, struct backtrace value) {
	return mark_arr_312(mark_ctx, value.return_stack);
}
...
struct void_ mark_arr_312(struct mark_ctx* mark_ctx, struct arr_1 a) {
	...
	if (_0) {
		return mark_elems_311(mark_ctx, a.data, (a.data + a.size));
	} else {
		return (struct void_) {};
	}
}
...
/* mark-visit<launch<nat>.lambda0> (generated) (generated) */
struct void_ mark_visit_320(struct mark_ctx* mark_ctx, struct launch__lambda0 value) {
	return mark_visit_301(mark_ctx, value.res);
}
/* mark-visit<gc-ptr(launch<nat>.lambda0)> (generated) (generated) */
struct void_ mark_visit_321(struct mark_ctx* mark_ctx, struct launch__lambda0* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct launch__lambda0));
	if (_0) {
...
/* mark-visit<subscript<?out, ?in0, ?in1>.lambda0.lambda0> (generated) (generated) */
struct void_ mark_visit_322(struct mark_ctx* mark_ctx, struct subscript_17__lambda0__lambda0 value) {
	return mark_visit_301(mark_ctx, value.res);
}
/* mark-visit<gc-ptr(subscript<?out, ?in0, ?in1>.lambda0.lambda0)> (generated) (generated) */
struct void_ mark_visit_323(struct mark_ctx* mark_ctx, struct subscript_17__lambda0__lambda0* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct subscript_17__lambda0__lambda0));
	if (_0) {
...
/* mark-visit<subscript<?out, ?in0, ?in1>.lambda0> (generated) (generated) */
struct void_ mark_visit_324(struct mark_ctx* mark_ctx, struct subscript_17__lambda0 value) {
	return mark_visit_301(mark_ctx, value.res);
}
/* mark-visit<gc-ptr(subscript<?out, ?in0, ?in1>.lambda0)> (generated) (generated) */
struct void_ mark_visit_325(struct mark_ctx* mark_ctx, struct subscript_17__lambda0* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct subscript_17__lambda0));
	if (_0) {
...
/* mark-visit<join<nat, nat, nat>.lambda0.lambda0> (generated) (generated) */
struct void_ mark_visit_326(struct mark_ctx* mark_ctx, struct join_1__lambda0__lambda0 value) {
	mark_visit_327(mark_ctx, value.remaining);
	mark_visit_301(mark_ctx, value.res);
	mark_visit_301(mark_ctx, value.a);
	return mark_visit_301(mark_ctx, value.b);
}
/* mark-visit<gc-ptr(cell<nat>)> (generated) (generated) */
struct void_ mark_visit_327(struct mark_ctx* mark_ctx, struct cell_0* value) {
	uint8_t dropped0;
	dropped0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct cell_0));
	
	return (struct void_) {};
}
/* mark-visit<gc-ptr(join<nat, nat, nat>.lambda0.lambda0)> (generated) (generated) */
struct void_ mark_visit_328(struct mark_ctx* mark_ctx, struct join_1__lambda0__lambda0* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct join_1__lambda0__lambda0));
	if (_0) {
...
/* mark-visit<join<nat, nat, nat>.lambda0> (generated) (generated) */
struct void_ mark_visit_329(struct mark_ctx* mark_ctx, struct join_1__lambda0 value) {
	mark_visit_330(mark_ctx, value.lock);
	mark_visit_327(mark_ctx, value.remaining);
	mark_visit_301(mark_ctx, value.res);
	mark_visit_301(mark_ctx, value.a);
	return mark_visit_301(mark_ctx, value.b);
}
/* mark-visit<gc-ptr(lock)> (generated) (generated) */
struct void_ mark_visit_330(struct mark_ctx* mark_ctx, struct lock* value) {
	uint8_t dropped0;
	dropped0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct lock));
	
	return (struct void_) {};
}
/* mark-visit<gc-ptr(join<nat, nat, nat>.lambda0)> (generated) (generated) */
struct void_ mark_visit_331(struct mark_ctx* mark_ctx, struct join_1__lambda0* value) {
	uint8_t _0 = mark(mark_ctx, (uint8_t*) value, sizeof(struct join_1__lambda0));
	if (_0) {
...
struct void_ mark_visit_333(struct mark_ctx* mark_ctx, struct mut_list value) {
	return mark_visit_334(mark_ctx, value.backing);
}
/* mark-visit<mut-arr<nat>> (generated) (generated) */
struct void_ mark_visit_334(struct mark_ctx* mark_ctx, struct mut_arr value) {
	return mark_arr_335(mark_ctx, value.inner);
}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	struct fut_0* fut_a0;
	fut_a0 = launch(ctx, (struct fun0) {0, .as0 = (struct void_) {}});
	
	struct fut_0* fut_b1;
	fut_b1 = launch(ctx, (struct fun0) {1, .as1 = (struct void_) {}});
	
	struct island_and_exclusion _0 = cur_island_and_exclusion(ctx);
	return join_1(ctx, fut_a0, fut_b1, (struct fun_ref2) {_0, (struct fun_act2_1) {0, .as0 = (struct void_) {}}});
}
/* launch<nat> fut<nat>(f fun0<fut<nat>>) */
struct fut_0* launch(struct ctx* ctx, struct fun0 f) {
	struct fut_0* res0;
	res0 = new_unresolved_fut(ctx);
	...
	uint64_t _0 = new_exclusion(island1);
	struct launch__lambda0* temp0;
	uint8_t* _1 = alloc(ctx, sizeof(struct launch__lambda0));
	temp0 = (struct launch__lambda0*) _1;
	
	*temp0 = (struct launch__lambda0) {f, res0};
	add_task_0(ctx, island1, _0, (struct fun_act0_0) {4, .as4 = temp0});
	return res0;
}
...
/* subscript<fut<?t>> fut<nat>(a fun0<fut<nat>>) */
struct fut_0* subscript_16(struct ctx* ctx, struct fun0 a) {
	return call_w_ctx_353(a, ctx);
}
/* call-w-ctx<gc-ptr(fut<nat>)> (generated) (generated) */
struct fut_0* call_w_ctx_353(struct fun0 a, struct ctx* ctx) {
	struct fun0 _0 = a;
	switch (_0.kind) {
		case 0: {
			...
			return main_0__lambda0(ctx, closure0);
		}
		case 1: {
			struct void_ closure1 = _0.as1;
...
/* launch<nat>.lambda0 void() */
struct void_ launch__lambda0(struct ctx* ctx, struct launch__lambda0* _closure) {
	struct fut_0* _0 = subscript_16(ctx, _closure->f);
	return forward_to__e(ctx, _0, _closure->res);
}
...
struct fut_0* main_0__lambda0(struct ctx* ctx, struct void_ _closure) {
	print((struct arr_0) {12, constantarr_0_10});
	uint64_t _0 = _plus(ctx, 1u, 1u);
	return resolved_1(ctx, _0);
}
/* main.lambda1 fut<nat>() */
struct fut_0* main_0__lambda1(struct ctx* ctx, struct void_ _closure) {
	print((struct arr_0) {12, constantarr_0_11});
	uint64_t _0 = _plus(ctx, 2u, 2u);
	return resolved_1(ctx, _0);
}
/* join<nat, nat, nat> fut<nat>(a fut<nat>, b fut<nat>, f fun-ref2<nat, nat, nat>) */
struct fut_0* join_1(struct ctx* ctx, struct fut_0* a, struct fut_0* b, struct fun_ref2 f) {
	struct fut_0* res0;
	res0 = new_unresolved_fut(ctx);
	...
	struct cell_0* remaining2;
	struct cell_0* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct cell_0));
	temp0 = (struct cell_0*) _0;
	
	*temp0 = (struct cell_0) {2u};
	remaining2 = temp0;
	
	struct fun_act0_0 decr_remaining3;
	struct join_1__lambda0* temp1;
	uint8_t* _1 = alloc(ctx, sizeof(struct join_1__lambda0));
	temp1 = (struct join_1__lambda0*) _1;
	
	*temp1 = (struct join_1__lambda0) {lock1, remaining2, res0, a, b, f};
	decr_remaining3 = (struct fun_act0_0) {8, .as8 = temp1};
	
	struct join_1__lambda1* temp2;
	uint8_t* _2 = alloc(ctx, sizeof(struct join_1__lambda1));
	temp2 = (struct join_1__lambda1*) _2;
	
	*temp2 = (struct join_1__lambda1) {decr_remaining3};
	then_void_1(ctx, a, (struct fun_act1_0) {2, .as2 = temp2});
	struct join_1__lambda2* temp3;
	uint8_t* _3 = alloc(ctx, sizeof(struct join_1__lambda2));
	temp3 = (struct join_1__lambda2*) _3;
	
	*temp3 = (struct join_1__lambda2) {decr_remaining3};
	then_void_1(ctx, b, (struct fun_act1_0) {3, .as3 = temp3});
	return res0;
}
/* new-lock lock() */
struct lock* new_lock(struct ctx* ctx) {
	struct lock* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct lock));
	temp0 = (struct lock*) _0;
	
	struct _atomic_bool _1 = new_atomic_bool();
	*temp0 = (struct lock) {_1};
	return temp0;
}
/* with-lock<void> void(l lock, f fun-act0<void>) */
struct void_ with_lock(struct ctx* ctx, struct lock* l, struct fun_act0_0 f) {
	acquire_lock(l);
	struct void_ res0;
...
/* set<nat> void(c cell<nat>, v nat) */
struct void_ set(struct cell_0* c, uint64_t v) {
	return (c->value = v, (struct void_) {});
}
/* get<nat> nat(c cell<nat>) */
uint64_t get_2(struct cell_0* c) {
	return c->value;
}
/* finish-join!<?out, ?in0, ?in1> void(res fut<nat>, a fut<nat>, b fut<nat>, f fun-ref2<nat, nat, nat>) */
struct void_ finish_join__e(struct ctx* ctx, struct fut_0* res, struct fut_0* a, struct fut_0* b, struct fun_ref2 f) {
	struct fut_state_0 _0 = a->state;
	switch (_0.kind) {
		case 0: {
			return hard_unreachable();
		}
		case 1: {
			struct fut_state_resolved_0 resolved_a0 = _0.as1;
			
			struct fut_state_0 _1 = b->state;
			switch (_1.kind) {
				case 0: {
					return hard_unreachable();
				}
				case 1: {
					struct fut_state_resolved_0 resolved_b1 = _1.as1;
					
					struct fut_0* _2 = subscript_17(ctx, f, resolved_a0.value, resolved_b1.value);
					return forward_to__e(ctx, _2, res);
				}
				case 2: {
					struct exception e2 = _1.as2;
					
					return reject__e(ctx, res, e2);
				}
				default:
					return (struct void_) {};
			}
		...
		case 2: {
			struct exception e3 = _0.as2;
			
			return reject__e(ctx, res, e3);
		}
		default:
			return (struct void_) {};
	}
...
/* subscript<?out, ?in0, ?in1> fut<nat>(f fun-ref2<nat, nat, nat>, p0 nat, p1 nat) */
struct fut_0* subscript_17(struct ctx* ctx, struct fun_ref2 f, uint64_t p0, uint64_t p1) {
	struct island* island0;
	island0 = get_island(ctx, f.island_and_exclusion.island);
	...
	struct subscript_17__lambda0* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct subscript_17__lambda0));
	temp0 = (struct subscript_17__lambda0*) _0;
	
	*temp0 = (struct subscript_17__lambda0) {f, p0, p1, res1};
	add_task_0(ctx, island0, f.island_and_exclusion.exclusion, (struct fun_act0_0) {6, .as6 = temp0});
	return res1;
}
/* subscript<fut<?r>, ?p0, ?p1> fut<nat>(a fun-act2<fut<nat>, nat, nat>, p0 nat, p1 nat) */
struct fut_0* subscript_18(struct ctx* ctx, struct fun_act2_1 a, uint64_t p0, uint64_t p1) {
	return call_w_ctx_367(a, ctx, p0, p1);
}
/* call-w-ctx<gc-ptr(fut<nat>), nat-64, nat-64> (generated) (generated) */
struct fut_0* call_w_ctx_367(struct fun_act2_1 a, struct ctx* ctx, uint64_t p0, uint64_t p1) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return main_0__lambda2(ctx, closure0, p0, p1);
		}
		default:
			return NULL;
	}
}
/* subscript<?out, ?in0, ?in1>.lambda0.lambda0 void() */
struct void_ subscript_17__lambda0__lambda0(struct ctx* ctx, struct subscript_17__lambda0__lambda0* _closure) {
	struct fut_0* _0 = subscript_18(ctx, _closure->f.fun, _closure->p0, _closure->p1);
	return forward_to__e(ctx, _0, _closure->res);
}
/* subscript<?out, ?in0, ?in1>.lambda0.lambda1 void(it exception) */
struct void_ subscript_17__lambda0__lambda1(struct ctx* ctx, struct subscript_17__lambda0__lambda1* _closure, struct exception it) {
	return reject__e(ctx, _closure->res, it);
}
/* subscript<?out, ?in0, ?in1>.lambda0 void() */
struct void_ subscript_17__lambda0(struct ctx* ctx, struct subscript_17__lambda0* _closure) {
	struct subscript_17__lambda0__lambda0* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct subscript_17__lambda0__lambda0));
	temp0 = (struct subscript_17__lambda0__lambda0*) _0;
	
	*temp0 = (struct subscript_17__lambda0__lambda0) {_closure->f, _closure->p0, _closure->p1, _closure->res};
	struct subscript_17__lambda0__lambda1* temp1;
	uint8_t* _1 = alloc(ctx, sizeof(struct subscript_17__lambda0__lambda1));
	temp1 = (struct subscript_17__lambda0__lambda1*) _1;
	
	*temp1 = (struct subscript_17__lambda0__lambda1) {_closure->res};
	return catch(ctx, (struct fun_act0_0) {5, .as5 = temp0}, (struct fun_act1_3) {2, .as2 = temp1});
}
/* join<nat, nat, nat>.lambda0.lambda0 void() */
struct void_ join_1__lambda0__lambda0(struct ctx* ctx, struct join_1__lambda0__lambda0* _closure) {
	uint64_t _0 = get_2(_closure->remaining);
	uint64_t _1 = _minus_2(ctx, _0, 1u);
	set(_closure->remaining, _1);
	uint64_t _2 = get_2(_closure->remaining);
	uint8_t _3 = _equal_0(_2, 0u);
	if (_3) {
		return finish_join__e(ctx, _closure->res, _closure->a, _closure->b, _closure->f);
	} else {
		return (struct void_) {};
	}
}
/* join<nat, nat, nat>.lambda0 void() */
struct void_ join_1__lambda0(struct ctx* ctx, struct join_1__lambda0* _closure) {
	struct join_1__lambda0__lambda0* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct join_1__lambda0__lambda0));
	temp0 = (struct join_1__lambda0__lambda0*) _0;
	
	*temp0 = (struct join_1__lambda0__lambda0) {_closure->remaining, _closure->res, _closure->a, _closure->b, _closure->f};
	return with_lock(ctx, _closure->lock, (struct fun_act0_0) {7, .as7 = temp0});
}
/* join<nat, nat, nat>.lambda1 void(ignore result<nat, exception>) */
struct void_ join_1__lambda1(struct ctx* ctx, struct join_1__lambda1* _closure, struct result_0 ignore) {
	return subscript_6(ctx, _closure->decr_remaining);
}
/* join<nat, nat, nat>.lambda2 void(ignore result<nat, exception>) */
struct void_ join_1__lambda2(struct ctx* ctx, struct join_1__lambda2* _closure, struct result_0 ignore) {
	return subscript_6(ctx, _closure->decr_remaining);
}
...
/* main.lambda2 fut<nat>(a nat, b nat) */
struct fut_0* main_0__lambda2(struct ctx* ctx, struct void_ _closure, uint64_t a, uint64_t b) {
	uint64_t _0 = _plus(ctx, a, b);
