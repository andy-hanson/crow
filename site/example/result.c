...
_Static_assert(sizeof(struct rect) == 32, "");
_Static_assert(sizeof(struct ok_2) == 8, "");
_Static_assert(sizeof(struct err_1) == 8, "");
_Static_assert(sizeof(struct vec_2) == 16, "");
_Static_assert(sizeof(struct float_range) == 16, "");
...
_Static_assert(sizeof(struct result_2) == 16, "");
...
char constantarr_0_493[37];
char constantarr_0_494[8];
char constantarr_0_495[35];
...
char constantarr_0_9[2] = ": ";
char constantarr_0_10[14] = "intersection: ";
char constantarr_0_11[1] = "<";
...
char constantarr_0_24[2] = ", ";
char constantarr_0_25[1] = ">";
char constantarr_0_26[4] = " to ";
char constantarr_0_27[7] = "off by ";
...
char constantarr_0_242[17] = "new-exception-ctx";
char constantarr_0_243[13] = "exception-ctx";
char constantarr_0_244[11] = "new-log-ctx";
...
char constantarr_0_251[7] = "new-ctx";
char constantarr_0_252[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_253[12] = "acquire-lock";
char constantarr_0_254[18] = "acquire-lock-recur";
char constantarr_0_255[16] = "try-acquire-lock";
char constantarr_0_256[7] = "try-set";
char constantarr_0_257[10] = "try-change";
char constantarr_0_258[23] = "compare-exchange-strong";
char constantarr_0_259[12] = "ptr-to<bool>";
char constantarr_0_260[5] = "value";
char constantarr_0_261[23] = "ref-of-val<atomic-bool>";
char constantarr_0_262[9] = "is-locked";
char constantarr_0_263[12] = "yield-thread";
char constantarr_0_264[13] = "pthread-yield";
char constantarr_0_265[9] = "==<int32>";
char constantarr_0_266[16] = "ref-of-val<lock>";
char constantarr_0_267[2] = "lk";
...
char constantarr_0_275[12] = "release-lock";
char constantarr_0_276[10] = "must-unset";
char constantarr_0_277[9] = "try-unset";
...
char constantarr_0_309[16] = "forward-to<?out>";
char constantarr_0_310[13] = "then-void<?t>";
char constantarr_0_311[21] = "resolve-or-reject<?t>";
char constantarr_0_312[27] = "resolve-or-reject-recur<?t>";
char constantarr_0_313[4] = "void";
...
char constantarr_0_320[24] = "forward-to<?out>.lambda0";
...
char constantarr_0_331[11] = "insert-task";
...
char constantarr_0_363[13] = "subscript<?t>";
...
char constantarr_0_369[10] = "reject<?r>";
...
char constantarr_0_459[8] = "pop-task";
...
char constantarr_0_472[37] = "push-capacity-must-be-sufficient<nat>";
char constantarr_0_473[12] = "capacity<?t>";
char constantarr_0_474[12] = "set-size<?t>";
char constantarr_0_475[16] = "noctx-set-at<?t>";
...
char constantarr_0_491[11] = "return-task";
char constantarr_0_492[32] = "noctx-must-remove-unordered<nat>";
char constantarr_0_493[37] = "noctx-must-remove-unordered-recur<?t>";
char constantarr_0_494[8] = "drop<?t>";
char constantarr_0_495[35] = "noctx-remove-unordered-at-index<?t>";
...
char constantarr_0_543[1] = "x";
char constantarr_0_544[1] = "y";
char constantarr_0_545[11] = "bottom-left";
char constantarr_0_546[5] = "vec-2";
char constantarr_0_547[4] = "left";
char constantarr_0_548[6] = "bottom";
char constantarr_0_549[11] = "value<rect>";
char constantarr_0_550[9] = "top-right";
char constantarr_0_551[5] = "right";
char constantarr_0_552[3] = "top";
char constantarr_0_553[12] = "value<float>";
char constantarr_0_554[24] = "intersection-or-distance";
char constantarr_0_555[8] = "<<float>";
char constantarr_0_556[3] = "max";
char constantarr_0_557[3] = "min";
char constantarr_0_558[10] = "err<float>";
char constantarr_0_559[8] = "><float>";
char constantarr_0_560[15] = "ok<float-range>";
char constantarr_0_561[11] = "float-range";
char constantarr_0_562[10] = "max<float>";
char constantarr_0_563[10] = "min<float>";
char constantarr_0_564[7] = "x-range";
char constantarr_0_565[7] = "y-range";
char constantarr_0_566[8] = "ok<rect>";
char constantarr_0_567[18] = "value<float-range>";
char constantarr_0_568[6] = "length";
char constantarr_0_569[11] = "square-root";
char constantarr_0_570[14] = "length-squared";
char constantarr_0_571[1] = "^";
char constantarr_0_572[4] = "decr";
...
struct arr_0 to_str_2(struct ctx* ctx, struct result_2 a);
struct arr_0 to_str_3(struct ctx* ctx, struct vec_2 a);
...
struct arr_0 to_str_6(struct ctx* ctx, uint64_t n);
...
struct vec_2 bottom_left(struct ctx* ctx, struct rect* a);
struct vec_2 top_right(struct ctx* ctx, struct rect* a);
struct result_2 intersection_or_distance_0(struct ctx* ctx, struct rect* a, struct rect* b);
struct result_3 intersection_or_distance_1(struct ctx* ctx, struct float_range a, struct float_range b);
uint8_t _less_2(double a, double b);
struct comparison compare_356(double a, double b);
uint8_t _greater_1(double a, double b);
double max(double a, double b);
double min_1(double a, double b);
struct float_range x_range(struct ctx* ctx, struct rect* a);
struct float_range y_range(struct ctx* ctx, struct rect* a);
struct rect* rect(struct ctx* ctx, struct float_range x_range, struct float_range y_range);
double length(struct ctx* ctx, struct vec_2 a);
extern double sqrt(double a);
double length_squared(struct ctx* ctx, struct vec_2 a);
double _power(struct ctx* ctx, double a, uint64_t b);
...
uint8_t* get_fun_ptr_74(uint64_t fun_id) {switch (fun_id) {
		...
		case 351: {
			return (uint8_t*) bottom_left;
		}
		case 352: {
			return (uint8_t*) top_right;
		}
		case 353: {
			return (uint8_t*) intersection_or_distance_0;
		}
		case 354: {
			return (uint8_t*) intersection_or_distance_1;
		}
		case 355: {
		...
		case 360: {
			return (uint8_t*) x_range;
		}
		case 361: {
			return (uint8_t*) y_range;
		}
		case 362: {
			return (uint8_t*) rect;
		}
		...
		case 365: {
			return (uint8_t*) length_squared;
		}
		case 366: {
			return (uint8_t*) _power;
		}
		case 367: {
			return (uint8_t*) decr;
		}
...
struct arr_0 get_fun_name_75(uint64_t fun_id) {switch (fun_id) {
		...
		case 5: {
			return (struct arr_0) {5, constantarr_0_41};
		}
		case 6: {
		...
		case 114: {
			return (struct arr_0) {17, constantarr_0_242};
		}
		case 115: {
		...
		case 122: {
			return (struct arr_0) {10, constantarr_0_257};
		}
		case 123: {
		...
		case 141: {
			return (struct arr_0) {21, constantarr_0_311};
		}
		case 142: {
			return (struct arr_0) {27, constantarr_0_312};
		}
		case 143: {
		...
		case 258: {
			return (struct arr_0) {37, constantarr_0_472};
		}
		case 259: {
		...
		case 267: {
			return (struct arr_0) {32, constantarr_0_492};
		}
		case 268: {
			return (struct arr_0) {37, constantarr_0_493};
		}
		case 269: {
			return (struct arr_0) {12, constantarr_0_203};
		}
		...
		case 271: {
			return (struct arr_0) {35, constantarr_0_495};
		}
		case 272: {
		...
		case 353: {
			return (struct arr_0) {24, constantarr_0_554};
		}
		case 354: {
			return (struct arr_0) {24, constantarr_0_554};
		}
		...
		case 363: {
			return (struct arr_0) {6, constantarr_0_568};
		}
		case 364: {
		...
		case 366: {
			return (struct arr_0) {1, constantarr_0_571};
		}
		case 367: {
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	struct rect* a0;
	struct rect* temp0;
	uint8_t* _0 = alloc(ctx, sizeof(struct rect));
	temp0 = (struct rect*) _0;
	
	*temp0 = (struct rect) {0.0, 1.0, 0.0, 1.0};
	a0 = temp0;
	
	struct rect* b1;
	struct rect* temp1;
	uint8_t* _1 = alloc(ctx, sizeof(struct rect));
	temp1 = (struct rect*) _1;
	
	*temp1 = (struct rect) {0x1.8000000000000p-1, 0x1.c000000000000p0, 0.5, 1.5};
	b1 = temp1;
	
	struct rect* c2;
	struct rect* temp2;
	uint8_t* _2 = alloc(ctx, sizeof(struct rect));
	temp2 = (struct rect*) _2;
	
	*temp2 = (struct rect) {1.5, 2.5, 0.0, 1.0};
	c2 = temp2;
	
	struct result_2 _3 = intersection_or_distance_0(ctx, a0, b1);
	struct arr_0 _4 = to_str_2(ctx, _3);
	print(_4);
	struct result_2 _5 = intersection_or_distance_0(ctx, b1, c2);
	struct arr_0 _6 = to_str_2(ctx, _5);
	print(_6);
	struct result_2 _7 = intersection_or_distance_0(ctx, a0, c2);
	struct arr_0 _8 = to_str_2(ctx, _7);
	print(_8);
	return resolved_1(ctx, 0u);
}
/* to-str arr<char>(a result<rect, float>) */
struct arr_0 to_str_2(struct ctx* ctx, struct result_2 a) {
	...
	switch (_0.kind) {
		case 0: {
			...
			struct vec_2 _1 = bottom_left(ctx, o0.value);
			struct arr_0 _2 = to_str_3(ctx, _1);
			struct arr_0 _3 = _plus_0(ctx, (struct arr_0) {14, constantarr_0_10}, _2);
			struct arr_0 _4 = _plus_0(ctx, _3, (struct arr_0) {4, constantarr_0_26});
			struct vec_2 _5 = top_right(ctx, o0.value);
			struct arr_0 _6 = to_str_3(ctx, _5);
			return _plus_0(ctx, _4, _6);
		}
		case 1: {
			struct err_1 e1 = _0.as1;
			
			struct arr_0 _7 = to_str_4(ctx, e1.value);
			return _plus_0(ctx, (struct arr_0) {7, constantarr_0_27}, _7);
		}
		default:
			return (struct arr_0) {0, NULL};
	}
}
/* to-str arr<char>(a vec-2) */
struct arr_0 to_str_3(struct ctx* ctx, struct vec_2 a) {
	struct arr_0 _0 = to_str_4(ctx, a.x);
	struct arr_0 _1 = _plus_0(ctx, (struct arr_0) {1, constantarr_0_11}, _0);
	struct arr_0 _2 = _plus_0(ctx, _1, (struct arr_0) {2, constantarr_0_24});
	struct arr_0 _3 = to_str_4(ctx, a.y);
	struct arr_0 _4 = _plus_0(ctx, _2, _3);
	return _plus_0(ctx, _4, (struct arr_0) {1, constantarr_0_25});
}
...
struct arr_0 to_str_4(struct ctx* ctx, double a) {
	...
	if (_1) {
		...
		if (_2) {
			struct arr_0 _3 = _plus_0(ctx, whole_part3, (struct arr_0) {1, constantarr_0_23});
			struct arr_0 _4 = to_str_6(ctx, tenths2);
			return _plus_0(ctx, _3, _4);
		} else {
			struct arr_0 _5 = _plus_0(ctx, whole_part3, (struct arr_0) {1, constantarr_0_23});
			struct arr_0 _6 = to_str_6(ctx, hundredths1);
...
struct arr_0 to_str_5(struct ctx* ctx, int64_t i) {
	...
	if (_1) {
		return _plus_0(ctx, (struct arr_0) {1, constantarr_0_22}, a0);
	} else {
		return a0;
	}
}
								...
								if (_7) {
									...
									if (_8) {
										...
										if (_9) {
											...
											hi0 = to_str_6(ctx, _10);
											
											struct arr_0 lo1;
											uint64_t _11 = mod_1(ctx, n, 10u);
											lo1 = to_str_6(ctx, _11);
...
struct vec_2 bottom_left(struct ctx* ctx, struct rect* a) {
	return (struct vec_2) {a->left, a->bottom};
}
/* top-right vec-2(a rect) */
struct vec_2 top_right(struct ctx* ctx, struct rect* a) {
	return (struct vec_2) {a->right, a->top};
}
/* intersection-or-distance result<rect, float>(a rect, b rect) */
struct result_2 intersection_or_distance_0(struct ctx* ctx, struct rect* a, struct rect* b) {
	struct result_3 x0;
	struct float_range _0 = x_range(ctx, a);
	struct float_range _1 = x_range(ctx, b);
	x0 = intersection_or_distance_1(ctx, _0, _1);
	
	struct result_3 y1;
	struct float_range _2 = y_range(ctx, a);
	struct float_range _3 = y_range(ctx, b);
	y1 = intersection_or_distance_1(ctx, _2, _3);
	
	struct result_3 _4 = x0;
	switch (_4.kind) {
		case 0: {
			struct ok_3 x_intersect2 = _4.as0;
			
			struct result_3 _5 = y1;
			switch (_5.kind) {
				case 0: {
					struct ok_3 y_intersect3 = _5.as0;
					
					struct rect* _6 = rect(ctx, x_intersect2.value, y_intersect3.value);
					return (struct result_2) {0, .as0 = (struct ok_2) {_6}};
				}
				case 1: {
					struct err_1 e4 = _5.as1;
					
					return (struct result_2) {1, .as1 = e4};
				}
				default:
		...
		case 1: {
			struct err_1 dx5 = _4.as1;
			
			double dy7;
			struct result_3 _7 = y1;
			switch (_7.kind) {
				case 0: {
					dy7 = 0.0;
					break;
			...
			double _8 = length(ctx, (struct vec_2) {dx5.value, dy7});
			return (struct result_2) {1, .as1 = (struct err_1) {_8}};
		}
		default:
			return (struct result_2) {0};
	}
...
struct result_3 intersection_or_distance_1(struct ctx* ctx, struct float_range a, struct float_range b) {
	uint8_t _0 = _less_2(a.max, b.min);
	if (_0) {
		return (struct result_3) {1, .as1 = (struct err_1) {(b.min - a.max)}};
	} else {
		uint8_t _1 = _greater_1(a.min, b.max);
		if (_1) {
			return (struct result_3) {1, .as1 = (struct err_1) {(a.min - b.max)}};
		} else {
			double _2 = max(a.min, b.min);
			double _3 = min_1(b.max, a.max);
			return (struct result_3) {0, .as0 = (struct ok_3) {(struct float_range) {_2, _3}}};
		}
	}
}
...
/* compare<float-64> (generated) (generated) */
struct comparison compare_356(double a, double b) {
	uint8_t _0 = (a < b);
	if (_0) {
		return (struct comparison) {0, .as0 = (struct less) {}};
...
/* max<float> float(a float, b float) */
double max(double a, double b) {
	uint8_t _0 = _less_2(a, b);
	if (_0) {
		return b;
	} else {
		return a;
...
/* min<float> float(a float, b float) */
double min_1(double a, double b) {
	uint8_t _0 = _less_2(a, b);
	if (_0) {
		return a;
...
struct float_range x_range(struct ctx* ctx, struct rect* a) {
	return (struct float_range) {a->left, a->right};
}
/* y-range float-range(a rect) */
struct float_range y_range(struct ctx* ctx, struct rect* a) {
	return (struct float_range) {a->bottom, a->top};
}
...
struct rect* rect(struct ctx* ctx, struct float_range x_range, struct float_range y_range) {
	...
	*temp0 = (struct rect) {x_range.min, x_range.max, y_range.min, y_range.max};
	return temp0;
}
/* length float(a vec-2) */
double length(struct ctx* ctx, struct vec_2 a) {
	double _0 = length_squared(ctx, a);
	return sqrt(_0);
}
/* length-squared float(a vec-2) */
double length_squared(struct ctx* ctx, struct vec_2 a) {
	double _0 = _power(ctx, a.x, 2u);
	double _1 = _power(ctx, a.y, 2u);
	return (_0 + _1);
}
/* ^ float(a float, b nat) */
double _power(struct ctx* ctx, double a, uint64_t b) {
	...
	if (_0) {
		...
		uint64_t _1 = decr(ctx, b);
		double _2 = _power(ctx, a, _1);
		return (a * _2);
	}
}
/* decr nat(a nat) */
