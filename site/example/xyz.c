...
char constantarr_0_513[11] = "drop<float>";
...
struct void_ drop_2(double _p0);
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	drop_2(0x1.8000000000000pffffffffffffffff);
	print((struct arr_0) {5, constantarr_0_10});
	return resolved_1(ctx, 0u);
}
/* drop<float> void(_ float) */
struct void_ drop_2(double _p0) {
	return (struct void_) {};
}
