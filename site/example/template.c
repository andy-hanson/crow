...
char constantarr_0_11[11] = "nats size: ";
...
char constantarr_0_22[10] = "nats sum: ";
char constantarr_0_23[13] = "floats size: ";
char constantarr_0_24[12] = "floats sum: ";
char constantarr_0_25[1] = "-";
char constantarr_0_26[1] = ".";
char constantarr_0_27[4] = "mark";
char constantarr_0_28[14] = "words-of-bytes";
char constantarr_0_29[10] = "unsafe-div";
char constantarr_0_30[25] = "round-up-to-multiple-of-8";
char constantarr_0_31[8] = "bits-and";
char constantarr_0_32[8] = "wrap-add";
char constantarr_0_33[8] = "bits-not";
char constantarr_0_34[12] = "as<ptr<nat>>";
char constantarr_0_35[19] = "ptr-cast<nat, nat8>";
char constantarr_0_36[11] = "hard-assert";
...
char constantarr_0_43[11] = "to-nat<nat>";
char constantarr_0_44[6] = "-<nat>";
char constantarr_0_45[8] = "wrap-sub";
char constantarr_0_46[11] = "size-of<?t>";
char constantarr_0_47[12] = "memory-start";
char constantarr_0_48[6] = "<<nat>";
char constantarr_0_49[17] = "memory-size-words";
char constantarr_0_50[7] = "<=<nat>";
char constantarr_0_51[7] = "+<bool>";
char constantarr_0_52[5] = "marks";
char constantarr_0_53[16] = "mark-range-recur";
char constantarr_0_54[13] = "ptr-eq?<bool>";
char constantarr_0_55[2] = "or";
char constantarr_0_56[11] = "deref<bool>";
char constantarr_0_57[9] = "set<bool>";
char constantarr_0_58[10] = "incr<bool>";
...
char constantarr_0_64[8] = "new-lock";
char constantarr_0_65[4] = "lock";
char constantarr_0_66[15] = "new-atomic-bool";
char constantarr_0_67[11] = "atomic-bool";
char constantarr_0_68[17] = "empty-arr<island>";
char constantarr_0_69[7] = "arr<?t>";
...
char constantarr_0_78[60] = "new-mut-list-by-val-with-capacity-from-unmanaged-memory<nat>";
char constantarr_0_79[11] = "mut-arr<?t>";
...
char constantarr_0_117[13] = "empty-arr<?t>";
...
char constantarr_0_137[11] = "validate-gc";
char constantarr_0_138[18] = "ptr-less-eq?<bool>";
char constantarr_0_139[13] = "ptr-less?<?t>";
char constantarr_0_140[10] = "mark-begin";
char constantarr_0_141[8] = "mark-cur";
char constantarr_0_142[8] = "mark-end";
char constantarr_0_143[17] = "ptr-less-eq?<nat>";
char constantarr_0_144[11] = "ptr-eq?<?t>";
char constantarr_0_145[10] = "data-begin";
char constantarr_0_146[8] = "data-cur";
...
char constantarr_0_156[9] = "incr<nat>";
...
char constantarr_0_528[9] = "node<nat>";
char constantarr_0_529[15] = "some<node<nat>>";
char constantarr_0_530[11] = "node<float>";
char constantarr_0_531[17] = "some<node<float>>";
char constantarr_0_532[1] = "/";
char constantarr_0_533[3] = "mod";
char constantarr_0_534[10] = "unsafe-mod";
char constantarr_0_535[9] = "size<nat>";
char constantarr_0_536[8] = "tail<?t>";
char constantarr_0_537[15] = "value<node<?t>>";
char constantarr_0_538[8] = "sum<nat>";
char constantarr_0_539[7] = "sum<?t>";
char constantarr_0_540[11] = "size<float>";
char constantarr_0_541[15] = "truncate-to-int";
char constantarr_0_542[1] = "*";
char constantarr_0_543[9] = "negative?";
char constantarr_0_544[6] = "<<int>";
char constantarr_0_545[3] = "abs";
char constantarr_0_546[6] = "?<int>";
char constantarr_0_547[3] = "neg";
char constantarr_0_548[6] = "to-nat";
char constantarr_0_549[7] = "min-int";
char constantarr_0_550[12] = "multiple-of?";
char constantarr_0_551[10] = "sum<float>";
...
uint64_t mod_0(struct ctx* ctx, uint64_t a, uint64_t b);
uint64_t size_2(struct ctx* ctx, struct node_0* a);
uint64_t size_3(struct ctx* ctx, uint64_t acc, struct opt_9 a);
uint64_t sum_0(struct ctx* ctx, struct node_0* a);
uint64_t sum_1(struct ctx* ctx, uint64_t acc, struct opt_9 a);
uint64_t size_4(struct ctx* ctx, struct node_1* a);
uint64_t size_5(struct ctx* ctx, uint64_t acc, struct opt_10 a);
struct arr_0 to_str_3(struct ctx* ctx, double a);
uint64_t mod_1(struct ctx* ctx, int64_t a, uint64_t b);
...
double sum_2(struct ctx* ctx, struct node_1* a);
double sum_3(struct ctx* ctx, double acc, struct opt_10 a);
...
uint8_t* get_fun_ptr_74(uint64_t fun_id) {switch (fun_id) {
		...
		case 339: {
			return (uint8_t*) sum_0;
		}
		case 340: {
			return (uint8_t*) sum_1;
		}
		case 341: {
		...
		case 355: {
			return (uint8_t*) sum_2;
		}
		case 356: {
			return (uint8_t*) sum_3;
		}
		case 357: {
...
struct arr_0 get_fun_name_75(uint64_t fun_id) {switch (fun_id) {
		...
		case 1: {
			return (struct arr_0) {14, constantarr_0_28};
		}
		case 2: {
			return (struct arr_0) {25, constantarr_0_30};
		}
		case 3: {
			return (struct arr_0) {11, constantarr_0_36};
		}
		case 4: {
		...
		case 16: {
			return (struct arr_0) {8, constantarr_0_64};
		}
		case 17: {
			return (struct arr_0) {15, constantarr_0_66};
		}
		case 18: {
			return (struct arr_0) {17, constantarr_0_68};
		}
		case 19: {
		...
		case 22: {
			return (struct arr_0) {60, constantarr_0_78};
		}
		case 23: {
		...
		case 347: {
			return (struct arr_0) {3, constantarr_0_545};
		}
		case 348: {
		...
		case 355: {
			return (struct arr_0) {10, constantarr_0_551};
		}
		case 356: {
			return (struct arr_0) {7, constantarr_0_539};
		}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	...
	struct node_0* nats0;
	struct node_0* temp2;
	uint8_t* _0 = alloc(ctx, sizeof(struct node_0));
	temp2 = (struct node_0*) _0;
	
	struct node_0* temp1;
	uint8_t* _1 = alloc(ctx, sizeof(struct node_0));
	temp1 = (struct node_0*) _1;
	
	struct node_0* temp0;
	uint8_t* _2 = alloc(ctx, sizeof(struct node_0));
	temp0 = (struct node_0*) _2;
	
	*temp0 = (struct node_0) {3u, (struct opt_9) {0, .as0 = (struct none) {}}};
	*temp1 = (struct node_0) {2u, (struct opt_9) {1, .as1 = (struct some_9) {temp0}}};
	*temp2 = (struct node_0) {1u, (struct opt_9) {1, .as1 = (struct some_9) {temp1}}};
	nats0 = temp2;
	
	struct node_1* floats1;
	struct node_1* temp4;
	uint8_t* _3 = alloc(ctx, sizeof(struct node_1));
	temp4 = (struct node_1*) _3;
	
	struct node_1* temp3;
	uint8_t* _4 = alloc(ctx, sizeof(struct node_1));
	temp3 = (struct node_1*) _4;
	
	*temp3 = (struct node_1) {2.2, (struct opt_10) {0, .as0 = (struct none) {}}};
	*temp4 = (struct node_1) {1.1, (struct opt_10) {1, .as1 = (struct some_10) {temp3}}};
	floats1 = temp4;
	
	uint64_t _5 = size_2(ctx, nats0);
	struct arr_0 _6 = to_str_2(ctx, _5);
	struct arr_0 _7 = _plus_0(ctx, (struct arr_0) {11, constantarr_0_11}, _6);
	print(_7);
	uint64_t _8 = sum_0(ctx, nats0);
	struct arr_0 _9 = to_str_2(ctx, _8);
	struct arr_0 _10 = _plus_0(ctx, (struct arr_0) {10, constantarr_0_22}, _9);
	print(_10);
	uint64_t _11 = size_4(ctx, floats1);
	struct arr_0 _12 = to_str_2(ctx, _11);
	struct arr_0 _13 = _plus_0(ctx, (struct arr_0) {13, constantarr_0_23}, _12);
	print(_13);
	double _14 = sum_2(ctx, floats1);
	struct arr_0 _15 = to_str_3(ctx, _14);
	struct arr_0 _16 = _plus_0(ctx, (struct arr_0) {12, constantarr_0_24}, _15);
	print(_16);
...
/* size<nat> nat(a node<nat>) */
uint64_t size_2(struct ctx* ctx, struct node_0* a) {
	return size_3(ctx, 1u, a->tail);
}
/* size<?t> nat(acc nat, a opt<node<nat>>) */
uint64_t size_3(struct ctx* ctx, uint64_t acc, struct opt_9 a) {
	top:;
	struct opt_9 _0 = a;
	switch (_0.kind) {
		...
		case 1: {
			...
			uint64_t _1 = _plus_1(ctx, acc, 1u);
			acc = _1;
			a = s0.value->tail;
			goto top;
		}
...
/* sum<nat> nat(a node<nat>) */
uint64_t sum_0(struct ctx* ctx, struct node_0* a) {
	return sum_1(ctx, a->head, a->tail);
}
/* sum<?t> nat(acc nat, a opt<node<nat>>) */
uint64_t sum_1(struct ctx* ctx, uint64_t acc, struct opt_9 a) {
	top:;
	struct opt_9 _0 = a;
	switch (_0.kind) {
		...
		case 1: {
			...
			uint64_t _1 = _plus_1(ctx, acc, s0.value->head);
			acc = _1;
			a = s0.value->tail;
			goto top;
		}
...
/* size<float> nat(a node<float>) */
uint64_t size_4(struct ctx* ctx, struct node_1* a) {
	return size_5(ctx, 1u, a->tail);
}
/* size<?t> nat(acc nat, a opt<node<float>>) */
uint64_t size_5(struct ctx* ctx, uint64_t acc, struct opt_10 a) {
	top:;
	struct opt_10 _0 = a;
	switch (_0.kind) {
...
struct arr_0 to_str_3(struct ctx* ctx, double a) {
	...
	hundredths1 = mod_1(ctx, times_1000, 100u);
	...
	if (_1) {
		...
		if (_2) {
			struct arr_0 _3 = _plus_0(ctx, whole_part3, (struct arr_0) {1, constantarr_0_26});
			struct arr_0 _4 = to_str_2(ctx, tenths2);
			return _plus_0(ctx, _3, _4);
		} else {
			struct arr_0 _5 = _plus_0(ctx, whole_part3, (struct arr_0) {1, constantarr_0_26});
			struct arr_0 _6 = to_str_2(ctx, hundredths1);
...
struct arr_0 to_str_4(struct ctx* ctx, int64_t i) {
	...
	if (_1) {
		return _plus_0(ctx, (struct arr_0) {1, constantarr_0_25}, a0);
	} else {
		return a0;
	}
}
...
uint8_t multiple_of__q(struct ctx* ctx, uint64_t a, uint64_t b) {
	uint64_t _0 = mod_0(ctx, a, b);
	return _equal_0(_0, 0u);
}
/* sum<float> float(a node<float>) */
double sum_2(struct ctx* ctx, struct node_1* a) {
	return sum_3(ctx, a->head, a->tail);
}
/* sum<?t> float(acc float, a opt<node<float>>) */
double sum_3(struct ctx* ctx, double acc, struct opt_10 a) {
	top:;
	struct opt_10 _0 = a;
	switch (_0.kind) {
