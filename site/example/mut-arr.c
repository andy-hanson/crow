...
struct fun_act1_5 {
	...
	union {
		...
		struct mut_arr_1__lambda0* as1;
		struct copy__lambda0* as2;
	};
};
...
_Static_assert(sizeof(struct copy__lambda0) == 16, "");
...
char constantarr_0_14[8];
char constantarr_0_15[9];
char constantarr_0_16[6];
char constantarr_0_17[10];
char constantarr_0_18[16];
...
char constantarr_0_64[14];
char constantarr_0_65[10];
char constantarr_0_66[4];
char constantarr_0_67[60];
...
struct arr_0 constantarr_1_0[5];
...
char constantarr_0_11[6] = "garlic";
char constantarr_0_12[5] = "onion";
char constantarr_0_13[6] = "pepper";
char constantarr_0_14[8] = "cinnamon";
char constantarr_0_15[9] = "chocolate";
char constantarr_0_16[6] = "a[3]: ";
char constantarr_0_17[10] = "slice[2]: ";
char constantarr_0_18[16] = "ingredients[3]: ";
...
char constantarr_0_60[13] = "new-condition";
char constantarr_0_61[9] = "condition";
char constantarr_0_62[22] = "ref-of-val<global-ctx>";
char constantarr_0_63[10] = "new-island";
char constantarr_0_64[14] = "new-task-queue";
char constantarr_0_65[10] = "task-queue";
char constantarr_0_66[4] = "none";
char constantarr_0_67[60] = "new-mut-list-by-val-with-capacity-from-unmanaged-memory<nat>";
...
char constantarr_0_207[13] = "tail<arr<?t>>";
char constantarr_0_208[6] = "forbid";
char constantarr_0_209[13] = "subscript<?t>";
char constantarr_0_210[14] = "from<nat, nat>";
char constantarr_0_211[12] = "to<nat, nat>";
char constantarr_0_212[1] = "-";
char constantarr_0_213[12] = "-><nat, nat>";
char constantarr_0_214[13] = "arrow<?a, ?b>";
...
char constantarr_0_239[17] = "new-exception-ctx";
char constantarr_0_240[13] = "exception-ctx";
char constantarr_0_241[11] = "new-log-ctx";
...
char constantarr_0_248[7] = "new-ctx";
char constantarr_0_249[18] = "as-any-ptr<gc-ctx>";
char constantarr_0_250[12] = "acquire-lock";
char constantarr_0_251[18] = "acquire-lock-recur";
char constantarr_0_252[16] = "try-acquire-lock";
char constantarr_0_253[7] = "try-set";
char constantarr_0_254[10] = "try-change";
char constantarr_0_255[23] = "compare-exchange-strong";
char constantarr_0_256[12] = "ptr-to<bool>";
char constantarr_0_257[5] = "value";
char constantarr_0_258[23] = "ref-of-val<atomic-bool>";
char constantarr_0_259[9] = "is-locked";
char constantarr_0_260[12] = "yield-thread";
char constantarr_0_261[13] = "pthread-yield";
char constantarr_0_262[9] = "==<int32>";
char constantarr_0_263[16] = "ref-of-val<lock>";
char constantarr_0_264[2] = "lk";
char constantarr_0_265[12] = "context-head";
char constantarr_0_266[23] = "size-of<by-val<gc-ctx>>";
char constantarr_0_267[6] = "set-gc";
char constantarr_0_268[12] = "set-next-ctx";
char constantarr_0_269[13] = "value<gc-ctx>";
char constantarr_0_270[16] = "set-context-head";
char constantarr_0_271[8] = "next-ctx";
char constantarr_0_272[12] = "release-lock";
char constantarr_0_273[10] = "must-unset";
char constantarr_0_274[9] = "try-unset";
...
char constantarr_0_289[10] = "then2<nat>";
char constantarr_0_290[16] = "then<?out, void>";
char constantarr_0_291[24] = "new-unresolved-fut<?out>";
char constantarr_0_292[7] = "fut<?t>";
char constantarr_0_293[23] = "fut-state-callbacks<?t>";
char constantarr_0_294[14] = "then-void<?in>";
...
char constantarr_0_306[16] = "forward-to<?out>";
char constantarr_0_307[13] = "then-void<?t>";
char constantarr_0_308[21] = "resolve-or-reject<?t>";
char constantarr_0_309[27] = "resolve-or-reject-recur<?t>";
...
char constantarr_0_364[10] = "reject<?r>";
...
char constantarr_0_402[22] = "handle-exceptions<nat>";
char constantarr_0_403[26] = "subscript<void, exception>";
char constantarr_0_404[17] = "exception-handler";
char constantarr_0_405[14] = "get-cur-island";
char constantarr_0_406[30] = "handle-exceptions<nat>.lambda0";
char constantarr_0_407[15] = "do-main.lambda0";
char constantarr_0_408[80] = "call-with-ctx<fut<nat>, arr<ptr<char>>, fun-ptr2<fut<nat>, ctx, arr<arr<char>>>>";
...
char constantarr_0_462[9] = "inner<?t>";
...
char constantarr_0_471[17] = "noctx-set-at!<?t>";
...
char constantarr_0_525[18] = "mut-arr<arr<char>>";
char constantarr_0_526[16] = "make-mut-arr<?t>";
char constantarr_0_527[29] = "new-uninitialized-mut-arr<?t>";
char constantarr_0_528[26] = "mut-arr<arr<char>>.lambda0";
char constantarr_0_529[20] = "subscript<arr<char>>";
char constantarr_0_530[24] = "set-subscript<arr<char>>";
char constantarr_0_531[16] = "noctx-set-at<?t>";
char constantarr_0_532[8] = "copy<?t>";
char constantarr_0_533[16] = "copy<?t>.lambda0";
char constantarr_0_534[13] = "resolved<nat>";
struct arr_0 constantarr_1_0[5] = {{5, constantarr_0_10}, {6, constantarr_0_11}, {5, constantarr_0_12}, {6, constantarr_0_13}, {8, constantarr_0_14}};
...
struct mut_arr_0 temp_as_mut_arr(struct mut_list* a);
...
struct arr_0 subscript_16(struct ctx* ctx, struct mut_arr_1 a, uint64_t index);
struct void_ set_subscript(struct ctx* ctx, struct mut_arr_1 a, uint64_t index, struct arr_0 value);
uint64_t size_2(struct mut_arr_1 a);
struct void_ noctx_set_at(struct mut_arr_1 a, uint64_t index, struct arr_0 value);
struct arr_1 arr(struct ctx* ctx, struct mut_arr_1 a);
struct mut_arr_1 copy(struct ctx* ctx, struct mut_arr_1 a);
struct arr_0 copy__lambda0(struct ctx* ctx, struct copy__lambda0* _closure, uint64_t it);
struct mut_arr_1 subscript_17(struct ctx* ctx, struct mut_arr_1 a, struct arrow range);
...
struct arr_0 get_fun_name_73(uint64_t fun_id) {switch (fun_id) {
		...
		case 4: {
			return (struct arr_0) {3, constantarr_0_29};
		}
		case 5: {
			return (struct arr_0) {5, constantarr_0_32};
		}
		case 6: {
		...
		case 18: {
			return (struct arr_0) {13, constantarr_0_60};
		}
		case 19: {
			return (struct arr_0) {10, constantarr_0_63};
		}
		case 20: {
			return (struct arr_0) {14, constantarr_0_64};
		}
		case 21: {
			return (struct arr_0) {60, constantarr_0_67};
		}
		case 22: {
		...
		case 118: {
			return (struct arr_0) {16, constantarr_0_252};
		}
		case 119: {
		...
		case 140: {
			return (struct arr_0) {27, constantarr_0_309};
		}
		case 141: {
		...
		case 212: {
			return (struct arr_0) {26, constantarr_0_403};
		}
		case 213: {
			return (struct arr_0) {0u, NULL};
		}
		...
		case 333: {
			return (struct arr_0) {29, constantarr_0_527};
		}
		case 334: {
			return (struct arr_0) {11, constantarr_0_68};
		}
		...
		case 336: {
			return (struct arr_0) {26, constantarr_0_528};
		}
		case 337: {
			return (struct arr_0) {20, constantarr_0_529};
		}
		case 338: {
			return (struct arr_0) {24, constantarr_0_530};
		}
		case 339: {
			return (struct arr_0) {8, constantarr_0_108};
		}
...
struct arr_0 call_w_ctx_194(struct fun_act1_5 a, struct ctx* ctx, uint64_t p0) {
	...
	switch (_0.kind) {
		...
		case 1: {
			struct mut_arr_1__lambda0* closure1 = _0.as1;
			
			return mut_arr_1__lambda0(ctx, closure1, p0);
		}
		case 2: {
			struct copy__lambda0* closure2 = _0.as2;
			
			return copy__lambda0(ctx, closure2, p0);
		}
		default:
			return (struct arr_0) {0, NULL};
	}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	struct mut_arr_1 ingredients0;
	ingredients0 = mut_arr_1(ctx, (struct arr_1) {5, constantarr_1_0});
	
	struct arr_0 _0 = subscript_16(ctx, ingredients0, 2u);
	print(_0);
	set_subscript(ctx, ingredients0, 2u, (struct arr_0) {9, constantarr_0_15});
	struct arr_0 _1 = subscript_16(ctx, ingredients0, 2u);
	print(_1);
	struct arr_1 a1;
	a1 = arr(ctx, ingredients0);
	
	struct arr_0 _2 = subscript_0(ctx, a1, 3u);
	print(_2);
	struct mut_arr_1 slice2;
	struct arrow _3 = _arrow(ctx, 1u, 4u);
	slice2 = subscript_17(ctx, ingredients0, _3);
	
	set_subscript(ctx, ingredients0, 3u, (struct arr_0) {8, constantarr_0_14});
	struct arr_0 _4 = subscript_0(ctx, a1, 3u);
	struct arr_0 _5 = _concat(ctx, (struct arr_0) {6, constantarr_0_16}, _4);
	print(_5);
	struct arr_0 _6 = subscript_16(ctx, slice2, 2u);
	struct arr_0 _7 = _concat(ctx, (struct arr_0) {10, constantarr_0_17}, _6);
	print(_7);
	struct arr_0 _8 = subscript_16(ctx, ingredients0, 3u);
	struct arr_0 _9 = _concat(ctx, (struct arr_0) {16, constantarr_0_18}, _8);
	print(_9);
	return resolved_1(ctx, 0u);
}
/* mut-arr<arr<char>> mut-arr<arr<char>>(a arr<arr<char>>) */
struct mut_arr_1 mut_arr_1(struct ctx* ctx, struct arr_1 a) {
...
/* mut-arr<arr<char>>.lambda0 arr<char>(it nat) */
struct arr_0 mut_arr_1__lambda0(struct ctx* ctx, struct mut_arr_1__lambda0* _closure, uint64_t it) {
	return subscript_0(ctx, _closure->a, it);
}
/* subscript<arr<char>> arr<char>(a mut-arr<arr<char>>, index nat) */
struct arr_0 subscript_16(struct ctx* ctx, struct mut_arr_1 a, uint64_t index) {
	return subscript_0(ctx, a.inner, index);
}
/* set-subscript<arr<char>> void(a mut-arr<arr<char>>, index nat, value arr<char>) */
struct void_ set_subscript(struct ctx* ctx, struct mut_arr_1 a, uint64_t index, struct arr_0 value) {
	uint64_t _0 = size_2(a);
	uint8_t _1 = _less(index, _0);
	assert(ctx, _1);
...
/* arr<arr<char>> arr<arr<char>>(a mut-arr<arr<char>>) */
struct arr_1 arr(struct ctx* ctx, struct mut_arr_1 a) {
	struct mut_arr_1 _0 = copy(ctx, a);
	return _0.inner;
}
/* copy<?t> mut-arr<arr<char>>(a mut-arr<arr<char>>) */
struct mut_arr_1 copy(struct ctx* ctx, struct mut_arr_1 a) {
	uint64_t _0 = size_2(a);
	struct copy__lambda0* temp0;
	uint8_t* _1 = alloc(ctx, sizeof(struct copy__lambda0));
	temp0 = (struct copy__lambda0*) _1;
	
	*temp0 = (struct copy__lambda0) {a};
	return make_mut_arr(ctx, _0, (struct fun_act1_5) {2, .as2 = temp0});
}
/* copy<?t>.lambda0 arr<char>(it nat) */
struct arr_0 copy__lambda0(struct ctx* ctx, struct copy__lambda0* _closure, uint64_t it) {
	return subscript_16(ctx, _closure->a, it);
}
/* subscript<arr<char>> mut-arr<arr<char>>(a mut-arr<arr<char>>, range arrow<nat, nat>) */
struct mut_arr_1 subscript_17(struct ctx* ctx, struct mut_arr_1 a, struct arrow range) {
