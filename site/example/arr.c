...
char constantarr_0_50[11] = "deref<bool>";
char constantarr_0_51[9] = "set<bool>";
char constantarr_0_52[10] = "incr<bool>";
...
char constantarr_0_58[8] = "new-lock";
char constantarr_0_59[4] = "lock";
char constantarr_0_60[15] = "new-atomic-bool";
...
char constantarr_0_129[11] = "validate-gc";
char constantarr_0_130[18] = "ptr-less-eq?<bool>";
char constantarr_0_131[13] = "ptr-less?<?t>";
char constantarr_0_132[10] = "mark-begin";
char constantarr_0_133[8] = "mark-cur";
char constantarr_0_134[8] = "mark-end";
char constantarr_0_135[17] = "ptr-less-eq?<nat>";
char constantarr_0_136[11] = "ptr-eq?<?t>";
...
char constantarr_0_141[10] = "size-words";
char constantarr_0_142[6] = "+<nat>";
char constantarr_0_143[11] = "range-free?";
char constantarr_0_144[12] = "set-mark-cur";
char constantarr_0_145[12] = "set-data-cur";
char constantarr_0_146[15] = "some<ptr<nat8>>";
char constantarr_0_147[19] = "ptr-cast<nat8, nat>";
char constantarr_0_148[9] = "incr<nat>";
...
char constantarr_0_154[13] = "some<ptr<?t>>";
char constantarr_0_155[18] = "ptr-cast<?t, nat8>";
...
char constantarr_0_173[14] = "set<ptr<nat8>>";
char constantarr_0_174[12] = "+<ptr<nat8>>";
char constantarr_0_175[11] = "get-fun-ptr";
char constantarr_0_176[14] = "set<arr<char>>";
char constantarr_0_177[12] = "+<arr<char>>";
char constantarr_0_178[12] = "get-fun-name";
char constantarr_0_179[10] = "noctx-incr";
...
char constantarr_0_205[18] = "copy-data-from<?t>";
char constantarr_0_206[6] = "memcpy";
...
char constantarr_0_525[19] = "map<arr<char>, nat>";
char constantarr_0_526[27] = "map<arr<char>, nat>.lambda0";
char constantarr_0_527[14] = "subscript<nat>";
char constantarr_0_528[1] = "/";
char constantarr_0_529[3] = "mod";
char constantarr_0_530[10] = "unsafe-mod";
char constantarr_0_531[12] = "main.lambda0";
char constantarr_0_532[4] = "each";
char constantarr_0_533[20] = "subscript<void, nat>";
char constantarr_0_534[12] = "main.lambda1";
char constantarr_0_535[13] = "resolved<nat>";
uint64_t constantarr_2_0[5] = {0u, 1u, 2u, 3u, 4u};
...
struct arr_1 map_1(struct ctx* ctx, struct arr_2 a, struct fun_act1_5 mapper);
uint64_t subscript_16(struct ctx* ctx, struct arr_2 a, uint64_t index);
struct arr_0 map_1__lambda0(struct ctx* ctx, struct map_1__lambda0* _closure, uint64_t i);
struct arr_2 subscript_17(struct ctx* ctx, struct arr_2 a, struct arrow range);
...
struct arr_0 main_0__lambda0(struct ctx* ctx, struct void_ _closure, uint64_t it);
struct void_ each(struct ctx* ctx, struct arrow r, struct fun_act1_6 f);
struct void_ subscript_18(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0);
struct void_ call_w_ctx_341(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0);
struct void_ main_0__lambda1(struct ctx* ctx, struct void_ _closure, uint64_t x);
...
struct arr_0 get_fun_name_73(uint64_t fun_id) {switch (fun_id) {
		case 0: {
			return (struct arr_0) {4, constantarr_0_21};
		}
		case 1: {
		...
		case 5: {
			return (struct arr_0) {5, constantarr_0_34};
		}
		case 6: {
		...
		case 16: {
			return (struct arr_0) {8, constantarr_0_58};
		}
		case 17: {
			return (struct arr_0) {15, constantarr_0_60};
		}
		case 18: {
			return (struct arr_0) {13, constantarr_0_62};
		}
		case 19: {
			return (struct arr_0) {10, constantarr_0_65};
		}
		case 20: {
			return (struct arr_0) {14, constantarr_0_66};
		}
		case 21: {
			return (struct arr_0) {60, constantarr_0_69};
		}
		case 22: {
		...
		case 60: {
			return (struct arr_0) {17, constantarr_0_135};
		}
		case 61: {
		...
		case 92: {
			return (struct arr_0) {18, constantarr_0_205};
		}
		case 93: {
		...
		case 333: {
			return (struct arr_0) {27, constantarr_0_526};
		}
		case 334: {
		...
		case 340: {
			return (struct arr_0) {20, constantarr_0_533};
		}
		case 341: {
			return (struct arr_0) {0u, NULL};
		}
...
struct arr_0 call_w_ctx_194(struct fun_act1_5 a, struct ctx* ctx, uint64_t p0) {
	...
	switch (_0.kind) {
		...
		case 2: {
			...
			return main_0__lambda0(ctx, closure2, p0);
		}
		default:
			return (struct arr_0) {0, NULL};
	}
...
struct fut_0* main_0(struct ctx* ctx, struct arr_1 _p0) {
	struct arr_0 slice0;
	struct arrow _0 = _arrow(ctx, 1u, 4u);
	struct arr_2 _1 = subscript_17(ctx, (struct arr_2) {5, constantarr_2_0}, _0);
	struct arr_1 _2 = map_1(ctx, _1, (struct fun_act1_5) {2, .as2 = (struct void_) {}});
	slice0 = join(ctx, _2, (struct arr_0) {2, constantarr_0_20});
	
	struct arrow _3 = _arrow(ctx, 1u, 5u);
	each(ctx, _3, (struct fun_act1_6) {0, .as0 = (struct void_) {}});
	print(slice0);
	return resolved_1(ctx, 0u);
}
/* map<arr<char>, nat> arr<arr<char>>(a arr<nat>, mapper fun-act1<arr<char>, nat>) */
struct arr_1 map_1(struct ctx* ctx, struct arr_2 a, struct fun_act1_5 mapper) {
...
/* subscript<?in> nat(a arr<nat>, index nat) */
uint64_t subscript_16(struct ctx* ctx, struct arr_2 a, uint64_t index) {
	uint8_t _0 = _less(index, a.size);
	assert(ctx, _0);
	return noctx_at_3(a, index);
}
/* map<arr<char>, nat>.lambda0 arr<char>(i nat) */
struct arr_0 map_1__lambda0(struct ctx* ctx, struct map_1__lambda0* _closure, uint64_t i) {
	uint64_t _0 = subscript_16(ctx, _closure->a, i);
	return subscript_12(ctx, _closure->mapper, _0);
}
/* subscript<nat> arr<nat>(a arr<nat>, range arrow<nat, nat>) */
struct arr_2 subscript_17(struct ctx* ctx, struct arr_2 a, struct arrow range) {
	uint8_t _0 = _lessOrEqual(range.from, range.to);
	assert(ctx, _0);
	uint8_t _1 = _lessOrEqual(range.to, a.size);
...
/* main.lambda0 arr<char>(it nat) */
struct arr_0 main_0__lambda0(struct ctx* ctx, struct void_ _closure, uint64_t it) {
	return to_str_2(ctx, it);
}
/* each void(r arrow<nat, nat>, f fun-act1<void, nat>) */
struct void_ each(struct ctx* ctx, struct arrow r, struct fun_act1_6 f) {
	top:;
	uint8_t _0 = _less(r.from, r.to);
	if (_0) {
		subscript_18(ctx, f, r.from);
		uint64_t _1 = _plus_1(ctx, r.from, 1u);
		struct arrow _2 = _arrow(ctx, _1, r.to);
		r = _2;
		f = f;
		goto top;
	} else {
...
/* subscript<void, nat> void(a fun-act1<void, nat>, p0 nat) */
struct void_ subscript_18(struct ctx* ctx, struct fun_act1_6 a, uint64_t p0) {
	return call_w_ctx_341(a, ctx, p0);
}
...
struct void_ call_w_ctx_341(struct fun_act1_6 a, struct ctx* ctx, uint64_t p0) {
	...
	switch (_0.kind) {
		case 0: {
			...
			return main_0__lambda1(ctx, closure0, p0);
		}
		default:
			return (struct void_) {};
	}
}
/* main.lambda1 void(x nat) */
struct void_ main_0__lambda1(struct ctx* ctx, struct void_ _closure, uint64_t x) {
	struct arr_0 _0 = to_str_2(ctx, x);
	return print(_0);
}
